...
-- Ensure Level 3+ users can access their generated audio via signed URLs (policy already exists)
-- The text-to-speech edge function generates signed URLs with 24-hour expiry
-- Only Level 3+ users can call the function, so access is properly restricted