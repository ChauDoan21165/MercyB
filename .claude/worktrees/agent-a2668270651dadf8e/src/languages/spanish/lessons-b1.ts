...
export const lessons: SpanishLesson[] = [
  // ── 1. preterite_vs_imperfect — spanish_preterite_imperfect_contrast ──
  {
    ...
    vocabulary: [
      { word: "vivir", english: "to live", pronunciation: "bee-BEER", part_of_speech: "verb" },
      { word: "llover", english: "to rain (o→ue stem change in present)", pronunciation: "yoh-BEHR", part_of_speech: "verb" },
      { word: "salir", english: "to leave / go out (yo salgo present)", pronunciation: "sah-LEER", part_of_speech: "verb" },
      ...
      { word: "siempre", english: "always (habitual marker — pairs with imperfect)", pronunciation: "SYEHM-preh", part_of_speech: "adverb" },
      { word: "luego", english: "then / later (sequence marker — pairs with preterite)", pronunciation: "LWEH-goh", part_of_speech: "adverb" },
      { word: "anoche", english: "last night (specific time — pairs with preterite)", pronunciation: "ah-NOH-cheh", part_of_speech: "adverb" },
      { word: "de niño / de niña", english: "as a child (childhood frame — pairs with imperfect)", pronunciation: "deh NEE-nyoh / deh NEE-nyah", part_of_speech: "phrase" },
    ],
    grammar: [
      {
  ...
  // ── 2. preterite_vs_imperfect — spanish_preterite_imperfect_narrative ──
  {
    ...
    vocabulary: [
      { word: "pasear", english: "to walk / stroll", pronunciation: "pah-seh-AR", part_of_speech: "verb" },
      { word: "cenar", english: "to eat dinner / have supper", pronunciation: "seh-NAR", part_of_speech: "verb" },
      { word: "saludar", english: "to greet / say hi", pronunciation: "sah-loo-DAR", part_of_speech: "verb" },
      { word: "sentarse", english: "to sit down (reflexive, e→ie)", pronunciation: "sehn-TAR-seh", part_of_speech: "verb" },
      { word: "llegar", english: "to arrive (-gar spelling change in yo preterite)", pronunciation: "yeh-GAR", part_of_speech: "verb" },
      { word: "el parque", english: "the park", pronunciation: "ehl PAR-keh", part_of_speech: "noun", gender: "m" },
      { word: "el restaurante", english: "the restaurant", pronunciation: "ehl rehs-tow-RAHN-teh", part_of_speech: "noun", gender: "m" },
      { word: "la luz", english: "the light / the power (electricity)", pronunciation: "lah looth", part_of_speech: "noun", gender: "f" },
      { word: "de repente", english: "suddenly (storytelling adverb — flips to preterite)", pronunciation: "deh reh-PEHN-teh", part_of_speech: "phrase" },
      { word: "ya no", english: "no longer / not anymore", pronunciation: "yah noh", part_of_speech: "phrase" },
    ],
    grammar: [
      {
    ...
    dialogue: [
      { speaker: "Ana", spanish: "¿Qué tal el fin de semana?", english: "How was the weekend?", pronunciation: "keh tahl ehl feen deh seh-MAH-nah", register: "informal" },
      { speaker: "Carlos", spanish: "Pues, el sábado hacía buen tiempo, así que fuimos a la playa.", english: "Well, on Saturday the weather was good, so we went to the beach.", pronunciation: "pwehs, ehl SAH-bah-doh ah-SEE-ah bwehn TYEHM-poh, ah-SEE keh FWEE-mohs ah lah PLAH-yah", register: "informal" },
      { speaker: "Ana", spanish: "¿Y qué hicisteis allí?", english: "And what did you all do there?", pronunciation: "ee keh ee-SEES-tehs ah-YEE", register: "informal" },
      { speaker: "Carlos", spanish: "Pues nada — nadamos un poco, comimos, dormimos la siesta. Estábamos muy relajados.", english: "Not much — we swam a bit, ate, took a nap. We were very relaxed.", pronunciation: "pwehs NAH-dah — nah-DAH-mohs oon POH-koh, koh-MEE-mohs, dohr-MEE-mohs lah SYEHS-tah. ehs-TAH-bah-mohs MOO-ee reh-lah-HAH-dohs", register: "informal" },
      { speaker: "Ana", spanish: "Suena perfecto.", english: "Sounds perfect.", pronunciation: "SWEH-nah pehr-FEHK-toh", register: "informal" },
    ],
    cultural_note:
  ...
  // ── 3. preterite_vs_imperfect — spanish_preterite_imperfect_meaning_change ──
  {
    ...
    vocabulary: [
      { word: "saber", english: "to know (a fact) — preterite: to find out", pronunciation: "sah-BEHR", part_of_speech: "verb" },
      { word: "conocer", english: "to know (person/place) — preterite: to meet", pronunciation: "koh-noh-SEHR", part_of_speech: "verb" },
      { word: "querer", english: "to want (e→ie) — preterite querer: to try / no querer: to refuse", pronunciation: "keh-REHR", part_of_speech: "verb" },
      { word: "poder", english: "to be able (o→ue) — preterite: to manage / no poder: to fail", pronunciation: "poh-DEHR", part_of_speech: "verb" },
      { word: "tener", english: "to have (e→ie) — preterite: to get / receive", pronunciation: "teh-NEHR", part_of_speech: "verb" },
      { word: "la respuesta", english: "the answer", pronunciation: "lah rrehs-PWEHS-tah", part_of_speech: "noun", gender: "f" },
      { word: "la pista", english: "the clue / hint", pronunciation: "lah PEES-tah", part_of_speech: "noun", gender: "f" },
      { word: "olvidar", english: "to forget", pronunciation: "ohl-bee-DAR", part_of_speech: "verb" },
      { word: "el accidente", english: "the accident", pronunciation: "ehl ahk-see-DEHN-teh", part_of_speech: "noun", gender: "m" },
      { word: "joven", english: "young", pronunciation: "HOH-behn", part_of_speech: "adjective" },
    ],
    grammar: [
      {
  ...
  // ── 4. preterite_vs_imperfect — spanish_preterite_imperfect_time_markers ──
  {
    ...
    vocabulary: [
      { word: "ayer", english: "yesterday (preterite trigger)", pronunciation: "ah-YEHR", part_of_speech: "adverb" },
      { word: "anoche", english: "last night (preterite trigger)", pronunciation: "ah-NOH-cheh", part_of_speech: "adverb" },
      { word: "siempre", english: "always (imperfect trigger)", pronunciation: "SYEHM-preh", part_of_speech: "adverb" },
      { word: "todos los días", english: "every day (imperfect trigger)", pronunciation: "TOH-dohs lohs DEE-ahs", part_of_speech: "phrase" },
      { word: "una vez", english: "once / one time (preterite trigger — bounded)", pronunciation: "OO-nah behs", part_of_speech: "phrase" },
      { word: "mientras", english: "while (imperfect trigger on its side)", pronunciation: "MYEHN-trahs", part_of_speech: "conjunction" },
      { word: "de repente", english: "suddenly (preterite trigger)", pronunciation: "deh reh-PEHN-teh", part_of_speech: "phrase" },
      { word: "a menudo", english: "often (imperfect trigger)", pronunciation: "ah meh-NOO-doh", part_of_speech: "phrase" },
      { word: "el lunes pasado", english: "last Monday (specific time — preterite)", pronunciation: "ehl LOO-nehs pah-SAH-doh", part_of_speech: "phrase" },
      { word: "de pequeño / de niño", english: "as a kid (imperfect trigger)", pronunciation: "deh peh-KEH-nyoh / deh NEE-nyoh", part_of_speech: "phrase" },
    ],
    grammar: [
      {
  ...
  // ── 5. subjunctive_intro — spanish_subjunctive_forms ──────────────────────
  {
    ...
    vocabulary: [
      { word: "hablar", english: "to speak — subj: hable, hables, hable, hablemos, habléis, hablen", pronunciation: "ah-BLAR", part_of_speech: "verb" },
      { word: "comer", english: "to eat — subj: coma, comas, coma, comamos, comáis, coman", pronunciation: "koh-MEHR", part_of_speech: "verb" },
      { word: "vivir", english: "to live — subj: viva, vivas, viva, vivamos, viváis, vivan", pronunciation: "bee-BEER", part_of_speech: "verb" },
      { word: "ser", english: "to be (essence) — DIRTY SIX subj: sea, seas, sea, seamos, seáis, sean", pronunciation: "sehr", part_of_speech: "verb" },
      { word: "estar", english: "to be (state) — DIRTY SIX subj: esté, estés, esté, estemos, estéis, estén", pronunciation: "ehs-TAR", part_of_speech: "verb" },
      { word: "ir", english: "to go — DIRTY SIX subj: vaya, vayas, vaya, vayamos, vayáis, vayan", pronunciation: "eer", part_of_speech: "verb" },
      { word: "saber", english: "to know — DIRTY SIX subj: sepa, sepas, sepa, sepamos, sepáis, sepan", pronunciation: "sah-BEHR", part_of_speech: "verb" },
      { word: "dar", english: "to give — DIRTY SIX subj: dé, des, dé, demos, deis, den", pronunciation: "dahr", part_of_speech: "verb" },
      { word: "haber", english: "auxiliary 'have' — DIRTY SIX subj: haya, hayas, haya, hayamos, hayáis, hayan", pronunciation: "ah-BEHR", part_of_speech: "verb" },
      { word: "tener", english: "to have (yo-form rule) — subj: tenga, tengas, tenga, tengamos, tengáis, tengan", pronunciation: "teh-NEHR", part_of_speech: "verb" },
      { word: "ojalá", english: "I hope / hopefully (always triggers subjunctive)", pronunciation: "oh-hah-LAH", part_of_speech: "interjection" },
    ],
    grammar: [
      {
  ...
  // ── 6. subjunctive_intro — spanish_subjunctive_volition ───────────────────
  {
    ...
    vocabulary: [
      { word: "querer", english: "to want (e→ie) — volition trigger", pronunciation: "keh-REHR", part_of_speech: "verb" },
      { word: "preferir", english: "to prefer (e→ie) — volition trigger", pronunciation: "preh-feh-REER", part_of_speech: "verb" },
      { word: "esperar", english: "to hope / to wait — volition trigger when meaning 'hope'", pronunciation: "ehs-peh-RAR", part_of_speech: "verb" },
      { word: "desear", english: "to desire / wish — volition trigger", pronunciation: "deh-seh-AR", part_of_speech: "verb" },
      { word: "recomendar", english: "to recommend (e→ie) — volition trigger", pronunciation: "rreh-koh-mehn-DAR", part_of_speech: "verb" },
      { word: "sugerir", english: "to suggest (e→ie) — volition trigger", pronunciation: "soo-heh-REER", part_of_speech: "verb" },
      { word: "aconsejar", english: "to advise — volition trigger", pronunciation: "ah-kohn-seh-HAR", part_of_speech: "verb" },
      { word: "pedir", english: "to ask (for / to do) (e→i) — volition trigger", pronunciation: "peh-DEER", part_of_speech: "verb" },
      { word: "decir que", english: "'tell to do' (volition) vs 'say that' (indicative) — context disambiguates", pronunciation: "deh-SEER keh", part_of_speech: "phrase" },
      { word: "ojalá (que)", english: "I hope / hopefully — ALWAYS subjunctive, no exceptions", pronunciation: "oh-hah-LAH (keh)", part_of_speech: "interjection" },
    ],
    grammar: [
      {
  ...
  // ── 7. subjunctive_intro — spanish_subjunctive_emotion ────────────────────
  {
    ...
    vocabulary: [
      { word: "alegrarse de", english: "to be glad / happy about", pronunciation: "ah-leh-GRAR-seh deh", part_of_speech: "verb" },
      { word: "me alegra", english: "it makes me happy (gustar-style)", pronunciation: "meh ah-LEH-grah", part_of_speech: "phrase" },
      { word: "tener miedo de", english: "to be afraid of / that", pronunciation: "teh-NEHR MYEH-doh deh", part_of_speech: "phrase" },
      { word: "es una pena que", english: "it's a shame / pity that", pronunciation: "ehs OO-nah PEH-nah keh", part_of_speech: "phrase" },
      { word: "es una lástima que", english: "it's a pity that", pronunciation: "ehs OO-nah LAHS-tee-mah keh", part_of_speech: "phrase" },
      { word: "me molesta que", english: "it bothers me that", pronunciation: "meh moh-LEHS-tah keh", part_of_speech: "phrase" },
      { word: "me preocupa que", english: "it worries me that", pronunciation: "meh preh-oh-KOO-pah keh", part_of_speech: "phrase" },
      { word: "me sorprende que", english: "it surprises me that", pronunciation: "meh sohr-PREHN-deh keh", part_of_speech: "phrase" },
      { word: "qué bien que", english: "how nice that (exclamation)", pronunciation: "keh byehn keh", part_of_speech: "phrase" },
      { word: "aprobar", english: "to pass (an exam) (o→ue)", pronunciation: "ah-proh-BAR", part_of_speech: "verb" },
    ],
    grammar: [
      {
  ...
  // ── 8. subjunctive_intro — spanish_subjunctive_doubt ──────────────────────
  {
    ...
    vocabulary: [
      { word: "creer", english: "to believe / think — indicative when affirmative, subjunctive when negated", pronunciation: "kreh-EHR", part_of_speech: "verb" },
      { word: "pensar", english: "to think (e→ie) — same flip rule as creer", pronunciation: "pehn-SAR", part_of_speech: "verb" },
      { word: "parecer", english: "to seem — 'me parece que' flips same way", pronunciation: "pah-reh-SEHR", part_of_speech: "verb" },
      { word: "dudar", english: "to doubt — triggers subjunctive (no dudar goes back to indicative)", pronunciation: "doo-DAR", part_of_speech: "verb" },
      { word: "negar", english: "to deny (e→ie) — triggers subjunctive (no negar back to indicative)", pronunciation: "neh-GAR", part_of_speech: "verb" },
      { word: "es posible que", english: "it's possible that — subjunctive trigger", pronunciation: "ehs poh-SEE-bleh keh", part_of_speech: "phrase" },
      { word: "es probable que", english: "it's likely that — subjunctive trigger", pronunciation: "ehs proh-BAH-bleh keh", part_of_speech: "phrase" },
      { word: "puede que", english: "maybe / it may be that — subjunctive trigger", pronunciation: "PWEH-deh keh", part_of_speech: "phrase" },
      { word: "quizás / quizá / tal vez", english: "perhaps / maybe — subjunctive triggers", pronunciation: "kee-SAHS / kee-SAH / tahl behs", part_of_speech: "phrase" },
      { word: "a lo mejor", english: "maybe (the indicative exception)", pronunciation: "ah loh meh-HOR", part_of_speech: "phrase" },
    ],
    grammar: [
      {
  ...
  // ── 9. future_conditional — spanish_future_probability ────────────────────
  {
    ...
    vocabulary: [
      { word: "el gimnasio", english: "the gym", pronunciation: "ehl heem-NAH-syoh", part_of_speech: "noun", gender: "m" },
      { word: "tener (irregular future)", english: "tener → tendré, tendrás, tendrá, tendremos, tendréis, tendrán", pronunciation: "teh-NEHR", part_of_speech: "verb" },
      { word: "salir (irregular future)", english: "salir → saldré, saldrás, saldrá, saldremos, saldréis, saldrán", pronunciation: "sah-LEER", part_of_speech: "verb" },
      { word: "poner (irregular future)", english: "poner → pondré, pondrás, pondrá, pondremos, pondréis, pondrán", pronunciation: "poh-NEHR", part_of_speech: "verb" },
      { word: "venir (irregular future)", english: "venir → vendré, vendrás, vendrá, vendremos, vendréis, vendrán", pronunciation: "beh-NEER", part_of_speech: "verb" },
      { word: "hacer (irregular future)", english: "hacer → haré, harás, hará, haremos, haréis, harán", pronunciation: "ah-SEHR", part_of_speech: "verb" },
      { word: "decir (irregular future)", english: "decir → diré, dirás, dirá, diremos, diréis, dirán", pronunciation: "deh-SEER", part_of_speech: "verb" },
      { word: "haber (irregular future)", english: "haber → habré, habrás, habrá, habremos, habréis, habrán", pronunciation: "ah-BEHR", part_of_speech: "verb" },
      { word: "querer (irregular future)", english: "querer → querré, querrás, querrá, querremos, querréis, querrán", pronunciation: "keh-REHR", part_of_speech: "verb" },
      { word: "saber (irregular future)", english: "saber → sabré, sabrás, sabrá, sabremos, sabréis, sabrán", pronunciation: "sah-BEHR", part_of_speech: "verb" },
    ],
    grammar: [
      {
  ...
  // ── 10. future_conditional — spanish_conditional_politeness ──────────────
  {
    ...
    vocabulary: [
      { word: "gustar (conditional)", english: "me gustaría = I would like (polite alternative to quiero)", pronunciation: "goos-tah-REE-ah", part_of_speech: "verb" },
      { word: "poder (conditional)", english: "podría = I/he/she could; podrías = you could (polite)", pronunciation: "poh-DREE-ah(s)", part_of_speech: "verb" },
      { word: "deber (conditional)", english: "debería = should (polite advice)", pronunciation: "deh-beh-REE-ah", part_of_speech: "verb" },
      { word: "querer (conditional)", english: "querría = would like (slightly more formal than gustaría)", pronunciation: "keh-RREE-ah", part_of_speech: "verb" },
      { word: "importar (conditional)", english: "¿te importaría? = would you mind?", pronunciation: "eem-por-tah-REE-ah", part_of_speech: "verb" },
      { word: "hacer (conditional)", english: "haría = I would do (irregular: har- stem)", pronunciation: "ah-REE-ah", part_of_speech: "verb" },
      { word: "decir (conditional)", english: "diría = I would say (irregular: dir- stem)", pronunciation: "dee-REE-ah", part_of_speech: "verb" },
      { word: "tener (conditional)", english: "tendría = I would have (irregular: tendr- stem)", pronunciation: "tehn-DREE-ah", part_of_speech: "verb" },
      { word: "venir (conditional)", english: "vendría = I would come (irregular: vendr- stem)", pronunciation: "behn-DREE-ah", part_of_speech: "verb" },
      { word: "en tu lugar", english: "in your place / if I were you", pronunciation: "ehn too loo-GAR", part_of_speech: "phrase" },
    ],
    grammar: [
      {
    ...
    dialogue: [
      { speaker: "Camarero", spanish: "¿Qué van a tomar?", english: "What will you have?", pronunciation: "keh bahn ah toh-MAR", register: "formal" },
      { speaker: "Cliente", spanish: "Me gustaría una caña, por favor.", english: "I'd like a small beer, please.", pronunciation: "meh goos-tah-REE-ah OO-nah KAH-nyah, por fah-BOR", register: "formal" },
      { speaker: "Camarero", spanish: "Muy bien. ¿Algo de comer?", english: "Very good. Anything to eat?", pronunciation: "MOO-ee byehn. AHL-goh deh koh-MEHR", register: "formal" },
      { speaker: "Cliente", spanish: "¿Podría traernos la carta?", english: "Could you bring us the menu?", pronunciation: "poh-DREE-ah trah-EHR-nohs lah KAR-tah", register: "formal" },
      { speaker: "Camarero", spanish: "Por supuesto, ahora mismo.", english: "Of course, right away.", pronunciation: "por soo-PWEHS-toh, ah-OH-rah MEES-moh", register: "formal" },
    ],
    cultural_note:
  ...
  // ── 11. future_conditional — spanish_si_conditionals ──────────────────────
  {
    ...
    vocabulary: [
      { word: "si", english: "if (NEVER followed by future or present subjunctive)", pronunciation: "see", part_of_speech: "conjunction" },
      { word: "tener (imperfect subjunctive)", english: "tener → tuviera, tuvieras, tuviera, tuviéramos, tuvierais, tuvieran (also -se forms: tuviese, tuvieses…)", pronunciation: "teh-NEHR", part_of_speech: "verb" },
      { word: "ser / ir (imperfect subjunctive)", english: "ser and ir share: fuera, fueras, fuera, fuéramos, fuerais, fueran", pronunciation: "sehr / eer", part_of_speech: "verb" },
      { word: "estar (imperfect subjunctive)", english: "estuviera, estuvieras, estuviera, estuviéramos, estuvierais, estuvieran", pronunciation: "ehs-TAR", part_of_speech: "verb" },
      { word: "haber (imperfect subjunctive)", english: "hubiera, hubieras, hubiera, hubiéramos, hubierais, hubieran (used for Type 3 conditionals)", pronunciation: "ah-BEHR", part_of_speech: "verb" },
      { word: "el mundo", english: "the world", pronunciation: "ehl MOON-doh", part_of_speech: "noun", gender: "m" },
      { word: "viajar", english: "to travel", pronunciation: "byah-HAR", part_of_speech: "verb" },
      { word: "directamente", english: "directly", pronunciation: "dee-rehk-tah-MEHN-teh", part_of_speech: "adverb" },
      { word: "la verdad", english: "the truth", pronunciation: "lah behr-DAHD", part_of_speech: "noun", gender: "f" },
      { word: "yo que tú", english: "if I were you (literally: I who you)", pronunciation: "yoh keh too", part_of_speech: "phrase" },
    ],
    grammar: [
      {
  ...
  // ── 12. por_vs_para — spanish_por_para_core ───────────────────────────────
  {
    ...
    vocabulary: [
      { word: "para", english: "for / to / toward (forward: destination, recipient, goal, deadline)", pronunciation: "PAH-rah", part_of_speech: "preposition" },
      { word: "por", english: "for / through / by / because of (backward/around: cause, route, exchange, means, duration)", pronunciation: "por", part_of_speech: "preposition" },
      { word: "el regalo", english: "the gift / present", pronunciation: "ehl rreh-GAH-loh", part_of_speech: "noun", gender: "m" },
      { word: "salir para", english: "to leave for (a destination)", pronunciation: "sah-LEER PAH-rah", part_of_speech: "phrase" },
      { word: "pasar por", english: "to pass through / by", pronunciation: "pah-SAR por", part_of_speech: "phrase" },
      { word: "estudiar", english: "to study", pronunciation: "ehs-too-DYAR", part_of_speech: "verb" },
      { word: "el camino", english: "the way / road / path", pronunciation: "ehl kah-MEE-noh", part_of_speech: "noun", gender: "m" },
      { word: "gracias por", english: "thanks for (always por for thanks)", pronunciation: "GRAH-syahs por", part_of_speech: "phrase" },
      { word: "para + infinitive", english: "in order to (purpose construction)", pronunciation: "PAH-rah", part_of_speech: "phrase" },
      { word: "la familia", english: "the family", pronunciation: "lah fah-MEE-lyah", part_of_speech: "noun", gender: "f" },
    ],
    grammar: [
      {
  ...
  // ── 13. por_vs_para — spanish_por_para_time ──────────────────────────────
  {
    ...
    vocabulary: [
      { word: "por dos horas / durante dos horas", english: "for two hours (duration — both forms work, durante is more LatAm)", pronunciation: "por dohs OH-rahs / doo-RAHN-teh dohs OH-rahs", part_of_speech: "phrase" },
      { word: "para el viernes", english: "by/for Friday (deadline)", pronunciation: "PAH-rah ehl BYEHR-nehs", part_of_speech: "phrase" },
      { word: "por la mañana", english: "in the morning (Spain default; LatAm often: en la mañana)", pronunciation: "por lah mah-NYAH-nah", part_of_speech: "phrase" },
      { word: "por la tarde", english: "in the afternoon", pronunciation: "por lah TAR-deh", part_of_speech: "phrase" },
      { word: "por la noche", english: "at night", pronunciation: "por lah NOH-cheh", part_of_speech: "phrase" },
      { word: "para mañana", english: "by/for tomorrow (deadline)", pronunciation: "PAH-rah mah-NYAH-nah", part_of_speech: "phrase" },
      { word: "el informe", english: "the report", pronunciation: "ehl een-FOR-meh", part_of_speech: "noun", gender: "m" },
      { word: "el proyecto", english: "the project", pronunciation: "ehl proh-YEHK-toh", part_of_speech: "noun", gender: "m" },
      { word: "sobre", english: "around (approximate time)", pronunciation: "SOH-breh", part_of_speech: "preposition" },
      { word: "necesitar", english: "to need", pronunciation: "neh-seh-see-TAR", part_of_speech: "verb" },
    ],
    grammar: [
      {
  ...
  // ── 14. por_vs_para — spanish_por_para_purpose_cause ─────────────────────
  {
    ...
    vocabulary: [
      { word: "ganar", english: "to earn / win", pronunciation: "gah-NAR", part_of_speech: "verb" },
      { word: "el dinero", english: "the money", pronunciation: "ehl dee-NEH-roh", part_of_speech: "noun", gender: "m" },
      { word: "la necesidad", english: "the necessity / need", pronunciation: "lah neh-seh-see-DAHD", part_of_speech: "noun", gender: "f" },
      { word: "el gusto", english: "the taste / pleasure", pronunciation: "ehl GOOS-toh", part_of_speech: "noun", gender: "m" },
      { word: "castigar", english: "to punish (-gar spelling change in yo preterite)", pronunciation: "kahs-tee-GAR", part_of_speech: "verb" },
      { word: "sacar", english: "to get / take out (-car spelling change)", pronunciation: "sah-KAR", part_of_speech: "verb" },
      { word: "la nota", english: "the grade / note", pronunciation: "lah NOH-tah", part_of_speech: "noun", gender: "f" },
      { word: "enfermo / enferma", english: "sick / ill", pronunciation: "ehn-FEHR-moh / ehn-FEHR-mah", part_of_speech: "adjective" },
      { word: "por eso", english: "that's why / for that reason", pronunciation: "por EH-soh", part_of_speech: "phrase" },
      { word: "para que", english: "in order that / so that (always followed by subjunctive)", pronunciation: "PAH-rah keh", part_of_speech: "conjunction" },
    ],
    grammar: [
      {
  ...
  // ── 15. travel — spanish_travel_hotel ─────────────────────────────────────
  {
    ...
    vocabulary: [
      { word: "la reserva", english: "the reservation (general / Spain)", pronunciation: "lah rreh-SEHR-bah", part_of_speech: "noun", gender: "f" },
      { word: "la habitación", english: "the (hotel) room", pronunciation: "lah ah-bee-tah-SYOHN", part_of_speech: "noun", gender: "f" },
      { word: "el desayuno", english: "the breakfast", pronunciation: "ehl deh-sah-YOO-noh", part_of_speech: "noun", gender: "m" },
      { word: "la llave", english: "the key", pronunciation: "lah YAH-beh", part_of_speech: "noun", gender: "f" },
      { word: "el ascensor", english: "the elevator (Spain, most LatAm)", pronunciation: "ehl ah-sehn-SOR", part_of_speech: "noun", gender: "m" },
      { word: "la planta", english: "the floor (level) — Spain default; LatAm often: el piso", pronunciation: "lah PLAHN-tah", part_of_speech: "noun", gender: "f" },
      { word: "con vistas a", english: "with views of (always plural 'vistas')", pronunciation: "kohn BEES-tahs ah", part_of_speech: "phrase" },
      { word: "el aire acondicionado", english: "air conditioning", pronunciation: "ehl AH-ee-reh ah-kohn-dee-syoh-NAH-doh", part_of_speech: "noun", gender: "m" },
      { word: "el wifi", english: "the wifi (la contraseña = the password)", pronunciation: "ehl WEE-fee", part_of_speech: "noun", gender: "m" },
      { word: "el documento de identidad", english: "the ID (required at check-in by law in Spain)", pronunciation: "ehl doh-koo-MEHN-toh deh ee-dehn-tee-DAHD", part_of_speech: "noun", gender: "m" },
    ],
    grammar: [
      {
    ...
    dialogue: [
      { speaker: "Recepcionista", spanish: "Buenas tardes, ¿en qué puedo ayudarle?", english: "Good afternoon, how can I help you?", pronunciation: "BWEH-nahs TAR-dehs, ehn keh PWEH-doh ah-yoo-DAR-leh", register: "formal" },
      { speaker: "Cliente", spanish: "Buenas tardes. Tengo una reserva a nombre de López.", english: "Good afternoon. I have a reservation under the name López.", pronunciation: "BWEH-nahs TAR-dehs. TEHN-goh OO-nah rreh-SEHR-bah ah NOHM-breh deh LOH-pehs", register: "formal" },
      { speaker: "Recepcionista", spanish: "Perfecto. Su documento de identidad, por favor.", english: "Perfect. Your ID, please.", pronunciation: "pehr-FEHK-toh. soo doh-koo-MEHN-toh deh ee-dehn-tee-DAHD, por fah-BOR", register: "formal" },
      { speaker: "Cliente", spanish: "Aquí lo tiene. ¿A qué hora es el desayuno?", english: "Here you go. What time is breakfast?", pronunciation: "ah-KEE loh TYEH-neh. ah keh OH-rah ehs ehl deh-sah-YOO-noh", register: "formal" },
      { speaker: "Recepcionista", spanish: "De siete a diez, en el comedor de la planta baja.", english: "From seven to ten, in the dining room on the ground floor.", pronunciation: "deh SYEH-teh ah DYEHS, ehn ehl koh-meh-DOR deh lah PLAHN-tah BAH-hah", register: "formal" },
      { speaker: "Cliente", spanish: "Muy bien. ¿Me podría dar la llave del wifi también?", english: "Great. Could you also give me the wifi key?", pronunciation: "MOO-ee byehn. meh poh-DREE-ah dahr lah YAH-beh dehl WEE-fee tahm-BYEHN", register: "formal" },
    ],
    cultural_note:
  ...
  // ── 16. travel — spanish_travel_complaints ────────────────────────────────
  {
    ...
    vocabulary: [
      { word: "el problema", english: "the problem", pronunciation: "ehl proh-BLEH-mah", part_of_speech: "noun", gender: "m" },
      { word: "funcionar", english: "to work / function (for things, not people)", pronunciation: "foon-syoh-NAR", part_of_speech: "verb" },
      { word: "el gerente / la gerente", english: "the manager", pronunciation: "ehl heh-REHN-teh", part_of_speech: "noun", gender: "mf" },
      { word: "el encargado / la encargada", english: "the person in charge", pronunciation: "ehl ehn-kar-GAH-doh", part_of_speech: "noun", gender: "mf" },
      { word: "la hoja de reclamaciones", english: "official complaints form (Spain — legally required)", pronunciation: "lah OH-hah deh rreh-klah-mah-SYOH-nehs", part_of_speech: "noun", gender: "f" },
      { word: "el reembolso", english: "the refund", pronunciation: "ehl rreh-ehm-BOL-soh", part_of_speech: "noun", gender: "m" },
      { word: "la devolución", english: "the return / refund (LatAm common alternative)", pronunciation: "lah deh-boh-loo-SYOHN", part_of_speech: "noun", gender: "f" },
      { word: "las molestias", english: "the inconvenience (always plural in this fixed phrase)", pronunciation: "lahs moh-LEHS-tyahs", part_of_speech: "noun", gender: "f" },
      { word: "inaceptable", english: "unacceptable", pronunciation: "ee-nah-sehp-TAH-bleh", part_of_speech: "adjective" },
      { word: "esperar (imperfect)", english: "esperaba = was expecting (polite complaint frame)", pronunciation: "ehs-peh-RAH-bah", part_of_speech: "verb" },
    ],
    grammar: [
      {
    ...
    dialogue: [
      { speaker: "Cliente", spanish: "Disculpe, llevo media hora esperando y nadie me atiende.", english: "Excuse me, I've been waiting half an hour and no one is helping me.", pronunciation: "dees-KOOL-peh, YEH-boh MEH-dyah OH-rah ehs-peh-RAHN-doh ee NAH-dyeh meh ah-TYEHN-deh", register: "formal" },
      { speaker: "Empleado", spanish: "Disculpe la espera. ¿En qué puedo ayudarle?", english: "Sorry for the wait. How can I help you?", pronunciation: "dees-KOOL-peh lah ehs-PEH-rah. ehn keh PWEH-doh ah-yoo-DAR-leh", register: "formal" },
      { speaker: "Cliente", spanish: "El vuelo está cancelado y nadie me ha dado información.", english: "The flight is cancelled and no one has given me any information.", pronunciation: "ehl BWEH-loh ehs-TAH kahn-seh-LAH-doh ee NAH-dyeh meh ah DAH-doh een-for-mah-SYOHN", register: "formal" },
      { speaker: "Empleado", spanish: "Lo siento mucho. Voy a comprobar las opciones de reembolso.", english: "I'm very sorry. I'll check the refund options.", pronunciation: "loh SYEHN-toh MOO-choh. boy ah kohm-proh-BAR lahs ohp-SYOH-nehs deh rreh-ehm-BOL-soh", register: "formal" },
      { speaker: "Cliente", spanish: "Si no se resuelve hoy, voy a pedir una hoja de reclamaciones.", english: "If it doesn't get resolved today, I'm going to ask for a complaints form.", pronunciation: "see noh seh rreh-SWEHL-beh oy, boy ah peh-DEER OO-nah OH-hah deh rreh-klah-mah-SYOH-nehs", register: "formal" },
    ],
    cultural_note:
  ...
  // ── 17. work — spanish_work_office ────────────────────────────────────────
  {
    ...
    vocabulary: [
      { word: "la reunión", english: "the meeting", pronunciation: "lah rreh-oo-NYOHN", part_of_speech: "noun", gender: "f" },
      { word: "el correo (electrónico)", english: "the email (full form: correo electrónico)", pronunciation: "ehl koh-RREH-oh", part_of_speech: "noun", gender: "m" },
      { word: "el informe", english: "the report", pronunciation: "ehl een-FOR-meh", part_of_speech: "noun", gender: "m" },
      { word: "el plazo", english: "the deadline / time limit", pronunciation: "ehl PLAH-soh", part_of_speech: "noun", gender: "m" },
      { word: "entregar", english: "to deliver / hand in", pronunciation: "ehn-treh-GAR", part_of_speech: "verb" },
      { word: "adjuntar", english: "to attach (a file)", pronunciation: "ahd-hoon-TAR", part_of_speech: "verb" },
      { word: "reenviar", english: "to forward (an email)", pronunciation: "rreh-ehn-byar", part_of_speech: "verb" },
      { word: "el / la jefe / jefa", english: "the boss", pronunciation: "ehl HEH-feh / lah HEH-fah", part_of_speech: "noun", gender: "mf" },
      { word: "el compañero / la compañera", english: "the coworker / colleague", pronunciation: "ehl kohm-pah-NYEH-roh / lah kohm-pah-NYEH-rah", part_of_speech: "noun", gender: "mf" },
      { word: "quedo a su disposición", english: "I remain at your disposal (formal sign-off)", pronunciation: "KEH-doh ah soo dees-poh-see-SYOHN", part_of_speech: "phrase" },
      { word: "atentamente", english: "sincerely / regards (formal email closing)", pronunciation: "ah-tehn-tah-MEHN-teh", part_of_speech: "adverb" },
      { word: "un saludo", english: "regards (less formal email closing)", pronunciation: "oon sah-LOO-doh", part_of_speech: "phrase" },
    ],
    grammar: [
      {
    ...
    dialogue: [
      { speaker: "Jefa", spanish: "¿Tienes el informe listo para la reunión?", english: "Do you have the report ready for the meeting?", pronunciation: "TYEH-nehs ehl een-FOR-meh LEES-toh PAH-rah lah rreh-oo-NYOHN", register: "informal" },
      { speaker: "Empleado", spanish: "Casi. Lo estoy revisando ahora mismo.", english: "Almost. I'm reviewing it right now.", pronunciation: "KAH-see. loh ehs-TOY rreh-bee-SAHN-doh ah-OH-rah MEES-moh", register: "informal" },
      { speaker: "Jefa", spanish: "Vale, perfecto. Recuerda copiar a Marta cuando lo envíes.", english: "Okay, perfect. Remember to copy Marta when you send it.", pronunciation: "BAH-leh, pehr-FEHK-toh. rreh-KWEHR-dah koh-PYAR ah MAR-tah KWAHN-doh loh ehn-BEE-ehs", register: "informal" },
      { speaker: "Empleado", spanish: "Sin problema. ¿A qué hora es la reunión?", english: "No problem. What time is the meeting?", pronunciation: "seen proh-BLEH-mah. ah keh OH-rah ehs lah rreh-oo-NYOHN", register: "informal" },
      { speaker: "Jefa", spanish: "A las once. Nos vemos en la sala dos.", english: "At eleven. See you in meeting room two.", pronunciation: "ah lahs OHN-seh. nohs BEH-mohs ehn lah SAH-lah dohs", register: "informal" },
    ],
    cultural_note:
  ...
  // ── 18. work — spanish_work_interviews ────────────────────────────────────
  {
    ...
    vocabulary: [
      { word: "el currículum / el CV", english: "the CV / résumé (full form: curriculum vitae)", pronunciation: "ehl koo-RREE-koo-loom / ehl seh BEH", part_of_speech: "noun", gender: "m" },
      { word: "el puesto (de trabajo)", english: "the position / job", pronunciation: "ehl PWEHS-toh", part_of_speech: "noun", gender: "m" },
      { word: "la entrevista", english: "the interview", pronunciation: "lah ehn-treh-BEES-tah", part_of_speech: "noun", gender: "f" },
      { word: "la empresa", english: "the company / business", pronunciation: "lah ehm-PREH-sah", part_of_speech: "noun", gender: "f" },
      { word: "contratar", english: "to hire", pronunciation: "kohn-trah-TAR", part_of_speech: "verb" },
      { word: "la experiencia", english: "the experience", pronunciation: "lah ehks-peh-RYEHN-syah", part_of_speech: "noun", gender: "f" },
      { word: "el sueldo / el salario", english: "the salary / wage", pronunciation: "ehl SWEHL-doh / ehl sah-LAH-ryoh", part_of_speech: "noun", gender: "m" },
      { word: "la debilidad", english: "the weakness", pronunciation: "lah deh-bee-lee-DAHD", part_of_speech: "noun", gender: "f" },
      { word: "el punto fuerte", english: "the strength / strong point", pronunciation: "ehl POON-toh FWEHR-teh", part_of_speech: "noun", gender: "m" },
      { word: "resolutivo / resolutiva", english: "resourceful / good at solving problems", pronunciation: "rreh-soh-loo-TEE-boh / rreh-soh-loo-TEE-bah", part_of_speech: "adjective" },
      { word: "comprometido / comprometida", english: "committed / engaged (positive — not 'compromised'!)", pronunciation: "kohm-proh-meh-TEE-doh / kohm-proh-meh-TEE-dah", part_of_speech: "adjective" },
      { word: "incorporación", english: "start date (literal: incorporation)", pronunciation: "een-kor-poh-rah-SYOHN", part_of_speech: "noun", gender: "f" },
    ],
    grammar: [
      {
  ...
  // ── 19. health — spanish_health_doctor ────────────────────────────────────
  {
    ...
    vocabulary: [
      { word: "doler", english: "to hurt (works like gustar — me duele, te duele, le duele…) (o→ue)", pronunciation: "doh-LEHR", part_of_speech: "verb" },
      { word: "sentirse", english: "to feel (reflexive, e→ie) — me siento bien / mal", pronunciation: "sehn-TEER-seh", part_of_speech: "verb" },
      { word: "la fiebre", english: "the fever", pronunciation: "lah FYEH-breh", part_of_speech: "noun", gender: "f" },
      { word: "la tos", english: "the cough", pronunciation: "lah tohs", part_of_speech: "noun", gender: "f" },
      { word: "el resfriado", english: "the head cold (safer than 'constipado' anywhere outside Spain)", pronunciation: "ehl rrehs-fryah-doh", part_of_speech: "noun", gender: "m" },
      { word: "constipado", english: "WARNING: head cold in Spain / constipated in much of LatAm — false friend", pronunciation: "kohns-tee-PAH-doh", part_of_speech: "adjective" },
      { word: "la consulta", english: "the doctor's office (Spain; LatAm: el consultorio)", pronunciation: "lah kohn-SOOL-tah", part_of_speech: "noun", gender: "f" },
      { word: "la farmacia", english: "the pharmacy", pronunciation: "lah far-MAH-syah", part_of_speech: "noun", gender: "f" },
      { word: "el / la farmacéutico/a", english: "the pharmacist", pronunciation: "ehl far-mah-SEH-oo-tee-koh", part_of_speech: "noun", gender: "mf" },
      { word: "el jarabe", english: "the cough syrup / liquid medicine", pronunciation: "ehl hah-RAH-beh", part_of_speech: "noun", gender: "m" },
      { word: "la receta", english: "the prescription (also: recipe — same word)", pronunciation: "lah rreh-SEH-tah", part_of_speech: "noun", gender: "f" },
      { word: "la garganta", english: "the throat", pronunciation: "lah gar-GAHN-tah", part_of_speech: "noun", gender: "f" },
    ],
    grammar: [
      {
    ...
    dialogue: [
      { speaker: "Médico", spanish: "Buenos días, ¿qué le pasa?", english: "Good morning, what's wrong?", pronunciation: "BWEH-nohs DEE-ahs, keh leh PAH-sah", register: "formal" },
      { speaker: "Paciente", spanish: "Pues llevo dos días con dolor de garganta y fiebre.", english: "Well, I've had a sore throat and fever for two days.", pronunciation: "pwehs YEH-boh dohs DEE-ahs kohn doh-LOR deh gar-GAHN-tah ee FYEH-breh", register: "formal" },
      { speaker: "Médico", spanish: "¿Tiene tos también?", english: "Do you have a cough as well?", pronunciation: "TYEH-neh tohs tahm-BYEHN", register: "formal" },
      { speaker: "Paciente", spanish: "Sí, sobre todo por la noche. Y me siento muy cansado.", english: "Yes, especially at night. And I feel very tired.", pronunciation: "see, SOH-breh TOH-doh por lah NOH-cheh. ee meh SYEHN-toh MOO-ee kahn-SAH-doh", register: "formal" },
      { speaker: "Médico", spanish: "Le voy a recetar un antibiótico y reposo. Vuelva si no mejora en una semana.", english: "I'm going to prescribe you an antibiotic and rest. Come back if you don't improve in a week.", pronunciation: "leh boy ah rreh-seh-TAR oon ahn-tee-BYOH-tee-koh ee rreh-POH-soh. BWEHL-bah see noh meh-HOH-rah ehn OO-nah seh-MAH-nah", register: "formal" },
    ],
    cultural_note:
  ...
  // ── 20. opinions — spanish_opinions_creo_que ──────────────────────────────
  {
    ...
    vocabulary: [
      { word: "creer que", english: "to think / believe that (indicative when affirmative, subjunctive when negated)", pronunciation: "kreh-EHR keh", part_of_speech: "verb" },
      { word: "pensar que", english: "to think that (same flip rule as creer)", pronunciation: "pehn-SAR keh", part_of_speech: "verb" },
      { word: "opinar que", english: "to be of the opinion that", pronunciation: "oh-pee-NAR keh", part_of_speech: "verb" },
      { word: "me parece que", english: "it seems to me that (same flip rule)", pronunciation: "meh pah-REH-seh keh", part_of_speech: "phrase" },
      { word: "estar de acuerdo con", english: "to agree with (always 'estar')", pronunciation: "ehs-TAR deh ah-KWEHR-doh kohn", part_of_speech: "phrase" },
      { word: "totalmente / del todo", english: "totally / entirely (qualifier for agreement strength)", pronunciation: "toh-tahl-MEHN-teh / dehl TOH-doh", part_of_speech: "adverb" },
      { word: "en parte", english: "partly / in part (soft agreement)", pronunciation: "ehn PAR-teh", part_of_speech: "phrase" },
      { word: "para mí", english: "for me / in my view (opinion frame)", pronunciation: "PAH-rah mee", part_of_speech: "phrase" },
      { word: "depende", english: "it depends (universal hedging response)", pronunciation: "deh-PEHN-deh", part_of_speech: "verb" },
      { word: "por un lado / por otro lado", english: "on one hand / on the other hand", pronunciation: "por oon LAH-doh / por OH-troh LAH-doh", part_of_speech: "phrase" },
      { word: "el punto de vista", english: "the point of view", pronunciation: "ehl POON-toh deh BEES-tah", part_of_speech: "noun", gender: "m" },
      { word: "la opinión", english: "the opinion", pronunciation: "lah oh-pee-NYOHN", part_of_speech: "noun", gender: "f" },
    ],
    grammar: [
      {
