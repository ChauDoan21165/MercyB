  ...
  return (
    <div className="rounded-lg border border-slate-200 bg-white p-3">
      ...
      {showKey && q.explanation_vi && (
        <p className="mt-0.5 text-xs italic text-slate-500">{q.explanation_vi}</p>
      )}
      {feedbackVisible && (
  ...
  return (
    <div className="mx-auto w-full max-w-3xl px-4 py-6">
      <header className="mb-4">
        <Link to="/exam-prep/ielts/reading" className="inline-flex items-center gap-1 text-xs text-slate-500 hover:text-slate-800">
          <ChevronLeft size={14} />
