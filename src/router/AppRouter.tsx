...
const PlacementBenchmarkDashboard = lazyWithRetry(() => import("@/pages/admin/PlacementBenchmarkDashboard"));
        ...
        <Route element={<AppHeroShell />}>
          ...
          <Route path="/admin/*" element={<AdminRoute />}>
            <Route element={<AdminLayoutShell />}>
              ...
              <Route path="placement-benchmarks"  element={<LazyPage><PlacementBenchmarkDashboard /></LazyPage>} />
