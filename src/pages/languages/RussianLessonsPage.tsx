...
const FALLBACK_LESSONS: LessonLike[] = [
  ...
  { id: 'russian-starter-2', level: 'A2', titleVi: 'Câu Russian đời sống', titleEn: 'Everyday Russian sentences', descriptionVi: 'Mở rộng câu ngắn cho đời sống hằng ngày.', descriptionEn: 'Expand short sentences for daily life.' },
  { id: 'russian-starter-3', level: 'C2', titleVi: 'C2: Russian nâng cao', titleEn: 'C2: Advanced Russian', descriptionVi: 'Bài C2 mẫu bảo đảm cấp độ C2 luôn hiển thị nếu dữ liệu thật chưa tải.', descriptionEn: 'Sample C2 card so the C2 section remains visible if course data is not loaded.' }
];
...
export default function RussianLessonsPage() {
  ...
  const headline = uiLang === "en" ? "Russian — real-life lessons, explained clearly. From Cyrillic to advanced discourse." : "Russian cho người Việt — từ Cyrillic đến giao tiếp nâng cao.";
  const languageMeta = uiLang === "en" ? "Practical Russian lessons: Cyrillic, daily-life phrases, work situations, and clear communication." : "Bài học Russian thực dụng: chữ Cyrillic, mẫu câu đời sống, công việc, và giao tiếp rõ ràng.";
            ...
            {sectionLessons.length === 0 ? (
              ...
              <div className="space-y-2">
                {sectionLessons.map((lesson, index) => {
                  const title = lessonTitle(lesson, uiLang, "Russian lesson");
