      ...
      <section className="py-16 px-6" style={{ backgroundColor: "#F0F4F0" }}>
        <div className="max-w-4xl mx-auto space-y-8">
          <HomepageSection
            ...
            body={{
              en: "This Survival & Resilience module gives you essential life skills for staying safe, steady, and confident in a world where weather and daily disruptions are becoming more unpredictable. Instead of teaching extreme or complicated survival techniques, these 25 rooms focus on clear, practical knowledge that everyday people can apply immediately—parents, teenagers, elders, and those living alone.\nEach room contains six detailed entries of about 200 words, helping you understand risks calmly, take the right actions, and support the people you love. The goal is simple: accessible safety literacy for everyone, built through steady learning rather than fear. With a small VIP1 upgrade, you gain lifelong skills that strengthen independence, preparedness, and inner stability during difficult moments.",
              vi: "Phần \"Sinh Tồn & Kiên Cường\" này mang đến những kỹ năng thiết yếu để bạn an toàn và vững vàng trong bối cảnh thời tiết và cuộc sống ngày càng khó lường. Thay vì dạy các kỹ thuật sinh tồn phức tạp hay cực đoan, 25 phòng học này tập trung vào kiến thức rõ ràng, thực tế và phù hợp cho mọi người—từ cha mẹ, thanh thiếu niên đến người lớn tuổi và người sống một mình.\nMỗi phòng có sáu mục nội dung chi tiết (khoảng 200 từ mỗi mục), giúp bạn hiểu rủi ro một cách bình tĩnh, hành động đúng thời điểm và hỗ trợ người thân một cách hiệu quả. Mục tiêu rất đơn giản: phổ cập kỹ năng an toàn cho mọi người mà không tạo ra nỗi sợ hãi. Chỉ với mức nâng cấp nhỏ VIP1, bạn nhận được những kỹ năng trọn đời để tự chủ, chuẩn bị và bình tĩnh trong những lúc khó khăn."
            }}
            audio={{
