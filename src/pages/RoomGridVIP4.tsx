...
const RoomGridVIP4 = () => {
  ...
  const { data: rooms, isLoading: loading, error: queryError, refetch: refresh } = useEmergencyVipRooms('vip4');
  const error = queryError ? new Error('Failed to load VIP4 rooms') : null;
