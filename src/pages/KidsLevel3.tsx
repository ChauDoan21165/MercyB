...
const KidsLevel3 = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="min-h-screen" style={{ backgroundColor: 'hsl(271, 91%, 65%)' }}>
            ...
            {rooms.map((room) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Hover Effect */}
                  <div className="absolute inset-0 bg-gradient-to-br from-purple-500/10 to-purple-600/10 opacity-0 group-hover:opacity-100 transition-opacity rounded-lg" />
                </Card>
              );
            })}
          </div>
