...
const KidsLevel1 = () => {
  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="min-h-screen" style={{ backgroundColor: 'hsl(142, 76%, 36%)' }}>
            ...
            {rooms.map((room) => {
              ...
              return (
                ...
                >
                  ...
                  {/* Hover Effect */}
                  <div className="absolute inset-0 bg-gradient-to-br from-green-500/10 to-green-600/10 opacity-0 group-hover:opacity-100 transition-opacity rounded-lg" />
                </Card>
              );
            })}
          </div>
