...
const KidsChat = () => {
  ...
  const fetchRoomData = async () => {
    try {
      ...
      // For all Level 3 rooms, if database entries have no audio, fall back to JSON version with audio
      const isLevel3 = roomData?.level_id === 'level3';
      if (isLevel3 && roomId && roomData?.level_id) {
