...
const STATUS_BORDER: Record<DegradationStatus, string> = {
  ...
  warning: "#f59e0b",
  alert: "#ef4444",
  insufficient_data: "#94a3b8", // a11y-contrast:exception — used as borderColor on the status badge (WCAG 1.4.11 non-text 3:1; slate-500 on white = 3.13:1 PASSES). Not text. Audit doc §wave-5.
};
