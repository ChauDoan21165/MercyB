      ...
      >
        ...
        <div style={{ minWidth: 0, flex: 1 }}>
          <div style={{ fontSize: isPhone ? z(18) : z(20), fontWeight: 900, color: "rgba(8,75,90,0.94)", letterSpacing: -0.3 }}>
            {nt({ en: "Try one word — no signup", vi: "Thử một từ — không cần đăng nhập", es: "Prueba una palabra — sin registro", fr: "Essayez un mot — sans inscription", de: "Ein Wort testen — keine Anmeldung", ru: "Попробуйте одно слово — без регистрации", pa: "ਇੱਕ ਸ਼ਬਦ ਅਜ਼ਮਾਓ — ਸਾਈਨ ਅੱਪ ਨਹੀਂ", sw: "Jaribu neno moja — hakuna kujisajili", ja: "一言試す — サインアップ不要", zh: "试说一个词 — 无需登录", id: "Coba satu kata — tanpa daftar", th: "ลองหนึ่งคำ — ไม่ต้องสมัคร", ar: "جرب كلمة واحدة — بدون تسجيل", hi: "एक शब्द आज़माएं — साइनअप नहीं", ur: "ایک لفظ آزمائیں — سائن اپ کی ضرورت نہیں", ko: "한 단어 체험하기 — 가입 없음", pt: "Experimente uma palavra — sem cadastro", tr: "Bir kelime dene — kayıt gerekmez" })}
          </div>
          {!isPhone && (
            <div style={{ fontSize: z(12), fontWeight: 700, color: "rgba(8,75,90,0.55)", marginTop: 2 }}>
              {nt({ en: "Try pronunciation — no signup", vi: "Thử phát âm — không cần đăng nhập", es: "Prueba la pronunciación — sin registro", fr: "Essayez la prononciation — sans inscription", de: "Aussprache testen — keine Anmeldung", ru: "Попробуйте произношение — без регистрации", pa: "ਉਚਾਰਨ ਅਜ਼ਮਾਓ — ਸਾਈਨ ਅੱਪ ਨਹੀਂ", sw: "Jaribu matamshi — hakuna kujisajili", ja: "発音を試す — サインアップ不要", zh: "试发音 — 无需登录", id: "Coba pengucapan — tanpa daftar", th: "ลองออกเสียง — ไม่ต้องสมัคร", ar: "جرب النطق — بدون تسجيل", hi: "उच्चारण आज़माएं — साइनअप नहीं", ur: "تلفظ آزمائیں — سائن اپ کی ضرورت نہیں", ko: "발음 체험하기 — 가입 없음", pt: "Experimente a pronúncia — sem cadastro", tr: "Telaffuzu dene — kayıt gerekmez" })}
            </div>
          )}
        ...
        <section ref={stageRef} style={{ marginTop: isPhone ? 10 : 14, display: "flex", flexDirection: "column", gap: isPhone ? 10 : 12 }} aria-label="Homepage choices">
            ...
            >
              <div style={{
                ...
                <span style={{ fontSize: z(13), fontWeight: 700, color: "rgba(8,75,90,0.78)", flex: 1, textAlign: "left" }}>
                  {nt({ en: "Try pronunciation now — no signup", vi: "Thử phát âm ngay — không cần đăng nhập", es: "Prueba la pronunciación ahora — sin registro", fr: "Essayez la prononciation maintenant — sans inscription", de: "Jetzt Aussprache testen — keine Anmeldung", ru: "Попробуйте произношение сейчас — без регистрации", pa: "ਹੁਣੇ ਉਚਾਰਨ ਅਜ਼ਮਾਓ — ਸਾਈਨ ਅੱਪ ਨਹੀਂ", sw: "Jaribu matamshi sasa — hakuna kujisajili", ja: "今すぐ発音を試す — サインアップ不要", zh: "立即试发音 — 无需登录", id: "Coba pengucapan sekarang — tanpa perlu daftar", th: "ลองออกเสียงตอนนี้ — ไม่ต้องสมัครสมาชิก", ar: "جرب النطق الآن — لا حاجة للتسجيل", hi: "अभी उच्चारण आज़माएं — साइनअप की ज़रूरत नहीं", ur: "ابھی تلفظ آزمائیں — سائن اپ کی ضرورت نہیں", ko: "지금 발음을 체험해보세요 — 가입 불필요", pt: "Experimente a pronúncia agora — sem precisar se cadastrar", tr: "Şimdi telaffuzu dene — kayıt gerekmez" })}
                </span>
          ...
          {isPhone && (
            <div style={{
              ...
              {nt({ en: "Explore", vi: "Khám phá", es: "Explorar", fr: "Explorer", de: "Entdecken", ru: "Исследовать", pa: "ਖੋਜ", sw: "Chunguza", ja: "探索", zh: "探索", id: "Jelajahi", th: "สำรวจ", ar: "استكشف", hi: "एक्सप्लोर करें", ur: "دریافت کریں", ko: "둘러보기", pt: "Explorar", tr: "Keşfet" })}
            </div>
          )}
          <ProgressiveDisclosureCard
            cardId="library"
