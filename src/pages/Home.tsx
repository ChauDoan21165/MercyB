...
// FIX 100.4:
// - TOP HEADER ONLY:
//   - Move Mercy Blade to TRUE CENTER
//   - Double Mercy Blade visual size
//   - Keep buttons on the right (Sign in / Đăng nhập, Tier Map / Bản đồ app)
// - DO NOT TOUCH hero band or any content below.
  ...
  return (
    <div style={wrap}>
      <div style={frame}>
        ...
        {/* BOX 2: HERO (DO NOT TOUCH) */}
        <div style={hero}>
          <div style={heroInner}>
            <h1 style={heroTitle}>English &amp; Knowledge</h1>
            <div style={heroSub}>Colors of Life</div>
          </div>
        </div>
...
/* New thing to learn:
   True centering in headers is easiest with a 3-column grid (1fr | auto | 1fr),
   not with flex “space-between” tricks. */
