...
const TITLE = "Học tiếng Anh cho người Việt — MercyBlade";
const DESCRIPTION =
  "MercyBlade là ứng dụng học tiếng Anh được thiết kế riêng cho người Việt. Sửa lỗi phát âm, ngữ pháp theo đúng thói quen tiếng Việt, không phải app dịch lại.";
  ...
  return (
    <>
      ...
      <SeoLayout
        ...
        subheader="MercyBlade là ứng dụng học tiếng Anh đầu tiên thiết kế riêng cho người Việt — không phải bản dịch lại của Duolingo. Mọi lỗi phát âm, mọi lỗi ngữ pháp đều được giải thích bằng đúng thói quen của người Việt."
        utmCampaign={SLUG}
      >
        ...
        <section>
          ...
          <p>
            ...
            cách dùng "the/a", đến cách diễn đạt thì quá khứ. MercyBlade đi sâu vào
        ...
        <section>
          <h2 className="text-2xl font-bold text-slate-900 mb-3">
            MercyBlade khác gì với các app khác?
          </h2>
          <p>
