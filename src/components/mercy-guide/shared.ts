// Path: src/components/mercy-guide/shared.ts
...
export const MERCY_HOST_IMAGE_SRC = '/teacher-mercy.webp';
export const MERCY_HOST_IMAGE_FALLBACK = '/teacher-mercy.webp';
// Optimized variants of the same 640×640 portrait. Served via <picture> on
// the high-traffic room/guide surface with WebP as the canonical fallback.
export const MERCY_HOST_IMAGE_AVIF = '/teacher-mercy.avif';
export const MERCY_HOST_IMAGE_WEBP = '/teacher-mercy.webp';
