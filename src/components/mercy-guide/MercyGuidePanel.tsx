    ...
    <div className="relative flex h-full min-h-0 flex-col overflow-hidden border-l border-white/70 bg-gradient-to-br from-[#FFF8F1] via-[#FFFCFA] to-[#F7F5FF] shadow-2xl">
      ...
      >
        ...
        <div className="flex shrink-0 items-center gap-1">
          <button
            type="button"
            className="rounded-full p-2 text-slate-600 outline-none transition hover:bg-white/70 hover:text-slate-600 focus:outline-none focus:ring-0 focus-visible:outline-none focus-visible:ring-0"
          ...
          <button
            type="button"
            onClick={onClose}
            className="rounded-full border border-transparent bg-white/75 p-2 text-slate-600 transition hover:border-red-100 hover:bg-red-50 hover:text-red-500"
