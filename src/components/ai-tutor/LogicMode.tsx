...
export default function LogicMode({ latestCorrectedSentence }: Props) {
  ...
  return (
    ...
    >
      ...
      <PatternExplanation pattern={selectedPattern} />
...
function PatternExplanation({ pattern }: { pattern: VietlishCuratedPattern }) {
  return (
