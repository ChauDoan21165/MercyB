...
// VERSION: MB-BLUE-101.7f-size-controls-first-paint-fix
// NOTE:
// - Reconstructed host implementation
// - Corrected file/component identity
// - Removed mounted-based first-paint delay logic
// - Keeps care-loop logic, quick test, logging, voice test, and routing behavior
...
• Level 9 includes a daily minutes cap (so the system stays profitable)
        ...
        onClick: () => {
          ...
          if (!canVoiceTest) {
            addMsg(
              "assistant",
              lang === "vi"
                ? "Giọng nói Mercy Host là Level 9. Bạn có thể nâng cấp ở /tiers."
                : "Mercy Host Voice is Level 9 only. You can upgrade at /tiers.",
            );
            return;
          }
