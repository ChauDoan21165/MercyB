 ...
 * 
 * Displays Mercy's welcome greeting at the top of room pages.
 * Fade-in animation, dismissible, reopenable via floating icon.
 */
...
import type { MercyGreeting } from '@/lib/mercy-host/mercyHost';

interface MercyHostGreetingProps {
  greeting: MercyGreeting;
  show: boolean;
  onDismiss: () => void;
  onReopen: () => void;
  className?: string;
...
export function MercyHostGreeting({
  greeting,
  show,
  onDismiss,
  onReopen,
  className
}: MercyHostGreetingProps) {
