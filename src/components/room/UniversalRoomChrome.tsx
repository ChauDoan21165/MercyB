...
export default function UniversalRoomChrome({
  ...
  return (
    <div className="w-full">
      {/* Box 2 — Room header */}
      <div className="mb-4 rounded-2xl border bg-white/70 backdrop-blur p-4 md:p-5 shadow-sm">
      ...
      <div className="mb-4 rounded-2xl border bg-white/70 backdrop-blur p-4 md:p-5 shadow-sm">
        <div className="text-center text-sm md:text-base leading-relaxed">
          <div>
            Welcome to this room, please click a keyword to start.
          </div>
          <div className="mt-1">
            Chào mừng bạn đến với phòng này, vui lòng nhấp vào từ khóa để bắt đầu.
          </div>
        </div>
      ...
      {/* Box 4 — Stage */}
      <div className="rounded-2xl border bg-white/70 backdrop-blur p-4 md:p-6 shadow-sm min-h-[420px]">
        {childrenStage}
      </div>

      {/* Box 5 — Thin feedback */}
      <div className="mt-4 rounded-2xl border bg-white/70 backdrop-blur p-2 md:p-3 shadow-sm">
