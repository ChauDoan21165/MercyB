...
export const lessons: SpanishLesson[] = [
  // ── 1. greetings — spanish_greetings_basic ─────────────────────────────
  {
    ...
    vocabulary: [
      { word: "hola", english: "hello", pronunciation: "OH-lah", part_of_speech: "interjection" },
      { word: "buenos días", english: "good morning", pronunciation: "BWEH-nohs DEE-ahs", part_of_speech: "phrase" },
      { word: "buenas tardes", english: "good afternoon", pronunciation: "BWEH-nahs TAR-dehs", part_of_speech: "phrase" },
      { word: "buenas noches", english: "good night / good evening (after dark)", pronunciation: "BWEH-nahs NOH-chehs", part_of_speech: "phrase" },
      { word: "¿cómo estás?", english: "how are you? (informal)", pronunciation: "KOH-moh ehs-TAHS", part_of_speech: "question" },
      { word: "¿cómo está?", english: "how are you? (formal)", pronunciation: "KOH-moh ehs-TAH", part_of_speech: "question" },
      { word: "bien", english: "well / good", pronunciation: "BYEHN", part_of_speech: "adverb" },
      { word: "mucho gusto", english: "nice to meet you", pronunciation: "MOO-choh GOOS-toh", part_of_speech: "phrase" },
    ],
    dialogue: [
      { speaker: "Ana", spanish: "¡Hola! ¿Cómo estás?", english: "Hi! How are you?", pronunciation: "OH-lah! KOH-moh ehs-TAHS?", register: "informal" },
      { speaker: "Carlos", spanish: "Bien, gracias. ¿Y tú?", english: "Good, thanks. And you?", pronunciation: "BYEHN, GRAH-syahs. ee TOO?", register: "informal" },
      { speaker: "Ana", spanish: "Muy bien. Mucho gusto.", english: "Very well. Nice to meet you.", pronunciation: "moo-EE BYEHN. MOO-choh GOOS-toh", register: "informal" },
      { speaker: "Carlos", spanish: "Igualmente.", english: "Likewise.", pronunciation: "ee-gwahl-MEHN-teh", register: "informal" },
    ],
    cultural_note:
  ...
  // ── 2. greetings — spanish_greetings_introductions ─────────────────────
  {
    ...
    vocabulary: [
      { word: "me llamo", english: "my name is (literally: I call myself)", pronunciation: "meh YAH-moh", part_of_speech: "reflexive phrase" },
      { word: "soy", english: "I am (ser — permanent)", pronunciation: "soy", part_of_speech: "verb" },
      { word: "de", english: "from / of", pronunciation: "deh", part_of_speech: "preposition" },
      { word: "encantado/a", english: "pleased (m/f — adjective agrees with speaker)", pronunciation: "ehn-kahn-TAH-doh / -dah", part_of_speech: "adjective", gender: "mf" },
      { word: "tú", english: "you (informal singular)", pronunciation: "TOO", part_of_speech: "pronoun" },
      { word: "usted", english: "you (formal singular)", pronunciation: "oos-TEHD", part_of_speech: "pronoun" },
    ],
    grammar: [
      {
        point: "tú vs usted",
    ...
    dialogue: [
      { speaker: "Profesora", spanish: "Hola, buenos días. ¿Cómo se llama?", english: "Hello, good morning. What's your name?", pronunciation: "OH-lah, BWEH-nohs DEE-ahs. KOH-moh seh YAH-mah?", register: "formal" },
      { speaker: "Estudiante", spanish: "Me llamo Tom. Soy de Inglaterra.", english: "My name is Tom. I'm from England.", pronunciation: "meh YAH-moh tahm. soy deh een-glah-TEH-rrah", register: "neutral" },
      { speaker: "Profesora", spanish: "Encantada. Bienvenido a la clase.", english: "Pleased to meet you. Welcome to the class.", pronunciation: "ehn-kahn-TAH-dah. byehn-veh-NEE-doh ah lah KLAH-seh", register: "formal" },
    ],
    cultural_note:
  ...
  // ── 3. ser_estar_intro — spanish_ser_estar_overview ────────────────────
  {
    ...
    vocabulary: [
      { word: "ser", english: "to be (permanent / defining)", pronunciation: "SEHR", part_of_speech: "verb" },
      { word: "estar", english: "to be (temporary / location / state)", pronunciation: "ehs-TAHR", part_of_speech: "verb" },
      { word: "soy", english: "I am (ser)", pronunciation: "soy", part_of_speech: "verb" },
      { word: "estoy", english: "I am (estar)", pronunciation: "ehs-TOY", part_of_speech: "verb" },
      { word: "eres", english: "you are (ser, informal)", pronunciation: "EH-rehs", part_of_speech: "verb" },
      { word: "estás", english: "you are (estar, informal)", pronunciation: "ehs-TAHS", part_of_speech: "verb" },
      { word: "es", english: "he/she/it is (ser)", pronunciation: "ehs", part_of_speech: "verb" },
      { word: "está", english: "he/she/it is (estar)", pronunciation: "ehs-TAH", part_of_speech: "verb" },
    ],
    grammar: [
      {
  ...
  // ── 5. gendered_nouns — spanish_gender_articles ────────────────────────
  {
    ...
    vocabulary: [
      { word: "el libro", english: "the book", pronunciation: "ehl LEE-broh", part_of_speech: "noun", gender: "m" },
      { word: "la mesa", english: "the table", pronunciation: "lah MEH-sah", part_of_speech: "noun", gender: "f" },
      { word: "el coche", english: "the car (Spain)", pronunciation: "ehl KOH-cheh", part_of_speech: "noun", gender: "m", regional: [{ region: "LatAm", form: "el carro", note: "Used across most of Latin America; auto is also common." }] },
      { word: "la casa", english: "the house", pronunciation: "lah KAH-sah", part_of_speech: "noun", gender: "f" },
      { word: "el día", english: "the day", pronunciation: "ehl DEE-ah", part_of_speech: "noun", gender: "m", regional: [{ region: "all", form: "el día", note: "Ends in -a but is MASCULINE. Common irregular. Same with: el mapa, el sofá, el problema, el sistema, el clima." }] },
      { word: "la mano", english: "the hand", pronunciation: "lah MAH-noh", part_of_speech: "noun", gender: "f", regional: [{ region: "all", form: "la mano", note: "Ends in -o but is FEMININE. Common irregular. Same with: la foto (foto-grafía), la moto (moto-cicleta), la radio." }] },
    ],
    grammar: [
      {
  ...
  // ── 6. gendered_nouns — spanish_gender_adjectives ──────────────────────
  {
    ...
    vocabulary: [
      { word: "grande", english: "big", pronunciation: "GRAHN-deh", part_of_speech: "adjective", regional: [{ region: "all", form: "grande", note: "Same form for m/f. Plural: grandes. Shortens to 'gran' before any singular noun: 'un gran amigo'." }] },
      { word: "pequeño/a", english: "small", pronunciation: "peh-KEH-nyoh / -nyah", part_of_speech: "adjective", gender: "mf" },
      { word: "bonito/a", english: "pretty / nice-looking", pronunciation: "boh-NEE-toh / -tah", part_of_speech: "adjective", gender: "mf" },
      { word: "feo/a", english: "ugly", pronunciation: "FEH-oh / -ah", part_of_speech: "adjective", gender: "mf" },
      { word: "interesante", english: "interesting", pronunciation: "een-teh-reh-SAHN-teh", part_of_speech: "adjective" },
      { word: "difícil", english: "difficult", pronunciation: "dee-FEE-seel", part_of_speech: "adjective" },
      { word: "fácil", english: "easy", pronunciation: "FAH-seel", part_of_speech: "adjective" },
    ],
    grammar: [
      {
  ...
  // ── 7. present_tense — spanish_present_tense_regular ───────────────────
  {
    ...
    vocabulary: [
      { word: "hablar", english: "to speak", pronunciation: "ah-BLAHR", part_of_speech: "verb" },
      { word: "comer", english: "to eat", pronunciation: "koh-MEHR", part_of_speech: "verb" },
      { word: "vivir", english: "to live", pronunciation: "vee-VEER", part_of_speech: "verb" },
      { word: "trabajar", english: "to work", pronunciation: "trah-bah-HAHR", part_of_speech: "verb" },
      { word: "estudiar", english: "to study", pronunciation: "ehs-too-DYAHR", part_of_speech: "verb" },
      { word: "beber", english: "to drink", pronunciation: "beh-BEHR", part_of_speech: "verb" },
  ...
  // ── 8. present_tense — spanish_present_tense_irregular_yo ──────────────
  {
    ...
    vocabulary: [
      { word: "tener", english: "to have", pronunciation: "teh-NEHR", part_of_speech: "verb" },
      { word: "tengo", english: "I have", pronunciation: "TEHN-goh", part_of_speech: "verb" },
      { word: "hacer", english: "to do / to make", pronunciation: "ah-SEHR", part_of_speech: "verb" },
      { word: "hago", english: "I do / I make", pronunciation: "AH-goh", part_of_speech: "verb" },
      { word: "poner", english: "to put / to place", pronunciation: "poh-NEHR", part_of_speech: "verb" },
      { word: "salir", english: "to leave / to go out", pronunciation: "sah-LEER", part_of_speech: "verb" },
      { word: "conocer", english: "to know (a person/place)", pronunciation: "koh-noh-SEHR", part_of_speech: "verb" },
      { word: "saber", english: "to know (a fact / how to)", pronunciation: "sah-BEHR", part_of_speech: "verb" },
    ],
    cultural_note:
  ...
  // ── 9. numbers — spanish_numbers_basic ────────────────────────────────
  {
    ...
    vocabulary: [
      { word: "uno", english: "one", pronunciation: "OO-noh", part_of_speech: "number" },
      { word: "diez", english: "ten", pronunciation: "DYEHS", part_of_speech: "number" },
      { word: "veinte", english: "twenty", pronunciation: "VEYN-teh", part_of_speech: "number" },
      { word: "treinta", english: "thirty", pronunciation: "TREYN-tah", part_of_speech: "number" },
      { word: "cien", english: "one hundred", pronunciation: "SYEHN", part_of_speech: "number" },
      { word: "el número", english: "the number", pronunciation: "ehl NOO-meh-roh", part_of_speech: "noun", gender: "m" },
      { word: "los años", english: "years (literally: the years)", pronunciation: "lohs AH-nyohs", part_of_speech: "noun", gender: "m" },
    ],
    cultural_note:
  ...
  // ── 10. time_dates — spanish_time_dates ────────────────────────────────
  {
    ...
    vocabulary: [
      { word: "la hora", english: "the hour / time", pronunciation: "lah OH-rah", part_of_speech: "noun", gender: "f" },
      { word: "el día", english: "the day", pronunciation: "ehl DEE-ah", part_of_speech: "noun", gender: "m" },
      { word: "hoy", english: "today", pronunciation: "oy", part_of_speech: "adverb" },
      { word: "mañana", english: "tomorrow / morning", pronunciation: "mah-NYAH-nah", part_of_speech: "adverb", regional: [{ region: "all", form: "mañana", note: "Means BOTH 'tomorrow' AND 'morning' depending on context. Por la mañana = in the morning. Hasta mañana = see you tomorrow." }] },
      { word: "ayer", english: "yesterday", pronunciation: "ah-YEHR", part_of_speech: "adverb" },
      { word: "la semana", english: "the week", pronunciation: "lah seh-MAH-nah", part_of_speech: "noun", gender: "f" },
      { word: "el mes", english: "the month", pronunciation: "ehl mehs", part_of_speech: "noun", gender: "m" },
      { word: "el año", english: "the year", pronunciation: "ehl AH-nyoh", part_of_speech: "noun", gender: "m" },
    ],
    cultural_note:
  ...
  // ── 11. family — spanish_family ────────────────────────────────────────
  {
    ...
    vocabulary: [
      { word: "el padre", english: "the father", pronunciation: "ehl PAH-dreh", part_of_speech: "noun", gender: "m" },
      { word: "la madre", english: "the mother", pronunciation: "lah MAH-dreh", part_of_speech: "noun", gender: "f" },
      { word: "los padres", english: "parents (collective)", pronunciation: "lohs PAH-drehs", part_of_speech: "noun", gender: "m" },
      { word: "el hermano", english: "the brother", pronunciation: "ehl ehr-MAH-noh", part_of_speech: "noun", gender: "m" },
      { word: "la hermana", english: "the sister", pronunciation: "lah ehr-MAH-nah", part_of_speech: "noun", gender: "f" },
      { word: "el abuelo", english: "the grandfather", pronunciation: "ehl ah-BWEH-loh", part_of_speech: "noun", gender: "m" },
      { word: "la abuela", english: "the grandmother", pronunciation: "lah ah-BWEH-lah", part_of_speech: "noun", gender: "f" },
      { word: "el tío", english: "the uncle", pronunciation: "ehl TEE-oh", part_of_speech: "noun", gender: "m", regional: [{ region: "Spain", form: "tío (slang)", note: "Also means 'dude/man' in Spain casual speech: '¡qué guay, tío!' = 'how cool, dude!'. Not used this way in LatAm." }] },
      { word: "la tía", english: "the aunt", pronunciation: "lah TEE-ah", part_of_speech: "noun", gender: "f" },
      { word: "el primo", english: "the (male) cousin", pronunciation: "ehl PREE-moh", part_of_speech: "noun", gender: "m" },
      { word: "la prima", english: "the (female) cousin", pronunciation: "lah PREE-mah", part_of_speech: "noun", gender: "f" },
      { word: "el hijo", english: "the son", pronunciation: "ehl EE-hoh", part_of_speech: "noun", gender: "m" },
      { word: "la hija", english: "the daughter", pronunciation: "lah EE-hah", part_of_speech: "noun", gender: "f" },
    ],
    grammar: [
      {
  ...
  // ── 12. food_basics — spanish_food_ordering ────────────────────────────
  {
    ...
    vocabulary: [
      { word: "el café", english: "the coffee / the café", pronunciation: "ehl kah-FEH", part_of_speech: "noun", gender: "m", regional: [{ region: "Spain", form: "café solo / cortado / con leche", note: "Spain has detailed coffee terminology. Solo = espresso. Cortado = espresso with dash of milk. Con leche = half-and-half." }, { region: "Mexico", form: "café americano", note: "American-style filter coffee. Less common in Spain." }] },
      { word: "el agua", english: "the water", pronunciation: "ehl AH-gwah", part_of_speech: "noun", gender: "f", regional: [{ region: "all", form: "el agua", note: "Feminine noun, but uses 'el' instead of 'la' because singular feminine words starting with stressed 'a-' do. Plural is 'las aguas'." }] },
      { word: "la cerveza", english: "the beer", pronunciation: "lah sehr-VEH-sah", part_of_speech: "noun", gender: "f", regional: [{ region: "Spain", form: "una caña", note: "Small draft beer (~200ml). The default beer order in Spain. 'Una cerveza' sounds formal." }, { region: "Mexico", form: "una chela", note: "Slang. 'Una cerveza' is the neutral form." }] },
      { word: "la cuenta", english: "the check / bill", pronunciation: "lah KWEHN-tah", part_of_speech: "noun", gender: "f" },
      { word: "el menú", english: "the menu", pronunciation: "ehl meh-NOO", part_of_speech: "noun", gender: "m", regional: [{ region: "Spain", form: "la carta", note: "In Spain, 'la carta' is the menu of all dishes. 'El menú' is specifically the fixed-price lunch deal." }] },
      { word: "el desayuno", english: "the breakfast", pronunciation: "ehl deh-sah-YOO-noh", part_of_speech: "noun", gender: "m" },
      { word: "la comida", english: "the food / the lunch (Spain)", pronunciation: "lah koh-MEE-dah", part_of_speech: "noun", gender: "f", regional: [{ region: "Spain", form: "la comida = lunch", note: "In Spain, 'la comida' specifically means lunch (the main meal of the day)." }, { region: "Mexico", form: "la comida = food/meal", note: "In Mexico, 'la comida' is general 'food' or any meal." }] },
      { word: "la cena", english: "the dinner", pronunciation: "lah SEH-nah", part_of_speech: "noun", gender: "f" },
    ],
    dialogue: [
      { speaker: "Camarero", spanish: "Buenos días. ¿Qué desea tomar?", english: "Good morning. What would you like to drink?", pronunciation: "BWEH-nohs DEE-ahs. keh deh-SEH-ah toh-MAHR?", register: "formal" },
      { speaker: "Cliente", spanish: "Un café con leche y una tostada, por favor.", english: "A coffee with milk and toast, please.", pronunciation: "oon kah-FEH kohn LEH-cheh ee OO-nah tohs-TAH-dah, pohr fah-VOHR", register: "neutral" },
      { speaker: "Camarero", spanish: "Muy bien, ¿algo más?", english: "Very well, anything else?", pronunciation: "moo-EE BYEHN, AHL-goh MAHS?", register: "formal" },
      { speaker: "Cliente", spanish: "No, gracias. Eso es todo.", english: "No, thanks. That's all.", pronunciation: "noh, GRAH-syahs. EH-soh ehs TOH-doh", register: "neutral" },
    ],
    cultural_note:
  ...
  // ── 13. food_basics — spanish_food_market ──────────────────────────────
  {
    ...
    vocabulary: [
      ...
      { word: "el kilo", english: "the kilo (kilogram)", pronunciation: "ehl KEE-loh", part_of_speech: "noun", gender: "m" },
      { word: "la manzana", english: "the apple", pronunciation: "lah mahn-SAH-nah", part_of_speech: "noun", gender: "f" },
      { word: "el tomate", english: "the tomato", pronunciation: "ehl toh-MAH-teh", part_of_speech: "noun", gender: "m" },
      { word: "la cebolla", english: "the onion", pronunciation: "lah seh-BOH-yah", part_of_speech: "noun", gender: "f" },
      { word: "el queso", english: "the cheese", pronunciation: "ehl KEH-soh", part_of_speech: "noun", gender: "m" },
      { word: "el pan", english: "the bread", pronunciation: "ehl pahn", part_of_speech: "noun", gender: "m" },
      { word: "el aguacate", english: "the avocado", pronunciation: "ehl ah-gwah-KAH-teh", part_of_speech: "noun", gender: "m", regional: [{ region: "Spain & Mexico & most LatAm", form: "el aguacate", note: "Náhuatl-origin word, used widely." }, { region: "Argentina / Chile / Peru / Uruguay", form: "la palta", note: "Quechua-origin word. Same fruit, totally different word." }] },
      { word: "maduro/a", english: "ripe", pronunciation: "mah-DOO-roh / -rah", part_of_speech: "adjective", gender: "mf" },
      { word: "fresco/a", english: "fresh", pronunciation: "FREHS-koh / -kah", part_of_speech: "adjective", gender: "mf" },
    ],
    dialogue: [
      { speaker: "Vendedor", spanish: "¿Qué le pongo?", english: "What can I get you? (Literally: What do I put for you?)", pronunciation: "keh leh POHN-goh?", register: "neutral" },
      { speaker: "Cliente", spanish: "Un kilo de tomates, por favor. ¿Están maduros?", english: "A kilo of tomatoes, please. Are they ripe?", pronunciation: "oon KEE-loh deh toh-MAH-tehs, pohr fah-VOHR. ehs-TAHN mah-DOO-rohs?", register: "neutral" },
      { speaker: "Vendedor", spanish: "Sí, hoy mismo del huerto. ¿Algo más?", english: "Yes, fresh from the garden today. Anything else?", pronunciation: "see, oy MEES-moh dehl WEHR-toh. AHL-goh MAHS?", register: "neutral" },
      { speaker: "Cliente", spanish: "Sí, medio kilo de cebollas también.", english: "Yes, half a kilo of onions too.", pronunciation: "see, MEH-dyoh KEE-loh deh seh-BOH-yahs tahm-BYEHN", register: "neutral" },
    ],
    cultural_note:
  ...
  // ── 14. questions — spanish_question_words ─────────────────────────────
  {
    ...
    vocabulary: [
      { word: "qué", english: "what", pronunciation: "keh", part_of_speech: "interrogative" },
      { word: "cómo", english: "how", pronunciation: "KOH-moh", part_of_speech: "interrogative" },
      { word: "dónde", english: "where", pronunciation: "DOHN-deh", part_of_speech: "interrogative" },
      { word: "cuándo", english: "when", pronunciation: "KWAHN-doh", part_of_speech: "interrogative" },
      { word: "por qué", english: "why", pronunciation: "pohr keh", part_of_speech: "interrogative" },
      { word: "porque", english: "because (NOT a question word)", pronunciation: "POHR-keh", part_of_speech: "conjunction" },
      { word: "quién", english: "who", pronunciation: "KYEHN", part_of_speech: "interrogative" },
      { word: "cuál", english: "which", pronunciation: "KWAHL", part_of_speech: "interrogative" },
      { word: "cuánto/a", english: "how much / how many", pronunciation: "KWAHN-toh / -tah", part_of_speech: "interrogative" },
    ],
    exercises: [
      {
        type: "fill_blank",
