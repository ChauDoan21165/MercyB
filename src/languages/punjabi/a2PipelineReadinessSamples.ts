// src/languages/punjabi/a2PipelineReadinessSamples.ts
//
// Punjabi A2 pipeline-readiness samples for Vietnamese-speaking and
...
export type PunjabiA2PipelineReadinessScenario =
  | "daily_routines"
  | "appointments"
  | "transport"
  | "housing"
...
export type PunjabiA2PipelineReadinessStyle =
  | "pipeline_readiness"
  | "ci_readiness"
  | "mr_readiness"
  | "pre_integration";

export type PunjabiA2PipelineReadinessLine = {
  pa: string;
  romanization: string;
  vi: string;
  en: string;
...
export type PunjabiA2PipelineReadinessTrap = {
  trap_vi: string;
  trap_en: string;
  fix_pa: string;
...
export type PunjabiA2PipelineReadinessItem = {
  id: string;
  scenario: PunjabiA2PipelineReadinessScenario;
  style: PunjabiA2PipelineReadinessStyle;
  title_vi: string;
  title_en: string;
  pipeline_goal_vi: string;
  pipeline_goal_en: string;
  ...
  lines: PunjabiA2PipelineReadinessLine[];
  checks: {
    q_vi: string;
    q_en: string;
    answer_pa: string;
  ...
  traps: PunjabiA2PipelineReadinessTrap[];
};

const scriptAwarenessVi =
  "Gurmukhi là chữ chính trong pipeline-readiness samples; Shahmukhi chỉ được nhắc để nhận biết, không phải khóa riêng.";
const scriptAwarenessEn =
  "Gurmukhi is the main script in these pipeline-readiness samples; Shahmukhi is mentioned only for awareness, not as a separate course.";

export const a2PipelineReadinessSamples: PunjabiA2PipelineReadinessItem[] = [
  {
    id: "pa_a2_pipeline_daily_routines",
    scenario: "daily_routines",
    style: "pipeline_readiness",
    title_vi: "Pipeline-readiness: thói quen hằng ngày",
    title_en: "Pipeline-readiness: daily routines",
    pipeline_goal_vi: "Giữ giờ, thói quen sáng, và một câu quá khứ ngắn ổn định trước tích hợp.",
    pipeline_goal_en: "Keep time, morning routine, and one short past sentence stable before integration.",
    stable_signal_vi: "Ổn nếu giờ thức dậy và giờ rời nhà không bị đổi chỗ.",
    stable_signal_en: "Stable if wake-up and leaving-home times are not swapped.",
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
    canada_practical_vi: "Hữu ích cho lớp ESL, ca làm sáng, và appointment sớm ở Canada.",
    canada_practical_en: "Useful for ESL classes, morning shifts, and early appointments in Canada.",
    lines: [
  ...
  {
    id: "pa_a2_pipeline_appointments",
    scenario: "appointments",
    style: "ci_readiness",
    title_vi: "CI-readiness: lịch hẹn",
    title_en: "CI-readiness: appointments",
    pipeline_goal_vi: "Giữ lịch hẹn, giấy tờ cần mang, và câu đổi lịch có điều kiện trong cùng mẫu.",
    pipeline_goal_en: "Keep appointment time, required documents, and conditional reschedule language in one sample.",
    stable_signal_vi: "Ổn nếu lịch hiện tại và đồ cần mang đều rõ.",
    stable_signal_en: "Stable if the current appointment and items to bring are both clear.",
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  {
    id: "pa_a2_pipeline_transport",
    scenario: "transport",
    style: "pre_integration",
    title_vi: "Pre-integration: đi lại",
    title_en: "Pre-integration: transport",
    pipeline_goal_vi: "Giữ tuyến, điểm xuống, và thông báo trễ nhất quán.",
    pipeline_goal_en: "Keep route, stop, and delay notice consistent.",
    stable_signal_vi: "Ổn nếu điểm đến, điểm xuống, và số phút trễ đều được giữ.",
    stable_signal_en: "Stable if destination, stop, and delay length are all retained.",
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  {
    id: "pa_a2_pipeline_housing",
    scenario: "housing",
    style: "mr_readiness",
    title_vi: "MR-readiness: nhà ở",
    title_en: "MR-readiness: housing",
    pipeline_goal_vi: "Giữ opener lịch sự, vấn đề, thời điểm bắt đầu, và yêu cầu sửa.",
    pipeline_goal_en: "Keep polite opener, problem, start time, and repair request.",
    stable_signal_vi: "Ổn nếu sự cố không bị đổi từ sink sang appliance khác.",
    stable_signal_en: "Stable if the issue does not shift from the sink to another appliance.",
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
    canada_practical_vi: "Phù hợp khi nhắn landlord, building manager, hoặc maintenance ở Canada.",
    canada_practical_en: "Fits messaging a landlord, building manager, or maintenance in Canada.",
    lines: [
  ...
  {
    id: "pa_a2_pipeline_school",
    scenario: "school",
    style: "pipeline_readiness",
    title_vi: "Pipeline-readiness: trường học",
    title_en: "Pipeline-readiness: school",
    pipeline_goal_vi: "Giữ vắng học, lý do, và yêu cầu gửi homework rõ ràng.",
    pipeline_goal_en: "Keep absence, reason, and homework request clear.",
    stable_signal_vi: "Ổn nếu người bị bệnh là trẻ và yêu cầu gửi bài vẫn rõ.",
    stable_signal_en: "Stable if the sick person is the child and the work request stays clear.",
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
    canada_practical_vi: "Dùng được với teacher email, school office, và parent portal ở Canada.",
    canada_practical_en: "Usable with teacher email, school office, and parent portals in Canada.",
    lines: [
  ...
  {
    id: "pa_a2_pipeline_childcare",
    scenario: "childcare",
    style: "ci_readiness",
    title_vi: "CI-readiness: childcare pickup",
    title_en: "CI-readiness: childcare pickup",
    pipeline_goal_vi: "Giữ người đón thay, giờ không đến được, và pickup list rõ.",
    pipeline_goal_en: "Keep alternate pickup person, unavailable time, and pickup list clear.",
    stable_signal_vi: "Ổn nếu tên người đón và list khớp nhau.",
  ...
  {
    id: "pa_a2_pipeline_workplace_small_talk",
    scenario: "workplace_small_talk",
    style: "mr_readiness",
    title_vi: "MR-readiness: small talk nơi làm",
    title_en: "MR-readiness: workplace small talk",
    pipeline_goal_vi: "Giữ chào hỏi, trả lời ngắn, và chuyển sang nhiệm vụ rõ.",
    pipeline_goal_en: "Keep greeting, short reply, and task transition clear.",
    ...
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
    canada_practical_vi: "Dùng được trong break room, shift handoff, và với supervisor ở Canada.",
    canada_practical_en: "Usable in a break room, shift handoff, and with a supervisor in Canada.",
    lines: [
  ...
  {
    id: "pa_a2_pipeline_forms",
    scenario: "forms",
    style: "pipeline_readiness",
    title_vi: "Pipeline-readiness: forms",
    title_en: "Pipeline-readiness: forms",
    pipeline_goal_vi: "Giữ tên, địa chỉ, và giấy tờ thiếu ổn định trong field form.",
    pipeline_goal_en: "Keep name, address, and missing document stable in form fields.",
    stable_signal_vi: "Ổn nếu các field form không đổi giữa câu và check.",
    stable_signal_en: "Stable if form fields do not change between lines and checks.",
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  {
    id: "pa_a2_pipeline_short_messages",
    scenario: "short_messages",
    style: "pre_integration",
    title_vi: "Pre-integration: tin nhắn ngắn",
    title_en: "Pre-integration: short messages",
    pipeline_goal_vi: "Giữ giờ, nơi, và vật cần mang được tách đúng.",
    pipeline_goal_en: "Keep time, place, and items to bring extracted correctly.",
    stable_signal_vi: "Ổn nếu thời gian, địa điểm, và vật cần mang đều có.",
    stable_signal_en: "Stable if time, place, and item to bring are all present.",
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  {
    id: "pa_a2_pipeline_service_flow",
    scenario: "service_flow",
    style: "ci_readiness",
    title_vi: "CI-readiness: luồng dịch vụ",
    title_en: "CI-readiness: service flow",
    pipeline_goal_vi: "Giữ opener, nhu cầu chính, và câu hỏi giấy tờ đầy đủ.",
    pipeline_goal_en: "Keep opener, main need, and document question complete.",
    stable_signal_vi: "Ổn nếu nhu cầu đổi địa chỉ và câu hỏi giấy tờ nối nhau rõ.",
    stable_signal_en: "Stable if change-address need and document question connect clearly.",
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  {
    id: "pa_a2_pipeline_polite_problem",
    scenario: "polite_problem_descriptions",
    style: "mr_readiness",
    title_vi: "MR-readiness: mô tả vấn đề lịch sự",
    title_en: "MR-readiness: polite problem descriptions",
    pipeline_goal_vi: "Giữ opener lịch sự, vấn đề, yêu cầu kiểm tra, và bước tiếp theo.",
    pipeline_goal_en: "Keep polite opener, problem, check request, and next-step question.",
    stable_signal_vi: "Ổn nếu vấn đề thẻ không hoạt động được giữ nguyên.",
    stable_signal_en: "Stable if the card-not-working problem stays unchanged.",
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  {
    id: "pa_a2_pipeline_interaction_repair",
    scenario: "interaction_repair",
    style: "pre_integration",
    title_vi: "Pre-integration: sửa chữa tương tác",
    title_en: "Pre-integration: interaction repair",
    pipeline_goal_vi: "Giữ báo chưa hiểu, xin nhắc lại, và xác nhận nghĩa đầy đủ.",
    pipeline_goal_en: "Keep non-understanding signal, repetition request, and meaning confirmation complete.",
    stable_signal_vi: "Ổn nếu có đủ ba bước repair trong cùng luồng.",
    stable_signal_en: "Stable if all three repair steps remain in the same flow.",
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
    canada_practical_vi: "Hữu ích khi xác nhận lịch clinic, school office, hoặc service counter ở Canada.",
    canada_practical_en: "Useful when confirming a clinic, school office, or service-counter schedule in Canada.",
    lines: [
