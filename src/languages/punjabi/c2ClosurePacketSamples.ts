// Punjabi C2 pre-closure-packet samples for Vietnamese- and English-speaking learners.
// Gurmukhi is primary; romanization is a reading aid.
//
// Scope/status: study-support pre-closure-packet samples only, not certification,
...
export type PunjabiC2ClosurePacketFocus =
...
export type PunjabiC2ClosurePacketContext = "public" | "professional" | "community";
export type PunjabiC2ClosurePacketStyle = "pre_closure_packet" | "runner_readiness" | "pipeline_readiness" | "pre_integration";

export type PunjabiC2ClosurePacketPhrase = {
  gurmukhi: string;
  romanization: string;
  vi: string;
  en: string;
...
export type PunjabiC2ClosurePacketCheck = {
  check_vi: string;
  check_en: string;
  signal_vi: string;
  signal_en: string;
...
export type PunjabiC2ClosurePacketTrap = {
  trap_vi: string;
  trap_en: string;
  repair_vi: string;
  repair_en: string;
...
export type PunjabiC2ClosurePacketSample = {
  id: string;
  focus: PunjabiC2ClosurePacketFocus;
  context: PunjabiC2ClosurePacketContext;
  style: PunjabiC2ClosurePacketStyle;
  title_vi: string;
  title_en: string;
  scenario_vi: string;
  scenario_en: string;
  ...
  sample_vi: string;
  sample_en: string;
  pre_closure_packet_phrases: PunjabiC2ClosurePacketPhrase[];
  checks: PunjabiC2ClosurePacketCheck[];
  learner_trap?: PunjabiC2ClosurePacketTrap;
  canada_practical?: boolean;
};

export const C2_PRE_CLOSURE_PACKET_SAMPLES_DISCLAIMER = {
  vi: "Bộ pre-closure-packet Punjabi C2 này chỉ hỗ trợ học tập, không phải chứng nhận hay xếp lớp chính thức. Gurmukhi là chính; phiên âm chỉ giúp đọc. Thẩm định bản xứ được hoãn lại. Shahmukhi chỉ được nhắc để nhận biết hệ chữ.",
  en: "This C2 Punjabi pre-closure-packet sample pack supports study only, not certification or official placement. Gurmukhi is primary; romanization only supports reading. Native review is deferred. Shahmukhi is noted only for script awareness.",
} as const;

export const c2ClosurePacketSamples: PunjabiC2ClosurePacketSample[] = [
  {
    id: "pa_c2_pre_closure_packet_nuanced_disagreement_professional",
    focus: "nuanced_disagreement",
    context: "professional",
    style: "pre_closure_packet",
    title_vi: "pre-closure-packet: bất đồng tinh tế",
    title_en: "pre-closure-packet: nuanced disagreement",
    ...
    sample_gurmukhi: "ਦਿਸ਼ਾ ਠੀਕ ਹੈ, ਪਰ pre-closure-packet ਤੋਂ ਪਹਿਲਾਂ ਇਸ ਦਲੀਲ ਨੂੰ ਇੱਕ ਵਾਰੀ ਹੋਰ ਪਰਖ ਲਈਏ।",
    sample_romanization: "disha theek hai, par pre-closure-packet ton pehlaan is dalil nu ikk vari hor parakh laie.",
    sample_vi: "Hướng đi đúng, nhưng trước pre-closure-packet ta hãy kiểm tra lập luận này thêm một lần.",
    sample_en: "The direction is right, but before pre-closure-packet let's test this argument once more.",
    pre_closure_packet_phrases: [
    ...
    learner_trap: {
      ...
      trap_en: "Direct negation before pre-closure-packet makes the tone too tense.",
  ...
  {
    id: "pa_c2_pre_closure_packet_diplomacy_community_canada",
    focus: "diplomacy",
    context: "community",
    style: "runner_readiness",
    title_vi: "pre-closure-packet: ngoại giao phạm vi",
    title_en: "pre-closure-packet: scope diplomacy",
    scenario_vi: "Một nhóm cộng đồng ở Canada muốn thêm đề xuất sau hạn ổn định.",
    scenario_en: "A Canadian community group wants to add a suggestion after the pre-A11 closure-packet review deadline.",
    ...
    sample_gurmukhi: "ਸੁਝਾਅ ਲਈ ਧੰਨਵਾਦ। ਇਸ pre-closure-packet ਵਿੱਚ ਹੱਦ ਨਹੀਂ ਬਦਲੇਗੀ, ਪਰ ਅਗਲੇ ਚੱਕਰ ਲਈ ਇਸ ਨੂੰ ਸੰਭਾਲ ਲੈਂਦੇ ਹਾਂ।",
    sample_romanization: "sujhaa lai dhanvaad. is pre-closure-packet vich hadd nahin badlegi, par agle chakkar lai is nu sambhaal lainde haan.",
    sample_vi: "Cảm ơn đề xuất. Trong pre-closure-packet này phạm vi sẽ không đổi, nhưng ta sẽ giữ lại cho vòng sau.",
    sample_en: "Thank you for the suggestion. In this pre-closure-packet the scope will not change, but we will keep it for the next cycle.",
    pre_closure_packet_phrases: [
  ...
  {
    id: "pa_c2_pre_closure_packet_mediation_public",
    focus: "mediation",
    context: "public",
    style: "pipeline_readiness",
    title_vi: "pre-closure-packet: trung gian công khai",
    title_en: "pre-closure-packet: public mediation",
    ...
    sample_gurmukhi: "ਦੋਵੇਂ ਪਾਸਿਆਂ ਦੀ ਗੱਲ ਦਰਜ ਹੈ; pre-closure-packet ਸਾਂਝੇ ਮਾਪਦੰਡ ਦੇ ਆਧਾਰ ਤੇ ਕੀਤਾ ਜਾਵੇਗਾ।",
    sample_romanization: "dovein pasian di gall darj hai; pre-closure-packet sanjhe mapdand de aadhaar te kita javega.",
    sample_vi: "Ý kiến của cả hai bên đã được ghi nhận; pre-closure-packet sẽ dựa trên tiêu chí chung.",
    sample_en: "Both sides' points are recorded; the pre-closure-packet will be based on shared criteria.",
    pre_closure_packet_phrases: [
  ...
  {
    id: "pa_c2_pre_closure_packet_deescalation_professional",
    focus: "deescalation",
    context: "professional",
    style: "pre_closure_packet",
    title_vi: "pre-closure-packet: hạ nhiệt trách nhiệm",
    title_en: "pre-closure-packet: de-escalating ownership",
    scenario_vi: "Cuộc họp ổn định cuối căng vì một lỗi nhỏ còn được nhắc lại.",
    scenario_en: "A pre-closure-packet meeting is tense because a small issue keeps being repeated.",
    ...
    sample_gurmukhi: "ਮੁੱਦਾ ਦਰਜ ਹੋ ਗਿਆ ਹੈ; ਹੁਣ ਵਿਅਕਤੀ ਨਹੀਂ, ਸੁਧਾਰ ਦੇ ਕਦਮ ਨੂੰ pre-closure-packet ਵਿੱਚ ਪੱਕਾ ਕਰੀਏ।",
    sample_romanization: "mudda darj ho giya hai; hun vyakti nahin, sudhaar de kadam nu pre-closure-packet vich pakka kariye.",
    sample_vi: "Vấn đề đã được ghi nhận; bây giờ không nói về cá nhân, hãy ổn định bước sửa trong pre-closure-packet.",
    sample_en: "The issue has been recorded; now let's focus on the repair step, not the person, in pre-closure-packet.",
    pre_closure_packet_phrases: [
  ...
  {
    id: "pa_c2_pre_closure_packet_audience_adaptation_canada",
    focus: "audience_adaptation",
    context: "community",
    style: "pre_integration",
    title_vi: "pre-closure-packet: thông báo cho nhóm đa thế hệ",
    title_en: "pre-closure-packet: notice for a multi-generational group",
  ...
  {
    id: "pa_c2_pre_closure_packet_sensitive_topic_public",
    focus: "sensitive_topic_framing",
    context: "public",
    style: "pipeline_readiness",
    title_vi: "pre-closure-packet: khung chủ đề nhạy cảm",
    title_en: "pre-closure-packet: sensitive-topic framing",
    scenario_vi: "Một nhận xét công khai kéo bản ổn định cuối sang chính trị, tôn giáo, tiền bạc, hoặc danh tính cá nhân.",
    scenario_en: "A public comment pulls the pre-closure-packet toward politics, religion, money, or personal identity.",
    ...
    sample_gurmukhi: "ਇਹ ਵਿਸ਼ਾ ਸੰਵੇਦਨਸ਼ੀਲ ਹੈ, ਇਸ ਲਈ pre-closure-packet ਨੂੰ ਕੰਮ ਨਾਲ ਜੁੜੇ ਹਿੱਸੇ ਤੱਕ ਹੀ ਰੱਖੀਏ।",
    sample_romanization: "ih visha sanvedansheel hai, is lai pre-closure-packet nu kamm naal jurre hisse takk hi rakhie.",
    sample_vi: "Chủ đề này nhạy cảm, vì vậy hãy giữ pre-closure-packet chỉ trong phần liên quan công việc.",
    sample_en: "This topic is sensitive, so let's keep pre-closure-packet only to the work-related part.",
    pre_closure_packet_phrases: [
  ...
  {
    id: "pa_c2_pre_closure_packet_public_calibration_professional",
    focus: "public_communication_calibration",
    context: "professional",
    style: "runner_readiness",
    title_vi: "pre-closure-packet: cân chỉnh thông báo",
    title_en: "pre-closure-packet: calibrated announcement",
    ...
    sample_gurmukhi: "ਇਹ ਹਿੱਸਾ pre-closure-packet ਵਿੱਚ ਹੈ; ਵਰਤੋਂ ਦੌਰਾਨ ਆਉਣ ਵਾਲੀ ਪ੍ਰਤੀਕਿਰਿਆ ਨੂੰ ਫਿਰ ਵੀ ਧਿਆਨ ਨਾਲ ਵੇਖਾਂਗੇ।",
    sample_romanization: "ih hissa pre-closure-packet vich hai; varton dauran aun vali pratikiria nu phir vi dhian naal vekhange.",
    sample_vi: "Phần này đã ở pre-closure-packet; tuy vậy trong quá trình sử dụng chúng tôi vẫn sẽ theo dõi phản hồi cẩn thận.",
    sample_en: "This part is in pre-closure-packet; still, during use we will watch feedback carefully.",
    pre_closure_packet_phrases: [
      { gurmukhi: "pre-closure-packet ਵਿੱਚ ਹੈ", romanization: "pre-closure-packet vich hai", vi: "Đang ở pre-closure-packet.", en: "Is in pre-closure-packet." },
  ...
  {
    id: "pa_c2_pre_closure_packet_register_safety_community",
    focus: "register_safety",
    context: "community",
    style: "pre_integration",
    title_vi: "pre-closure-packet: an toàn register cộng đồng",
    title_en: "pre-closure-packet: community register safety",
...
export const c2ClosurePacketSamplesByFocus = (focus: PunjabiC2ClosurePacketFocus) =>
  c2ClosurePacketSamples.filter((sample) => sample.focus === focus);

export const c2ClosurePacketSamplesByContext = (context: PunjabiC2ClosurePacketContext) =>
  c2ClosurePacketSamples.filter((sample) => sample.context === context);
