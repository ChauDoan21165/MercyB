// Punjabi Canada survival runner-readiness samples for Vietnamese-speaking and
...
export type PunjabiCanadaSurvivalRunnerReadinessDomain =
  | "clinic"
  | "pharmacy"
  | "school_childcare"
  | "bank"
...
export type PunjabiCanadaSurvivalRunnerReadinessUse =
  | "runner_readiness"
  | "pipeline_readiness"
  | "ci_readiness"
  | "mr_readiness"
...
export type PunjabiCanadaSurvivalRunnerReadinessItem = {
  id: string;
  domain: PunjabiCanadaSurvivalRunnerReadinessDomain;
  use: PunjabiCanadaSurvivalRunnerReadinessUse;
  ...
  meaning_en: string;
  support_pa: string[];
  runner_readiness_check_vi: string;
  runner_readiness_check_en: string;
...
export type PunjabiCanadaSurvivalRunnerReadinessScope = {
  name: string;
  audience: string[];
  scriptPolicy: string;
  reviewStatus: string;
...
export const PUNJABI_CANADA_SURVIVAL_RUNNER_READINESS_SCOPE: PunjabiCanadaSurvivalRunnerReadinessScope = {
  name: "Punjabi Canada Survival Runner Readiness Samples",
  ...
  boundaries: [
    "Language support only for Canada survival runner-readiness samples.",
    "No medical, legal, financial, tenancy, or workplace safety advice.",
  ],
};

export const PUNJABI_CANADA_SURVIVAL_RUNNER_READINESS_SAMPLES: PunjabiCanadaSurvivalRunnerReadinessItem[] = [
  {
    id: "pa-ca-runnerreadiness-clinic-001",
    domain: "clinic",
    use: "runner_readiness",
    runner_readiness_vi: "Khóa cuối câu phòng khám để người học xin nói chậm và nhắc lại trước khi trả lời.",
    runner_readiness_en:
      "Runner-readiness sample checks the clinic line so the learner can ask for slow speech and a repeat before answering.",
    ...
    runner_readiness_check_vi: "Runner-readiness giữ câu ở hỗ trợ ngôn ngữ, không đưa lời khuyên y tế.",
    runner_readiness_check_en: "Runner-readiness keeps this as language support, not medical advice.",
  ...
  {
    id: "pa-ca-runnerreadiness-pharmacy-002",
    domain: "pharmacy",
    use: "pipeline_readiness",
    runner_readiness_vi: "Khóa cuối câu nhà thuốc để nêu dị ứng và xin ghi thông tin bằng văn bản.",
    runner_readiness_en: "Runner-readiness sample checks the pharmacy line for stating an allergy and asking for written information.",
    ...
    runner_readiness_check_vi: "Runner-readiness xác nhận câu không thêm liều lượng hoặc tư vấn thuốc.",
    runner_readiness_check_en: "Runner-readiness confirms the line adds no dosage or medicine advice.",
  ...
  {
    id: "pa-ca-runnerreadiness-school-003",
    domain: "school_childcare",
    use: "pre_integration",
    runner_readiness_vi: "Khóa cuối câu trường học hoặc childcare khi phụ huynh cần hiểu thông báo.",
    runner_readiness_en: "Runner-readiness sample checks the school or childcare line when a parent needs to understand a notice.",
    ...
    runner_readiness_check_vi: "Pre-integration xác nhận câu nối được với trường, childcare, và form.",
    runner_readiness_check_en: "Pre-integration confirms the line connects to school, childcare, and form flows.",
  ...
  {
    id: "pa-ca-runnerreadiness-bank-004",
    domain: "bank",
    use: "ci_readiness",
    runner_readiness_vi: "Khóa cuối câu ngân hàng để mở tài khoản và hỏi phí mà không chuyển sang tư vấn tiền bạc.",
    runner_readiness_en:
      "Runner-readiness sample checks the bank line for opening an account and asking fees without moving into money advice.",
    ...
    runner_readiness_check_vi: "CI-readiness giữ câu ngoài thẻ, vay, hoặc lời khuyên tài chính.",
    runner_readiness_check_en: "CI-readiness keeps the line away from cards, loans, or financial advice.",
  ...
  {
    id: "pa-ca-runnerreadiness-housing-005",
    domain: "housing",
    use: "runner_readiness",
    runner_readiness_vi: "Khóa cuối câu nhà thuê để xin lịch sửa và phản hồi bằng văn bản.",
    runner_readiness_en: "Runner-readiness sample checks the rental line for asking a repair timeline and written reply.",
    ...
    runner_readiness_check_vi: "Runner-readiness xác nhận câu chỉ xin lịch và văn bản, không phải tư vấn pháp lý.",
    runner_readiness_check_en: "Runner-readiness confirms the line only asks for timing and writing, not legal advice.",
  ...
  {
    id: "pa-ca-runnerreadiness-transport-006",
    domain: "transport",
    use: "pre_integration",
    runner_readiness_vi: "Khóa cuối câu giao thông để hỏi đúng tuyến và điểm xuống.",
    runner_readiness_en: "Runner-readiness sample checks the transit line for checking the route and stop.",
    ...
    runner_readiness_check_vi: "Pre-integration xác nhận câu nối được với chỉ đường và lịch trình.",
    runner_readiness_check_en: "Pre-integration confirms the line connects to directions and schedule content.",
  ...
  {
    id: "pa-ca-runnerreadiness-public-office-007",
    domain: "public_office",
    use: "mr_readiness",
    runner_readiness_vi: "Khóa cuối câu cơ quan công để hỏi quầy đúng và giấy tờ cần có.",
    runner_readiness_en:
      "Runner-readiness sample checks the public-office line for asking the right counter and required documents.",
    ...
    runner_readiness_check_vi: "Runner-readiness xác nhận câu dùng được ở quầy dịch vụ và form.",
    runner_readiness_check_en: "Runner-readiness confirms the line works at a service counter and with forms.",
  ...
  {
    id: "pa-ca-runnerreadiness-forms-008",
    domain: "forms_service_desk",
    use: "runner_readiness",
    runner_readiness_vi: "Khóa cuối câu bàn dịch vụ để chỉ phần form chưa hiểu.",
    runner_readiness_en: "Runner-readiness sample checks the service-desk line for pointing to the unclear form section.",
    ...
    runner_readiness_check_vi: "Runner-readiness xác nhận câu form đủ rõ trước khi khóa nội dung.",
    runner_readiness_check_en: "Runner-readiness confirms the form line is clear before content freeze.",
  ...
  {
    id: "pa-ca-runnerreadiness-interpreter-009",
    domain: "interpreter_request",
    use: "pipeline_readiness",
    runner_readiness_vi: "Khóa cuối câu xin thông dịch viên khi tình huống vượt quá mức hiểu.",
    runner_readiness_en: "Runner-readiness sample checks the interpreter request when the situation exceeds the learner's understanding.",
    ...
    runner_readiness_check_vi: "CI-readiness xác nhận Shahmukhi chỉ là nhận biết, không phải khóa học đầy đủ.",
    runner_readiness_check_en: "CI-readiness confirms Shahmukhi is awareness only, not a full course.",
  ...
  {
    id: "pa-ca-runnerreadiness-emergency-010",
    domain: "emergency_boundary",
    use: "mr_readiness",
    runner_readiness_vi: "Khóa cuối câu khẩn cấp khi có nguy hiểm thật sự và cần gọi 911.",
    runner_readiness_en: "Runner-readiness sample checks the emergency line when there is real danger and 911 is needed.",
    ...
    runner_readiness_check_vi: "Runner-readiness giữ câu rõ và không thay thế dịch vụ khẩn cấp.",
    runner_readiness_check_en: "Runner-readiness keeps the line clear and does not replace emergency services.",
  ...
  {
    id: "pa-ca-runnerreadiness-recovery-011",
    domain: "service_recovery",
    use: "runner_readiness",
    runner_readiness_vi: "Khóa cuối câu phục hồi dịch vụ khi thông tin sai hoặc chưa khớp.",
    runner_readiness_en:
      "Runner-readiness sample checks the service-recovery line when information is wrong or does not match.",
    ...
    runner_readiness_check_vi: "Runner-readiness xác nhận câu sửa lỗi vẫn lịch sự và thực tế.",
    runner_readiness_check_en: "Runner-readiness confirms the correction line stays polite and practical.",
  ...
  {
    id: "pa-ca-runnerreadiness-workplace-012",
    domain: "workplace_safety",
    use: "pre_integration",
    runner_readiness_vi: "Khóa cuối câu nơi làm việc khi người học chưa hiểu hướng dẫn an toàn.",
    runner_readiness_en:
      "Runner-readiness sample checks the workplace line when the learner did not understand a safety instruction.",
    ...
    runner_readiness_check_vi: "Pre-integration giữ câu ở mức xin làm rõ ngôn ngữ, không đưa hướng dẫn kỹ thuật.",
    runner_readiness_check_en: "Pre-integration keeps this as language clarification, not technical instruction.",
...
export default PUNJABI_CANADA_SURVIVAL_RUNNER_READINESS_SAMPLES;
