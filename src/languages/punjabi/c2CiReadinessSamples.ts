// Punjabi C2 CI-readiness samples for Vietnamese- and English-speaking learners.
// Gurmukhi is primary; romanization is a reading aid.
//
// Scope/status: study-support CI-readiness samples only, not certification,
...
export type PunjabiC2CiReadinessFocus =
...
export type PunjabiC2CiReadinessContext = "public" | "professional" | "community";
export type PunjabiC2CiReadinessStyle = "ci_readiness" | "mr_readiness" | "final_freeze" | "pre_integration";

export type PunjabiC2CiReadinessPhrase = {
  gurmukhi: string;
  romanization: string;
  vi: string;
  en: string;
...
export type PunjabiC2CiReadinessCheck = {
  check_vi: string;
  check_en: string;
  signal_vi: string;
  signal_en: string;
...
export type PunjabiC2CiReadinessTrap = {
  trap_vi: string;
  trap_en: string;
  repair_vi: string;
  repair_en: string;
...
export type PunjabiC2CiReadinessSample = {
  id: string;
  focus: PunjabiC2CiReadinessFocus;
  context: PunjabiC2CiReadinessContext;
  style: PunjabiC2CiReadinessStyle;
  title_vi: string;
  title_en: string;
  scenario_vi: string;
  scenario_en: string;
  ...
  sample_vi: string;
  sample_en: string;
  ci_readiness_phrases: PunjabiC2CiReadinessPhrase[];
  checks: PunjabiC2CiReadinessCheck[];
  learner_trap?: PunjabiC2CiReadinessTrap;
  canada_practical?: boolean;
};

export const C2_CI_READINESS_SAMPLES_DISCLAIMER = {
  vi: "Bộ CI-readiness Punjabi C2 này chỉ hỗ trợ học tập, không phải chứng nhận hay xếp lớp chính thức. Gurmukhi là chính; phiên âm chỉ giúp đọc. Thẩm định bản xứ được hoãn lại. Shahmukhi chỉ được nhắc để nhận biết hệ chữ.",
  en: "This C2 Punjabi CI-readiness sample pack supports study only, not certification or official placement. Gurmukhi is primary; romanization only supports reading. Native review is deferred. Shahmukhi is noted only for script awareness.",
} as const;

export const c2CiReadinessSamples: PunjabiC2CiReadinessSample[] = [
  {
    id: "pa_c2_ci_readiness_nuanced_disagreement_professional",
    focus: "nuanced_disagreement",
    context: "professional",
    style: "ci_readiness",
    title_vi: "CI readiness: bất đồng tinh tế",
    title_en: "CI readiness: nuanced disagreement",
    ...
    sample_gurmukhi: "ਦਿਸ਼ਾ ਠੀਕ ਹੈ, ਪਰ CI readiness ਤੋਂ ਪਹਿਲਾਂ ਇਸ ਦਲੀਲ ਨੂੰ ਇੱਕ ਵਾਰੀ ਹੋਰ ਪਰਖ ਲਈਏ।",
    sample_romanization: "disha theek hai, par CI readiness ton pehlaan is dalil nu ikk vari hor parakh laie.",
    sample_vi: "Hướng đi đúng, nhưng trước CI readiness ta hãy kiểm tra lập luận này thêm một lần.",
    sample_en: "The direction is right, but before CI readiness let's test this argument once more.",
    ci_readiness_phrases: [
    ...
    learner_trap: {
      ...
      trap_en: "Direct negation before CI readiness makes the tone too tense.",
  ...
  {
    id: "pa_c2_ci_readiness_diplomacy_community_canada",
    focus: "diplomacy",
    context: "community",
    style: "final_freeze",
    title_vi: "CI readiness: ngoại giao phạm vi",
    title_en: "CI readiness: scope diplomacy",
    scenario_vi: "Một nhóm cộng đồng ở Canada muốn thêm đề xuất sau hạn ổn định.",
    scenario_en: "A Canadian community group wants to add a suggestion after the CI review deadline.",
    ...
    sample_gurmukhi: "ਸੁਝਾਅ ਲਈ ਧੰਨਵਾਦ। ਇਸ CI readiness ਵਿੱਚ ਹੱਦ ਨਹੀਂ ਬਦਲੇਗੀ, ਪਰ ਅਗਲੇ ਚੱਕਰ ਲਈ ਇਸ ਨੂੰ ਸੰਭਾਲ ਲੈਂਦੇ ਹਾਂ।",
    sample_romanization: "sujhaa lai dhanvaad. is CI readiness vich hadd nahin badlegi, par agle chakkar lai is nu sambhaal lainde haan.",
    sample_vi: "Cảm ơn đề xuất. Trong CI readiness này phạm vi sẽ không đổi, nhưng ta sẽ giữ lại cho vòng sau.",
    sample_en: "Thank you for the suggestion. In this CI readiness the scope will not change, but we will keep it for the next cycle.",
    ci_readiness_phrases: [
  ...
  {
    id: "pa_c2_ci_readiness_mediation_public",
    focus: "mediation",
    context: "public",
    style: "mr_readiness",
    title_vi: "CI readiness: trung gian công khai",
    title_en: "CI readiness: public mediation",
    ...
    sample_gurmukhi: "ਦੋਵੇਂ ਪਾਸਿਆਂ ਦੀ ਗੱਲ ਦਰਜ ਹੈ; CI readiness ਸਾਂਝੇ ਮਾਪਦੰਡ ਦੇ ਆਧਾਰ ਤੇ ਕੀਤਾ ਜਾਵੇਗਾ।",
    sample_romanization: "dovein pasian di gall darj hai; CI readiness sanjhe mapdand de aadhaar te kita javega.",
    sample_vi: "Ý kiến của cả hai bên đã được ghi nhận; CI readiness sẽ dựa trên tiêu chí chung.",
    sample_en: "Both sides' points are recorded; the CI readiness will be based on shared criteria.",
    ci_readiness_phrases: [
  ...
  {
    id: "pa_c2_ci_readiness_deescalation_professional",
    focus: "deescalation",
    context: "professional",
    style: "ci_readiness",
    title_vi: "CI readiness: hạ nhiệt trách nhiệm",
    title_en: "CI readiness: de-escalating ownership",
    scenario_vi: "Cuộc họp ổn định cuối căng vì một lỗi nhỏ còn được nhắc lại.",
    scenario_en: "A CI readiness meeting is tense because a small issue keeps being repeated.",
    ...
    sample_gurmukhi: "ਮੁੱਦਾ ਦਰਜ ਹੋ ਗਿਆ ਹੈ; ਹੁਣ ਵਿਅਕਤੀ ਨਹੀਂ, ਸੁਧਾਰ ਦੇ ਕਦਮ ਨੂੰ CI readiness ਵਿੱਚ ਪੱਕਾ ਕਰੀਏ।",
    sample_romanization: "mudda darj ho giya hai; hun vyakti nahin, sudhaar de kadam nu CI readiness vich pakka kariye.",
    sample_vi: "Vấn đề đã được ghi nhận; bây giờ không nói về cá nhân, hãy ổn định bước sửa trong CI readiness.",
    sample_en: "The issue has been recorded; now let's focus on the repair step, not the person, in CI readiness.",
    ci_readiness_phrases: [
  ...
  {
    id: "pa_c2_ci_readiness_audience_adaptation_canada",
    focus: "audience_adaptation",
    context: "community",
    style: "pre_integration",
    title_vi: "CI readiness: thông báo cho nhóm đa thế hệ",
    title_en: "CI readiness: notice for a multi-generational group",
  ...
  {
    id: "pa_c2_ci_readiness_sensitive_topic_public",
    focus: "sensitive_topic_framing",
    context: "public",
    style: "mr_readiness",
    title_vi: "CI readiness: khung chủ đề nhạy cảm",
    title_en: "CI readiness: sensitive-topic framing",
    scenario_vi: "Một nhận xét công khai kéo bản ổn định cuối sang chính trị, tôn giáo, tiền bạc, hoặc danh tính cá nhân.",
    scenario_en: "A public comment pulls the CI readiness toward politics, religion, money, or personal identity.",
    ...
    sample_gurmukhi: "ਇਹ ਵਿਸ਼ਾ ਸੰਵੇਦਨਸ਼ੀਲ ਹੈ, ਇਸ ਲਈ CI readiness ਨੂੰ ਕੰਮ ਨਾਲ ਜੁੜੇ ਹਿੱਸੇ ਤੱਕ ਹੀ ਰੱਖੀਏ।",
    sample_romanization: "ih visha sanvedansheel hai, is lai CI readiness nu kamm naal jurre hisse takk hi rakhie.",
    sample_vi: "Chủ đề này nhạy cảm, vì vậy hãy giữ CI readiness chỉ trong phần liên quan công việc.",
    sample_en: "This topic is sensitive, so let's keep CI readiness only to the work-related part.",
    ci_readiness_phrases: [
  ...
  {
    id: "pa_c2_ci_readiness_public_calibration_professional",
    focus: "public_communication_calibration",
    context: "professional",
    style: "final_freeze",
    title_vi: "CI readiness: cân chỉnh thông báo",
    title_en: "CI readiness: calibrated announcement",
    ...
    sample_gurmukhi: "ਇਹ ਹਿੱਸਾ CI readiness ਵਿੱਚ ਹੈ; ਵਰਤੋਂ ਦੌਰਾਨ ਆਉਣ ਵਾਲੀ ਪ੍ਰਤੀਕਿਰਿਆ ਨੂੰ ਫਿਰ ਵੀ ਧਿਆਨ ਨਾਲ ਵੇਖਾਂਗੇ।",
    sample_romanization: "ih hissa CI readiness vich hai; varton dauran aun vali pratikiria nu phir vi dhian naal vekhange.",
    sample_vi: "Phần này đã ở CI readiness; tuy vậy trong quá trình sử dụng chúng tôi vẫn sẽ theo dõi phản hồi cẩn thận.",
    sample_en: "This part is in CI readiness; still, during use we will watch feedback carefully.",
    ci_readiness_phrases: [
      { gurmukhi: "CI readiness ਵਿੱਚ ਹੈ", romanization: "CI readiness vich hai", vi: "Đang ở CI readiness.", en: "Is in CI readiness." },
  ...
  {
    id: "pa_c2_ci_readiness_register_safety_community",
    focus: "register_safety",
    context: "community",
    style: "pre_integration",
    title_vi: "CI readiness: an toàn register cộng đồng",
    title_en: "CI readiness: community register safety",
...
export const c2CiReadinessSamplesByFocus = (focus: PunjabiC2CiReadinessFocus) =>
  c2CiReadinessSamples.filter((sample) => sample.focus === focus);

export const c2CiReadinessSamplesByContext = (context: PunjabiC2CiReadinessContext) =>
  c2CiReadinessSamples.filter((sample) => sample.context === context);
