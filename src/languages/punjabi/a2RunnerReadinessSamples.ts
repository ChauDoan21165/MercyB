// src/languages/punjabi/a2RunnerReadinessSamples.ts
//
// Punjabi A2 runner-readiness samples for Vietnamese-speaking and
...
export type PunjabiA2RunnerReadinessScenario =
  | "daily_routines"
  | "appointments"
  | "transport"
  | "housing"
...
export type PunjabiA2RunnerReadinessStyle =
  | "runner_readiness"
  | "pipeline_readiness"
  | "ci_readiness"
  | "pre_integration";

export type PunjabiA2RunnerReadinessLine = {
  pa: string;
  romanization: string;
  vi: string;
  en: string;
...
export type PunjabiA2RunnerReadinessTrap = {
  trap_vi: string;
  trap_en: string;
  fix_pa: string;
...
export type PunjabiA2RunnerReadinessItem = {
  id: string;
  scenario: PunjabiA2RunnerReadinessScenario;
  style: PunjabiA2RunnerReadinessStyle;
  title_vi: string;
  title_en: string;
  runner_goal_vi: string;
  runner_goal_en: string;
...
const scriptAwarenessVi =
  "Gurmukhi là chữ chính trong runner-readiness samples; Shahmukhi chỉ được nhắc để nhận biết, không phải khóa riêng.";
const scriptAwarenessEn =
  "Gurmukhi is the main script in these runner-readiness samples; Shahmukhi is mentioned only for awareness, not as a separate course.";

export const a2RunnerReadinessSamples: PunjabiA2RunnerReadinessItem[] = [
  {
    id: "pa_a2_runner_daily_routines",
    scenario: "daily_routines",
    style: "runner_readiness",
    title_vi: "Runner-readiness: thói quen hằng ngày",
    title_en: "Runner-readiness: daily routines",
    runner_goal_vi: "Kiểm tra giờ, thói quen sáng, và một câu quá khứ ngắn vẫn ổn trong automated runner.",
    runner_goal_en: "Check that time, morning routine, and one short past sentence stay stable in the automated runner.",
  ...
  {
    id: "pa_a2_runner_appointments",
    scenario: "appointments",
    style: "pipeline_readiness",
    title_vi: "Pipeline-readiness: lịch hẹn",
    title_en: "Pipeline-readiness: appointments",
    runner_goal_vi: "Giữ lịch hẹn, giấy tờ cần mang, và câu đổi lịch có điều kiện trong cùng mẫu runner.",
    runner_goal_en: "Keep appointment time, required documents, and conditional reschedule language in one runner sample.",
  ...
  {
    id: "pa_a2_runner_transport",
    scenario: "transport",
    style: "ci_readiness",
    title_vi: "CI-readiness: đi lại",
    title_en: "CI-readiness: transport",
    runner_goal_vi: "Giữ tuyến, điểm xuống, và thông báo trễ nhất quán khi chạy test.",
    runner_goal_en: "Keep route, stop, and delay notice consistent when tests run.",
  ...
  {
    id: "pa_a2_runner_housing",
    scenario: "housing",
    style: "pre_integration",
    title_vi: "Pre-integration: nhà ở",
    title_en: "Pre-integration: housing",
    runner_goal_vi: "Giữ opener lịch sự, vấn đề, thời điểm bắt đầu, và yêu cầu sửa.",
    runner_goal_en: "Keep polite opener, problem, start time, and repair request.",
  ...
  {
    id: "pa_a2_runner_school",
    scenario: "school",
    style: "runner_readiness",
    title_vi: "Runner-readiness: trường học",
    title_en: "Runner-readiness: school",
    runner_goal_vi: "Giữ vắng học, lý do, và yêu cầu gửi homework rõ ràng.",
    runner_goal_en: "Keep absence, reason, and homework request clear.",
  ...
  {
    id: "pa_a2_runner_childcare",
    scenario: "childcare",
    style: "pipeline_readiness",
    title_vi: "Pipeline-readiness: childcare pickup",
    title_en: "Pipeline-readiness: childcare pickup",
    runner_goal_vi: "Giữ người đón thay, giờ không đến được, và pickup list rõ.",
    runner_goal_en: "Keep alternate pickup person, unavailable time, and pickup list clear.",
  ...
  {
    id: "pa_a2_runner_workplace_small_talk",
    scenario: "workplace_small_talk",
    style: "ci_readiness",
    title_vi: "CI-readiness: small talk nơi làm",
    title_en: "CI-readiness: workplace small talk",
    runner_goal_vi: "Giữ chào hỏi, trả lời ngắn, và chuyển sang nhiệm vụ rõ.",
    runner_goal_en: "Keep greeting, short reply, and task transition clear.",
  ...
  {
    id: "pa_a2_runner_forms",
    scenario: "forms",
    style: "pre_integration",
    title_vi: "Pre-integration: forms",
    title_en: "Pre-integration: forms",
    runner_goal_vi: "Giữ tên, địa chỉ, và giấy tờ thiếu ổn định trong field form.",
    runner_goal_en: "Keep name, address, and missing document stable in form fields.",
  ...
  {
    id: "pa_a2_runner_short_messages",
    scenario: "short_messages",
    style: "runner_readiness",
    title_vi: "Runner-readiness: tin nhắn ngắn",
    title_en: "Runner-readiness: short messages",
    runner_goal_vi: "Giữ giờ, nơi, và vật cần mang được tách đúng trong runner.",
    runner_goal_en: "Keep time, place, and items to bring extracted correctly in the runner.",
  ...
  {
    id: "pa_a2_runner_service_flow",
    scenario: "service_flow",
    style: "pipeline_readiness",
    title_vi: "Pipeline-readiness: luồng dịch vụ",
    title_en: "Pipeline-readiness: service flow",
    runner_goal_vi: "Giữ opener, nhu cầu chính, và câu hỏi giấy tờ đầy đủ.",
    runner_goal_en: "Keep opener, main need, and document question complete.",
  ...
  {
    id: "pa_a2_runner_polite_problem",
    ...
    runner_goal_vi: "Giữ opener lịch sự, vấn đề, yêu cầu kiểm tra, và bước tiếp theo.",
    runner_goal_en: "Keep polite opener, problem, check request, and next-step question.",
  ...
  {
    id: "pa_a2_runner_interaction_repair",
    scenario: "interaction_repair",
    style: "pre_integration",
    title_vi: "Pre-integration: sửa chữa tương tác",
    title_en: "Pre-integration: interaction repair",
    runner_goal_vi: "Giữ báo chưa hiểu, xin nhắc lại, và xác nhận nghĩa đầy đủ.",
    runner_goal_en: "Keep non-understanding signal, repetition request, and meaning confirmation complete.",
