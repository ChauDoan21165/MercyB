// Punjabi A1 acceptance samples for Vietnamese-speaking and English-speaking learners.
// Gurmukhi is primary; romanization supports recall. Native review is deferred.

export type PunjabiA1AcceptanceDomain =
  | "greetings"
  | "identity"
  | "family"
  | "numbers"
...
export type PunjabiA1AcceptanceStyle =
  | "acceptance"
  | "ship_candidate"
  | "go_no_go"
  | "closure_validation"
...
export type PunjabiA1AcceptanceSample = {
  id: string;
  domain: PunjabiA1AcceptanceDomain;
  style: PunjabiA1AcceptanceStyle;
  prompt_vi: string;
  prompt_en: string;
  cue_pa: string;
  romanization?: string;
...
export const acceptanceScriptAwareness =
  "Gurmukhi is the primary script for this Punjabi A1 acceptance set. Shahmukhi is awareness only, not a full course track.";

export const punjabiA1AcceptanceSamples: PunjabiA1AcceptanceSample[] = [
  {
    id: "pa_a1_acceptance_greeting_001",
    domain: "greetings",
    style: "acceptance",
    prompt_vi: "Xác nhận câu chào ổn định cho bản acceptance.",
    prompt_en: "Confirm the greeting is stable for the acceptance.",
    cue_pa: "ਸਤ ਸ੍ਰੀ ਅਕਾਲ।",
    romanization: "sat sri akal",
    meaning_vi: "Xin chào.",
    meaning_en: "Hello.",
    expected_pa: "ਸਤ ਸ੍ਰੀ ਅਕਾਲ।",
    acceptance_check_vi: "Câu chào phải mở được luồng A1.",
    acceptance_check_en: "The greeting must open the A1 flow.",
  ...
  {
    id: "pa_a1_acceptance_identity_001",
    domain: "identity",
    style: "qa",
    ...
    acceptance_check_vi: "Khung tên phải nối được sau câu chào.",
    acceptance_check_en: "The name frame must connect after the greeting.",
  ...
  {
    id: "pa_a1_acceptance_family_001",
    domain: "family",
    ...
    acceptance_check_vi: "Mẫu này kiểm tra người thân và 'tôi có'.",
    acceptance_check_en: "This checks family members and 'I have'.",
  ...
  {
    id: "pa_a1_acceptance_numbers_001",
    domain: "numbers",
    style: "go_no_go",
    ...
    acceptance_check_vi: "Số phải chạy được trước khi nối sang giá.",
    acceptance_check_en: "The number must work before linking to a price.",
  ...
  {
    id: "pa_a1_acceptance_prices_001",
    domain: "prices",
    style: "selector",
    ...
    acceptance_check_vi: "Giá phải giữ số và đơn vị tiền rõ ràng.",
    acceptance_check_en: "The price must keep number and currency clear.",
  ...
  },
  {
    ...
    acceptance_check_vi: "Mẫu nhu cầu phải giữ ਮੈਨੂੰ ... ਚਾਹੀਦਾ ਹੈ.",
    acceptance_check_en: "The need frame must keep ਮੈਨੂੰ ... ਚਾਹੀਦਾ ਹੈ.",
  ...
  {
    id: "pa_a1_acceptance_directions_001",
    domain: "directions",
    style: "qa",
    ...
    acceptance_check_vi: "Câu hỏi vị trí phải giữ ਕਿੱਥੇ ਹੈ.",
    acceptance_check_en: "The location question must keep ਕਿੱਥੇ ਹੈ.",
  ...
  },
  {
    ...
    acceptance_check_vi: "Câu xin giúp là câu cứu nguy của bản A1.",
    acceptance_check_en: "The help request is the rescue line for A1.",
  ...
  {
    id: "pa_a1_acceptance_repetition_001",
    domain: "repetition",
    style: "acceptance",
    ...
    acceptance_check_vi: "Câu này xử lý khi thiếu số, giá, hoặc hướng dẫn.",
    acceptance_check_en: "This handles missed numbers, prices, or directions.",
  ...
  {
    id: "pa_a1_acceptance_politeness_001",
    domain: "politeness",
    ...
    expected_pa: "ਧੰਨਵਾਦ।",
    acceptance_check_vi: "Lời cảm ơn đóng luồng dịch vụ một cách lịch sự.",
    acceptance_check_en: "Thanks close the service flow politely.",
  ...
  {
    id: "pa_a1_acceptance_gurmukhi_001",
    ...
    acceptance_check_vi: "Chữ gốc phải là nội dung chính.",
    acceptance_check_en: "The original script must be the main content.",
  ...
  {
    id: "pa_a1_acceptance_romanization_001",
    ...
    meaning_en: "help",
    expected_pa: "ਮਦਦ",
    acceptance_check_vi: "Romanization hỗ trợ âm, nhưng đáp án vẫn là Gurmukhi.",
    acceptance_check_en: "Romanization supports sound, but the answer stays Gurmukhi.",
  ...
  {
    id: "pa_a1_acceptance_canada_counter_001",
    ...
    acceptance_check_vi: "Mẫu này nối 'tôi có' với 'tôi cần' ở mức A1.",
    acceptance_check_en: "This connects 'I have' with 'I need' at A1 level.",
...
export default punjabiA1AcceptanceSamples;
