// Punjabi A1 MR-readiness evidence for Vietnamese-speaking and English-speaking learners.
// Gurmukhi is primary; romanization supports recognition. Native review is deferred.

export type PunjabiA1MrReadinessDomain =
  | "greetings"
  | "identity"
  | "family"
  | "numbers"
...
export type PunjabiA1MrReadinessStyle =
  | "mr_readiness"
  | "final_freeze"
  | "final_lock"
  | "owner_acceptance"
...
export type PunjabiA1MrReadinessSample = {
  id: string;
  domain: PunjabiA1MrReadinessDomain;
  style: PunjabiA1MrReadinessStyle;
  prompt_vi: string;
  prompt_en: string;
  cue_pa: string;
  romanization?: string;
...
export const mrReadinessScriptAwareness =
  "Gurmukhi is the primary script for this Punjabi A1 MR-readiness set. Shahmukhi is awareness only, not a full course track.";

export const punjabiA1MrReadinessEvidence: PunjabiA1MrReadinessSample[] = [
  {
    id: "pa_a1_mr_readiness_greeting_001",
    domain: "greetings",
    style: "mr_readiness",
    ...
    mr_readiness_check_vi: "Câu chào phải giữ Gurmukhi làm nội dung chính.",
    mr_readiness_check_en: "The greeting must keep Gurmukhi as the primary content.",
  ...
  {
    id: "pa_a1_mr_readiness_identity_001",
    domain: "identity",
    style: "final_lock",
    ...
    mr_readiness_check_vi: "Mẫu ਮੇਰਾ ਨਾਮ ... ਹੈ phải còn nguyên trước khi hỏi lại.",
    mr_readiness_check_en: "The ਮੇਰਾ ਨਾਮ ... ਹੈ frame must stay intact before asking back.",
  ...
  {
    id: "pa_a1_mr_readiness_family_001",
    domain: "family",
    style: "final_freeze",
    ...
    mr_readiness_check_vi: "Mẫu gia đình phải kiểm tra cả giới thiệu người thân và 'tôi có'.",
    mr_readiness_check_en: "The family sample must check both introducing a relative and 'I have'.",
  ...
  {
    id: "pa_a1_mr_readiness_numbers_001",
    domain: "numbers",
    ...
    mr_readiness_check_vi: "Số phải đọc được bằng Gurmukhi trước khi nối với giá.",
    mr_readiness_check_en: "The number must be readable in Gurmukhi before linking to prices.",
  ...
  {
    id: "pa_a1_mr_readiness_prices_001",
    domain: "prices",
    style: "qa",
    ...
    mr_readiness_check_vi: "Câu giá phải dùng được ở quầy hoặc cửa hàng Canada.",
    mr_readiness_check_en: "The price question must work at a Canada counter or shop.",
  ...
  {
    id: "pa_a1_mr_readiness_food_001",
    domain: "food",
    ...
    mr_readiness_check_vi: "Mẫu nhu cầu phải rõ chủ thể và vật cần.",
    mr_readiness_check_en: "The need frame must clearly show who needs what.",
  ...
  {
    id: "pa_a1_mr_readiness_directions_001",
    domain: "directions",
    ...
    mr_readiness_check_vi: "Câu hỏi vị trí phải giữ ਕਿੱਥੇ ਹੈ ở cuối.",
    mr_readiness_check_en: "The location question must keep ਕਿੱਥੇ ਹੈ at the end.",
  ...
  {
    id: "pa_a1_mr_readiness_help_001",
    domain: "help",
    style: "mr_readiness",
    ...
    mr_readiness_check_vi: "Đây là câu cứu nguy A1 và phải luôn có trong bản đóng băng cuối.",
    mr_readiness_check_en: "This is the A1 rescue line and must remain in the final freeze.",
  ...
  {
    id: "pa_a1_mr_readiness_repetition_001",
    domain: "repetition",
    ...
    mr_readiness_check_vi: "Câu này phải hỗ trợ khi nghe thiếu số, giá hoặc hướng dẫn.",
    mr_readiness_check_en: "This must support missed numbers, prices, or directions.",
  ...
  {
    id: "pa_a1_mr_readiness_politeness_001",
    domain: "politeness",
    style: "final_acceptance",
    ...
    mr_readiness_check_vi: "Lịch sự phải còn trong luồng dịch vụ ngắn.",
    mr_readiness_check_en: "Politeness must remain in the short service flow.",
  ...
  {
    id: "pa_a1_mr_readiness_gurmukhi_001",
    ...
    mr_readiness_check_vi: "Nhóm chữ phải kiểm tra Gurmukhi trước romanization.",
    mr_readiness_check_en: "The word set must check Gurmukhi before romanization.",
  ...
  {
    id: "pa_a1_mr_readiness_romanization_001",
    ...
    meaning_en: "again",
    expected_pa: "ਦੁਬਾਰਾ",
    mr_readiness_check_vi: "Romanization hỗ trợ đọc âm, nhưng đáp án đóng băng là Gurmukhi.",
    mr_readiness_check_en: "Romanization supports sound, but the frozen answer is Gurmukhi.",
  ...
  {
    id: "pa_a1_mr_readiness_canada_counter_001",
    ...
    mr_readiness_check_vi: "Câu này phải giữ mức A1, không biến thành bài giấy tờ nâng cao.",
    mr_readiness_check_en: "This must stay A1 and not become an advanced document lesson.",
...
export default punjabiA1MrReadinessEvidence;
