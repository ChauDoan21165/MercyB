// Punjabi A1 closure-packet samples for Vietnamese-speaking and English-speaking learners.
// Gurmukhi is primary; romanization supports recognition. Native review is deferred.

export type PunjabiA1ClosurePacketDomain =
  | "greetings"
  | "identity"
  | "family"
  | "numbers"
...
export type PunjabiA1ClosurePacketStyle =
  | "pre_a11_closure"
  | "pre_merge"
  | "ci_readiness"
  | "pipeline_readiness"
...
export type PunjabiA1ClosurePacketSample = {
  id: string;
  domain: PunjabiA1ClosurePacketDomain;
  style: PunjabiA1ClosurePacketStyle;
  prompt_vi: string;
  prompt_en: string;
  cue_pa: string;
  romanization?: string;
  ...
  meaning_en: string;
  expected_pa: string;
  closure_packet_check_vi: string;
  closure_packet_check_en: string;
  readiness_vi: string;
  readiness_en: string;
  trap?: {
    audience: "vi" | "en" | "both";
...
export const closurePacketScriptAwareness =
  "Gurmukhi is the primary script for this Punjabi A1 closure-packet set. Shahmukhi is awareness only, not a full course track.";

export const punjabiA1ClosurePacketSamples: PunjabiA1ClosurePacketSample[] = [
  {
    id: "pa_a1_closure_packet_greeting_001",
    domain: "greetings",
    style: "pre_a11_closure",
    ...
    closure_packet_check_vi: "Câu chào phải giữ Gurmukhi làm nội dung chính.",
    closure_packet_check_en: "The greeting must keep Gurmukhi as the primary content.",
  ...
  {
    id: "pa_a1_closure_packet_identity_001",
    domain: "identity",
    style: "pre_merge",
    ...
    closure_packet_check_vi: "Mẫu ਮੇਰਾ ਨਾਮ ... ਹੈ phải còn nguyên trước khi hỏi lại.",
    closure_packet_check_en: "The ਮੇਰਾ ਨਾਮ ... ਹੈ frame must stay intact before asking back.",
  ...
  {
    id: "pa_a1_closure_packet_family_001",
    domain: "family",
    style: "ci_readiness",
    ...
    closure_packet_check_vi: "Mẫu gia đình phải kiểm tra cả giới thiệu người thân và 'tôi có'.",
    closure_packet_check_en: "The family sample must check both introducing a relative and 'I have'.",
  ...
  {
    id: "pa_a1_closure_packet_numbers_001",
    domain: "numbers",
    ...
    closure_packet_check_vi: "Số phải đọc được bằng Gurmukhi trước khi nối với giá.",
    closure_packet_check_en: "The number must be readable in Gurmukhi before linking to prices.",
  ...
  {
    id: "pa_a1_closure_packet_prices_001",
    domain: "prices",
    style: "qa",
    ...
    closure_packet_check_vi: "Câu giá phải dùng được ở quầy hoặc cửa hàng Canada.",
    closure_packet_check_en: "The price question must work at a Canada counter or shop.",
  ...
  {
    id: "pa_a1_closure_packet_food_001",
    domain: "food",
    ...
    closure_packet_check_vi: "Mẫu nhu cầu phải rõ chủ thể và vật cần.",
    closure_packet_check_en: "The need frame must clearly show who needs what.",
  ...
  {
    id: "pa_a1_closure_packet_directions_001",
    domain: "directions",
    ...
    closure_packet_check_vi: "Câu hỏi vị trí phải giữ ਕਿੱਥੇ ਹੈ ở cuối.",
    closure_packet_check_en: "The location question must keep ਕਿੱਥੇ ਹੈ at the end.",
  ...
  {
    id: "pa_a1_closure_packet_help_001",
    domain: "help",
    style: "pre_a11_closure",
    ...
    closure_packet_check_vi: "Đây là câu cứu nguy A1 và phải luôn có trong bản đóng băng cuối.",
    closure_packet_check_en: "This is the A1 rescue line and must remain in the final freeze.",
  ...
  {
    id: "pa_a1_closure_packet_repetition_001",
    domain: "repetition",
    style: "pipeline_readiness",
    ...
    closure_packet_check_vi: "Câu này phải hỗ trợ khi nghe thiếu số, giá hoặc hướng dẫn.",
    closure_packet_check_en: "This must support missed numbers, prices, or directions.",
  ...
  {
    id: "pa_a1_closure_packet_politeness_001",
    domain: "politeness",
    style: "readiness_check",
    ...
    closure_packet_check_vi: "Lịch sự phải còn trong luồng dịch vụ ngắn.",
    closure_packet_check_en: "Politeness must remain in the short service flow.",
  ...
  {
    id: "pa_a1_closure_packet_gurmukhi_001",
    ...
    closure_packet_check_vi: "Nhóm chữ phải kiểm tra Gurmukhi trước romanization.",
    closure_packet_check_en: "The word set must check Gurmukhi before romanization.",
  ...
  {
    id: "pa_a1_closure_packet_romanization_001",
    ...
    meaning_en: "again",
    expected_pa: "ਦੁਬਾਰਾ",
    closure_packet_check_vi: "Romanization hỗ trợ đọc âm, nhưng đáp án đóng băng là Gurmukhi.",
    closure_packet_check_en: "Romanization supports sound, but the frozen answer is Gurmukhi.",
  ...
  {
    id: "pa_a1_closure_packet_canada_counter_001",
    ...
    closure_packet_check_vi: "Câu này phải giữ mức A1, không biến thành bài giấy tờ nâng cao.",
    closure_packet_check_en: "This must stay A1 and not become an advanced document lesson.",
...
export default punjabiA1ClosurePacketSamples;
