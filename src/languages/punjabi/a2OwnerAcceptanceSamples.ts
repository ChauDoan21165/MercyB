// src/languages/punjabi/a2OwnerAcceptanceSamples.ts
//
// Punjabi A2 owner-acceptance samples for Vietnamese-speaking and
...
export type PunjabiA2OwnerAcceptanceScenario =
  | "daily_routine"
  | "appointments"
  | "transport"
  | "housing"
...
export type PunjabiA2OwnerAcceptanceStyle =
  | "owner_acceptance"
  | "final_acceptance"
  | "ship_candidate"
  | "pre_integration";

export type PunjabiA2OwnerAcceptanceLine = {
  pa: string;
  romanization: string;
  vi: string;
  en: string;
...
export type PunjabiA2OwnerAcceptanceTrap = {
  trap_vi: string;
  trap_en: string;
  fix_pa: string;
...
export type PunjabiA2OwnerAcceptanceItem = {
  id: string;
  scenario: PunjabiA2OwnerAcceptanceScenario;
  style: PunjabiA2OwnerAcceptanceStyle;
  title_vi: string;
  title_en: string;
  owner_goal_vi: string;
  owner_goal_en: string;
  ...
  lines: PunjabiA2OwnerAcceptanceLine[];
  checks: {
    q_vi: string;
    q_en: string;
    answer_pa: string;
  ...
  traps: PunjabiA2OwnerAcceptanceTrap[];
};

const scriptAwarenessVi =
  "Gurmukhi là chữ chính trong owner-acceptance samples; Shahmukhi chỉ được nhắc để nhận biết, không phải khóa riêng.";
const scriptAwarenessEn =
  "Gurmukhi is the main script in these owner-acceptance samples; Shahmukhi is mentioned only for awareness, not as a separate course.";

export const a2OwnerAcceptanceSamples: PunjabiA2OwnerAcceptanceItem[] = [
  {
    id: "pa_a2_owner_daily_routine",
    scenario: "daily_routine",
    style: "owner_acceptance",
    title_vi: "Owner acceptance: thói quen hằng ngày",
    title_en: "Owner acceptance: daily routine",
    owner_goal_vi: "Owner chấp nhận nếu giờ, thói quen sáng, và câu quá khứ ngắn đều rõ.",
    owner_goal_en: "Owner accepts if time, morning routine, and a short past sentence are clear.",
    accept_signal_vi: "Accept nếu giờ thức dậy và giờ ra khỏi nhà không bị lẫn.",
    accept_signal_en: "Accept if wake-up and leaving-home times are not confused.",
    return_signal_vi: "Return nếu câu quá khứ mất chủ thể hoặc sai mốc giờ.",
  ...
  {
    id: "pa_a2_owner_appointments",
    scenario: "appointments",
    style: "final_acceptance",
    title_vi: "Final acceptance: lịch hẹn",
    title_en: "Final acceptance: appointments",
    owner_goal_vi: "Owner chấp nhận nếu lịch, giấy tờ, và câu đổi lịch nếu cần đều giữ nguyên.",
    owner_goal_en: "Owner accepts if appointment, documents, and optional reschedule sentence stay intact.",
    ...
    return_signal_vi: "Return nếu câu đổi lịch làm mất lịch hiện tại.",
  ...
  {
    id: "pa_a2_owner_transport",
    scenario: "transport",
    style: "pre_integration",
    title_vi: "Pre-integration: đi lại",
    title_en: "Pre-integration: transport",
    owner_goal_vi: "Owner chấp nhận nếu tuyến, điểm xuống, và báo trễ nhất quán.",
    owner_goal_en: "Owner accepts if route, stop, and delay notice are consistent.",
    ...
    return_signal_vi: "Return nếu thiếu điểm đến hoặc thời lượng trễ.",
  ...
  {
    id: "pa_a2_owner_housing",
    scenario: "housing",
    style: "owner_acceptance",
    title_vi: "Owner acceptance: nhà ở",
    title_en: "Owner acceptance: housing",
    owner_goal_vi: "Owner chấp nhận nếu opener lịch sự, sự cố, thời điểm, và yêu cầu sửa đầy đủ.",
    owner_goal_en: "Owner accepts if polite opener, problem, timing, and repair request are complete.",
    ...
    return_signal_vi: "Return nếu thiếu thời điểm hoặc đổi sự cố.",
  ...
  {
    id: "pa_a2_owner_school",
    scenario: "school",
    style: "ship_candidate",
    title_vi: "Ship candidate: trường học",
    title_en: "Ship candidate: school",
    owner_goal_vi: "Owner chấp nhận nếu vắng học, lý do, và yêu cầu homework rõ.",
    owner_goal_en: "Owner accepts if absence, reason, and homework request are clear.",
    ...
    return_signal_vi: "Return nếu lẫn người bệnh hoặc thiếu yêu cầu bài.",
  ...
  {
    id: "pa_a2_owner_childcare",
    scenario: "childcare",
    style: "final_acceptance",
    title_vi: "Final acceptance: childcare pickup",
    title_en: "Final acceptance: childcare pickup",
    owner_goal_vi: "Owner chấp nhận nếu người đón thay, thời gian, và pickup list rõ.",
    owner_goal_en: "Owner accepts if alternate pickup person, time, and pickup list are clear.",
    accept_signal_vi: "Accept nếu tên người đón và list khớp.",
    accept_signal_en: "Accept if pickup name and list match.",
    return_signal_vi: "Return nếu người đón không rõ hoặc không có trong list.",
  ...
  {
    id: "pa_a2_owner_workplace_small_talk",
    scenario: "workplace_small_talk",
    style: "owner_acceptance",
    title_vi: "Owner acceptance: small talk nơi làm",
    title_en: "Owner acceptance: workplace small talk",
    owner_goal_vi: "Owner chấp nhận nếu chào hỏi, trả lời ngắn, và chuyển sang nhiệm vụ rõ.",
    owner_goal_en: "Owner accepts if greeting, short reply, and task transition are clear.",
    ...
    return_signal_vi: "Return nếu small talk quá dài hoặc thiếu câu việc.",
  ...
  {
    id: "pa_a2_owner_forms",
    scenario: "forms",
    style: "ship_candidate",
    title_vi: "Ship candidate: forms",
    title_en: "Ship candidate: forms",
    owner_goal_vi: "Owner chấp nhận nếu tên, địa chỉ, và giấy tờ thiếu giữ nguyên.",
    owner_goal_en: "Owner accepts if name, address, and missing document stay consistent.",
    ...
    return_signal_vi: "Return nếu lẫn tên với địa chỉ hoặc thiếu giấy tờ.",
  ...
  {
    id: "pa_a2_owner_short_messages",
    scenario: "short_messages",
    style: "pre_integration",
    title_vi: "Pre-integration: tin nhắn ngắn",
    title_en: "Pre-integration: short messages",
    owner_goal_vi: "Owner chấp nhận nếu giờ, nơi, và vật cần mang được tách đúng.",
    owner_goal_en: "Owner accepts if time, place, and item to bring are extracted correctly.",
    ...
    return_signal_vi: "Return nếu chỉ giữ địa điểm hoặc chỉ giữ vật cần mang.",
  ...
  {
    id: "pa_a2_owner_service_flow",
    scenario: "service_flow",
    style: "final_acceptance",
    title_vi: "Final acceptance: luồng dịch vụ",
    title_en: "Final acceptance: service flow",
    owner_goal_vi: "Owner chấp nhận nếu opener, nhu cầu, và câu hỏi giấy tờ đầy đủ.",
    owner_goal_en: "Owner accepts if opener, need, and document question are complete.",
    ...
    return_signal_vi: "Return nếu nêu nhu cầu nhưng không hỏi bước tiếp theo.",
  ...
  {
    id: "pa_a2_owner_polite_problem",
    scenario: "polite_problem_descriptions",
    style: "owner_acceptance",
    title_vi: "Owner acceptance: mô tả vấn đề lịch sự",
    title_en: "Owner acceptance: polite problem descriptions",
    owner_goal_vi: "Owner chấp nhận nếu opener lịch sự, vấn đề, và câu hỏi bước tiếp theo rõ.",
    owner_goal_en: "Owner accepts if polite opener, problem, and next-step question are clear.",
    ...
    return_signal_vi: "Return nếu ਇਸ ਨੂੰ không còn trỏ về vấn đề đã nêu.",
  ...
  {
    id: "pa_a2_owner_interaction_repair",
    scenario: "interaction_repair",
    style: "pre_integration",
    title_vi: "Pre-integration: sửa chữa tương tác",
    title_en: "Pre-integration: interaction repair",
    owner_goal_vi: "Owner chấp nhận nếu báo chưa hiểu, xin nhắc lại, và xác nhận nghĩa đầy đủ.",
    owner_goal_en: "Owner accepts if non-understanding signal, repetition request, and meaning confirmation are complete.",
    accept_signal_vi: "Accept nếu có đủ ba bước repair.",
    accept_signal_en: "Accept if all three repair steps are present.",
    return_signal_vi: "Return nếu chỉ nói 'what?' hoặc không xác nhận lại.",
