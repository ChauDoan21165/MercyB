// Punjabi A1 release-candidate samples for Vietnamese-speaking and English-speaking learners.
// Gurmukhi is primary; romanization supports recall. Native review is deferred.

export type PunjabiA1ReleaseCandidateDomain =
  | "greetings"
  | "identity"
  | "family"
  | "numbers"
...
export type PunjabiA1ReleaseCandidateStyle =
  | "release_candidate"
  | "closure_validation"
  | "pre_integration"
  | "readiness_check"
...
export type PunjabiA1ReleaseCandidateSample = {
  id: string;
  domain: PunjabiA1ReleaseCandidateDomain;
  style: PunjabiA1ReleaseCandidateStyle;
  prompt_vi: string;
  prompt_en: string;
  cue_pa: string;
  romanization?: string;
  ...
  meaning_en: string;
  expected_pa: string;
  release_check_vi: string;
  release_check_en: string;
  readiness_vi: string;
  readiness_en: string;
  trap?: {
    audience: "vi" | "en" | "both";
...
export const releaseCandidateScriptAwareness =
  "Gurmukhi is the primary script for this Punjabi A1 release-candidate set. Shahmukhi is awareness only, not a full course track.";

export const punjabiA1ReleaseCandidateSamples: PunjabiA1ReleaseCandidateSample[] = [
  {
    id: "pa_a1_release_greeting_001",
    domain: "greetings",
    style: "release_candidate",
    prompt_vi: "Xác nhận câu chào ổn định cho bản release candidate.",
    prompt_en: "Confirm the greeting is stable for the release candidate.",
    cue_pa: "ਸਤ ਸ੍ਰੀ ਅਕਾਲ।",
    romanization: "sat sri akal",
    meaning_vi: "Xin chào.",
    meaning_en: "Hello.",
    expected_pa: "ਸਤ ਸ੍ਰੀ ਅਕਾਲ।",
    release_check_vi: "Câu chào phải mở được luồng A1.",
    release_check_en: "The greeting must open the A1 flow.",
  ...
  },
  {
    ...
    release_check_vi: "Khung tên phải nối được sau câu chào.",
    release_check_en: "The name frame must connect after the greeting.",
  ...
  },
  {
    ...
    release_check_vi: "Mẫu này kiểm tra người thân và 'tôi có'.",
    release_check_en: "This checks family members and 'I have'.",
  ...
  },
  {
    ...
    release_check_vi: "Số phải chạy được trước khi nối sang giá.",
    release_check_en: "The number must work before linking to a price.",
  ...
  },
  {
    ...
    release_check_vi: "Giá phải giữ số và đơn vị tiền rõ ràng.",
    release_check_en: "The price must keep number and currency clear.",
  ...
  },
  {
    ...
    release_check_vi: "Mẫu nhu cầu phải giữ ਮੈਨੂੰ ... ਚਾਹੀਦਾ ਹੈ.",
    release_check_en: "The need frame must keep ਮੈਨੂੰ ... ਚਾਹੀਦਾ ਹੈ.",
  ...
  {
    id: "pa_a1_release_directions_001",
    domain: "directions",
    style: "qa",
    ...
    release_check_vi: "Câu hỏi vị trí phải giữ ਕਿੱਥੇ ਹੈ.",
    release_check_en: "The location question must keep ਕਿੱਥੇ ਹੈ.",
  ...
  },
  {
    ...
    release_check_vi: "Câu xin giúp là câu cứu nguy của bản A1.",
    release_check_en: "The help request is the rescue line for A1.",
  ...
  {
    id: "pa_a1_release_repetition_001",
    domain: "repetition",
    style: "release_candidate",
    ...
    release_check_vi: "Câu này xử lý khi thiếu số, giá, hoặc hướng dẫn.",
    release_check_en: "This handles missed numbers, prices, or directions.",
  ...
  {
    id: "pa_a1_release_politeness_001",
    domain: "politeness",
    style: "closure_validation",
    ...
    expected_pa: "ਧੰਨਵਾਦ।",
    release_check_vi: "Lời cảm ơn đóng luồng dịch vụ một cách lịch sự.",
    release_check_en: "Thanks close the service flow politely.",
  ...
  },
  {
    ...
    release_check_vi: "Chữ gốc phải là nội dung chính.",
    release_check_en: "The original script must be the main content.",
  ...
  {
    id: "pa_a1_release_romanization_001",
    ...
    meaning_en: "help",
    expected_pa: "ਮਦਦ",
    release_check_vi: "Romanization hỗ trợ âm, nhưng đáp án vẫn là Gurmukhi.",
    release_check_en: "Romanization supports sound, but the answer stays Gurmukhi.",
  ...
  {
    id: "pa_a1_release_canada_counter_001",
    ...
    release_check_vi: "Mẫu này nối 'tôi có' với 'tôi cần' ở mức A1.",
    release_check_en: "This connects 'I have' with 'I need' at A1 level.",
...
export default punjabiA1ReleaseCandidateSamples;
