// Punjabi Canada survival ledger samples for Vietnamese-speaking and
...
export type PunjabiCanadaSurvivalLedgerDomain =
  | "clinic"
  | "pharmacy"
  | "school_childcare"
  | "bank"
...
export type PunjabiCanadaSurvivalLedgerCheck =
  | "pre_a11_ledger"
  | "archive"
  | "archive"
  | "pre_integration";

export type PunjabiCanadaSurvivalLedgerSample = {
  id: string;
  domain: PunjabiCanadaSurvivalLedgerDomain;
  check: PunjabiCanadaSurvivalLedgerCheck;
  phrase_pa: string;
  romanization: string;
  meaning_vi: string;
  meaning_en: string;
  ...
  ledger_note_vi: string;
  ledger_note_en: string;
...
export type PunjabiCanadaSurvivalLedgerScope = {
  name: string;
  audience: string[];
  scriptPolicy: string;
  reviewStatus: string;
...
export const PUNJABI_CANADA_SURVIVAL_LEDGER_SCOPE: PunjabiCanadaSurvivalLedgerScope = {
  name: "Punjabi Canada Survival Ledger Samples",
  ...
  ledgerBoundary:
    "Pre-A11-ledger, archive, signoff, and pre-integration content samples for Canadian survival communication; not A11 integration, not legal advice, not medical advice, and not financial advice.",
};

export const PUNJABI_CANADA_SURVIVAL_LEDGER_DOMAINS: PunjabiCanadaSurvivalLedgerDomain[] = [
  "clinic",
  "pharmacy",
  "school_childcare",
  "bank",
...
export const PUNJABI_CANADA_SURVIVAL_LEDGER_SAMPLES: PunjabiCanadaSurvivalLedgerSample[] = [
  {
    id: "pa-ca-ledger-clinic-001",
    domain: "clinic",
    check: "pre_a11_ledger",
    ...
    ledger_note_vi: "Pre-A11-ledger giữ phrase, repair request, và next-step handoff mà không tích hợp A11.",
    ledger_note_en: "The pre-A11-ledger keeps phrase, repair request, and next-step handoff without A11 integration.",
    readiness_signal_vi: "Signoff ổn nếu có Gurmukhi, romanization, Vietnamese, English, và clinic context.",
    readiness_signal_en: "Signoff is stable if it has Gurmukhi, romanization, Vietnamese, English, and clinic context.",
  ...
  },
  {
    ...
    ledger_note_vi: "Signoff sample chứng minh pharmacy content không tự đưa liều hoặc chẩn đoán.",
    ledger_note_en: "The signoff sample proves pharmacy content does not provide dose or diagnosis.",
    readiness_signal_vi: "Archive ổn nếu learner xin pharmacist viết số lần/ngày thay vì đoán.",
    readiness_signal_en: "Archive is stable if the learner asks the pharmacist to write times per day instead of guessing.",
  ...
  {
    id: "pa-ca-ledger-school-childcare-003",
    ...
    ledger_note_vi: "Archive ledger đóng gói child, date, action, và optional pickup detail.",
    ledger_note_en: "The archive ledger packages child, date, action, and optional pickup detail.",
  ...
  },
  {
    ...
    ledger_note_vi: "Pre-A11-ledger giữ bank sample ở mức service information, không khuyến nghị sản phẩm.",
    ledger_note_en: "The pre-A11-ledger keeps the bank sample at service information level, not product recommendation.",
    readiness_signal_vi: "Signoff ổn nếu fee request và financial boundary đều có mặt.",
    readiness_signal_en: "Signoff is stable if fee request and financial boundary are both present.",
  ...
  },
  {
    ...
    ledger_note_vi: "Pre-integration ledger có unit, issue, repair time, và written confirmation.",
    ledger_note_en: "The pre-integration ledger has unit, issue, repair time, and written confirmation.",
    readiness_signal_vi: "Archive ổn nếu housing task không chuyển thành tenancy advice.",
    readiness_signal_en: "Archive is stable if the housing task does not become tenancy advice.",
  ...
  },
  {
    ...
    ledger_note_vi: "Signoff ledger có route, direction, transfer, và delay repair line.",
    ledger_note_en: "The signoff ledger has route, direction, transfer, and delay repair line.",
    readiness_signal_vi: "Pre-A11-ledger ổn nếu transport content dùng transit/bus nhưng không hứa schedule.",
    readiness_signal_en: "Pre-A11-ledger is stable if transport content uses transit/bus but does not promise schedule.",
  ...
  {
    id: "pa-ca-ledger-public-office-007",
    ...
    ledger_note_vi: "Archive ledger đóng gói counter, documents, checklist, và next step.",
    ledger_note_en: "The archive ledger packages counter, documents, checklist, and next step.",
    readiness_signal_vi: "Signoff ổn nếu public office flow không thành legal advice.",
    readiness_signal_en: "Signoff is stable if public office flow does not become legal advice.",
  ...
  },
  {
    ...
    ledger_note_vi: "Pre-A11-ledger sample chứng minh forms coverage, correction request, và official-process boundary.",
    ledger_note_en: "The pre-A11-ledger sample proves forms coverage, correction request, and official-process boundary.",
  ...
  {
    id: "pa-ca-ledger-interpreter-009",
    ...
    ledger_note_vi: "Pre-integration ledger đóng gói pause line, interpreter request, và no-signing-until-clear boundary.",
    ledger_note_en: "The pre-integration ledger packages pause line, interpreter request, and no-signing-until-clear boundary.",
    readiness_signal_vi: "Signoff ổn nếu interpreter request chỉ là language support, không phải professional decision.",
    readiness_signal_en: "Signoff is stable if interpreter request is language support, not professional decision.",
  ...
  },
  {
    ...
    ledger_note_vi: "Signoff ledger có immediate need, address, service type, và interpreter option.",
    ledger_note_en: "The signoff ledger has immediate need, address, service type, and interpreter option.",
    readiness_signal_vi: "Pre-A11-ledger ổn nếu emergency boundary không thay thế emergency services.",
    readiness_signal_en: "Pre-A11-ledger is stable if emergency boundary does not replace emergency services.",
  ...
  {
    id: "pa-ca-ledger-service-recovery-011",
    ...
    ledger_note_vi: "Archive ledger có repair phrase, written next step, và polite follow-up.",
    ledger_note_en: "The archive ledger has repair phrase, written next step, and polite follow-up.",
    readiness_signal_vi: "Signoff ổn nếu service recovery giúp learner không im lặng.",
    readiness_signal_en: "Signoff is stable if service recovery helps the learner avoid silence.",
  ...
  },
  {
    ...
    ledger_note_vi: "Pre-integration ledger đóng gói safety issue, supervisor handoff, và written report step.",
    ledger_note_en: "The pre-integration ledger packages safety issue, supervisor handoff, and written report step.",
    readiness_signal_vi: "Pre-A11-ledger ổn nếu workplace task không chuyển thành claim guidance.",
    readiness_signal_en: "Pre-A11-ledger is stable if the workplace task does not become claim guidance.",
...
export default PUNJABI_CANADA_SURVIVAL_LEDGER_SAMPLES;
