// Punjabi Canada survival final-lock samples for Vietnamese-speaking and
...
export type PunjabiCanadaSurvivalFinalLockDomain =
  | "clinic"
  | "pharmacy"
  | "school_childcare"
  | "bank"
...
export type PunjabiCanadaSurvivalFinalLockUse =
  | "final_lock"
  | "owner_acceptance"
  | "final_acceptance"
  | "pre_integration";

export type PunjabiCanadaSurvivalFinalLockItem = {
  id: string;
  domain: PunjabiCanadaSurvivalFinalLockDomain;
  use: PunjabiCanadaSurvivalFinalLockUse;
  final_lock_vi: string;
  final_lock_en: string;
  goal_vi: string;
  goal_en: string;
  phrase_pa: string;
  romanization: string;
...
export type PunjabiCanadaSurvivalFinalLockScope = {
  name: string;
  audience: string[];
  scriptPolicy: string;
  reviewStatus: string;
...
export const PUNJABI_CANADA_SURVIVAL_FINAL_LOCK_SCOPE: PunjabiCanadaSurvivalFinalLockScope = {
  name: "Punjabi Canada Survival Final Lock Samples",
  ...
  boundaries: [
    "Language support only for Canada survival final-lock samples.",
    "No medical, legal, financial, tenancy, or workplace safety advice.",
  ],
};

export const PUNJABI_CANADA_SURVIVAL_FINAL_LOCK_SAMPLES: PunjabiCanadaSurvivalFinalLockItem[] = [
  {
    id: "pa-ca-finallock-clinic-001",
    domain: "clinic",
    use: "final_lock",
    final_lock_vi: "Khóa cuối câu phòng khám để người học xin nói chậm và nhắc lại trước khi trả lời.",
    final_lock_en: "Final-lock the clinic line so the learner can ask for slow speech and a repeat before answering.",
    ...
    final_lock_check_vi: "Final-lock giữ câu ở hỗ trợ ngôn ngữ, không đưa lời khuyên y tế.",
    final_lock_check_en: "Final-lock keeps this as language support, not medical advice.",
  ...
  {
    id: "pa-ca-finallock-pharmacy-002",
    domain: "pharmacy",
    use: "final_acceptance",
    final_lock_vi: "Khóa cuối câu nhà thuốc để nêu dị ứng và xin ghi thông tin bằng văn bản.",
    final_lock_en: "Final-lock the pharmacy line for stating an allergy and asking for written information.",
    ...
    final_lock_check_vi: "Final-acceptance xác nhận câu không thêm liều lượng hoặc tư vấn thuốc.",
    final_lock_check_en: "Final acceptance confirms the line adds no dosage or medicine advice.",
  ...
  {
    id: "pa-ca-finallock-school-003",
    domain: "school_childcare",
    use: "pre_integration",
    final_lock_vi: "Khóa cuối câu trường học hoặc childcare khi phụ huynh cần hiểu thông báo.",
    final_lock_en: "Final-lock the school or childcare line when a parent needs to understand a notice.",
    ...
    final_lock_check_vi: "Pre-integration xác nhận câu nối được với trường, childcare, và form.",
    final_lock_check_en: "Pre-integration confirms the line connects to school, childcare, and form flows.",
  ...
  {
    id: "pa-ca-finallock-bank-004",
    domain: "bank",
    use: "owner_acceptance",
    final_lock_vi: "Khóa cuối câu ngân hàng để mở tài khoản và hỏi phí mà không chuyển sang tư vấn tiền bạc.",
    final_lock_en: "Final-lock the bank line for opening an account and asking fees without moving into money advice.",
    ...
    final_lock_check_vi: "Owner Acceptance giữ câu ngoài thẻ, vay, hoặc lời khuyên tài chính.",
    final_lock_check_en: "Owner Acceptance keeps the line away from cards, loans, or financial advice.",
  ...
  {
    id: "pa-ca-finallock-housing-005",
    domain: "housing",
    use: "final_lock",
    final_lock_vi: "Khóa cuối câu nhà thuê để xin lịch sửa và phản hồi bằng văn bản.",
    final_lock_en: "Final-lock the rental line for asking a repair timeline and written reply.",
    ...
    final_lock_check_vi: "Final-lock xác nhận câu chỉ xin lịch và văn bản, không phải tư vấn pháp lý.",
    final_lock_check_en: "Final-lock confirms the line only asks for timing and writing, not legal advice.",
  ...
  {
    id: "pa-ca-finallock-transport-006",
    domain: "transport",
    use: "pre_integration",
    final_lock_vi: "Khóa cuối câu giao thông để hỏi đúng tuyến và điểm xuống.",
    final_lock_en: "Final-lock the transit line for checking the route and stop.",
    ...
    final_lock_check_vi: "Pre-integration xác nhận câu nối được với chỉ đường và lịch trình.",
    final_lock_check_en: "Pre-integration confirms the line connects to directions and schedule content.",
  ...
  {
    id: "pa-ca-finallock-public-office-007",
    domain: "public_office",
    use: "final_acceptance",
    final_lock_vi: "Khóa cuối câu cơ quan công để hỏi quầy đúng và giấy tờ cần có.",
    final_lock_en: "Final-lock the public-office line for asking the right counter and required documents.",
    ...
    final_lock_check_vi: "Final-acceptance xác nhận câu dùng được ở quầy dịch vụ và form.",
    final_lock_check_en: "Final acceptance confirms the line works at a service counter and with forms.",
  ...
  {
    id: "pa-ca-finallock-forms-008",
    domain: "forms_service_desk",
    use: "final_lock",
    final_lock_vi: "Khóa cuối câu bàn dịch vụ để chỉ phần form chưa hiểu.",
    final_lock_en: "Final-lock the service-desk line for pointing to the unclear form section.",
    ...
    final_lock_check_vi: "Final-lock xác nhận câu form đủ rõ trước khi khóa nội dung.",
    final_lock_check_en: "Final-lock confirms the form line is clear before content freeze.",
  ...
  {
    id: "pa-ca-finallock-interpreter-009",
    domain: "interpreter_request",
    use: "owner_acceptance",
    final_lock_vi: "Khóa cuối câu xin thông dịch viên khi tình huống vượt quá mức hiểu.",
    final_lock_en: "Final-lock the interpreter request when the situation exceeds the learner's understanding.",
    ...
    final_lock_check_vi: "Owner Acceptance xác nhận Shahmukhi chỉ là nhận biết, không phải khóa học đầy đủ.",
    final_lock_check_en: "Owner Acceptance confirms Shahmukhi is awareness only, not a full course.",
  ...
  {
    id: "pa-ca-finallock-emergency-010",
    domain: "emergency_boundary",
    use: "final_acceptance",
    final_lock_vi: "Khóa cuối câu khẩn cấp khi có nguy hiểm thật sự và cần gọi 911.",
    final_lock_en: "Final-lock the emergency line when there is real danger and 911 is needed.",
    ...
    final_lock_check_vi: "Final-acceptance giữ câu rõ và không thay thế dịch vụ khẩn cấp.",
    final_lock_check_en: "Final acceptance keeps the line clear and does not replace emergency services.",
  ...
  {
    id: "pa-ca-finallock-recovery-011",
    domain: "service_recovery",
    use: "final_lock",
    final_lock_vi: "Khóa cuối câu phục hồi dịch vụ khi thông tin sai hoặc chưa khớp.",
    final_lock_en: "Final-lock the service-recovery line when information is wrong or does not match.",
    ...
    final_lock_check_vi: "Final-lock xác nhận câu sửa lỗi vẫn lịch sự và thực tế.",
    final_lock_check_en: "Final-lock confirms the correction line stays polite and practical.",
  ...
  {
    id: "pa-ca-finallock-workplace-012",
    domain: "workplace_safety",
    use: "pre_integration",
    final_lock_vi: "Khóa cuối câu nơi làm việc khi người học chưa hiểu hướng dẫn an toàn.",
    final_lock_en: "Final-lock the workplace line when the learner did not understand a safety instruction.",
    ...
    final_lock_check_vi: "Pre-integration giữ câu ở mức xin làm rõ ngôn ngữ, không đưa hướng dẫn kỹ thuật.",
    final_lock_check_en: "Pre-integration keeps this as language clarification, not technical instruction.",
...
export default PUNJABI_CANADA_SURVIVAL_FINAL_LOCK_SAMPLES;
