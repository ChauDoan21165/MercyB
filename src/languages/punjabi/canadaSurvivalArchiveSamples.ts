// Punjabi Canada survival archive samples for Vietnamese-speaking and
...
export type PunjabiCanadaSurvivalArchiveDomain =
  | "clinic"
  | "pharmacy"
  | "school_childcare"
  | "bank"
...
export type PunjabiCanadaSurvivalArchiveCheck =
  | "pre_a11_archive"
  | "signoff"
  | "seal"
  | "pre_integration";

export type PunjabiCanadaSurvivalArchiveSample = {
  id: string;
  domain: PunjabiCanadaSurvivalArchiveDomain;
  check: PunjabiCanadaSurvivalArchiveCheck;
  phrase_pa: string;
  romanization: string;
  meaning_vi: string;
  meaning_en: string;
  ...
  archive_note_vi: string;
  archive_note_en: string;
...
export type PunjabiCanadaSurvivalArchiveScope = {
  name: string;
  audience: string[];
  scriptPolicy: string;
  reviewStatus: string;
...
export const PUNJABI_CANADA_SURVIVAL_ARCHIVE_SCOPE: PunjabiCanadaSurvivalArchiveScope = {
  name: "Punjabi Canada Survival Archive Samples",
  ...
  archiveBoundary:
    "Pre-A11-archive, signoff, seal, and pre-integration content samples for Canadian survival communication; not A11 integration, not legal advice, not medical advice, and not financial advice.",
};

export const PUNJABI_CANADA_SURVIVAL_ARCHIVE_DOMAINS: PunjabiCanadaSurvivalArchiveDomain[] = [
  "clinic",
  "pharmacy",
  "school_childcare",
  "bank",
...
export const PUNJABI_CANADA_SURVIVAL_ARCHIVE_SAMPLES: PunjabiCanadaSurvivalArchiveSample[] = [
  {
    id: "pa-ca-archive-clinic-001",
    domain: "clinic",
    check: "pre_a11_archive",
    ...
    archive_note_vi: "Pre-A11-archive giữ phrase, repair request, và next-step handoff mà không tích hợp A11.",
    archive_note_en: "The pre-A11-archive keeps phrase, repair request, and next-step handoff without A11 integration.",
  ...
  },
  {
    ...
    archive_note_vi: "Seal sample chứng minh pharmacy content không tự đưa liều hoặc chẩn đoán.",
    archive_note_en: "The seal sample proves pharmacy content does not provide dose or diagnosis.",
    readiness_signal_vi: "Signoff ổn nếu learner xin pharmacist viết số lần/ngày thay vì đoán.",
    readiness_signal_en: "Signoff is stable if the learner asks the pharmacist to write times per day instead of guessing.",
  ...
  {
    id: "pa-ca-archive-school-childcare-003",
    ...
    archive_note_vi: "Signoff archive đóng gói child, date, action, và optional pickup detail.",
    archive_note_en: "The signoff archive packages child, date, action, and optional pickup detail.",
  ...
  },
  {
    ...
    archive_note_vi: "Pre-A11-archive giữ bank sample ở mức service information, không khuyến nghị sản phẩm.",
    archive_note_en: "The pre-A11-archive keeps the bank sample at service information level, not product recommendation.",
  ...
  },
  {
    ...
    archive_note_vi: "Pre-integration archive có unit, issue, repair time, và written confirmation.",
    archive_note_en: "The pre-integration archive has unit, issue, repair time, and written confirmation.",
    readiness_signal_vi: "Signoff ổn nếu housing task không chuyển thành tenancy advice.",
    readiness_signal_en: "Signoff is stable if the housing task does not become tenancy advice.",
  ...
  {
    id: "pa-ca-archive-transport-006",
    domain: "transport",
    check: "seal",
    ...
    archive_note_vi: "Seal archive có route, direction, transfer, và delay repair line.",
    archive_note_en: "The seal archive has route, direction, transfer, and delay repair line.",
    readiness_signal_vi: "Pre-A11-archive ổn nếu transport content dùng transit/bus nhưng không hứa schedule.",
    readiness_signal_en: "Pre-A11-archive is stable if transport content uses transit/bus but does not promise schedule.",
  ...
  {
    id: "pa-ca-archive-public-office-007",
    ...
    archive_note_vi: "Signoff archive đóng gói counter, documents, checklist, và next step.",
    archive_note_en: "The signoff archive packages counter, documents, checklist, and next step.",
  ...
  },
  {
    ...
    archive_note_vi: "Pre-A11-archive sample chứng minh forms coverage, correction request, và official-process boundary.",
    archive_note_en: "The pre-A11-archive sample proves forms coverage, correction request, and official-process boundary.",
  ...
  {
    id: "pa-ca-archive-interpreter-009",
    ...
    archive_note_vi: "Pre-integration archive đóng gói pause line, interpreter request, và no-signing-until-clear boundary.",
    archive_note_en: "The pre-integration archive packages pause line, interpreter request, and no-signing-until-clear boundary.",
  ...
  {
    id: "pa-ca-archive-emergency-010",
    ...
    archive_note_vi: "Seal archive có immediate need, address, service type, và interpreter option.",
    archive_note_en: "The seal archive has immediate need, address, service type, and interpreter option.",
    readiness_signal_vi: "Pre-A11-archive ổn nếu emergency boundary không thay thế emergency services.",
    readiness_signal_en: "Pre-A11-archive is stable if emergency boundary does not replace emergency services.",
  ...
  {
    id: "pa-ca-archive-service-recovery-011",
    ...
    archive_note_vi: "Signoff archive có repair phrase, written next step, và polite follow-up.",
    archive_note_en: "The signoff archive has repair phrase, written next step, and polite follow-up.",
  ...
  {
    id: "pa-ca-archive-workplace-012",
    ...
    archive_note_vi: "Pre-integration archive đóng gói safety issue, supervisor handoff, và written report step.",
    archive_note_en: "The pre-integration archive packages safety issue, supervisor handoff, and written report step.",
    readiness_signal_vi: "Pre-A11-archive ổn nếu workplace task không chuyển thành claim guidance.",
    readiness_signal_en: "Pre-A11-archive is stable if the workplace task does not become claim guidance.",
...
export default PUNJABI_CANADA_SURVIVAL_ARCHIVE_SAMPLES;
