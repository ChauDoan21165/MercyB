// Punjabi C1 owner-acceptance samples for Vietnamese-speaking and English-speaking learners.
//
...
export type PunjabiC1OwnerAcceptanceArea =
  | "source_summary"
  | "cautious_claim"
  | "evidence_comparison"
...
export type PunjabiC1OwnerAcceptanceMode =
  | "owner_acceptance"
  | "final_acceptance"
  | "ship_candidate"
  | "pre_integration";

export type PunjabiC1OwnerAcceptancePhrase = {
  pa: string;
  rom: string;
  vi: string;
  en: string;
...
export type PunjabiC1OwnerAcceptanceSample = {
  id: string;
  level: "C1";
  area: PunjabiC1OwnerAcceptanceArea;
  mode: PunjabiC1OwnerAcceptanceMode;
  title_pa: string;
  title_rom: string;
  title_vi: string;
  title_en: string;
  owner_prompt_vi: string;
  owner_prompt_en: string;
  sample: PunjabiC1OwnerAcceptancePhrase;
  owner_acceptance_checks_vi: readonly string[];
  owner_acceptance_checks_en: readonly string[];
  final_acceptance_checks_vi: readonly string[];
  final_acceptance_checks_en: readonly string[];
  pre_integration_notes_vi: readonly string[];
  pre_integration_notes_en: readonly string[];
  canada_example: PunjabiC1OwnerAcceptancePhrase & {
    context_vi: string;
    context_en: string;
  };
...
export const c1OwnerAcceptanceSamplesScriptAwareness = {
...
export const c1OwnerAcceptanceSamples: PunjabiC1OwnerAcceptanceSample[] = [
  {
    id: "pa_c1_owner_acceptance_source_summary",
    level: "C1",
    area: "source_summary",
    mode: "owner_acceptance",
    title_pa: "ਸਰੋਤ ਸਾਰ owner-acceptance",
    title_rom: "sarot saar owner-acceptance",
    title_vi: "Owner-acceptance tóm tắt nguồn",
    title_en: "Source summary owner acceptance",
    owner_prompt_vi: "Xác nhận summary đủ chuẩn owner acceptance: claim, evidence và neutrality đều rõ.",
    owner_prompt_en: "Confirm the summary meets owner acceptance: claim, evidence, and neutrality are clear.",
    sample: {
    ...
    owner_acceptance_checks_vi: ["Claim rõ.", "Evidence đi kèm.", "Giọng neutral."],
    owner_acceptance_checks_en: ["Clear claim.", "Evidence included.", "Neutral tone."],
    final_acceptance_checks_vi: ["Không thêm opinion.", "Không bỏ evidence chính.", "Không phóng đại nguồn."],
    final_acceptance_checks_en: ["No added opinion.", "Does not drop main evidence.", "Does not overstate the source."],
    pre_integration_notes_vi: ["Sẵn sàng cho owner review.", "Không cần dữ liệu live.", "Dùng được trong rubric."],
    pre_integration_notes_en: ["Ready for owner review.", "No live data needed.", "Usable in a rubric."],
    canada_example: {
  ...
  {
    id: "pa_c1_owner_acceptance_cautious_claim",
    level: "C1",
    area: "cautious_claim",
    mode: "final_acceptance",
    title_pa: "ਸਾਵਧਾਨ ਦਾਅਵਾ final-acceptance",
    title_rom: "savdhan daava final-acceptance",
    title_vi: "Final-acceptance claim thận trọng",
    title_en: "Cautious claim final acceptance",
    owner_prompt_vi: "Kiểm tra claim có đủ mạnh để owner accept nhưng vẫn không vượt evidence.",
    owner_prompt_en: "Check that the claim is strong enough for owner acceptance while not exceeding the evidence.",
    sample: {
    ...
    owner_acceptance_checks_vi: ["Có hedge.", "Có giới hạn scale.", "Claim vẫn rõ."],
    owner_acceptance_checks_en: ["Has hedging.", "Has a scale limit.", "The claim remains clear."],
    final_acceptance_checks_vi: ["Không chắc từ pilot nhỏ.", "Không hedge đến mơ hồ.", "Không tạo claim thời sự."],
    final_acceptance_checks_en: ["Not certain from a small pilot.", "Not hedged into vagueness.", "No current-news claim."],
  ...
  {
    id: "pa_c1_owner_acceptance_evidence_comparison",
    level: "C1",
    area: "evidence_comparison",
    mode: "ship_candidate",
    title_pa: "ਸਬੂਤ ਤੁਲਨਾ ship-candidate",
    title_rom: "sabut tulna ship-candidate",
    title_vi: "Ship-candidate so sánh bằng chứng",
    title_en: "Evidence comparison ship candidate",
    owner_prompt_vi: "Xác nhận comparison phân biệt nguồn và giữ kết luận vừa mức.",
    owner_prompt_en: "Confirm the comparison distinguishes sources and keeps a measured conclusion.",
    sample: {
    ...
    owner_acceptance_checks_vi: ["Vai trò nguồn rõ.", "Comparison rõ.", "Kết luận vừa mức."],
    owner_acceptance_checks_en: ["Source roles are clear.", "Comparison is clear.", "Measured conclusion."],
    final_acceptance_checks_vi: ["Không trộn evidence.", "Không chọn phe quá sớm.", "Không bỏ limitation."],
    final_acceptance_checks_en: ["Evidence is not blended.", "Does not take a side too early.", "Does not omit limitations."],
  ...
  {
    id: "pa_c1_owner_acceptance_formal_correspondence",
    level: "C1",
    ...
    owner_prompt_vi: "Kiểm tra email formal có request rõ, lịch sự và không giống chat.",
    owner_prompt_en: "Check that the formal email has a clear request, polite tone, and does not sound like chat.",
    sample: {
    ...
    owner_acceptance_checks_vi: ["Request rõ.", "Tone lịch sự.", "Độ formal đủ."],
    owner_acceptance_checks_en: ["Clear request.", "Polite tone.", "Formal enough."],
    final_acceptance_checks_vi: ["Không trách móc.", "Không quá vòng vo.", "Không giống tin nhắn bạn bè."],
    final_acceptance_checks_en: ["No blaming.", "Not overly indirect.", "Not like a message to a friend."],
  ...
  {
    id: "pa_c1_owner_acceptance_executive_summary",
    level: "C1",
    area: "executive_summary",
    mode: "owner_acceptance",
    title_pa: "ਕਾਰਜਕਾਰੀ ਸੰਖੇਪ owner-acceptance",
    title_rom: "karjakari sankhep owner-acceptance",
    title_vi: "Owner-acceptance bản tóm tắt điều hành",
    title_en: "Executive summary owner acceptance",
    owner_prompt_vi: "Xác nhận executive summary đủ gọn nhưng giữ priority, risk và next step.",
    owner_prompt_en: "Confirm that the executive summary is concise while keeping priority, risk, and next step.",
    sample: {
    ...
    owner_acceptance_checks_vi: ["Có priority.", "Có risk.", "Có next step."],
    owner_acceptance_checks_en: ["Has a priority.", "Has a risk.", "Has a next step."],
    final_acceptance_checks_vi: ["Không lan man.", "Không thành report dài.", "Không bỏ action."],
    final_acceptance_checks_en: ["Does not ramble.", "Does not become a long report.", "Does not omit action."],
    pre_integration_notes_vi: ["Sẵn sàng cho owner acceptance.", "Compact cho app data.", "Không cần dữ liệu ngoài."],
    pre_integration_notes_en: ["Ready for owner acceptance.", "Compact for app data.", "No outside data required."],
    canada_example: {
  ...
  {
    id: "pa_c1_owner_acceptance_register_calibration",
    level: "C1",
    area: "register_calibration",
    mode: "final_acceptance",
    title_pa: "ਰਜਿਸਟਰ calibration final-acceptance",
    title_rom: "register calibration final-acceptance",
    title_vi: "Final-acceptance chỉnh register",
    title_en: "Register calibration final acceptance",
    owner_prompt_vi: "Kiểm tra register chuyên nghiệp, rõ và không quá thân mật.",
    owner_prompt_en: "Check that the register is professional, clear, and not too casual.",
    sample: {
    ...
    owner_acceptance_checks_vi: ["Professional.", "Giữ ý gốc.", "Không quá lạnh."],
    owner_acceptance_checks_en: ["Professional.", "Keeps original meaning.", "Not too cold."],
    final_acceptance_checks_vi: ["Không dịch word-by-word từ văn nói.", "Không quá casual.", "Không đổi nghĩa."],
    final_acceptance_checks_en: ["Does not translate spoken style word for word.", "Not too casual.", "Does not change meaning."],
  ...
  {
    id: "pa_c1_owner_acceptance_presentation_response",
    level: "C1",
    area: "presentation_response",
    mode: "ship_candidate",
    title_pa: "ਪੇਸ਼ਕਾਰੀ ਜਵਾਬ ship-candidate",
    title_rom: "peshkari jawab ship-candidate",
    title_vi: "Ship-candidate phản hồi thuyết trình",
    title_en: "Presentation response ship candidate",
    owner_prompt_vi: "Kiểm tra phản hồi Q&A có lịch sự, giới hạn claim và next step rõ.",
    owner_prompt_en: "Check that the Q&A response is polite, limits the claim, and gives a clear next step.",
    sample: {
    ...
    owner_acceptance_checks_vi: ["Mở đầu lịch sự.", "Claim giới hạn.", "Có next step."],
    owner_acceptance_checks_en: ["Polite opening.", "Limited claim.", "Has a next step."],
    final_acceptance_checks_vi: ["Không phòng thủ.", "Không né câu hỏi.", "Không hứa kết quả chưa có."],
    final_acceptance_checks_en: ["Not defensive.", "Does not avoid the question.", "Does not promise unavailable results."],
  ...
  {
    id: "pa_c1_owner_acceptance_public_professional_service_tone",
    level: "C1",
    ...
    owner_prompt_vi: "Kiểm tra tone dịch vụ công/chuyên nghiệp rõ, lịch sự và action-oriented.",
    owner_prompt_en: "Check that the public/professional-service tone is clear, polite, and action-oriented.",
    sample: {
    ...
    owner_acceptance_checks_vi: ["Rõ cho người dân.", "Lịch sự.", "Có action cụ thể."],
    owner_acceptance_checks_en: ["Clear for the public.", "Polite.", "Has a specific action."],
    final_acceptance_checks_vi: ["Không dùng slang.", "Không có threat tone.", "Không mơ hồ deadline."],
    final_acceptance_checks_en: ["No slang.", "No threatening tone.", "Not vague about the deadline."],
