// Punjabi C2 go-no-go samples for Vietnamese- and English-speaking learners.
// Gurmukhi is primary; romanization is a reading aid.
//
// Scope/status: study-support go-no-go samples only, not certification,
...
export type PunjabiC2GoNoGoFocus =
...
export type PunjabiC2GoNoGoContext = "public" | "professional" | "community";
export type PunjabiC2GoNoGoStyle =
  | "go_no_go"
  | "closure_validation"
  | "pre_integration"
  | "readiness";

export type PunjabiC2GoNoGoPhrase = {
  gurmukhi: string;
  romanization: string;
  vi: string;
  en: string;
...
export type PunjabiC2GoNoGoCheck = {
  check_vi: string;
  check_en: string;
  signal_vi: string;
  signal_en: string;
...
export type PunjabiC2GoNoGoTrap = {
  trap_vi: string;
  trap_en: string;
  repair_vi: string;
  repair_en: string;
...
export type PunjabiC2GoNoGoSample = {
  id: string;
  focus: PunjabiC2GoNoGoFocus;
  context: PunjabiC2GoNoGoContext;
  style: PunjabiC2GoNoGoStyle;
  title_vi: string;
  title_en: string;
  scenario_vi: string;
  scenario_en: string;
  ...
  sample_vi: string;
  sample_en: string;
  go_no_go_phrases: PunjabiC2GoNoGoPhrase[];
  checks: PunjabiC2GoNoGoCheck[];
  learner_trap?: PunjabiC2GoNoGoTrap;
  canada_practical?: boolean;
};

export const C2_GO_NO_GO_SAMPLES_DISCLAIMER = {
  vi: "Bộ go-no-go Punjabi C2 này chỉ hỗ trợ học tập, không phải chứng nhận hay xếp lớp chính thức. Gurmukhi là chính; phiên âm chỉ giúp đọc. Thẩm định bản xứ được hoãn lại. Shahmukhi chỉ được nhắc để nhận biết hệ chữ.",
  en: "This C2 Punjabi go-no-go sample pack supports study only, not certification or official placement. Gurmukhi is primary; romanization only supports reading. Native review is deferred. Shahmukhi is noted only for script awareness.",
} as const;

export const c2GoNoGoSamples: PunjabiC2GoNoGoSample[] = [
  {
    id: "pa_c2_gonogo_nuanced_disagreement_professional",
    focus: "nuanced_disagreement",
    context: "professional",
    style: "go_no_go",
    title_vi: "Go/no-go: bất đồng tinh tế",
    title_en: "Go no-go: nuanced disagreement",
  ...
  {
    id: "pa_c2_gonogo_diplomacy_community_canada",
    focus: "diplomacy",
    context: "community",
    style: "closure_validation",
    title_vi: "Go/no-go: từ chối ngoại giao",
    title_en: "Go no-go: diplomatic decline",
  ...
  {
    id: "pa_c2_gonogo_mediation_public",
    focus: "mediation",
    context: "public",
    style: "go_no_go",
    title_vi: "Go/no-go: trung gian công khai",
    title_en: "Go no-go: public mediation",
  ...
  {
    id: "pa_c2_gonogo_deescalation_professional",
    focus: "deescalation",
    context: "professional",
    style: "readiness",
    title_vi: "Go/no-go: hạ nhiệt cuộc họp",
    title_en: "Go no-go: meeting de-escalation",
  ...
  {
    id: "pa_c2_gonogo_audience_adaptation_canada",
    focus: "audience_adaptation",
    context: "community",
    style: "pre_integration",
    title_vi: "Go/no-go: điều chỉnh cho nhóm đa thế hệ",
    title_en: "Go no-go: adaptation for a multi-generational group",
  ...
  {
    id: "pa_c2_gonogo_sensitive_topic_public",
    focus: "sensitive_topic_framing",
    context: "public",
    style: "closure_validation",
    title_vi: "Go/no-go: chủ đề nhạy cảm",
    title_en: "Go no-go: sensitive topic framing",
  ...
  {
    id: "pa_c2_gonogo_public_communication",
    focus: "public_communication_calibration",
    context: "public",
    style: "go_no_go",
    title_vi: "Go/no-go: thông báo công khai",
    title_en: "Go no-go: public communication",
  ...
  {
    id: "pa_c2_gonogo_register_safety_professional_canada",
    focus: "register_safety",
    context: "professional",
    style: "readiness",
    title_vi: "Go/no-go: an toàn register email",
    title_en: "Go no-go: email register safety",
...
export const c2GoNoGoSamplesByFocus = (
  focus: PunjabiC2GoNoGoFocus,
): PunjabiC2GoNoGoSample[] => c2GoNoGoSamples.filter((item) => item.focus === focus);

export const c2GoNoGoSamplesByContext = (
  context: PunjabiC2GoNoGoContext,
): PunjabiC2GoNoGoSample[] => c2GoNoGoSamples.filter((item) => item.context === context);
