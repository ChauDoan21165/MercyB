// Punjabi Canada survival seal samples for Vietnamese-speaking and
...
export type PunjabiCanadaSurvivalSealDomain =
  | "clinic"
  | "pharmacy"
  | "school_childcare"
  | "bank"
...
export type PunjabiCanadaSurvivalSealCheck =
  | "pre_a11_seal"
  | "closure_packet"
  | "pre_merge"
  | "pre_integration";

export type PunjabiCanadaSurvivalSealSample = {
  id: string;
  domain: PunjabiCanadaSurvivalSealDomain;
  check: PunjabiCanadaSurvivalSealCheck;
  phrase_pa: string;
  romanization: string;
  meaning_vi: string;
  meaning_en: string;
...
export type PunjabiCanadaSurvivalSealScope = {
  name: string;
  audience: string[];
  scriptPolicy: string;
  reviewStatus: string;
...
export const PUNJABI_CANADA_SURVIVAL_SEAL_SCOPE: PunjabiCanadaSurvivalSealScope = {
  name: "Punjabi Canada Survival Seal Samples",
  ...
  sealBoundary:
    "Pre-A11-seal, snapshot, closure-packet, pre-merge, and pre-integration content samples for Canadian survival communication; not A11 integration, not legal advice, not medical advice, and not financial advice.",
};

export const PUNJABI_CANADA_SURVIVAL_SEAL_DOMAINS: PunjabiCanadaSurvivalSealDomain[] = [
  "clinic",
  "pharmacy",
  "school_childcare",
  "bank",
...
export const PUNJABI_CANADA_SURVIVAL_SEAL_SAMPLES: PunjabiCanadaSurvivalSealSample[] = [
  {
    id: "pa-ca-seal-clinic-001",
    domain: "clinic",
    check: "pre_a11_seal",
    ...
    seal_note_vi: "Pre-A11-seal giữ phrase, repair request, và next-step handoff mà không tích hợp A11.",
    seal_note_en: "The pre-A11-seal keeps phrase, repair request, and next-step handoff without A11 integration.",
  ...
  },
  {
    ...
    seal_note_vi: "Closure-packet sample chứng minh pharmacy content không tự đưa liều hoặc chẩn đoán.",
    seal_note_en: "The closure-packet sample proves pharmacy content does not provide dose or diagnosis.",
  ...
  {
    id: "pa-ca-seal-school-childcare-003",
    ...
    seal_note_vi: "Pre-merge seal đóng gói child, date, action, và optional pickup detail.",
    seal_note_en: "The pre-merge seal packages child, date, action, and optional pickup detail.",
  ...
  },
  {
    ...
    seal_note_vi: "Pre-A11-seal giữ bank sample ở mức service information, không khuyến nghị sản phẩm.",
    seal_note_en: "The pre-A11-seal keeps the bank sample at service information level, not product recommendation.",
  ...
  },
  {
    ...
    seal_note_vi: "Pre-integration seal có unit, issue, repair time, và written confirmation.",
    seal_note_en: "The pre-integration seal has unit, issue, repair time, and written confirmation.",
  ...
  },
  {
    ...
    seal_note_vi: "Closure-packet seal có route, direction, transfer, và delay repair line.",
    seal_note_en: "The closure-packet seal has route, direction, transfer, and delay repair line.",
    readiness_signal_vi: "Pre-A11-seal ổn nếu transport content dùng transit/bus nhưng không hứa schedule.",
    readiness_signal_en: "Pre-A11-seal is stable if transport content uses transit/bus but does not promise schedule.",
  ...
  {
    id: "pa-ca-seal-public-office-007",
    ...
    seal_note_vi: "Pre-merge seal đóng gói counter, documents, checklist, và next step.",
    seal_note_en: "The pre-merge seal packages counter, documents, checklist, and next step.",
  ...
  },
  {
    ...
    seal_note_vi: "Pre-A11-seal sample chứng minh forms coverage, correction request, và official-process boundary.",
    seal_note_en: "The pre-A11-seal sample proves forms coverage, correction request, and official-process boundary.",
  ...
  },
  {
    ...
    seal_note_vi: "Pre-integration seal đóng gói pause line, interpreter request, và no-signing-until-clear boundary.",
    seal_note_en: "The pre-integration seal packages pause line, interpreter request, and no-signing-until-clear boundary.",
  ...
  },
  {
    ...
    seal_note_vi: "Closure-packet seal có immediate need, address, service type, và interpreter option.",
    seal_note_en: "The closure-packet seal has immediate need, address, service type, and interpreter option.",
    readiness_signal_vi: "Pre-A11-seal ổn nếu emergency boundary không thay thế emergency services.",
    readiness_signal_en: "Pre-A11-seal is stable if emergency boundary does not replace emergency services.",
  ...
  {
    id: "pa-ca-seal-service-recovery-011",
    ...
    seal_note_vi: "Pre-merge seal có repair phrase, written next step, và polite follow-up.",
    seal_note_en: "The pre-merge seal has repair phrase, written next step, and polite follow-up.",
  ...
  },
  {
    ...
    seal_note_vi: "Pre-integration seal đóng gói safety issue, supervisor handoff, và written report step.",
    seal_note_en: "The pre-integration seal packages safety issue, supervisor handoff, and written report step.",
    readiness_signal_vi: "Pre-A11-seal ổn nếu workplace task không chuyển thành claim guidance.",
    readiness_signal_en: "Pre-A11-seal is stable if the workplace task does not become claim guidance.",
...
export default PUNJABI_CANADA_SURVIVAL_SEAL_SAMPLES;
