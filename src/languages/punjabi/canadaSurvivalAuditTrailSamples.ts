// Punjabi Canada survival audit trail samples for Vietnamese-speaking and
...
export type PunjabiCanadaSurvivalAuditTrailDomain =
  | "clinic"
  | "pharmacy"
  | "school_childcare"
  | "bank"
...
export type PunjabiCanadaSurvivalAuditTrailCheck =
  | "pre_a11_audit_trail"
  | "traceability"
  | "evidence_receipt"
  | "pre_integration";

export type PunjabiCanadaSurvivalAuditTrailSample = {
  id: string;
  domain: PunjabiCanadaSurvivalAuditTrailDomain;
  check: PunjabiCanadaSurvivalAuditTrailCheck;
  phrase_pa: string;
  romanization: string;
  meaning_vi: string;
  meaning_en: string;
  ...
  auditTrail_note_vi: string;
  auditTrail_note_en: string;
...
export type PunjabiCanadaSurvivalAuditTrailScope = {
  name: string;
  audience: string[];
  scriptPolicy: string;
  reviewStatus: string;
  auditTrailBoundary: string;
};

export const PUNJABI_CANADA_SURVIVAL_AUDIT_TRAIL_SCOPE: PunjabiCanadaSurvivalAuditTrailScope = {
  name: "Punjabi Canada Survival Audit Trail Samples",
  ...
  auditTrailBoundary:
    "Pre-A11-audit-trail, traceability, evidence receipt, and pre-integration content samples for Canadian survival communication; not A11 integration, not legal advice, not medical advice, and not financial advice. These samples connect practical survival content to learner goals and audit-trail review.",
};

export const PUNJABI_CANADA_SURVIVAL_AUDIT_TRAIL_DOMAINS: PunjabiCanadaSurvivalAuditTrailDomain[] = [
  "clinic",
  "pharmacy",
  "school_childcare",
  "bank",
...
export const PUNJABI_CANADA_SURVIVAL_AUDIT_TRAIL_SAMPLES: PunjabiCanadaSurvivalAuditTrailSample[] = [
  {
    id: "pa-ca-audit-trail-clinic-001",
    domain: "clinic",
    check: "pre_a11_audit_trail",
    ...
    auditTrail_note_vi: "Pre-A11-audit-trail giữ phrase, repair request, và next-step handoff mà không tích hợp A11.",
    auditTrail_note_en: "The pre-A11-auditTrail keeps phrase, repair request, and next-step handoff without A11 integration.",
    readiness_signal_vi: "Evidence Receipt ổn nếu có Gurmukhi, romanization, Vietnamese, English, và clinic context.",
    readiness_signal_en: "Evidence Receipt is stable if it has Gurmukhi, romanization, Vietnamese, English, and clinic context.",
  ...
  {
    id: "pa-ca-audit-trail-pharmacy-002",
    domain: "pharmacy",
    ...
    auditTrail_note_vi: "Evidence Receipt sample chứng minh pharmacy content không tự đưa liều hoặc chẩn đoán.",
    auditTrail_note_en: "The evidence receipt sample proves pharmacy content does not provide dose or diagnosis.",
    readiness_signal_vi: "Traceability ổn nếu learner xin pharmacist viết số lần/ngày thay vì đoán.",
    readiness_signal_en: "Traceability is stable if the learner asks the pharmacist to write times per day instead of guessing.",
  ...
  {
    id: "pa-ca-audit-trail-school-childcare-003",
    ...
    auditTrail_note_vi: "Traceability auditTrail đóng gói child, date, action, và optional pickup detail.",
    auditTrail_note_en: "The traceability auditTrail packages child, date, action, and optional pickup detail.",
  ...
  },
  {
    ...
    auditTrail_note_vi: "Pre-A11-audit-trail giữ bank sample ở mức service information, không khuyến nghị sản phẩm.",
    auditTrail_note_en: "The pre-A11-auditTrail keeps the bank sample at service information level, not product recommendation.",
    readiness_signal_vi: "Evidence Receipt ổn nếu fee request và financial boundary đều có mặt.",
    readiness_signal_en: "Evidence Receipt is stable if fee request and financial boundary are both present.",
  ...
  {
    id: "pa-ca-audit-trail-housing-005",
    domain: "housing",
    ...
    auditTrail_note_vi: "Pre-integration auditTrail có unit, issue, repair time, và written confirmation.",
    auditTrail_note_en: "The pre-integration auditTrail has unit, issue, repair time, and written confirmation.",
    readiness_signal_vi: "Traceability ổn nếu housing task không chuyển thành tenancy advice.",
    readiness_signal_en: "Traceability is stable if the housing task does not become tenancy advice.",
  ...
  {
    id: "pa-ca-audit-trail-transport-006",
    domain: "transport",
    check: "evidence_receipt",
    ...
    auditTrail_note_vi: "Evidence Receipt auditTrail có route, direction, transfer, và delay repair line.",
    auditTrail_note_en: "The evidence receipt auditTrail has route, direction, transfer, and delay repair line.",
    readiness_signal_vi: "Pre-A11-audit-trail ổn nếu transport content dùng transit/bus nhưng không hứa schedule.",
    readiness_signal_en: "Pre-A11-audit-trail is stable if transport content uses transit/bus but does not promise schedule.",
  ...
  {
    id: "pa-ca-audit-trail-public-office-007",
    ...
    auditTrail_note_vi: "Traceability auditTrail đóng gói counter, documents, checklist, và next step.",
    auditTrail_note_en: "The traceability auditTrail packages counter, documents, checklist, and next step.",
    readiness_signal_vi: "Evidence Receipt ổn nếu public office flow không thành legal advice.",
    readiness_signal_en: "Evidence Receipt is stable if public office flow does not become legal advice.",
  ...
  {
    id: "pa-ca-audit-trail-forms-008",
    domain: "forms",
    check: "pre_a11_audit_trail",
    ...
    auditTrail_note_vi: "Pre-A11-audit-trail sample chứng minh forms coverage, correction request, và official-process boundary.",
    auditTrail_note_en: "The pre-A11-auditTrail sample proves forms coverage, correction request, and official-process boundary.",
  ...
  {
    id: "pa-ca-audit-trail-interpreter-009",
    ...
    auditTrail_note_vi: "Pre-integration auditTrail đóng gói pause line, interpreter request, và no-signing-until-clear boundary.",
    auditTrail_note_en: "The pre-integration auditTrail packages pause line, interpreter request, and no-signing-until-clear boundary.",
    readiness_signal_vi: "Evidence Receipt ổn nếu interpreter request chỉ là language support, không phải professional decision.",
    readiness_signal_en: "Evidence Receipt is stable if interpreter request is language support, not professional decision.",
  ...
  {
    id: "pa-ca-audit-trail-emergency-010",
    ...
    auditTrail_note_vi: "Evidence Receipt auditTrail có immediate need, address, service type, và interpreter option.",
    auditTrail_note_en: "The evidence receipt auditTrail has immediate need, address, service type, and interpreter option.",
    readiness_signal_vi: "Pre-A11-audit-trail ổn nếu emergency boundary không thay thế emergency services.",
    readiness_signal_en: "Pre-A11-audit-trail is stable if emergency boundary does not replace emergency services.",
  ...
  {
    id: "pa-ca-audit-trail-service-recovery-011",
    ...
    auditTrail_note_vi: "Traceability auditTrail có repair phrase, written next step, và polite follow-up.",
    auditTrail_note_en: "The traceability auditTrail has repair phrase, written next step, and polite follow-up.",
    readiness_signal_vi: "Evidence Receipt ổn nếu service recovery giúp learner không im lặng.",
    readiness_signal_en: "Evidence Receipt is stable if service recovery helps the learner avoid silence.",
  ...
  {
    id: "pa-ca-audit-trail-workplace-012",
    ...
    auditTrail_note_vi: "Pre-integration auditTrail đóng gói safety issue, supervisor handoff, và written report step.",
    auditTrail_note_en: "The pre-integration auditTrail packages safety issue, supervisor handoff, and written report step.",
    readiness_signal_vi: "Pre-A11-audit-trail ổn nếu workplace task không chuyển thành claim guidance.",
    readiness_signal_en: "Pre-A11-audit-trail is stable if the workplace task does not become claim guidance.",
...
export default PUNJABI_CANADA_SURVIVAL_AUDIT_TRAIL_SAMPLES;
