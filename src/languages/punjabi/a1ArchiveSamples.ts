// Punjabi A1 archive samples for Vietnamese-speaking and English-speaking learners.
// Gurmukhi is primary; romanization supports recognition. Native review is deferred.

export type PunjabiA1ArchiveDomain =
  | "greetings"
  | "identity"
  | "family"
  | "numbers"
...
export type PunjabiA1ArchiveStyle =
  | "pre_a11_archive"
  | "pre_snapshot"
  | "pre_signoff"
  | "pre_seal"
...
export type PunjabiA1ArchiveSample = {
  id: string;
  domain: PunjabiA1ArchiveDomain;
  style: PunjabiA1ArchiveStyle;
  prompt_vi: string;
  prompt_en: string;
  cue_pa: string;
  romanization?: string;
  ...
  meaning_en: string;
  expected_pa: string;
  archive_check_vi: string;
  archive_check_en: string;
  readiness_vi: string;
  readiness_en: string;
  trap?: {
    audience: "vi" | "en" | "both";
...
export const archiveScriptAwareness =
  "Gurmukhi is the primary script for this Punjabi A1 archive set. Shahmukhi is awareness only, not a full course track.";

export const punjabiA1ArchiveSamples: PunjabiA1ArchiveSample[] = [
  {
    id: "pa_a1_archive_greeting_001",
    domain: "greetings",
    style: "pre_snapshot",
    ...
    archive_check_vi: "Câu chào phải giữ Gurmukhi làm nội dung chính.",
    archive_check_en: "The greeting must keep Gurmukhi as the primary content.",
  ...
  },
  {
    ...
    archive_check_vi: "Mẫu ਮੇਰਾ ਨਾਮ ... ਹੈ phải còn nguyên trước khi hỏi lại.",
    archive_check_en: "The ਮੇਰਾ ਨਾਮ ... ਹੈ frame must stay intact before asking back.",
    readiness_vi: "Sẵn sàng cho archive nếu không bỏ ਹੈ.",
    readiness_en: "Ready for archive if ਹੈ is not dropped.",
  ...
  {
    id: "pa_a1_archive_family_001",
    domain: "family",
    style: "pre_merge",
    prompt_vi: "Chụp nhanh mẫu nói về gia đình đơn giản trước khi merge.",
    prompt_en: "Archive a simple family statement before merge.",
    ...
    archive_check_vi: "Mẫu gia đình phải kiểm tra cả giới thiệu người thân và 'tôi có'.",
    archive_check_en: "The family sample must check both introducing a relative and 'I have'.",
    readiness_vi: "Sẵn sàng cho archive nếu phân biệt ਮੇਰੇ và ਮੇਰੇ ਕੋਲ.",
    readiness_en: "Ready for archive if ਮੇਰੇ and ਮੇਰੇ ਕੋਲ are distinguished.",
  ...
  {
    id: "pa_a1_archive_numbers_001",
    domain: "numbers",
    style: "readiness_check",
    prompt_vi: "Chụp nhanh số lượng trong tình huống vé.",
    prompt_en: "Archive quantity in a ticket situation.",
    cue_pa: "ਤਿੰਨ ਟਿਕਟਾਂ।",
    romanization: "tinn tiktan",
    meaning_vi: "Ba vé.",
    meaning_en: "Three tickets.",
    expected_pa: "ਤਿੰਨ ਟਿਕਟਾਂ।",
    archive_check_vi: "Số phải đọc được bằng Gurmukhi trước khi nối với giá.",
    archive_check_en: "The number must be readable in Gurmukhi before linking to prices.",
    readiness_vi: "Sẵn sàng cho archive nếu nhận ra ਤਿੰਨ không cần chữ Latin trước.",
    readiness_en: "Ready for archive if ਤਿੰਨ is recognized without Latin text first.",
  ...
  {
    id: "pa_a1_archive_prices_001",
    domain: "prices",
    style: "qa",
    prompt_vi: "Chụp nhanh câu hỏi giá ngắn.",
    prompt_en: "Archive a short price question.",
    ...
    archive_check_vi: "Câu giá phải dùng được ở quầy hoặc cửa hàng Canada.",
    archive_check_en: "The price question must work at a Canada counter or shop.",
    readiness_vi: "Sẵn sàng cho archive nếu không đổi thành trật tự tiếng Anh.",
    readiness_en: "Ready for archive if it is not reordered like English.",
  ...
  {
    id: "pa_a1_archive_food_001",
    domain: "food",
    style: "pre_integration",
    prompt_vi: "Chụp nhanh câu nhu cầu đồ ăn/uống cơ bản trước tích hợp.",
    prompt_en: "Archive the basic food or drink need line before integration.",
    ...
    archive_check_vi: "Mẫu nhu cầu phải rõ chủ thể và vật cần.",
    archive_check_en: "The need frame must clearly show who needs what.",
    readiness_vi: "Sẵn sàng cho archive nếu giữ ਮੈਨੂੰ ... ਚਾਹੀਦੀ ਹੈ.",
    readiness_en: "Ready for archive if ਮੈਨੂੰ ... ਚਾਹੀਦੀ ਹੈ is kept.",
  ...
  {
    id: "pa_a1_archive_directions_001",
    domain: "directions",
    ...
    archive_check_vi: "Câu hỏi vị trí phải giữ ਕਿੱਥੇ ਹੈ ở cuối.",
    archive_check_en: "The location question must keep ਕਿੱਥੇ ਹੈ at the end.",
  ...
  },
  {
    ...
    archive_check_vi: "Đây là câu cứu nguy A1 và phải luôn có trong bản đóng băng cuối.",
    archive_check_en: "This is the A1 rescue line and must remain in the final freeze.",
  ...
  {
    id: "pa_a1_archive_repetition_001",
    domain: "repetition",
    style: "pre_signoff",
    prompt_vi: "Chụp nhanh câu xin nhắc lại lịch sự trước signoff.",
    prompt_en: "Archive the polite request to repeat before signoff.",
    ...
    archive_check_vi: "Câu này phải hỗ trợ khi nghe thiếu số, giá hoặc hướng dẫn.",
    archive_check_en: "This must support missed numbers, prices, or directions.",
    readiness_vi: "Sẵn sàng cho archive nếu dùng được trước khi bỏ cuộc.",
    readiness_en: "Ready for archive if usable before giving up.",
  ...
  {
    id: "pa_a1_archive_politeness_001",
    domain: "politeness",
    style: "pre_seal",
    prompt_vi: "Niêm phong lượt lịch sự cuối cùng.",
    prompt_en: "Seal the final polite turn.",
    cue_pa: "ਧੰਨਵਾਦ ਜੀ।",
    romanization: "dhanvad ji",
    meaning_vi: "Cảm ơn ạ.",
    meaning_en: "Thank you politely.",
    expected_pa: "ਧੰਨਵਾਦ ਜੀ।",
    archive_check_vi: "Lịch sự phải còn trong luồng dịch vụ ngắn.",
    archive_check_en: "Politeness must remain in the short service flow.",
    readiness_vi: "Sẵn sàng cho archive nếu người học biết đóng lượt bằng cảm ơn.",
    readiness_en: "Ready for archive if the learner can close the turn with thanks.",
  ...
  },
  {
    ...
    archive_check_vi: "Nhóm chữ phải kiểm tra Gurmukhi trước romanization.",
    archive_check_en: "The word set must check Gurmukhi before romanization.",
  ...
  {
    id: "pa_a1_archive_romanization_001",
    ...
    meaning_en: "again",
    expected_pa: "ਦੁਬਾਰਾ",
    archive_check_vi: "Romanization hỗ trợ đọc âm, nhưng đáp án đóng băng là Gurmukhi.",
    archive_check_en: "Romanization supports sound, but the frozen answer is Gurmukhi.",
  ...
  {
    id: "pa_a1_archive_canada_counter_001",
    ...
    archive_check_vi: "Câu này phải giữ mức A1, không biến thành bài giấy tờ nâng cao.",
    archive_check_en: "This must stay A1 and not become an advanced document lesson.",
...
export default punjabiA1ArchiveSamples;
