// src/languages/punjabi/a2ShipCandidateSamples.ts
//
// Punjabi A2 ship-candidate samples for Vietnamese-speaking and English-speaking
...
export type PunjabiA2ShipCandidateScenario =
  | "daily_routine"
  | "appointments"
  | "transport"
  | "housing"
...
export type PunjabiA2ShipCandidateStyle =
  | "ship_candidate"
  | "go_no_go"
  | "release_candidate"
  | "pre_integration";

export type PunjabiA2ShipCandidateLine = {
  pa: string;
  romanization: string;
  vi: string;
  en: string;
...
export type PunjabiA2ShipCandidateTrap = {
  trap_vi: string;
  trap_en: string;
  fix_pa: string;
...
export type PunjabiA2ShipCandidateItem = {
  id: string;
  scenario: PunjabiA2ShipCandidateScenario;
  style: PunjabiA2ShipCandidateStyle;
  title_vi: string;
  title_en: string;
  ship_goal_vi: string;
  ship_goal_en: string;
  ...
  traps: PunjabiA2ShipCandidateTrap[];
};

const scriptAwarenessVi =
  "Gurmukhi là chữ chính trong ship-candidate samples; Shahmukhi chỉ được nhắc để nhận biết, không phải khóa riêng.";
const scriptAwarenessEn =
  "Gurmukhi is the main script in these ship-candidate samples; Shahmukhi is mentioned only for awareness, not as a separate course.";

export const a2ShipCandidateSamples: PunjabiA2ShipCandidateItem[] = [
  {
    id: "pa_a2_ship_daily_routine",
    scenario: "daily_routine",
    style: "ship_candidate",
    title_vi: "Ship candidate: thói quen hằng ngày",
    title_en: "Ship candidate: daily routine",
    ship_goal_vi: "Xác nhận giờ, hành động sáng, và một câu quá khứ ngắn đã sẵn sàng.",
    ship_goal_en: "Confirm time, morning action, and one short past sentence are ready.",
    readiness_signal_vi: "Ready nếu giờ thức dậy, giờ ra khỏi nhà, và quá khứ đều rõ.",
    readiness_signal_en: "Ready if wake-up time, leaving-home time, and past action are clear.",
    hold_signal_vi: "Hold nếu lẫn giờ thức dậy với giờ ra khỏi nhà.",
    hold_signal_en: "Hold if wake-up time is confused with leaving-home time.",
  ...
  {
    id: "pa_a2_ship_appointments",
    scenario: "appointments",
    style: "go_no_go",
    title_vi: "Go/no-go: lịch hẹn",
    title_en: "Go/no-go: appointments",
    ship_goal_vi: "Xác nhận ngày giờ, giấy tờ, và câu đổi lịch nếu cần.",
    ship_goal_en: "Confirm date/time, documents, and reschedule sentence if needed.",
    readiness_signal_vi: "Ready nếu lịch hiện tại và đồ cần mang đều có.",
    readiness_signal_en: "Ready if current appointment and items to bring are both present.",
    hold_signal_vi: "Hold nếu câu đổi lịch làm mất lịch hiện tại.",
    hold_signal_en: "Hold if the reschedule sentence erases the current appointment.",
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  {
    id: "pa_a2_ship_transport",
    scenario: "transport",
    style: "pre_integration",
    title_vi: "Pre-integration: đi lại",
    title_en: "Pre-integration: transport",
    ship_goal_vi: "Xác nhận tuyến, điểm xuống, và báo trễ đã nhất quán.",
    ship_goal_en: "Confirm route, stop, and delay notice are consistent.",
    readiness_signal_vi: "Ready nếu điểm đến, điểm xuống, và thời lượng trễ đều rõ.",
    readiness_signal_en: "Ready if destination, stop, and delay length are all clear.",
    hold_signal_vi: "Hold nếu thiếu điểm đến hoặc thời lượng trễ.",
    hold_signal_en: "Hold if destination or delay length is missing.",
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  {
    id: "pa_a2_ship_housing",
    scenario: "housing",
    style: "release_candidate",
    title_vi: "Release candidate: nhà ở",
    title_en: "Release candidate: housing",
    ship_goal_vi: "Xác nhận opener lịch sự, sự cố, thời điểm, và yêu cầu sửa.",
    ship_goal_en: "Confirm polite opener, problem, timing, and repair request.",
    readiness_signal_vi: "Ready nếu sự cố giữ nguyên từ mô tả đến yêu cầu.",
    readiness_signal_en: "Ready if the problem stays the same from description to request.",
    hold_signal_vi: "Hold nếu thiếu thời điểm hoặc đổi sự cố.",
    hold_signal_en: "Hold if timing is missing or the problem changes.",
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  {
    id: "pa_a2_ship_school",
    scenario: "school",
    style: "ship_candidate",
    title_vi: "Ship candidate: trường học",
    title_en: "Ship candidate: school",
    ship_goal_vi: "Xác nhận vắng học, lý do, và yêu cầu homework.",
    ship_goal_en: "Confirm absence, reason, and homework request.",
    readiness_signal_vi: "Ready nếu người bị bệnh là trẻ và yêu cầu gửi bài rõ.",
    readiness_signal_en: "Ready if the sick person is the child and the work request is clear.",
    hold_signal_vi: "Hold nếu lẫn người bệnh hoặc thiếu yêu cầu bài.",
    hold_signal_en: "Hold if the sick person is confused or the work request is missing.",
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  {
    id: "pa_a2_ship_childcare",
    scenario: "childcare",
    style: "go_no_go",
    title_vi: "Go/no-go: childcare pickup",
    title_en: "Go/no-go: childcare pickup",
    ship_goal_vi: "Xác nhận người đón thay, thời gian, và pickup list.",
    ship_goal_en: "Confirm alternate pickup person, time, and pickup list.",
    readiness_signal_vi: "Ready nếu tên người đón và list khớp.",
    readiness_signal_en: "Ready if pickup name and list match.",
    hold_signal_vi: "Hold nếu người đón không rõ hoặc không có trong list.",
    hold_signal_en: "Hold if the pickup person is unclear or not on the list.",
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  {
    id: "pa_a2_ship_workplace_small_talk",
    ...
    ship_goal_vi: "Xác nhận chào hỏi, trả lời ngắn, và chuyển sang nhiệm vụ.",
    ship_goal_en: "Confirm greeting, short reply, and task transition.",
    readiness_signal_vi: "Ready nếu small talk lịch sự và task rõ.",
    readiness_signal_en: "Ready if small talk is polite and the task is clear.",
    hold_signal_vi: "Hold nếu small talk quá dài hoặc thiếu câu việc.",
    hold_signal_en: "Hold if small talk is too long or the work sentence is missing.",
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  },
  {
    ...
    ship_goal_vi: "Xác nhận tên, địa chỉ, và giấy tờ thiếu.",
    ship_goal_en: "Confirm name, address, and missing document.",
    readiness_signal_vi: "Ready nếu các field form không đổi giữa các câu.",
    readiness_signal_en: "Ready if form fields stay consistent across lines.",
    hold_signal_vi: "Hold nếu lẫn tên với địa chỉ hoặc thiếu giấy tờ.",
    hold_signal_en: "Hold if name/address are confused or the document is missing.",
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  {
    id: "pa_a2_ship_short_messages",
    scenario: "short_messages",
    style: "pre_integration",
    title_vi: "Pre-integration: tin nhắn ngắn",
    title_en: "Pre-integration: short messages",
    ship_goal_vi: "Xác nhận giờ, nơi, và vật cần mang được tách đúng.",
    ship_goal_en: "Confirm time, place, and item to bring are extracted correctly.",
    readiness_signal_vi: "Ready nếu giữ đủ thời gian, địa điểm, và vật cần mang.",
    readiness_signal_en: "Ready if time, place, and item to bring are all kept.",
    hold_signal_vi: "Hold nếu chỉ giữ địa điểm hoặc chỉ giữ vật cần mang.",
    hold_signal_en: "Hold if only the place or only the item is kept.",
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  {
    id: "pa_a2_ship_service_flow",
    scenario: "service_flow",
    style: "go_no_go",
    title_vi: "Go/no-go: luồng dịch vụ",
    title_en: "Go/no-go: service flow",
    ship_goal_vi: "Xác nhận opener, nhu cầu, và câu hỏi giấy tờ.",
    ship_goal_en: "Confirm opener, need, and document question.",
    readiness_signal_vi: "Ready nếu nhu cầu và câu hỏi giấy tờ nối nhau rõ.",
    readiness_signal_en: "Ready if the need and document question clearly connect.",
    hold_signal_vi: "Hold nếu nêu nhu cầu nhưng không hỏi bước tiếp theo.",
    hold_signal_en: "Hold if the need is stated but no next-step question is asked.",
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  },
  {
    ...
    ship_goal_vi: "Xác nhận opener lịch sự, vấn đề, và câu hỏi bước tiếp theo.",
    ship_goal_en: "Confirm polite opener, problem, and next-step question.",
    readiness_signal_vi: "Ready nếu vấn đề được nêu và được yêu cầu kiểm tra rõ.",
    readiness_signal_en: "Ready if the problem is stated and clearly requested for checking.",
    hold_signal_vi: "Hold nếu ਇਸ ਨੂੰ không còn trỏ về vấn đề đã nêu.",
    hold_signal_en: "Hold if is nu no longer points back to the stated problem.",
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  {
    id: "pa_a2_ship_interaction_repair",
    scenario: "interaction_repair",
    style: "pre_integration",
    title_vi: "Pre-integration: sửa chữa tương tác",
    title_en: "Pre-integration: interaction repair",
    ship_goal_vi: "Xác nhận báo chưa hiểu, xin nhắc lại, và xác nhận nghĩa.",
    ship_goal_en: "Confirm non-understanding signal, repetition request, and meaning confirmation.",
    readiness_signal_vi: "Ready nếu có đủ ba bước repair.",
    readiness_signal_en: "Ready if all three repair steps are present.",
    hold_signal_vi: "Hold nếu chỉ nói 'what?' hoặc không xác nhận lại.",
    hold_signal_en: "Hold if it only says 'what?' or does not confirm back.",
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
    lines: [
