// Punjabi A1 signoff samples for Vietnamese-speaking and English-speaking learners.
// Gurmukhi is primary; romanization supports recognition. Native review is deferred.

export type PunjabiA1SignoffDomain =
  | "greetings"
  | "identity"
  | "family"
  | "numbers"
...
export type PunjabiA1SignoffStyle =
  | "pre_a11_signoff"
  | "pre_snapshot"
  | "closure_packet"
  | "pre_merge"
...
export type PunjabiA1SignoffSample = {
  id: string;
  domain: PunjabiA1SignoffDomain;
  style: PunjabiA1SignoffStyle;
  prompt_vi: string;
  prompt_en: string;
  cue_pa: string;
  romanization?: string;
  ...
  meaning_en: string;
  expected_pa: string;
  signoff_check_vi: string;
  signoff_check_en: string;
  readiness_vi: string;
  readiness_en: string;
  trap?: {
    audience: "vi" | "en" | "both";
...
export const signoffScriptAwareness =
  "Gurmukhi is the primary script for this Punjabi A1 signoff set. Shahmukhi is awareness only, not a full course track.";

export const punjabiA1SignoffSamples: PunjabiA1SignoffSample[] = [
  {
    id: "pa_a1_signoff_greeting_001",
    domain: "greetings",
    style: "pre_snapshot",
    ...
    signoff_check_vi: "Câu chào phải giữ Gurmukhi làm nội dung chính.",
    signoff_check_en: "The greeting must keep Gurmukhi as the primary content.",
  ...
  },
  {
    ...
    signoff_check_vi: "Mẫu ਮੇਰਾ ਨਾਮ ... ਹੈ phải còn nguyên trước khi hỏi lại.",
    signoff_check_en: "The ਮੇਰਾ ਨਾਮ ... ਹੈ frame must stay intact before asking back.",
    readiness_vi: "Sẵn sàng cho signoff nếu không bỏ ਹੈ.",
    readiness_en: "Ready for signoff if ਹੈ is not dropped.",
  ...
  {
    id: "pa_a1_signoff_family_001",
    domain: "family",
    style: "pre_merge",
    prompt_vi: "Chụp nhanh mẫu nói về gia đình đơn giản trước khi merge.",
    prompt_en: "Signoff a simple family statement before merge.",
    ...
    signoff_check_vi: "Mẫu gia đình phải kiểm tra cả giới thiệu người thân và 'tôi có'.",
    signoff_check_en: "The family sample must check both introducing a relative and 'I have'.",
    readiness_vi: "Sẵn sàng cho signoff nếu phân biệt ਮੇਰੇ và ਮੇਰੇ ਕੋਲ.",
    readiness_en: "Ready for signoff if ਮੇਰੇ and ਮੇਰੇ ਕੋਲ are distinguished.",
  ...
  {
    id: "pa_a1_signoff_numbers_001",
    domain: "numbers",
    style: "readiness_check",
    prompt_vi: "Chụp nhanh số lượng trong tình huống vé.",
    prompt_en: "Signoff quantity in a ticket situation.",
    cue_pa: "ਤਿੰਨ ਟਿਕਟਾਂ।",
    romanization: "tinn tiktan",
    meaning_vi: "Ba vé.",
    meaning_en: "Three tickets.",
    expected_pa: "ਤਿੰਨ ਟਿਕਟਾਂ।",
    signoff_check_vi: "Số phải đọc được bằng Gurmukhi trước khi nối với giá.",
    signoff_check_en: "The number must be readable in Gurmukhi before linking to prices.",
    readiness_vi: "Sẵn sàng cho signoff nếu nhận ra ਤਿੰਨ không cần chữ Latin trước.",
    readiness_en: "Ready for signoff if ਤਿੰਨ is recognized without Latin text first.",
  ...
  {
    id: "pa_a1_signoff_prices_001",
    domain: "prices",
    style: "qa",
    prompt_vi: "Chụp nhanh câu hỏi giá ngắn.",
    prompt_en: "Signoff a short price question.",
    ...
    signoff_check_vi: "Câu giá phải dùng được ở quầy hoặc cửa hàng Canada.",
    signoff_check_en: "The price question must work at a Canada counter or shop.",
    readiness_vi: "Sẵn sàng cho signoff nếu không đổi thành trật tự tiếng Anh.",
    readiness_en: "Ready for signoff if it is not reordered like English.",
  ...
  {
    id: "pa_a1_signoff_food_001",
    domain: "food",
    style: "pre_integration",
    prompt_vi: "Chụp nhanh câu nhu cầu đồ ăn/uống cơ bản trước tích hợp.",
    prompt_en: "Signoff the basic food or drink need line before integration.",
    ...
    signoff_check_vi: "Mẫu nhu cầu phải rõ chủ thể và vật cần.",
    signoff_check_en: "The need frame must clearly show who needs what.",
    readiness_vi: "Sẵn sàng cho signoff nếu giữ ਮੈਨੂੰ ... ਚਾਹੀਦੀ ਹੈ.",
    readiness_en: "Ready for signoff if ਮੈਨੂੰ ... ਚਾਹੀਦੀ ਹੈ is kept.",
  ...
  {
    id: "pa_a1_signoff_directions_001",
    domain: "directions",
    ...
    signoff_check_vi: "Câu hỏi vị trí phải giữ ਕਿੱਥੇ ਹੈ ở cuối.",
    signoff_check_en: "The location question must keep ਕਿੱਥੇ ਹੈ at the end.",
  ...
  {
    id: "pa_a1_signoff_help_001",
    domain: "help",
    style: "pre_a11_signoff",
    ...
    signoff_check_vi: "Đây là câu cứu nguy A1 và phải luôn có trong bản đóng băng cuối.",
    signoff_check_en: "This is the A1 rescue line and must remain in the final freeze.",
  ...
  {
    id: "pa_a1_signoff_repetition_001",
    domain: "repetition",
    style: "pipeline_readiness",
    ...
    signoff_check_vi: "Câu này phải hỗ trợ khi nghe thiếu số, giá hoặc hướng dẫn.",
    signoff_check_en: "This must support missed numbers, prices, or directions.",
  ...
  {
    id: "pa_a1_signoff_politeness_001",
    domain: "politeness",
    style: "readiness_check",
    ...
    signoff_check_vi: "Lịch sự phải còn trong luồng dịch vụ ngắn.",
    signoff_check_en: "Politeness must remain in the short service flow.",
  ...
  },
  {
    ...
    signoff_check_vi: "Nhóm chữ phải kiểm tra Gurmukhi trước romanization.",
    signoff_check_en: "The word set must check Gurmukhi before romanization.",
  ...
  {
    id: "pa_a1_signoff_romanization_001",
    ...
    meaning_en: "again",
    expected_pa: "ਦੁਬਾਰਾ",
    signoff_check_vi: "Romanization hỗ trợ đọc âm, nhưng đáp án đóng băng là Gurmukhi.",
    signoff_check_en: "Romanization supports sound, but the frozen answer is Gurmukhi.",
  ...
  {
    id: "pa_a1_signoff_canada_counter_001",
    ...
    signoff_check_vi: "Câu này phải giữ mức A1, không biến thành bài giấy tờ nâng cao.",
    signoff_check_en: "This must stay A1 and not become an advanced document lesson.",
...
export default punjabiA1SignoffSamples;
