export type PunjabiB1GoNoGoFocus =
...
export type PunjabiGoNoGoTrap = {
  trap_en: string;
  trap_vi: string;
  better: PunjabiGoNoGoLine;
};

export type PunjabiGoNoGoCheck = {
  goNoGoPrompt_en: string;
  goNoGoPrompt_vi: string;
  sampleLine: PunjabiGoNoGoLine;
  readinessSignals_en: string[];
  readinessSignals_vi: string[];
};

export type PunjabiB1GoNoGoCard = {
  id: string;
  level: "B1";
  focus: PunjabiB1GoNoGoFocus;
  title_en: string;
  title_vi: string;
  scenario_en: string;
  scenario_vi: string;
  canadaContext: string;
  goNoGo: PunjabiGoNoGoCheck;
  commonTraps: PunjabiGoNoGoTrap[];
...
export const punjabiB1GoNoGoSamples: PunjabiB1GoNoGoCard[] = [
  {
    id: "b1-go-no-go-situation-explanation",
    level: "B1",
    focus: "situation_explanation",
    title_en: "Go/no-go situation explanation",
    ...
    commonTraps: [
      {
        trap_en: "Adding unrelated background at go-no-go stage.",
    ...
    closureValidationNote_en:
      "Language practice only, not medical advice. Go/no-go status depends on stable closure-validation.",
  ...
  {
    id: "b1-go-no-go-event-retelling",
    level: "B1",
    focus: "event_retelling",
    title_en: "Go/no-go event retelling",
  ...
  {
    id: "b1-go-no-go-clarification",
    level: "B1",
    focus: "clarification",
    title_en: "Go/no-go clarification",
    ...
    closureValidationNote_en:
      "Go/no-go clarification passes when closure-validation leaves no unclear next step.",
    closureValidationNote_vi:
  ...
  {
    id: "b1-go-no-go-service-recovery",
    level: "B1",
    focus: "service_recovery",
    title_en: "Go/no-go service recovery",
    ...
    closureValidationNote_en:
      "Native review is deferred. Go/no-go service recovery is ready when closure-validation avoids escalation.",
    closureValidationNote_vi:
  ...
  {
    id: "b1-go-no-go-issue-resolution",
    level: "B1",
    focus: "issue_resolution",
    title_en: "Go/no-go issue resolution",
    ...
    closureValidationNote_en:
      "Language practice only, not legal or financial advice. Go/no-go issue resolution should not invent outcomes.",
    closureValidationNote_vi:
  ...
  {
    id: "b1-go-no-go-follow-up-message",
    level: "B1",
    focus: "follow_up_message",
    title_en: "Go/no-go follow-up",
    ...
    closureValidationNote_en:
      "Go/no-go follow-up passes when closure-validation keeps the message short and actionable.",
    closureValidationNote_vi:
  ...
  {
    id: "b1-go-no-go-workplace-task",
    level: "B1",
    focus: "workplace_task",
    title_en: "Go/no-go workplace update",
    ...
    closureValidationNote_en:
      "Workplace go-no-go status depends on respectful closure-validation.",
    closureValidationNote_vi:
  ...
  {
    id: "b1-go-no-go-housing-school-community",
    level: "B1",
    focus: "housing_school_community",
    title_en: "Go/no-go public task",
    ...
    closureValidationNote_en:
      "Go-no-go public-task language remains practical and avoids legal, financial, or eligibility advice.",
    closureValidationNote_vi:
  ...
  {
    id: "b1-go-no-go-register-safe-repair",
    level: "B1",
    focus: "register_safe_repair",
    title_en: "Go/no-go register repair",
    ...
    closureValidationNote_en:
      "Native review is deferred. Go/no-go repair is ready when closure-validation keeps tone and task clear.",
    closureValidationNote_vi:
