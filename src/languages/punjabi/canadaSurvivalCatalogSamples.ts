// Punjabi Canada survival catalog samples for Vietnamese-speaking and
...
export type PunjabiCanadaSurvivalCatalogDomain =
  | "clinic"
  | "pharmacy"
  | "school_childcare"
  | "bank"
...
export type PunjabiCanadaSurvivalCatalogCheck =
  | "pre_a11_catalog"
  | "bundle"
  | "receipt"
  | "pre_integration";

export type PunjabiCanadaSurvivalCatalogSample = {
  id: string;
  domain: PunjabiCanadaSurvivalCatalogDomain;
  check: PunjabiCanadaSurvivalCatalogCheck;
  phrase_pa: string;
  romanization: string;
  meaning_vi: string;
  meaning_en: string;
...
export type PunjabiCanadaSurvivalCatalogScope = {
  name: string;
  audience: string[];
  scriptPolicy: string;
  reviewStatus: string;
...
export const PUNJABI_CANADA_SURVIVAL_CATALOG_SCOPE: PunjabiCanadaSurvivalCatalogScope = {
  name: "Punjabi Canada Survival Catalog Samples",
  ...
  catalogBoundary:
    "Pre-A11-catalog, bundle, receipt, and pre-integration content samples for Canadian survival communication; not A11 integration, not legal advice, not medical advice, and not financial advice.",
};

export const PUNJABI_CANADA_SURVIVAL_CATALOG_DOMAINS: PunjabiCanadaSurvivalCatalogDomain[] = [
  "clinic",
  "pharmacy",
  "school_childcare",
  "bank",
...
export const PUNJABI_CANADA_SURVIVAL_CATALOG_SAMPLES: PunjabiCanadaSurvivalCatalogSample[] = [
  {
    id: "pa-ca-catalog-clinic-001",
    domain: "clinic",
    check: "pre_a11_catalog",
    ...
    catalog_note_vi: "Pre-A11-catalog giữ phrase, repair request, và next-step handoff mà không tích hợp A11.",
    catalog_note_en: "The pre-A11-catalog keeps phrase, repair request, and next-step handoff without A11 integration.",
    readiness_signal_vi: "Receipt ổn nếu có Gurmukhi, romanization, Vietnamese, English, và clinic context.",
    readiness_signal_en: "Receipt is stable if it has Gurmukhi, romanization, Vietnamese, English, and clinic context.",
  ...
  },
  {
    ...
    catalog_note_vi: "Receipt sample chứng minh pharmacy content không tự đưa liều hoặc chẩn đoán.",
    catalog_note_en: "The receipt sample proves pharmacy content does not provide dose or diagnosis.",
    readiness_signal_vi: "Bundle ổn nếu learner xin pharmacist viết số lần/ngày thay vì đoán.",
    readiness_signal_en: "Bundle is stable if the learner asks the pharmacist to write times per day instead of guessing.",
  ...
  {
    id: "pa-ca-catalog-school-childcare-003",
    ...
    catalog_note_vi: "Bundle catalog đóng gói child, date, action, và optional pickup detail.",
    catalog_note_en: "The bundle catalog packages child, date, action, and optional pickup detail.",
  ...
  },
  {
    ...
    catalog_note_vi: "Pre-A11-catalog giữ bank sample ở mức service information, không khuyến nghị sản phẩm.",
    catalog_note_en: "The pre-A11-catalog keeps the bank sample at service information level, not product recommendation.",
    readiness_signal_vi: "Receipt ổn nếu fee request và financial boundary đều có mặt.",
    readiness_signal_en: "Receipt is stable if fee request and financial boundary are both present.",
  ...
  },
  {
    ...
    catalog_note_vi: "Pre-integration catalog có unit, issue, repair time, và written confirmation.",
    catalog_note_en: "The pre-integration catalog has unit, issue, repair time, and written confirmation.",
    readiness_signal_vi: "Bundle ổn nếu housing task không chuyển thành tenancy advice.",
    readiness_signal_en: "Bundle is stable if the housing task does not become tenancy advice.",
  ...
  {
    id: "pa-ca-catalog-transport-006",
    domain: "transport",
    check: "receipt",
    ...
    catalog_note_vi: "Receipt catalog có route, direction, transfer, và delay repair line.",
    catalog_note_en: "The receipt catalog has route, direction, transfer, and delay repair line.",
    readiness_signal_vi: "Pre-A11-catalog ổn nếu transport content dùng transit/bus nhưng không hứa schedule.",
    readiness_signal_en: "Pre-A11-catalog is stable if transport content uses transit/bus but does not promise schedule.",
  ...
  {
    id: "pa-ca-catalog-public-office-007",
    ...
    catalog_note_vi: "Bundle catalog đóng gói counter, documents, checklist, và next step.",
    catalog_note_en: "The bundle catalog packages counter, documents, checklist, and next step.",
    readiness_signal_vi: "Receipt ổn nếu public office flow không thành legal advice.",
    readiness_signal_en: "Receipt is stable if public office flow does not become legal advice.",
  ...
  },
  {
    ...
    catalog_note_vi: "Pre-A11-catalog sample chứng minh forms coverage, correction request, và official-process boundary.",
    catalog_note_en: "The pre-A11-catalog sample proves forms coverage, correction request, and official-process boundary.",
  ...
  {
    id: "pa-ca-catalog-interpreter-009",
    ...
    catalog_note_vi: "Pre-integration catalog đóng gói pause line, interpreter request, và no-signing-until-clear boundary.",
    catalog_note_en: "The pre-integration catalog packages pause line, interpreter request, and no-signing-until-clear boundary.",
    readiness_signal_vi: "Receipt ổn nếu interpreter request chỉ là language support, không phải professional decision.",
    readiness_signal_en: "Receipt is stable if interpreter request is language support, not professional decision.",
  ...
  {
    id: "pa-ca-catalog-emergency-010",
    ...
    catalog_note_vi: "Receipt catalog có immediate need, address, service type, và interpreter option.",
    catalog_note_en: "The receipt catalog has immediate need, address, service type, and interpreter option.",
    readiness_signal_vi: "Pre-A11-catalog ổn nếu emergency boundary không thay thế emergency services.",
    readiness_signal_en: "Pre-A11-catalog is stable if emergency boundary does not replace emergency services.",
  ...
  {
    id: "pa-ca-catalog-service-recovery-011",
    ...
    catalog_note_vi: "Bundle catalog có repair phrase, written next step, và polite follow-up.",
    catalog_note_en: "The bundle catalog has repair phrase, written next step, and polite follow-up.",
    readiness_signal_vi: "Receipt ổn nếu service recovery giúp learner không im lặng.",
    readiness_signal_en: "Receipt is stable if service recovery helps the learner avoid silence.",
  ...
  {
    id: "pa-ca-catalog-workplace-012",
    ...
    catalog_note_vi: "Pre-integration catalog đóng gói safety issue, supervisor handoff, và written report step.",
    catalog_note_en: "The pre-integration catalog packages safety issue, supervisor handoff, and written report step.",
    readiness_signal_vi: "Pre-A11-catalog ổn nếu workplace task không chuyển thành claim guidance.",
    readiness_signal_en: "Pre-A11-catalog is stable if the workplace task does not become claim guidance.",
...
export default PUNJABI_CANADA_SURVIVAL_CATALOG_SAMPLES;
