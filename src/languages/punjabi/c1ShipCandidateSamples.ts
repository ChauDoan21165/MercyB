// Punjabi C1 ship-candidate samples for Vietnamese-speaking and English-speaking learners.
//
...
export type PunjabiC1ShipCandidateArea =
  | "source_summary"
  | "cautious_claim"
  | "evidence_comparison"
...
export type PunjabiC1ShipCandidateMode =
  | "ship_candidate"
  | "go_no_go"
  | "release_candidate"
  | "pre_integration";

export type PunjabiC1ShipCandidatePhrase = {
  pa: string;
  rom: string;
  vi: string;
  en: string;
...
export type PunjabiC1ShipCandidateSample = {
  id: string;
  level: "C1";
  area: PunjabiC1ShipCandidateArea;
  mode: PunjabiC1ShipCandidateMode;
  title_pa: string;
  title_rom: string;
  title_vi: string;
  title_en: string;
  ship_prompt_vi: string;
  ship_prompt_en: string;
  sample: PunjabiC1ShipCandidatePhrase;
  ship_checks_vi: readonly string[];
  ship_checks_en: readonly string[];
  go_no_go_checks_vi: readonly string[];
  go_no_go_checks_en: readonly string[];
  pre_integration_notes_vi: readonly string[];
  pre_integration_notes_en: readonly string[];
  canada_example: PunjabiC1ShipCandidatePhrase & {
    context_vi: string;
    context_en: string;
  };
...
export const c1ShipCandidateSamplesScriptAwareness = {
...
export const c1ShipCandidateSamples: PunjabiC1ShipCandidateSample[] = [
  {
    id: "pa_c1_ship_candidate_source_summary",
    level: "C1",
    area: "source_summary",
    mode: "ship_candidate",
    title_pa: "ਸਰੋਤ ਸਾਰ ship-candidate",
    title_rom: "sarot saar ship-candidate",
    title_vi: "Ship-candidate tóm tắt nguồn",
    title_en: "Source summary ship candidate",
    ship_prompt_vi: "Xác nhận summary đã sẵn sàng ship: claim, evidence và neutrality đều rõ.",
    ship_prompt_en: "Confirm the summary is ready to ship: claim, evidence, and neutrality are all clear.",
    sample: {
    ...
    ship_checks_vi: ["Claim rõ.", "Evidence đi kèm.", "Giọng neutral."],
    ship_checks_en: ["Clear claim.", "Evidence included.", "Neutral tone."],
    go_no_go_checks_vi: ["Không thêm opinion.", "Không bỏ evidence chính.", "Không phóng đại nguồn."],
    go_no_go_checks_en: ["No added opinion.", "Does not drop main evidence.", "Does not overstate the source."],
    pre_integration_notes_vi: ["Sẵn sàng cho ship review.", "Không cần dữ liệu live.", "Dùng được trong rubric."],
    pre_integration_notes_en: ["Ready for ship review.", "No live data needed.", "Usable in a rubric."],
    canada_example: {
  ...
  {
    id: "pa_c1_ship_candidate_cautious_claim",
    level: "C1",
    area: "cautious_claim",
    mode: "go_no_go",
    title_pa: "ਸਾਵਧਾਨ ਦਾਅਵਾ go-no-go",
    title_rom: "savdhan daava go-no-go",
    title_vi: "Go/no-go claim thận trọng",
    title_en: "Cautious claim go/no-go",
    ship_prompt_vi: "Kiểm tra claim có đủ mạnh để ship nhưng vẫn không vượt evidence.",
    ship_prompt_en: "Check that the claim is strong enough to ship while not exceeding the evidence.",
    sample: {
    ...
    ship_checks_vi: ["Có hedge.", "Có giới hạn scale.", "Claim vẫn rõ."],
    ship_checks_en: ["Has hedging.", "Has a scale limit.", "The claim remains clear."],
    go_no_go_checks_vi: ["Không chắc từ pilot nhỏ.", "Không hedge đến mơ hồ.", "Không tạo claim thời sự."],
    go_no_go_checks_en: ["Not certain from a small pilot.", "Not hedged into vagueness.", "No current-news claim."],
  ...
  {
    id: "pa_c1_ship_candidate_evidence_comparison",
    level: "C1",
    ...
    ship_prompt_vi: "Xác nhận comparison phân biệt nguồn và giữ kết luận vừa mức.",
    ship_prompt_en: "Confirm the comparison distinguishes sources and keeps a measured conclusion.",
    sample: {
    ...
    ship_checks_vi: ["Vai trò nguồn rõ.", "Comparison rõ.", "Kết luận vừa mức."],
    ship_checks_en: ["Source roles are clear.", "Comparison is clear.", "Measured conclusion."],
    go_no_go_checks_vi: ["Không trộn evidence.", "Không chọn phe quá sớm.", "Không bỏ limitation."],
    go_no_go_checks_en: ["Evidence is not blended.", "Does not take a side too early.", "Does not omit limitations."],
  ...
  {
    id: "pa_c1_ship_candidate_formal_correspondence",
    level: "C1",
    ...
    ship_prompt_vi: "Kiểm tra email formal có request rõ, lịch sự và không giống chat.",
    ship_prompt_en: "Check that the formal email has a clear request, polite tone, and does not sound like chat.",
    sample: {
    ...
    ship_checks_vi: ["Request rõ.", "Tone lịch sự.", "Độ formal đủ."],
    ship_checks_en: ["Clear request.", "Polite tone.", "Formal enough."],
    go_no_go_checks_vi: ["Không trách móc.", "Không quá vòng vo.", "Không giống tin nhắn bạn bè."],
    go_no_go_checks_en: ["No blaming.", "Not overly indirect.", "Not like a message to a friend."],
  ...
  {
    id: "pa_c1_ship_candidate_executive_summary",
    level: "C1",
    area: "executive_summary",
    mode: "ship_candidate",
    title_pa: "ਕਾਰਜਕਾਰੀ ਸੰਖੇਪ ship-candidate",
    title_rom: "karjakari sankhep ship-candidate",
    title_vi: "Ship-candidate bản tóm tắt điều hành",
    title_en: "Executive summary ship candidate",
    ship_prompt_vi: "Xác nhận executive summary đủ gọn nhưng giữ priority, risk và next step.",
    ship_prompt_en: "Confirm that the executive summary is concise while keeping priority, risk, and next step.",
    sample: {
    ...
    ship_checks_vi: ["Có priority.", "Có risk.", "Có next step."],
    ship_checks_en: ["Has a priority.", "Has a risk.", "Has a next step."],
    go_no_go_checks_vi: ["Không lan man.", "Không thành report dài.", "Không bỏ action."],
    go_no_go_checks_en: ["Does not ramble.", "Does not become a long report.", "Does not omit action."],
    pre_integration_notes_vi: ["Sẵn sàng cho ship review.", "Compact cho app data.", "Không cần dữ liệu ngoài."],
    pre_integration_notes_en: ["Ready for ship review.", "Compact for app data.", "No outside data required."],
    canada_example: {
  ...
  {
    id: "pa_c1_ship_candidate_register_calibration",
    level: "C1",
    ...
    ship_prompt_vi: "Kiểm tra register chuyên nghiệp, rõ và không quá thân mật.",
    ship_prompt_en: "Check that the register is professional, clear, and not too casual.",
    sample: {
    ...
    ship_checks_vi: ["Professional.", "Giữ ý gốc.", "Không quá lạnh."],
    ship_checks_en: ["Professional.", "Keeps original meaning.", "Not too cold."],
    go_no_go_checks_vi: ["Không dịch word-by-word từ văn nói.", "Không quá casual.", "Không đổi nghĩa."],
    go_no_go_checks_en: ["Does not translate spoken style word for word.", "Not too casual.", "Does not change meaning."],
  ...
  {
    id: "pa_c1_ship_candidate_presentation_response",
    level: "C1",
    area: "presentation_response",
    mode: "go_no_go",
    title_pa: "ਪੇਸ਼ਕਾਰੀ ਜਵਾਬ go-no-go",
    title_rom: "peshkari jawab go-no-go",
    title_vi: "Go/no-go phản hồi thuyết trình",
    title_en: "Presentation response go/no-go",
    ship_prompt_vi: "Kiểm tra phản hồi Q&A có lịch sự, giới hạn claim và next step rõ.",
    ship_prompt_en: "Check that the Q&A response is polite, limits the claim, and gives a clear next step.",
    sample: {
    ...
    ship_checks_vi: ["Mở đầu lịch sự.", "Claim giới hạn.", "Có next step."],
    ship_checks_en: ["Polite opening.", "Limited claim.", "Has a next step."],
    go_no_go_checks_vi: ["Không phòng thủ.", "Không né câu hỏi.", "Không hứa kết quả chưa có."],
    go_no_go_checks_en: ["Not defensive.", "Does not avoid the question.", "Does not promise unavailable results."],
  ...
  {
    id: "pa_c1_ship_candidate_public_professional_tone",
    level: "C1",
    ...
    ship_prompt_vi: "Kiểm tra tone công vụ/chuyên nghiệp rõ, lịch sự và action-oriented.",
    ship_prompt_en: "Check that the public/professional tone is clear, polite, and action-oriented.",
    sample: {
    ...
    ship_checks_vi: ["Rõ cho người dân.", "Lịch sự.", "Có action cụ thể."],
    ship_checks_en: ["Clear for the public.", "Polite.", "Has a specific action."],
    go_no_go_checks_vi: ["Không dùng slang.", "Không có threat tone.", "Không mơ hồ deadline."],
    go_no_go_checks_en: ["No slang.", "No threatening tone.", "Not vague about the deadline."],
