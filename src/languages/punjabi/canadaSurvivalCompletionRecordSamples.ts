// Punjabi Canada survival completion record samples for Vietnamese-speaking and
...
export type PunjabiCanadaSurvivalCompletionRecordDomain =
  | "clinic"
  | "pharmacy"
  | "school_childcare"
  | "bank"
...
export type PunjabiCanadaSurvivalCompletionRecordCheck =
  | "pre_a11_completion_record"
  | "inventory_seal"
  | "catalog"
  | "pre_integration";

export type PunjabiCanadaSurvivalCompletionRecordSample = {
  id: string;
  domain: PunjabiCanadaSurvivalCompletionRecordDomain;
  check: PunjabiCanadaSurvivalCompletionRecordCheck;
  phrase_pa: string;
  romanization: string;
  meaning_vi: string;
  meaning_en: string;
  ...
  completionRecord_note_vi: string;
  completionRecord_note_en: string;
...
export type PunjabiCanadaSurvivalCompletionRecordScope = {
  name: string;
  audience: string[];
  scriptPolicy: string;
  reviewStatus: string;
  completionRecordBoundary: string;
};

export const PUNJABI_CANADA_SURVIVAL_COMPLETION_RECORD_SCOPE: PunjabiCanadaSurvivalCompletionRecordScope = {
  name: "Punjabi Canada Survival Completion Record Samples",
  ...
  completionRecordBoundary:
    "Pre-A11-completion-record, inventory seal, catalog, and pre-integration content samples for Canadian survival communication; not A11 integration, not legal advice, not medical advice, and not financial advice.",
};

export const PUNJABI_CANADA_SURVIVAL_COMPLETION_RECORD_DOMAINS: PunjabiCanadaSurvivalCompletionRecordDomain[] = [
  "clinic",
  "pharmacy",
  "school_childcare",
  "bank",
...
export const PUNJABI_CANADA_SURVIVAL_COMPLETION_RECORD_SAMPLES: PunjabiCanadaSurvivalCompletionRecordSample[] = [
  {
    id: "pa-ca-completion-record-clinic-001",
    domain: "clinic",
    check: "pre_a11_completion_record",
    ...
    completionRecord_note_vi: "Pre-A11-completion-record giữ phrase, repair request, và next-step handoff mà không tích hợp A11.",
    completionRecord_note_en: "The pre-A11-completionRecord keeps phrase, repair request, and next-step handoff without A11 integration.",
    readiness_signal_vi: "Catalog ổn nếu có Gurmukhi, romanization, Vietnamese, English, và clinic context.",
    readiness_signal_en: "Catalog is stable if it has Gurmukhi, romanization, Vietnamese, English, and clinic context.",
  ...
  {
    id: "pa-ca-completion-record-pharmacy-002",
    domain: "pharmacy",
    check: "catalog",
    ...
    completionRecord_note_vi: "Catalog sample chứng minh pharmacy content không tự đưa liều hoặc chẩn đoán.",
    completionRecord_note_en: "The catalog sample proves pharmacy content does not provide dose or diagnosis.",
    readiness_signal_vi: "Inventory Seal ổn nếu learner xin pharmacist viết số lần/ngày thay vì đoán.",
    readiness_signal_en: "Inventory Seal is stable if the learner asks the pharmacist to write times per day instead of guessing.",
  ...
  {
    id: "pa-ca-completion-record-school-childcare-003",
    ...
    completionRecord_note_vi: "Inventory Seal completionRecord đóng gói child, date, action, và optional pickup detail.",
    completionRecord_note_en: "The inventory seal completionRecord packages child, date, action, and optional pickup detail.",
  ...
  {
    id: "pa-ca-completion-record-bank-004",
    domain: "bank",
    check: "pre_a11_completion_record",
    ...
    completionRecord_note_vi: "Pre-A11-completion-record giữ bank sample ở mức service information, không khuyến nghị sản phẩm.",
    completionRecord_note_en: "The pre-A11-completionRecord keeps the bank sample at service information level, not product recommendation.",
    readiness_signal_vi: "Catalog ổn nếu fee request và financial boundary đều có mặt.",
    readiness_signal_en: "Catalog is stable if fee request and financial boundary are both present.",
  ...
  {
    id: "pa-ca-completion-record-housing-005",
    domain: "housing",
    ...
    completionRecord_note_vi: "Pre-integration completionRecord có unit, issue, repair time, và written confirmation.",
    completionRecord_note_en: "The pre-integration completionRecord has unit, issue, repair time, and written confirmation.",
    readiness_signal_vi: "Inventory Seal ổn nếu housing task không chuyển thành tenancy advice.",
    readiness_signal_en: "Inventory Seal is stable if the housing task does not become tenancy advice.",
  ...
  {
    id: "pa-ca-completion-record-transport-006",
    domain: "transport",
    check: "catalog",
    ...
    completionRecord_note_vi: "Catalog completionRecord có route, direction, transfer, và delay repair line.",
    completionRecord_note_en: "The catalog completionRecord has route, direction, transfer, and delay repair line.",
    readiness_signal_vi: "Pre-A11-completion-record ổn nếu transport content dùng transit/bus nhưng không hứa schedule.",
    readiness_signal_en: "Pre-A11-completion-record is stable if transport content uses transit/bus but does not promise schedule.",
  ...
  {
    id: "pa-ca-completion-record-public-office-007",
    ...
    completionRecord_note_vi: "Inventory Seal completionRecord đóng gói counter, documents, checklist, và next step.",
    completionRecord_note_en: "The inventory seal completionRecord packages counter, documents, checklist, and next step.",
    readiness_signal_vi: "Catalog ổn nếu public office flow không thành legal advice.",
    readiness_signal_en: "Catalog is stable if public office flow does not become legal advice.",
  ...
  {
    id: "pa-ca-completion-record-forms-008",
    domain: "forms",
    check: "pre_a11_completion_record",
    ...
    completionRecord_note_vi: "Pre-A11-completion-record sample chứng minh forms coverage, correction request, và official-process boundary.",
    completionRecord_note_en: "The pre-A11-completionRecord sample proves forms coverage, correction request, and official-process boundary.",
  ...
  {
    id: "pa-ca-completion-record-interpreter-009",
    ...
    completionRecord_note_vi: "Pre-integration completionRecord đóng gói pause line, interpreter request, và no-signing-until-clear boundary.",
    completionRecord_note_en: "The pre-integration completionRecord packages pause line, interpreter request, and no-signing-until-clear boundary.",
    readiness_signal_vi: "Catalog ổn nếu interpreter request chỉ là language support, không phải professional decision.",
    readiness_signal_en: "Catalog is stable if interpreter request is language support, not professional decision.",
  ...
  {
    id: "pa-ca-completion-record-emergency-010",
    ...
    completionRecord_note_vi: "Catalog completionRecord có immediate need, address, service type, và interpreter option.",
    completionRecord_note_en: "The catalog completionRecord has immediate need, address, service type, and interpreter option.",
    readiness_signal_vi: "Pre-A11-completion-record ổn nếu emergency boundary không thay thế emergency services.",
    readiness_signal_en: "Pre-A11-completion-record is stable if emergency boundary does not replace emergency services.",
  ...
  {
    id: "pa-ca-completion-record-service-recovery-011",
    ...
    completionRecord_note_vi: "Inventory Seal completionRecord có repair phrase, written next step, và polite follow-up.",
    completionRecord_note_en: "The inventory seal completionRecord has repair phrase, written next step, and polite follow-up.",
    readiness_signal_vi: "Catalog ổn nếu service recovery giúp learner không im lặng.",
    readiness_signal_en: "Catalog is stable if service recovery helps the learner avoid silence.",
  ...
  {
    id: "pa-ca-completion-record-workplace-012",
    ...
    completionRecord_note_vi: "Pre-integration completionRecord đóng gói safety issue, supervisor handoff, và written report step.",
    completionRecord_note_en: "The pre-integration completionRecord packages safety issue, supervisor handoff, and written report step.",
    readiness_signal_vi: "Pre-A11-completion-record ổn nếu workplace task không chuyển thành claim guidance.",
    readiness_signal_en: "Pre-A11-completion-record is stable if the workplace task does not become claim guidance.",
...
export default PUNJABI_CANADA_SURVIVAL_COMPLETION_RECORD_SAMPLES;
