// Punjabi Canada survival ship-candidate samples for Vietnamese-speaking
...
export type PunjabiCanadaSurvivalShipCandidateDomain =
  | "clinic"
  | "pharmacy"
  | "school_childcare"
  | "bank"
...
export type PunjabiCanadaSurvivalShipCandidateUse =
  | "ship_candidate"
  | "closure_validation"
  | "pre_integration"
  | "handoff_check";

export type PunjabiCanadaSurvivalShipCandidateItem = {
  id: string;
  domain: PunjabiCanadaSurvivalShipCandidateDomain;
  use: PunjabiCanadaSurvivalShipCandidateUse;
  ship_vi: string;
  ship_en: string;
  goal_vi: string;
  goal_en: string;
  ...
  meaning_en: string;
  support_pa: string[];
  ship_check_vi: string;
  ship_check_en: string;
...
export type PunjabiCanadaSurvivalShipCandidateScope = {
  name: string;
  audience: string[];
  scriptPolicy: string;
  reviewStatus: string;
...
export const PUNJABI_CANADA_SURVIVAL_SHIP_CANDIDATE_SCOPE: PunjabiCanadaSurvivalShipCandidateScope = {
  name: "Punjabi Canada Survival Ship Candidate Samples",
  ...
  boundaries: [
    "Language support only for Canada survival ship-candidate samples.",
    "No medical, legal, financial, tenancy, or workplace safety advice.",
  ],
};

export const PUNJABI_CANADA_SURVIVAL_SHIP_CANDIDATE_SAMPLES: PunjabiCanadaSurvivalShipCandidateItem[] = [
  {
    id: "pa-ca-shipcandidate-clinic-001",
    domain: "clinic",
    use: "ship_candidate",
    ship_vi: "Đóng kiểm câu phòng khám khi người học cần xin giải thích chậm trước khi trả lời.",
    ship_en: "Close-check the clinic line when the learner needs slower explanation before answering.",
    ...
    ship_check_vi: "Ship-candidate giữ câu ở mức hỗ trợ ngôn ngữ, không đưa lời khuyên y tế.",
    ship_check_en: "Ship candidate keeps this as language support, not medical advice.",
  ...
  {
    id: "pa-ca-shipcandidate-pharmacy-002",
    domain: "pharmacy",
    use: "closure_validation",
    ship_vi: "Đóng kiểm câu nhà thuốc để người học nêu dị ứng và xin ghi lại thông tin.",
    ship_en: "Close-check the pharmacy line so the learner can state an allergy and ask for writing.",
    ...
    ship_check_vi: "Closure-validation xác nhận câu không thêm liều lượng hoặc hướng dẫn thuốc.",
    ship_check_en: "The closure validation confirms the line does not add dosage or medicine instructions.",
  ...
  {
    id: "pa-ca-shipcandidate-school-003",
    domain: "school_childcare",
    use: "pre_integration",
    ship_vi: "Đóng kiểm câu form dùng được cho trường và childcare khi người học bị kẹt.",
    ship_en: "Close-check the form line for school and childcare when the learner is stuck.",
    ...
    ship_check_vi: "Pre-integration xác nhận câu nối được với trường, childcare, và form.",
    ship_check_en: "Pre-integration confirms the line connects to school, childcare, and form flows.",
  ...
  {
    id: "pa-ca-shipcandidate-bank-004",
    domain: "bank",
    use: "handoff_check",
    ship_vi: "Đóng kiểm câu ngân hàng giữ mục tiêu mở tài khoản và hỏi phí.",
    ship_en: "Close-check the bank line so it keeps the account-opening and fee goal.",
    ...
    ship_check_vi: "Handoff check xác nhận câu không trôi sang thẻ, vay, hoặc lời khuyên tiền bạc.",
    ship_check_en: "The handoff check confirms the line does not drift to cards, loans, or money advice.",
  ...
  {
    id: "pa-ca-shipcandidate-housing-005",
    domain: "housing",
    use: "ship_candidate",
    ship_vi: "Đóng kiểm câu nhà thuê khi cần thời gian sửa và phản hồi bằng văn bản.",
    ship_en: "Close-check the rental line when repair timing and a written reply are needed.",
    ...
    ship_check_vi: "Ship-candidate không biến câu sửa chữa thành tư vấn luật thuê nhà.",
    ship_check_en: "Ship candidate does not turn the repair line into tenancy advice.",
  ...
  {
    id: "pa-ca-shipcandidate-transport-006",
    domain: "transport",
    use: "pre_integration",
    ship_vi: "Đóng kiểm câu giao thông khi người học cần hỏi tuyến xe và điểm xuống.",
    ship_en: "Close-check the transport line when the learner needs route and stop confirmation.",
    ...
    ship_check_vi: "Pre-integration xác nhận câu nối được với phần chỉ đường và lịch trình.",
    ship_check_en: "Pre-integration confirms the line connects to directions and schedule content.",
  ...
  {
    id: "pa-ca-shipcandidate-public-office-007",
    domain: "public_office",
    use: "closure_validation",
    ship_vi: "Đóng kiểm câu cơ quan công khi người học cần biết quầy và giấy tờ.",
    ship_en: "Close-check the public-office line when the learner needs the right counter and documents.",
    ...
    ship_check_vi: "Closure-validation xác nhận câu nối được với form và quầy dịch vụ.",
    ship_check_en: "The closure validation confirms the line connects to form and service-counter flows.",
  ...
  {
    id: "pa-ca-shipcandidate-forms-008",
    domain: "forms_service_desk",
    use: "ship_candidate",
    ship_vi: "Đóng kiểm câu bàn dịch vụ khi người học cần chỉ phần form chưa hiểu.",
    ship_en: "Close-check the service-desk line when the learner needs to show the unclear form section.",
    ...
    ship_check_vi: "Ship-candidate xác nhận câu form đủ rõ trước khi ghép vào luồng cuối.",
    ship_check_en: "Ship candidate confirms the form line is clear before final flow linking.",
  ...
  {
    id: "pa-ca-shipcandidate-interpreter-009",
    domain: "interpreter_request",
    use: "handoff_check",
    ship_vi: "Đóng kiểm câu xin thông dịch viên khi tình huống vượt quá mức hiểu.",
    ship_en: "Close-check the interpreter request when the situation exceeds the learner's understanding.",
    ...
    ship_check_vi: "Handoff check xác nhận Shahmukhi chỉ là nhận biết, không phải khóa học đầy đủ.",
    ship_check_en: "The handoff check confirms Shahmukhi is awareness only, not a full course.",
  ...
  {
    id: "pa-ca-shipcandidate-emergency-010",
    domain: "emergency_boundary",
    use: "closure_validation",
    ship_vi: "Đóng kiểm câu khẩn cấp khi có nguy hiểm thật sự và cần gọi 911.",
    ship_en: "Close-check the emergency line when there is real danger and 911 is needed.",
    ...
    ship_check_vi: "Closure-validation giữ câu khẩn cấp rõ và không thay thế dịch vụ khẩn cấp.",
    ship_check_en: "The closure validation keeps the emergency line clear and does not replace emergency services.",
  ...
  {
    id: "pa-ca-shipcandidate-recovery-011",
    domain: "service_recovery",
    use: "ship_candidate",
    ship_vi: "Đóng kiểm câu phục hồi dịch vụ khi thông tin sai hoặc chưa khớp.",
    ship_en: "Close-check the service-recovery line when information is wrong or does not match.",
    ...
    ship_check_vi: "Ship-candidate xác nhận câu sửa lỗi vẫn lịch sự và thực tế.",
    ship_check_en: "Ship candidate confirms the correction line stays polite and practical.",
  ...
  {
    id: "pa-ca-shipcandidate-workplace-012",
    domain: "workplace_safety",
    use: "pre_integration",
    ship_vi: "Đóng kiểm câu nơi làm việc khi người học chưa hiểu hướng dẫn an toàn.",
    ship_en: "Close-check the workplace line when the learner did not understand a safety instruction.",
    ...
    ship_check_vi: "Pre-integration giữ câu ở mức xin làm rõ ngôn ngữ, không đưa hướng dẫn kỹ thuật.",
    ship_check_en: "Pre-integration keeps this as language clarification, not technical instruction.",
...
export default PUNJABI_CANADA_SURVIVAL_SHIP_CANDIDATE_SAMPLES;
