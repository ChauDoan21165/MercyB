// Punjabi C1 CI-readiness samples for Vietnamese-speaking and English-speaking learners.
//
...
export type PunjabiC1CiReadinessArea =
  | "source_summary"
  | "cautious_claim"
  | "evidence_comparison"
...
export type PunjabiC1CiReadinessMode =
  | "ci_readiness"
  | "mr_readiness"
  | "final_freeze"
  | "pre_integration";

export type PunjabiC1CiReadinessPhrase = {
  pa: string;
  rom: string;
  vi: string;
  en: string;
...
export type PunjabiC1CiReadinessSample = {
  id: string;
  level: "C1";
  area: PunjabiC1CiReadinessArea;
  mode: PunjabiC1CiReadinessMode;
  title_pa: string;
  title_rom: string;
  title_vi: string;
  title_en: string;
  ci_prompt_vi: string;
  ci_prompt_en: string;
  sample: PunjabiC1CiReadinessPhrase;
  ci_readiness_checks_vi: readonly string[];
  ci_readiness_checks_en: readonly string[];
  ...
  canada_example: PunjabiC1CiReadinessPhrase & {
    context_vi: string;
    context_en: string;
  };
...
export const c1CiReadinessSamplesScriptAwareness = {
  vi: "Bộ CI-readiness này dùng Gurmukhi làm chữ chính. Shahmukhi chỉ được nhắc để nhận biết một hệ chữ Punjabi khác, không phải phần luyện chính.",
  en: "This CI-readiness pack uses Gurmukhi as the primary script. Shahmukhi is mentioned only to recognize another Punjabi script, not as the main practice script.",
} as const;

export const c1CiReadinessSamples: PunjabiC1CiReadinessSample[] = [
  {
    id: "pa_c1_ci_readiness_source_summary",
    level: "C1",
    area: "source_summary",
    mode: "ci_readiness",
    title_pa: "ਸਰੋਤ ਸਾਰ CI-readiness",
    title_rom: "sarot saar CI-readiness",
    title_vi: "Sample CI-readiness cho tóm tắt nguồn",
    title_en: "CI-readiness sample for source summary",
    ci_prompt_vi: "Dùng sample này để kiểm tra CI có thể bắt claim, evidence và neutrality ổn định.",
    ci_prompt_en: "Use this sample to check that CI can catch stable claim, evidence, and neutrality.",
    sample: {
    ...
    ci_readiness_checks_vi: ["Claim rõ để test.", "Evidence có mặt.", "Không thêm opinion."],
    ci_readiness_checks_en: ["Clear claim for testing.", "Evidence is present.", "No added opinion."],
  ...
  {
    id: "pa_c1_ci_readiness_cautious_claim",
    level: "C1",
    area: "cautious_claim",
    mode: "mr_readiness",
    ...
    ci_prompt_vi: "Dùng sample này để kiểm tra claim có hedge nhưng vẫn đủ rõ.",
    ci_prompt_en: "Use this sample to check that the claim has hedging but remains clear.",
    sample: {
    ...
    ci_readiness_checks_vi: ["Có hedge.", "Có giới hạn scale.", "Claim không mơ hồ."],
    ci_readiness_checks_en: ["Has hedging.", "Has a scale limit.", "Claim is not vague."],
  ...
  {
    id: "pa_c1_ci_readiness_evidence_comparison",
    level: "C1",
    area: "evidence_comparison",
    mode: "final_freeze",
    title_pa: "ਸਬੂਤ ਤੁਲਨਾ final-freeze",
    title_rom: "sabut tulna final-freeze",
    title_vi: "So sánh bằng chứng cho final-freeze",
    title_en: "Evidence comparison for final freeze",
    ci_prompt_vi: "Dùng sample này để CI kiểm tra comparison giữa số liệu và trải nghiệm.",
    ci_prompt_en: "Use this sample so CI can check comparison between figures and experience.",
    sample: {
    ...
    ci_readiness_checks_vi: ["Phân biệt evidence.", "Có kết luận vừa mức.", "Không trộn nguồn."],
    ci_readiness_checks_en: ["Distinguishes evidence.", "Measured conclusion.", "Does not blend sources."],
    ...
    pre_integration_notes_vi: ["Không cần live data.", "Không chạm CI config.", "Dùng được trong app data."],
    pre_integration_notes_en: ["No live data needed.", "Does not touch CI config.", "Usable in app data."],
    canada_example: {
  ...
  {
    id: "pa_c1_ci_readiness_formal_correspondence",
    level: "C1",
    ...
    ci_prompt_vi: "Dùng sample này để test email formal: request rõ, lịch sự, không casual.",
    ci_prompt_en: "Use this sample to test a formal email: clear request, polite, not casual.",
    sample: {
    ...
    ci_readiness_checks_vi: ["Request rõ.", "Tone lịch sự.", "Không giống tin nhắn bạn bè."],
    ci_readiness_checks_en: ["Clear request.", "Polite tone.", "Not like a message to a friend."],
  ...
  {
    id: "pa_c1_ci_readiness_executive_summary",
    level: "C1",
    area: "executive_summary",
    mode: "ci_readiness",
    title_pa: "ਕਾਰਜਕਾਰੀ ਸੰਖੇਪ CI-readiness",
    title_rom: "karjakari sankhep CI-readiness",
    title_vi: "Executive summary cho CI-readiness",
    title_en: "Executive summary for CI readiness",
    ci_prompt_vi: "Dùng sample này để test summary ngắn có priority, risk và next step.",
    ci_prompt_en: "Use this sample to test a short summary with priority, risk, and next step.",
    sample: {
    ...
    ci_readiness_checks_vi: ["Có priority.", "Có risk.", "Có next step."],
    ci_readiness_checks_en: ["Has a priority.", "Has a risk.", "Has a next step."],
  ...
  {
    id: "pa_c1_ci_readiness_register_calibration",
    level: "C1",
    ...
    ci_prompt_vi: "Dùng sample này để test register formal, cautious và không quá casual.",
    ci_prompt_en: "Use this sample to test formal, cautious, and not-too-casual register.",
    sample: {
    ...
    ci_readiness_checks_vi: ["Register formal.", "Claim cautious.", "Không casual."],
    ci_readiness_checks_en: ["Formal register.", "Cautious claim.", "Not casual."],
  ...
  {
    id: "pa_c1_ci_readiness_presentation_response",
    level: "C1",
    area: "presentation_response",
    mode: "final_freeze",
    title_pa: "ਪ੍ਰਜ਼ੈਂਟੇਸ਼ਨ ਜਵਾਬ final-freeze",
    title_rom: "presentation jawab final-freeze",
    title_vi: "Phản hồi presentation cho final-freeze",
    title_en: "Presentation response for final freeze",
    ci_prompt_vi: "Dùng sample này để test câu trả lời Q&A có cấu trúc và không phòng thủ.",
    ci_prompt_en: "Use this sample to test a structured, non-defensive Q&A answer.",
    sample: {
    ...
    ci_readiness_checks_vi: ["Ghi nhận câu hỏi.", "Có cấu trúc.", "Không overstated."],
    ci_readiness_checks_en: ["Acknowledges the question.", "Structured.", "Not overstated."],
  ...
  {
    id: "pa_c1_ci_readiness_public_professional_tone",
    level: "C1",
    ...
    ci_prompt_vi: "Dùng sample này để CI kiểm tra thông báo công khai rõ, tôn trọng và có next action.",
    ci_prompt_en: "Use this sample so CI can check a public notice that is clear, respectful, and has a next action.",
    sample: {
    ...
    ci_readiness_checks_vi: ["Thông báo rõ.", "Tone tôn trọng.", "Có next action."],
    ci_readiness_checks_en: ["Clear notice.", "Respectful tone.", "Has a next action."],
