// Punjabi Canada survival MR-readiness evidence for Vietnamese-speaking and
...
export type PunjabiCanadaSurvivalMrReadinessDomain =
  | "clinic"
  | "pharmacy"
  | "school_childcare"
  | "bank"
...
export type PunjabiCanadaSurvivalMrReadinessUse =
  | "mr_readiness"
  | "final_freeze"
  | "final_lock"
  | "pre_integration";

export type PunjabiCanadaSurvivalMrReadinessItem = {
  id: string;
  domain: PunjabiCanadaSurvivalMrReadinessDomain;
  use: PunjabiCanadaSurvivalMrReadinessUse;
  mr_readiness_vi: string;
  mr_readiness_en: string;
  goal_vi: string;
  goal_en: string;
  phrase_pa: string;
  romanization: string;
  ...
  meaning_en: string;
  support_pa: string[];
  mr_readiness_check_vi: string;
  mr_readiness_check_en: string;
...
export type PunjabiCanadaSurvivalMrReadinessScope = {
  name: string;
  audience: string[];
  scriptPolicy: string;
  reviewStatus: string;
...
export const PUNJABI_CANADA_SURVIVAL_MR_READINESS_SCOPE: PunjabiCanadaSurvivalMrReadinessScope = {
  name: "Punjabi Canada Survival MR Readiness Evidence",
  ...
  boundaries: [
    "Language support only for Canada survival MR-readiness evidence.",
    "No medical, legal, financial, tenancy, or workplace safety advice.",
  ],
};

export const PUNJABI_CANADA_SURVIVAL_MR_READINESS_SAMPLES: PunjabiCanadaSurvivalMrReadinessItem[] = [
  {
    id: "pa-ca-mrreadiness-clinic-001",
    domain: "clinic",
    use: "mr_readiness",
    mr_readiness_vi: "Khóa cuối câu phòng khám để người học xin nói chậm và nhắc lại trước khi trả lời.",
    mr_readiness_en:
      "MR-readiness evidence checks the clinic line so the learner can ask for slow speech and a repeat before answering.",
    ...
    mr_readiness_check_vi: "MR-readiness giữ câu ở hỗ trợ ngôn ngữ, không đưa lời khuyên y tế.",
    mr_readiness_check_en: "MR-readiness keeps this as language support, not medical advice.",
  ...
  {
    id: "pa-ca-mrreadiness-pharmacy-002",
    domain: "pharmacy",
    use: "final_lock",
    mr_readiness_vi: "Khóa cuối câu nhà thuốc để nêu dị ứng và xin ghi thông tin bằng văn bản.",
    mr_readiness_en: "MR-readiness evidence checks the pharmacy line for stating an allergy and asking for written information.",
    ...
    mr_readiness_check_vi: "Final-lock xác nhận câu không thêm liều lượng hoặc tư vấn thuốc.",
    mr_readiness_check_en: "Final-lock confirms the line adds no dosage or medicine advice.",
  ...
  {
    id: "pa-ca-mrreadiness-school-003",
    domain: "school_childcare",
    use: "pre_integration",
    mr_readiness_vi: "Khóa cuối câu trường học hoặc childcare khi phụ huynh cần hiểu thông báo.",
    mr_readiness_en: "MR-readiness evidence checks the school or childcare line when a parent needs to understand a notice.",
    ...
    mr_readiness_check_vi: "Pre-integration xác nhận câu nối được với trường, childcare, và form.",
    mr_readiness_check_en: "Pre-integration confirms the line connects to school, childcare, and form flows.",
  ...
  {
    id: "pa-ca-mrreadiness-bank-004",
    domain: "bank",
    use: "final_freeze",
    mr_readiness_vi: "Khóa cuối câu ngân hàng để mở tài khoản và hỏi phí mà không chuyển sang tư vấn tiền bạc.",
    mr_readiness_en:
      "MR-readiness evidence checks the bank line for opening an account and asking fees without moving into money advice.",
    ...
    mr_readiness_check_vi: "Final-freeze giữ câu ngoài thẻ, vay, hoặc lời khuyên tài chính.",
    mr_readiness_check_en: "Final-freeze keeps the line away from cards, loans, or financial advice.",
  ...
  {
    id: "pa-ca-mrreadiness-housing-005",
    domain: "housing",
    use: "mr_readiness",
    mr_readiness_vi: "Khóa cuối câu nhà thuê để xin lịch sửa và phản hồi bằng văn bản.",
    mr_readiness_en: "MR-readiness evidence checks the rental line for asking a repair timeline and written reply.",
    ...
    mr_readiness_check_vi: "MR-readiness xác nhận câu chỉ xin lịch và văn bản, không phải tư vấn pháp lý.",
    mr_readiness_check_en: "MR-readiness confirms the line only asks for timing and writing, not legal advice.",
  ...
  {
    id: "pa-ca-mrreadiness-transport-006",
    domain: "transport",
    use: "pre_integration",
    mr_readiness_vi: "Khóa cuối câu giao thông để hỏi đúng tuyến và điểm xuống.",
    mr_readiness_en: "MR-readiness evidence checks the transit line for checking the route and stop.",
    ...
    mr_readiness_check_vi: "Pre-integration xác nhận câu nối được với chỉ đường và lịch trình.",
    mr_readiness_check_en: "Pre-integration confirms the line connects to directions and schedule content.",
  ...
  {
    id: "pa-ca-mrreadiness-public-office-007",
    domain: "public_office",
    use: "final_lock",
    mr_readiness_vi: "Khóa cuối câu cơ quan công để hỏi quầy đúng và giấy tờ cần có.",
    mr_readiness_en:
      "MR-readiness evidence checks the public-office line for asking the right counter and required documents.",
    ...
    mr_readiness_check_vi: "Final-lock xác nhận câu dùng được ở quầy dịch vụ và form.",
    mr_readiness_check_en: "Final-lock confirms the line works at a service counter and with forms.",
  ...
  {
    id: "pa-ca-mrreadiness-forms-008",
    domain: "forms_service_desk",
    use: "mr_readiness",
    mr_readiness_vi: "Khóa cuối câu bàn dịch vụ để chỉ phần form chưa hiểu.",
    mr_readiness_en: "MR-readiness evidence checks the service-desk line for pointing to the unclear form section.",
    ...
    mr_readiness_check_vi: "MR-readiness xác nhận câu form đủ rõ trước khi khóa nội dung.",
    mr_readiness_check_en: "MR-readiness confirms the form line is clear before content freeze.",
  ...
  {
    id: "pa-ca-mrreadiness-interpreter-009",
    domain: "interpreter_request",
    use: "final_freeze",
    mr_readiness_vi: "Khóa cuối câu xin thông dịch viên khi tình huống vượt quá mức hiểu.",
    mr_readiness_en: "MR-readiness evidence checks the interpreter request when the situation exceeds the learner's understanding.",
    ...
    mr_readiness_check_vi: "Final-freeze xác nhận Shahmukhi chỉ là nhận biết, không phải khóa học đầy đủ.",
    mr_readiness_check_en: "Final-freeze confirms Shahmukhi is awareness only, not a full course.",
  ...
  {
    id: "pa-ca-mrreadiness-emergency-010",
    domain: "emergency_boundary",
    use: "final_lock",
    mr_readiness_vi: "Khóa cuối câu khẩn cấp khi có nguy hiểm thật sự và cần gọi 911.",
    mr_readiness_en: "MR-readiness evidence checks the emergency line when there is real danger and 911 is needed.",
    ...
    mr_readiness_check_vi: "Final-lock giữ câu rõ và không thay thế dịch vụ khẩn cấp.",
    mr_readiness_check_en: "Final-lock keeps the line clear and does not replace emergency services.",
  ...
  {
    id: "pa-ca-mrreadiness-recovery-011",
    domain: "service_recovery",
    use: "mr_readiness",
    mr_readiness_vi: "Khóa cuối câu phục hồi dịch vụ khi thông tin sai hoặc chưa khớp.",
    mr_readiness_en:
      "MR-readiness evidence checks the service-recovery line when information is wrong or does not match.",
    ...
    mr_readiness_check_vi: "MR-readiness xác nhận câu sửa lỗi vẫn lịch sự và thực tế.",
    mr_readiness_check_en: "MR-readiness confirms the correction line stays polite and practical.",
  ...
  {
    id: "pa-ca-mrreadiness-workplace-012",
    domain: "workplace_safety",
    use: "pre_integration",
    mr_readiness_vi: "Khóa cuối câu nơi làm việc khi người học chưa hiểu hướng dẫn an toàn.",
    mr_readiness_en:
      "MR-readiness evidence checks the workplace line when the learner did not understand a safety instruction.",
    ...
    mr_readiness_check_vi: "Pre-integration giữ câu ở mức xin làm rõ ngôn ngữ, không đưa hướng dẫn kỹ thuật.",
    mr_readiness_check_en: "Pre-integration keeps this as language clarification, not technical instruction.",
...
export default PUNJABI_CANADA_SURVIVAL_MR_READINESS_SAMPLES;
