// Punjabi Canada survival closure packet samples for Vietnamese-speaking and
...
export type PunjabiCanadaSurvivalClosurePacketDomain =
  | "clinic"
  | "pharmacy"
  | "school_childcare"
  | "bank"
...
export type PunjabiCanadaSurvivalClosurePacketCheck =
  | "pre_a11_closure"
  | "pre_merge"
  | "ci_readiness"
  | "pre_integration";

export type PunjabiCanadaSurvivalClosurePacketSample = {
  id: string;
  domain: PunjabiCanadaSurvivalClosurePacketDomain;
  check: PunjabiCanadaSurvivalClosurePacketCheck;
  phrase_pa: string;
  romanization: string;
  meaning_vi: string;
  meaning_en: string;
  ...
  closure_note_vi: string;
  closure_note_en: string;
...
export type PunjabiCanadaSurvivalClosurePacketScope = {
  name: string;
  audience: string[];
  scriptPolicy: string;
  reviewStatus: string;
...
export const PUNJABI_CANADA_SURVIVAL_CLOSURE_PACKET_SCOPE: PunjabiCanadaSurvivalClosurePacketScope = {
  name: "Punjabi Canada Survival Closure Packet Samples",
  ...
  closureBoundary:
    "Pre-A11-closure, pre-merge, CI-readiness, and pre-integration content samples for Canadian survival communication; not A11 integration, not legal advice, not medical advice, and not financial advice.",
};

export const PUNJABI_CANADA_SURVIVAL_CLOSURE_PACKET_DOMAINS: PunjabiCanadaSurvivalClosurePacketDomain[] = [
  "clinic",
  "pharmacy",
  "school_childcare",
  "bank",
...
export const PUNJABI_CANADA_SURVIVAL_CLOSURE_PACKET_SAMPLES: PunjabiCanadaSurvivalClosurePacketSample[] = [
  {
    id: "pa-ca-closure-packet-clinic-001",
    domain: "clinic",
    check: "pre_a11_closure",
    ...
    closure_note_vi: "Pre-A11-closure sample giữ đủ phrase, repair request, và handoff mà không tích hợp A11.",
    closure_note_en: "The pre-A11-closure sample keeps phrase, repair request, and handoff without A11 integration.",
    readiness_signal_vi: "CI-readiness ổn nếu runner thấy Gurmukhi, romanization, Vietnamese, English, và clinic context.",
    readiness_signal_en: "CI-readiness is stable if a runner sees Gurmukhi, romanization, Vietnamese, English, and clinic context.",
  ...
  {
    id: "pa-ca-closure-packet-pharmacy-002",
    domain: "pharmacy",
    check: "ci_readiness",
    ...
    closure_note_vi: "CI-readiness sample chứng minh pharmacy content không tự đưa liều hoặc chẩn đoán.",
    closure_note_en: "The CI-readiness sample proves pharmacy content does not provide dose or diagnosis.",
    readiness_signal_vi: "Pre-merge ổn nếu learner xin pharmacist viết số lần/ngày thay vì đoán.",
    readiness_signal_en: "Pre-merge is stable if the learner asks the pharmacist to write times per day instead of guessing.",
  ...
  {
    id: "pa-ca-closure-packet-school-childcare-003",
    ...
    closure_note_vi: "Pre-merge sample đóng gói child, date, action, và optional pickup detail.",
    closure_note_en: "The pre-merge sample packages child, date, action, and optional pickup detail.",
    readiness_signal_vi: "Pre-integration ổn nếu runner thấy school/childcare domain và learner trap rõ.",
    readiness_signal_en: "Pre-integration is stable if a runner sees school/childcare domain and a clear learner trap.",
  ...
  {
    id: "pa-ca-closure-packet-bank-004",
    domain: "bank",
    check: "pre_a11_closure",
    ...
    closure_note_vi: "Pre-A11-closure giữ bank sample ở mức service information, không khuyến nghị sản phẩm.",
    closure_note_en: "Pre-A11-closure keeps the bank sample at service information level, not product recommendation.",
    readiness_signal_vi: "CI-readiness ổn nếu fee request và financial boundary đều có mặt.",
    readiness_signal_en: "CI-readiness is stable if fee request and financial boundary are both present.",
  ...
  {
    id: "pa-ca-closure-packet-housing-005",
    domain: "housing",
    ...
    closure_note_vi: "Pre-integration sample có unit, issue, repair time, và written confirmation.",
    closure_note_en: "The pre-integration sample has unit, issue, repair time, and written confirmation.",
    readiness_signal_vi: "Pre-merge ổn nếu housing task không chuyển thành tenancy advice.",
    readiness_signal_en: "Pre-merge is stable if the housing task does not become tenancy advice.",
  ...
  {
    id: "pa-ca-closure-packet-transport-006",
    domain: "transport",
    check: "ci_readiness",
    ...
    closure_note_vi: "CI-readiness sample có route, direction, transfer, và delay repair line.",
    closure_note_en: "The CI-readiness sample has route, direction, transfer, and delay repair line.",
    readiness_signal_vi: "Pre-A11-closure ổn nếu transport content dùng transit/bus nhưng không hứa schedule.",
    readiness_signal_en: "Pre-A11-closure is stable if transport content uses transit/bus but does not promise schedule.",
  ...
  {
    id: "pa-ca-closure-packet-public-office-007",
    ...
    closure_note_vi: "Pre-merge sample đóng gói counter, documents, checklist, và next step.",
    closure_note_en: "The pre-merge sample packages counter, documents, checklist, and next step.",
    readiness_signal_vi: "CI-readiness ổn nếu public office flow không thành legal advice.",
    readiness_signal_en: "CI-readiness is stable if public office flow does not become legal advice.",
  ...
  {
    id: "pa-ca-closure-packet-forms-008",
    domain: "forms",
    check: "pre_a11_closure",
    ...
    closure_note_vi: "Pre-A11-closure sample chứng minh forms coverage, correction request, và official-process boundary.",
    closure_note_en: "The pre-A11-closure sample proves forms coverage, correction request, and official-process boundary.",
  ...
  {
    id: "pa-ca-closure-packet-interpreter-009",
    ...
    closure_note_vi: "Pre-integration sample đóng gói pause line, interpreter request, và no-signing-until-clear boundary.",
    closure_note_en: "The pre-integration sample packages pause line, interpreter request, and no-signing-until-clear boundary.",
    readiness_signal_vi: "CI-readiness ổn nếu interpreter request chỉ là language support, không phải professional decision.",
    readiness_signal_en: "CI-readiness is stable if interpreter request is language support, not professional decision.",
  ...
  {
    id: "pa-ca-closure-packet-emergency-010",
    ...
    closure_note_vi: "CI-readiness sample có immediate need, address, service type, và interpreter option.",
    closure_note_en: "The CI-readiness sample has immediate need, address, service type, and interpreter option.",
    readiness_signal_vi: "Pre-A11-closure ổn nếu emergency boundary không thay thế emergency services.",
    readiness_signal_en: "Pre-A11-closure is stable if emergency boundary does not replace emergency services.",
  ...
  {
    id: "pa-ca-closure-packet-service-recovery-011",
    ...
    closure_note_vi: "Pre-merge sample có repair phrase, written next step, và polite follow-up.",
    closure_note_en: "The pre-merge sample has repair phrase, written next step, and polite follow-up.",
    readiness_signal_vi: "CI-readiness ổn nếu service recovery giúp learner không im lặng.",
    readiness_signal_en: "CI-readiness is stable if service recovery helps the learner avoid silence.",
  ...
  {
    id: "pa-ca-closure-packet-workplace-012",
    ...
    closure_note_vi: "Pre-integration sample đóng gói safety issue, supervisor handoff, và written report step.",
    closure_note_en: "The pre-integration sample packages safety issue, supervisor handoff, and written report step.",
    readiness_signal_vi: "Pre-A11-closure ổn nếu workplace task không chuyển thành claim guidance.",
    readiness_signal_en: "Pre-A11-closure is stable if the workplace task does not become claim guidance.",
...
export default PUNJABI_CANADA_SURVIVAL_CLOSURE_PACKET_SAMPLES;
