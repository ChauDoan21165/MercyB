// Punjabi C1 final-freeze samples for Vietnamese-speaking and English-speaking learners.
//
...
export type PunjabiC1FinalFreezeArea =
  | "source_summary"
  | "cautious_claim"
  | "evidence_comparison"
...
export type PunjabiC1FinalFreezeMode =
  | "final_freeze"
  | "owner_acceptance"
  | "final_acceptance"
  | "pre_integration";

export type PunjabiC1FinalFreezePhrase = {
  pa: string;
  rom: string;
  vi: string;
  en: string;
...
export type PunjabiC1FinalFreezeSample = {
  id: string;
  level: "C1";
  area: PunjabiC1FinalFreezeArea;
  mode: PunjabiC1FinalFreezeMode;
  title_pa: string;
  title_rom: string;
  title_vi: string;
  title_en: string;
  ...
  sample: PunjabiC1FinalFreezePhrase;
  final_freeze_checks_vi: readonly string[];
  final_freeze_checks_en: readonly string[];
  ...
  canada_example: PunjabiC1FinalFreezePhrase & {
    context_vi: string;
    context_en: string;
  };
...
export const c1FinalFreezeSamplesScriptAwareness = {
...
export const c1FinalFreezeSamples: PunjabiC1FinalFreezeSample[] = [
  {
    id: "pa_c1_final_freeze_source_summary",
    level: "C1",
    area: "source_summary",
    mode: "final_freeze",
    title_pa: "ਸਰੋਤ ਸਾਰ final-freeze",
    title_rom: "sarot saar final-freeze",
    title_vi: "Final-freeze tóm tắt nguồn",
    title_en: "Source summary final freeze",
    ...
    final_freeze_checks_vi: ["Claim rõ.", "Evidence đi kèm.", "Giọng neutral."],
    final_freeze_checks_en: ["Clear claim.", "Evidence included.", "Neutral tone."],
  ...
  {
    id: "pa_c1_final_freeze_cautious_claim",
    level: "C1",
    area: "cautious_claim",
    ...
    final_freeze_checks_vi: ["Có hedge.", "Có giới hạn scale.", "Claim vẫn rõ."],
    final_freeze_checks_en: ["Has hedging.", "Has a scale limit.", "The claim remains clear."],
    ...
    pre_integration_notes_vi: ["Dùng được trong final-freeze review.", "Không cần nguồn ngoài.", "Phù hợp C1."],
    pre_integration_notes_en: ["Usable in final-freeze review.", "No outside source needed.", "Fits C1."],
    canada_example: {
  ...
  {
    id: "pa_c1_final_freeze_evidence_comparison",
    level: "C1",
    ...
    final_freeze_checks_vi: ["Vai trò nguồn rõ.", "Comparison rõ.", "Kết luận vừa mức."],
    final_freeze_checks_en: ["Source roles are clear.", "Comparison is clear.", "Measured conclusion."],
  ...
  {
    id: "pa_c1_final_freeze_formal_correspondence",
    level: "C1",
    ...
    final_freeze_checks_vi: ["Request rõ.", "Tone lịch sự.", "Độ formal đủ."],
    final_freeze_checks_en: ["Clear request.", "Polite tone.", "Formal enough."],
  ...
  {
    id: "pa_c1_final_freeze_executive_summary",
    level: "C1",
    area: "executive_summary",
    mode: "final_freeze",
    title_pa: "ਕਾਰਜਕਾਰੀ ਸੰਖੇਪ final-freeze",
    title_rom: "karjakari sankhep final-freeze",
    title_vi: "Final-freeze bản tóm tắt điều hành",
    title_en: "Executive summary final freeze",
    ...
    final_freeze_checks_vi: ["Có priority.", "Có risk.", "Có next step."],
    final_freeze_checks_en: ["Has a priority.", "Has a risk.", "Has a next step."],
  ...
  {
    id: "pa_c1_final_freeze_register_calibration",
    level: "C1",
    ...
    final_freeze_checks_vi: ["Professional.", "Giữ ý gốc.", "Không quá lạnh."],
    final_freeze_checks_en: ["Professional.", "Keeps original meaning.", "Not too cold."],
  ...
  {
    id: "pa_c1_final_freeze_presentation_response",
    level: "C1",
    ...
    final_freeze_checks_vi: ["Mở đầu lịch sự.", "Claim giới hạn.", "Có next step."],
    final_freeze_checks_en: ["Polite opening.", "Limited claim.", "Has a next step."],
  ...
  {
    id: "pa_c1_final_freeze_public_professional_tone",
    level: "C1",
    ...
    final_freeze_checks_vi: ["Rõ cho người dân.", "Lịch sự.", "Có action cụ thể."],
    final_freeze_checks_en: ["Clear for the public.", "Polite.", "Has a specific action."],
