// Punjabi Canada survival signoff samples for Vietnamese-speaking and
...
export type PunjabiCanadaSurvivalSignoffDomain =
  | "clinic"
  | "pharmacy"
  | "school_childcare"
  | "bank"
...
export type PunjabiCanadaSurvivalSignoffCheck =
  | "pre_a11_signoff"
  | "seal"
  | "snapshot"
  | "pre_integration";

export type PunjabiCanadaSurvivalSignoffSample = {
  id: string;
  domain: PunjabiCanadaSurvivalSignoffDomain;
  check: PunjabiCanadaSurvivalSignoffCheck;
  phrase_pa: string;
  romanization: string;
  meaning_vi: string;
  meaning_en: string;
  ...
  signoff_note_vi: string;
  signoff_note_en: string;
...
export type PunjabiCanadaSurvivalSignoffScope = {
  name: string;
  audience: string[];
  scriptPolicy: string;
  reviewStatus: string;
...
export const PUNJABI_CANADA_SURVIVAL_SIGNOFF_SCOPE: PunjabiCanadaSurvivalSignoffScope = {
  name: "Punjabi Canada Survival Signoff Samples",
  ...
  signoffBoundary:
    "Pre-A11-signoff, seal, snapshot, and pre-integration content samples for Canadian survival communication; not A11 integration, not legal advice, not medical advice, and not financial advice.",
};

export const PUNJABI_CANADA_SURVIVAL_SIGNOFF_DOMAINS: PunjabiCanadaSurvivalSignoffDomain[] = [
  "clinic",
  "pharmacy",
  "school_childcare",
  "bank",
...
export const PUNJABI_CANADA_SURVIVAL_SIGNOFF_SAMPLES: PunjabiCanadaSurvivalSignoffSample[] = [
  {
    id: "pa-ca-signoff-clinic-001",
    domain: "clinic",
    check: "pre_a11_signoff",
    ...
    signoff_note_vi: "Pre-A11-signoff giữ phrase, repair request, và next-step handoff mà không tích hợp A11.",
    signoff_note_en: "The pre-A11-signoff keeps phrase, repair request, and next-step handoff without A11 integration.",
    readiness_signal_vi: "Seal ổn nếu có Gurmukhi, romanization, Vietnamese, English, và clinic context.",
    readiness_signal_en: "Seal is stable if it has Gurmukhi, romanization, Vietnamese, English, and clinic context.",
  ...
  },
  {
    ...
    signoff_note_vi: "Seal sample chứng minh pharmacy content không tự đưa liều hoặc chẩn đoán.",
    signoff_note_en: "The seal sample proves pharmacy content does not provide dose or diagnosis.",
    readiness_signal_vi: "Snapshot ổn nếu learner xin pharmacist viết số lần/ngày thay vì đoán.",
    readiness_signal_en: "Snapshot is stable if the learner asks the pharmacist to write times per day instead of guessing.",
  ...
  {
    id: "pa-ca-signoff-school-childcare-003",
    ...
    signoff_note_vi: "Snapshot signoff đóng gói child, date, action, và optional pickup detail.",
    signoff_note_en: "The snapshot signoff packages child, date, action, and optional pickup detail.",
  ...
  },
  {
    ...
    signoff_note_vi: "Pre-A11-signoff giữ bank sample ở mức service information, không khuyến nghị sản phẩm.",
    signoff_note_en: "The pre-A11-signoff keeps the bank sample at service information level, not product recommendation.",
    readiness_signal_vi: "Seal ổn nếu fee request và financial boundary đều có mặt.",
    readiness_signal_en: "Seal is stable if fee request and financial boundary are both present.",
  ...
  },
  {
    ...
    signoff_note_vi: "Pre-integration signoff có unit, issue, repair time, và written confirmation.",
    signoff_note_en: "The pre-integration signoff has unit, issue, repair time, and written confirmation.",
    readiness_signal_vi: "Snapshot ổn nếu housing task không chuyển thành tenancy advice.",
    readiness_signal_en: "Snapshot is stable if the housing task does not become tenancy advice.",
  ...
  {
    id: "pa-ca-signoff-transport-006",
    domain: "transport",
    check: "seal",
    ...
    signoff_note_vi: "Seal signoff có route, direction, transfer, và delay repair line.",
    signoff_note_en: "The seal signoff has route, direction, transfer, and delay repair line.",
    readiness_signal_vi: "Pre-A11-signoff ổn nếu transport content dùng transit/bus nhưng không hứa schedule.",
    readiness_signal_en: "Pre-A11-signoff is stable if transport content uses transit/bus but does not promise schedule.",
  ...
  {
    id: "pa-ca-signoff-public-office-007",
    ...
    signoff_note_vi: "Snapshot signoff đóng gói counter, documents, checklist, và next step.",
    signoff_note_en: "The snapshot signoff packages counter, documents, checklist, and next step.",
    readiness_signal_vi: "Seal ổn nếu public office flow không thành legal advice.",
    readiness_signal_en: "Seal is stable if public office flow does not become legal advice.",
  ...
  },
  {
    ...
    signoff_note_vi: "Pre-A11-signoff sample chứng minh forms coverage, correction request, và official-process boundary.",
    signoff_note_en: "The pre-A11-signoff sample proves forms coverage, correction request, and official-process boundary.",
  ...
  {
    id: "pa-ca-signoff-interpreter-009",
    ...
    signoff_note_vi: "Pre-integration signoff đóng gói pause line, interpreter request, và no-signing-until-clear boundary.",
    signoff_note_en: "The pre-integration signoff packages pause line, interpreter request, and no-signing-until-clear boundary.",
    readiness_signal_vi: "Seal ổn nếu interpreter request chỉ là language support, không phải professional decision.",
    readiness_signal_en: "Seal is stable if interpreter request is language support, not professional decision.",
  ...
  {
    id: "pa-ca-signoff-emergency-010",
    ...
    signoff_note_vi: "Seal signoff có immediate need, address, service type, và interpreter option.",
    signoff_note_en: "The seal signoff has immediate need, address, service type, and interpreter option.",
    readiness_signal_vi: "Pre-A11-signoff ổn nếu emergency boundary không thay thế emergency services.",
    readiness_signal_en: "Pre-A11-signoff is stable if emergency boundary does not replace emergency services.",
  ...
  {
    id: "pa-ca-signoff-service-recovery-011",
    ...
    signoff_note_vi: "Snapshot signoff có repair phrase, written next step, và polite follow-up.",
    signoff_note_en: "The snapshot signoff has repair phrase, written next step, and polite follow-up.",
    readiness_signal_vi: "Seal ổn nếu service recovery giúp learner không im lặng.",
    readiness_signal_en: "Seal is stable if service recovery helps the learner avoid silence.",
  ...
  {
    id: "pa-ca-signoff-workplace-012",
    ...
    signoff_note_vi: "Pre-integration signoff đóng gói safety issue, supervisor handoff, và written report step.",
    signoff_note_en: "The pre-integration signoff packages safety issue, supervisor handoff, and written report step.",
    readiness_signal_vi: "Pre-A11-signoff ổn nếu workplace task không chuyển thành claim guidance.",
    readiness_signal_en: "Pre-A11-signoff is stable if the workplace task does not become claim guidance.",
...
export default PUNJABI_CANADA_SURVIVAL_SIGNOFF_SAMPLES;
