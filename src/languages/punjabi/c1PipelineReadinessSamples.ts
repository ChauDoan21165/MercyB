// Punjabi C1 Pipeline-readiness samples for Vietnamese-speaking and English-speaking learners.
//
...
export type PunjabiC1PipelineReadinessArea =
  | "source_summary"
  | "cautious_claim"
  | "evidence_comparison"
...
export type PunjabiC1PipelineReadinessMode =
  | "pipeline_readiness"
  | "mr_readiness"
  | "ci_readiness"
  | "pre_integration";

export type PunjabiC1PipelineReadinessPhrase = {
  pa: string;
  rom: string;
  vi: string;
  en: string;
...
export type PunjabiC1PipelineReadinessSample = {
  id: string;
  level: "C1";
  area: PunjabiC1PipelineReadinessArea;
  mode: PunjabiC1PipelineReadinessMode;
  title_pa: string;
  title_rom: string;
  title_vi: string;
  title_en: string;
  pipeline_prompt_vi: string;
  pipeline_prompt_en: string;
  sample: PunjabiC1PipelineReadinessPhrase;
  ...
  canada_example: PunjabiC1PipelineReadinessPhrase & {
    context_vi: string;
    context_en: string;
  };
...
export const c1PipelineReadinessSamplesScriptAwareness = {
  vi: "Bộ Pipeline-readiness này dùng Gurmukhi làm chữ chính. Shahmukhi chỉ được nhắc để nhận biết một hệ chữ Punjabi khác, không phải phần luyện chính.",
  en: "This Pipeline-readiness pack uses Gurmukhi as the primary script. Shahmukhi is mentioned only to recognize another Punjabi script, not as the main practice script.",
} as const;

export const c1PipelineReadinessSamples: PunjabiC1PipelineReadinessSample[] = [
  {
    id: "pa_c1_pipeline_readiness_source_summary",
    level: "C1",
    area: "source_summary",
    mode: "pipeline_readiness",
    title_pa: "ਸਰੋਤ ਸਾਰ Pipeline-readiness",
    title_rom: "sarot saar Pipeline-readiness",
    title_vi: "Sample Pipeline-readiness cho tóm tắt nguồn",
    title_en: "Pipeline-readiness sample for source summary",
    pipeline_prompt_vi: "Dùng sample này để kiểm tra pipeline có thể bắt claim, evidence và neutrality ổn định.",
    pipeline_prompt_en: "Use this sample to check that pipeline can catch stable claim, evidence, and neutrality.",
    sample: {
    ...
    pipeline_readiness_checks_vi: ["Claim rõ để test.", "Evidence có mặt.", "Không thêm opinion."],
    pipeline_readiness_checks_en: ["Clear claim for testing.", "Evidence is present.", "No added opinion."],
  ...
  {
    id: "pa_c1_pipeline_readiness_cautious_claim",
    level: "C1",
    area: "cautious_claim",
    mode: "mr_readiness",
    ...
    pipeline_prompt_vi: "Dùng sample này để kiểm tra claim có hedge nhưng vẫn đủ rõ.",
    pipeline_prompt_en: "Use this sample to check that the claim has hedging but remains clear.",
    sample: {
    ...
    pipeline_readiness_checks_vi: ["Có hedge.", "Có giới hạn scale.", "Claim không mơ hồ."],
    pipeline_readiness_checks_en: ["Has hedging.", "Has a scale limit.", "Claim is not vague."],
  ...
  {
    id: "pa_c1_pipeline_readiness_evidence_comparison",
    level: "C1",
    ...
    pipeline_prompt_vi: "Dùng sample này để pipeline kiểm tra comparison giữa số liệu và trải nghiệm.",
    pipeline_prompt_en: "Use this sample so pipeline can check comparison between figures and experience.",
    sample: {
    ...
    pipeline_readiness_checks_vi: ["Phân biệt evidence.", "Có kết luận vừa mức.", "Không trộn nguồn."],
    pipeline_readiness_checks_en: ["Distinguishes evidence.", "Measured conclusion.", "Does not blend sources."],
    ...
    pre_integration_notes_vi: ["Không cần live data.", "Không chạm pipeline config.", "Dùng được trong app data."],
    pre_integration_notes_en: ["No live data needed.", "Does not touch pipeline config.", "Usable in app data."],
    canada_example: {
  ...
  {
    id: "pa_c1_pipeline_readiness_formal_correspondence",
    level: "C1",
    ...
    pipeline_prompt_vi: "Dùng sample này để test email formal: request rõ, lịch sự, không casual.",
    pipeline_prompt_en: "Use this sample to test a formal email: clear request, polite, not casual.",
    sample: {
    ...
    pipeline_readiness_checks_vi: ["Request rõ.", "Tone lịch sự.", "Không giống tin nhắn bạn bè."],
    pipeline_readiness_checks_en: ["Clear request.", "Polite tone.", "Not like a message to a friend."],
  ...
  {
    id: "pa_c1_pipeline_readiness_executive_summary",
    level: "C1",
    area: "executive_summary",
    mode: "pipeline_readiness",
    title_pa: "ਕਾਰਜਕਾਰੀ ਸੰਖੇਪ Pipeline-readiness",
    title_rom: "karjakari sankhep Pipeline-readiness",
    title_vi: "Executive summary cho Pipeline-readiness",
    title_en: "Executive summary for Pipeline readiness",
    pipeline_prompt_vi: "Dùng sample này để test summary ngắn có priority, risk và next step.",
    pipeline_prompt_en: "Use this sample to test a short summary with priority, risk, and next step.",
    sample: {
    ...
    pipeline_readiness_checks_vi: ["Có priority.", "Có risk.", "Có next step."],
    pipeline_readiness_checks_en: ["Has a priority.", "Has a risk.", "Has a next step."],
  ...
  {
    id: "pa_c1_pipeline_readiness_register_calibration",
    level: "C1",
    area: "register_calibration",
    mode: "mr_readiness",
    title_pa: "ਰਜਿਸਟਰ calibration MR-readiness",
    title_rom: "register calibration MR-readiness",
    title_vi: "Chỉnh register cho MR-readiness",
    title_en: "Register calibration for MR readiness",
    pipeline_prompt_vi: "Dùng sample này để test register formal, cautious và không quá casual.",
    pipeline_prompt_en: "Use this sample to test formal, cautious, and not-too-casual register.",
    sample: {
    ...
    pipeline_readiness_checks_vi: ["Register formal.", "Claim cautious.", "Không casual."],
    pipeline_readiness_checks_en: ["Formal register.", "Cautious claim.", "Not casual."],
  ...
  {
    id: "pa_c1_pipeline_readiness_presentation_response",
    level: "C1",
    ...
    pipeline_prompt_vi: "Dùng sample này để test câu trả lời Q&A có cấu trúc và không phòng thủ.",
    pipeline_prompt_en: "Use this sample to test a structured, non-defensive Q&A answer.",
    sample: {
    ...
    pipeline_readiness_checks_vi: ["Ghi nhận câu hỏi.", "Có cấu trúc.", "Không overstated."],
    pipeline_readiness_checks_en: ["Acknowledges the question.", "Structured.", "Not overstated."],
  ...
  {
    id: "pa_c1_pipeline_readiness_public_professional_tone",
    level: "C1",
    ...
    pipeline_prompt_vi: "Dùng sample này để pipeline kiểm tra thông báo công khai rõ, tôn trọng và có next action.",
    pipeline_prompt_en: "Use this sample so pipeline can check a public notice that is clear, respectful, and has a next action.",
    sample: {
    ...
    pipeline_readiness_checks_vi: ["Thông báo rõ.", "Tone tôn trọng.", "Có next action."],
    pipeline_readiness_checks_en: ["Clear notice.", "Respectful tone.", "Has a next action."],
