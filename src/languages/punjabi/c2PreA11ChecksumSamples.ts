// Punjabi C2 Pre-A11-checksum samples for Vietnamese- and English-speaking learners.
// Gurmukhi is primary; romanization is a reading aid.
//
// Scope/status: study-support Pre-A11-checksum samples only, not certification,
...
export type PunjabiC2PreA11ChecksumFocus =
...
export type PunjabiC2PreA11ChecksumContext = "public" | "professional" | "community";
export type PunjabiC2PreA11ChecksumStyle = "pre_a11_checksum" | "runner_readiness" | "pipeline_readiness" | "pre_integration";

export type PunjabiC2PreA11ChecksumPhrase = {
  gurmukhi: string;
  romanization: string;
  vi: string;
  en: string;
...
export type PunjabiC2PreA11ChecksumCheck = {
  check_vi: string;
  check_en: string;
  signal_vi: string;
  signal_en: string;
...
export type PunjabiC2PreA11ChecksumTrap = {
  trap_vi: string;
  trap_en: string;
  repair_vi: string;
  repair_en: string;
...
export type PunjabiC2PreA11ChecksumSample = {
  id: string;
  focus: PunjabiC2PreA11ChecksumFocus;
  context: PunjabiC2PreA11ChecksumContext;
  style: PunjabiC2PreA11ChecksumStyle;
  title_vi: string;
  title_en: string;
  scenario_vi: string;
  scenario_en: string;
  ...
  sample_vi: string;
  sample_en: string;
  pre_a11_checksum_phrases: PunjabiC2PreA11ChecksumPhrase[];
  checks: PunjabiC2PreA11ChecksumCheck[];
  learner_trap?: PunjabiC2PreA11ChecksumTrap;
  canada_practical?: boolean;
};

export const C2_PRE_A11_CHECKSUM_SAMPLES_DISCLAIMER = {
  vi: "Bộ Pre-A11-checksum Punjabi C2 này chỉ hỗ trợ học tập, không phải chứng nhận hay xếp lớp chính thức. Gurmukhi là chính; phiên âm chỉ giúp đọc. Thẩm định bản xứ được hoãn lại. Shahmukhi chỉ được nhắc để nhận biết hệ chữ.",
  en: "This C2 Punjabi Pre-A11-checksum sample pack supports study only, not certification or official placement. Gurmukhi is primary; romanization only supports reading. Native review is deferred. Shahmukhi is noted only for script awareness.",
} as const;

export const c2PreA11ChecksumSamples: PunjabiC2PreA11ChecksumSample[] = [
  {
    id: "pa_c2_pre_a11_checksum_nuanced_disagreement_professional",
    focus: "nuanced_disagreement",
    context: "professional",
    style: "pre_a11_checksum",
    title_vi: "Pre-A11 checksum: bất đồng tinh tế",
    title_en: "Pre-A11 checksum: nuanced disagreement",
    ...
    sample_gurmukhi: "ਦਿਸ਼ਾ ਠੀਕ ਹੈ, ਪਰ Pre-A11 checksum ਤੋਂ ਪਹਿਲਾਂ ਇਸ ਦਲੀਲ ਨੂੰ ਇੱਕ ਵਾਰੀ ਹੋਰ ਪਰਖ ਲਈਏ।",
    sample_romanization: "disha theek hai, par Pre-A11 checksum ton pehlaan is dalil nu ikk vari hor parakh laie.",
    sample_vi: "Hướng đi đúng, nhưng trước Pre-A11 checksum ta hãy kiểm tra lập luận này thêm một lần.",
    sample_en: "The direction is right, but before Pre-A11 checksum let's test this argument once more.",
    pre_a11_checksum_phrases: [
    ...
    learner_trap: {
      ...
      trap_en: "Direct negation before Pre-A11 checksum makes the tone too tense.",
  ...
  {
    id: "pa_c2_pre_a11_checksum_diplomacy_community_canada",
    focus: "diplomacy",
    context: "community",
    style: "runner_readiness",
    title_vi: "Pre-A11 checksum: ngoại giao phạm vi",
    title_en: "Pre-A11 checksum: scope diplomacy",
    scenario_vi: "Một nhóm cộng đồng ở Canada muốn thêm đề xuất sau hạn ổn định.",
    scenario_en: "A Canadian community group wants to add a suggestion after the pre-A11 checksum review deadline.",
    ...
    sample_gurmukhi: "ਸੁਝਾਅ ਲਈ ਧੰਨਵਾਦ। ਇਸ Pre-A11 checksum ਵਿੱਚ ਹੱਦ ਨਹੀਂ ਬਦਲੇਗੀ, ਪਰ ਅਗਲੇ ਚੱਕਰ ਲਈ ਇਸ ਨੂੰ ਸੰਭਾਲ ਲੈਂਦੇ ਹਾਂ।",
    sample_romanization: "sujhaa lai dhanvaad. is Pre-A11 checksum vich hadd nahin badlegi, par agle chakkar lai is nu sambhaal lainde haan.",
    sample_vi: "Cảm ơn đề xuất. Trong Pre-A11 checksum này phạm vi sẽ không đổi, nhưng ta sẽ giữ lại cho vòng sau.",
    sample_en: "Thank you for the suggestion. In this Pre-A11 checksum the scope will not change, but we will keep it for the next cycle.",
    pre_a11_checksum_phrases: [
  ...
  {
    id: "pa_c2_pre_a11_checksum_mediation_public",
    focus: "mediation",
    context: "public",
    style: "pipeline_readiness",
    title_vi: "Pre-A11 checksum: trung gian công khai",
    title_en: "Pre-A11 checksum: public mediation",
    ...
    sample_gurmukhi: "ਦੋਵੇਂ ਪਾਸਿਆਂ ਦੀ ਗੱਲ ਦਰਜ ਹੈ; Pre-A11 checksum ਸਾਂਝੇ ਮਾਪਦੰਡ ਦੇ ਆਧਾਰ ਤੇ ਕੀਤਾ ਜਾਵੇਗਾ।",
    sample_romanization: "dovein pasian di gall darj hai; Pre-A11 checksum sanjhe mapdand de aadhaar te kita javega.",
    sample_vi: "Ý kiến của cả hai bên đã được ghi nhận; Pre-A11 checksum sẽ dựa trên tiêu chí chung.",
    sample_en: "Both sides' points are recorded; the Pre-A11 checksum will be based on shared criteria.",
    pre_a11_checksum_phrases: [
  ...
  {
    id: "pa_c2_pre_a11_checksum_deescalation_professional",
    focus: "deescalation",
    context: "professional",
    style: "pre_a11_checksum",
    title_vi: "Pre-A11 checksum: hạ nhiệt trách nhiệm",
    title_en: "Pre-A11 checksum: de-escalating ownership",
    scenario_vi: "Cuộc họp ổn định cuối căng vì một lỗi nhỏ còn được nhắc lại.",
    scenario_en: "A Pre-A11 checksum meeting is tense because a small issue keeps being repeated.",
    ...
    sample_gurmukhi: "ਮੁੱਦਾ ਦਰਜ ਹੋ ਗਿਆ ਹੈ; ਹੁਣ ਵਿਅਕਤੀ ਨਹੀਂ, ਸੁਧਾਰ ਦੇ ਕਦਮ ਨੂੰ Pre-A11 checksum ਵਿੱਚ ਪੱਕਾ ਕਰੀਏ।",
    sample_romanization: "mudda darj ho giya hai; hun vyakti nahin, sudhaar de kadam nu Pre-A11 checksum vich pakka kariye.",
    sample_vi: "Vấn đề đã được ghi nhận; bây giờ không nói về cá nhân, hãy ổn định bước sửa trong Pre-A11 checksum.",
    sample_en: "The issue has been recorded; now let's focus on the repair step, not the person, in Pre-A11 checksum.",
    pre_a11_checksum_phrases: [
  ...
  {
    id: "pa_c2_pre_a11_checksum_audience_adaptation_canada",
    focus: "audience_adaptation",
    context: "community",
    style: "pre_integration",
    title_vi: "Pre-A11 checksum: thông báo cho nhóm đa thế hệ",
    title_en: "Pre-A11 checksum: notice for a multi-generational group",
  ...
  {
    id: "pa_c2_pre_a11_checksum_sensitive_topic_public",
    focus: "sensitive_topic_framing",
    context: "public",
    style: "pipeline_readiness",
    title_vi: "Pre-A11 checksum: khung chủ đề nhạy cảm",
    title_en: "Pre-A11 checksum: sensitive-topic framing",
    scenario_vi: "Một nhận xét công khai kéo bản ổn định cuối sang chính trị, tôn giáo, tiền bạc, hoặc danh tính cá nhân.",
    scenario_en: "A public comment pulls the Pre-A11 checksum toward politics, religion, money, or personal identity.",
    ...
    sample_gurmukhi: "ਇਹ ਵਿਸ਼ਾ ਸੰਵੇਦਨਸ਼ੀਲ ਹੈ, ਇਸ ਲਈ Pre-A11 checksum ਨੂੰ ਕੰਮ ਨਾਲ ਜੁੜੇ ਹਿੱਸੇ ਤੱਕ ਹੀ ਰੱਖੀਏ।",
    sample_romanization: "ih visha sanvedansheel hai, is lai Pre-A11 checksum nu kamm naal jurre hisse takk hi rakhie.",
    sample_vi: "Chủ đề này nhạy cảm, vì vậy hãy giữ Pre-A11 checksum chỉ trong phần liên quan công việc.",
    sample_en: "This topic is sensitive, so let's keep Pre-A11 checksum only to the work-related part.",
    pre_a11_checksum_phrases: [
  ...
  {
    id: "pa_c2_pre_a11_checksum_public_calibration_professional",
    focus: "public_communication_calibration",
    context: "professional",
    style: "runner_readiness",
    title_vi: "Pre-A11 checksum: cân chỉnh thông báo",
    title_en: "Pre-A11 checksum: calibrated announcement",
    ...
    sample_gurmukhi: "ਇਹ ਹਿੱਸਾ Pre-A11 checksum ਵਿੱਚ ਹੈ; ਵਰਤੋਂ ਦੌਰਾਨ ਆਉਣ ਵਾਲੀ ਪ੍ਰਤੀਕਿਰਿਆ ਨੂੰ ਫਿਰ ਵੀ ਧਿਆਨ ਨਾਲ ਵੇਖਾਂਗੇ।",
    sample_romanization: "ih hissa Pre-A11 checksum vich hai; varton dauran aun vali pratikiria nu phir vi dhian naal vekhange.",
    sample_vi: "Phần này đã ở Pre-A11 checksum; tuy vậy trong quá trình sử dụng chúng tôi vẫn sẽ theo dõi phản hồi cẩn thận.",
    sample_en: "This part is in Pre-A11 checksum; still, during use we will watch feedback carefully.",
    pre_a11_checksum_phrases: [
      { gurmukhi: "Pre-A11 checksum ਵਿੱਚ ਹੈ", romanization: "Pre-A11 checksum vich hai", vi: "Đang ở Pre-A11 checksum.", en: "Is in Pre-A11 checksum." },
  ...
  {
    id: "pa_c2_pre_a11_checksum_register_safety_community",
    focus: "register_safety",
    context: "community",
    style: "pre_integration",
    title_vi: "Pre-A11 checksum: an toàn register cộng đồng",
    title_en: "Pre-A11 checksum: community register safety",
...
export const c2PreA11ChecksumSamplesByFocus = (focus: PunjabiC2PreA11ChecksumFocus) =>
  c2PreA11ChecksumSamples.filter((sample) => sample.focus === focus);

export const c2PreA11ChecksumSamplesByContext = (context: PunjabiC2PreA11ChecksumContext) =>
  c2PreA11ChecksumSamples.filter((sample) => sample.context === context);
