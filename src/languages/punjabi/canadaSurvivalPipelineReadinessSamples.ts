// Punjabi Canada survival pipeline-readiness samples for Vietnamese-speaking and
...
export type PunjabiCanadaSurvivalPipelineReadinessDomain =
  | "clinic"
  | "pharmacy"
  | "school_childcare"
  | "bank"
...
export type PunjabiCanadaSurvivalPipelineReadinessUse =
  | "pipeline_readiness"
  | "ci_readiness"
  | "mr_readiness"
  | "pre_integration";

export type PunjabiCanadaSurvivalPipelineReadinessItem = {
  id: string;
  domain: PunjabiCanadaSurvivalPipelineReadinessDomain;
  use: PunjabiCanadaSurvivalPipelineReadinessUse;
  pipeline_readiness_vi: string;
  pipeline_readiness_en: string;
  goal_vi: string;
  goal_en: string;
  phrase_pa: string;
  romanization: string;
  ...
  meaning_en: string;
  support_pa: string[];
  pipeline_readiness_check_vi: string;
  pipeline_readiness_check_en: string;
...
export type PunjabiCanadaSurvivalPipelineReadinessScope = {
  name: string;
  audience: string[];
  scriptPolicy: string;
  reviewStatus: string;
...
export const PUNJABI_CANADA_SURVIVAL_PIPELINE_READINESS_SCOPE: PunjabiCanadaSurvivalPipelineReadinessScope = {
  name: "Punjabi Canada Survival Pipeline Readiness Samples",
  ...
  boundaries: [
    "Language support only for Canada survival pipeline-readiness samples.",
    "No medical, legal, financial, tenancy, or workplace safety advice.",
  ],
};

export const PUNJABI_CANADA_SURVIVAL_PIPELINE_READINESS_SAMPLES: PunjabiCanadaSurvivalPipelineReadinessItem[] = [
  {
    id: "pa-ca-pipelinereadiness-clinic-001",
    domain: "clinic",
    use: "pipeline_readiness",
    pipeline_readiness_vi: "Khóa cuối câu phòng khám để người học xin nói chậm và nhắc lại trước khi trả lời.",
    pipeline_readiness_en:
      "Pipeline-readiness sample checks the clinic line so the learner can ask for slow speech and a repeat before answering.",
    ...
    pipeline_readiness_check_vi: "Pipeline-readiness giữ câu ở hỗ trợ ngôn ngữ, không đưa lời khuyên y tế.",
    pipeline_readiness_check_en: "Pipeline-readiness keeps this as language support, not medical advice.",
  ...
  {
    id: "pa-ca-pipelinereadiness-pharmacy-002",
    domain: "pharmacy",
    use: "mr_readiness",
    pipeline_readiness_vi: "Khóa cuối câu nhà thuốc để nêu dị ứng và xin ghi thông tin bằng văn bản.",
    pipeline_readiness_en: "Pipeline-readiness sample checks the pharmacy line for stating an allergy and asking for written information.",
    ...
    pipeline_readiness_check_vi: "MR-readiness xác nhận câu không thêm liều lượng hoặc tư vấn thuốc.",
    pipeline_readiness_check_en: "MR-readiness confirms the line adds no dosage or medicine advice.",
  ...
  {
    id: "pa-ca-pipelinereadiness-school-003",
    domain: "school_childcare",
    use: "pre_integration",
    pipeline_readiness_vi: "Khóa cuối câu trường học hoặc childcare khi phụ huynh cần hiểu thông báo.",
    pipeline_readiness_en: "Pipeline-readiness sample checks the school or childcare line when a parent needs to understand a notice.",
    ...
    pipeline_readiness_check_vi: "Pre-integration xác nhận câu nối được với trường, childcare, và form.",
    pipeline_readiness_check_en: "Pre-integration confirms the line connects to school, childcare, and form flows.",
  ...
  {
    id: "pa-ca-pipelinereadiness-bank-004",
    domain: "bank",
    use: "ci_readiness",
    pipeline_readiness_vi: "Khóa cuối câu ngân hàng để mở tài khoản và hỏi phí mà không chuyển sang tư vấn tiền bạc.",
    pipeline_readiness_en:
      "Pipeline-readiness sample checks the bank line for opening an account and asking fees without moving into money advice.",
    ...
    pipeline_readiness_check_vi: "CI-readiness giữ câu ngoài thẻ, vay, hoặc lời khuyên tài chính.",
    pipeline_readiness_check_en: "CI-readiness keeps the line away from cards, loans, or financial advice.",
  ...
  {
    id: "pa-ca-pipelinereadiness-housing-005",
    domain: "housing",
    use: "pipeline_readiness",
    pipeline_readiness_vi: "Khóa cuối câu nhà thuê để xin lịch sửa và phản hồi bằng văn bản.",
    pipeline_readiness_en: "Pipeline-readiness sample checks the rental line for asking a repair timeline and written reply.",
    ...
    pipeline_readiness_check_vi: "Pipeline-readiness xác nhận câu chỉ xin lịch và văn bản, không phải tư vấn pháp lý.",
    pipeline_readiness_check_en: "Pipeline-readiness confirms the line only asks for timing and writing, not legal advice.",
  ...
  {
    id: "pa-ca-pipelinereadiness-transport-006",
    domain: "transport",
    use: "pre_integration",
    pipeline_readiness_vi: "Khóa cuối câu giao thông để hỏi đúng tuyến và điểm xuống.",
    pipeline_readiness_en: "Pipeline-readiness sample checks the transit line for checking the route and stop.",
    ...
    pipeline_readiness_check_vi: "Pre-integration xác nhận câu nối được với chỉ đường và lịch trình.",
    pipeline_readiness_check_en: "Pre-integration confirms the line connects to directions and schedule content.",
  ...
  {
    id: "pa-ca-pipelinereadiness-public-office-007",
    domain: "public_office",
    use: "mr_readiness",
    pipeline_readiness_vi: "Khóa cuối câu cơ quan công để hỏi quầy đúng và giấy tờ cần có.",
    pipeline_readiness_en:
      "Pipeline-readiness sample checks the public-office line for asking the right counter and required documents.",
    ...
    pipeline_readiness_check_vi: "MR-readiness xác nhận câu dùng được ở quầy dịch vụ và form.",
    pipeline_readiness_check_en: "MR-readiness confirms the line works at a service counter and with forms.",
  ...
  {
    id: "pa-ca-pipelinereadiness-forms-008",
    domain: "forms_service_desk",
    use: "pipeline_readiness",
    pipeline_readiness_vi: "Khóa cuối câu bàn dịch vụ để chỉ phần form chưa hiểu.",
    pipeline_readiness_en: "Pipeline-readiness sample checks the service-desk line for pointing to the unclear form section.",
    ...
    pipeline_readiness_check_vi: "Pipeline-readiness xác nhận câu form đủ rõ trước khi khóa nội dung.",
    pipeline_readiness_check_en: "Pipeline-readiness confirms the form line is clear before content freeze.",
  ...
  {
    id: "pa-ca-pipelinereadiness-interpreter-009",
    domain: "interpreter_request",
    use: "ci_readiness",
    pipeline_readiness_vi: "Khóa cuối câu xin thông dịch viên khi tình huống vượt quá mức hiểu.",
    pipeline_readiness_en: "Pipeline-readiness sample checks the interpreter request when the situation exceeds the learner's understanding.",
    ...
    pipeline_readiness_check_vi: "CI-readiness xác nhận Shahmukhi chỉ là nhận biết, không phải khóa học đầy đủ.",
    pipeline_readiness_check_en: "CI-readiness confirms Shahmukhi is awareness only, not a full course.",
  ...
  {
    id: "pa-ca-pipelinereadiness-emergency-010",
    domain: "emergency_boundary",
    use: "mr_readiness",
    pipeline_readiness_vi: "Khóa cuối câu khẩn cấp khi có nguy hiểm thật sự và cần gọi 911.",
    pipeline_readiness_en: "Pipeline-readiness sample checks the emergency line when there is real danger and 911 is needed.",
    ...
    pipeline_readiness_check_vi: "MR-readiness giữ câu rõ và không thay thế dịch vụ khẩn cấp.",
    pipeline_readiness_check_en: "MR-readiness keeps the line clear and does not replace emergency services.",
  ...
  {
    id: "pa-ca-pipelinereadiness-recovery-011",
    domain: "service_recovery",
    use: "pipeline_readiness",
    pipeline_readiness_vi: "Khóa cuối câu phục hồi dịch vụ khi thông tin sai hoặc chưa khớp.",
    pipeline_readiness_en:
      "Pipeline-readiness sample checks the service-recovery line when information is wrong or does not match.",
    ...
    pipeline_readiness_check_vi: "Pipeline-readiness xác nhận câu sửa lỗi vẫn lịch sự và thực tế.",
    pipeline_readiness_check_en: "Pipeline-readiness confirms the correction line stays polite and practical.",
  ...
  {
    id: "pa-ca-pipelinereadiness-workplace-012",
    domain: "workplace_safety",
    use: "pre_integration",
    pipeline_readiness_vi: "Khóa cuối câu nơi làm việc khi người học chưa hiểu hướng dẫn an toàn.",
    pipeline_readiness_en:
      "Pipeline-readiness sample checks the workplace line when the learner did not understand a safety instruction.",
    ...
    pipeline_readiness_check_vi: "Pre-integration giữ câu ở mức xin làm rõ ngôn ngữ, không đưa hướng dẫn kỹ thuật.",
    pipeline_readiness_check_en: "Pre-integration keeps this as language clarification, not technical instruction.",
...
export default PUNJABI_CANADA_SURVIVAL_PIPELINE_READINESS_SAMPLES;
