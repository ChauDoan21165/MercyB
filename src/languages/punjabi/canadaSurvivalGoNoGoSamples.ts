// Punjabi Canada survival go-no-go samples for Vietnamese-speaking
...
export type PunjabiCanadaSurvivalGoNoGoDomain =
  | "clinic"
  | "pharmacy"
  | "school_childcare"
  | "bank"
...
export type PunjabiCanadaSurvivalGoNoGoUse =
  | "go_no_go"
  | "closure_validation"
  | "pre_integration"
  | "handoff_check";

export type PunjabiCanadaSurvivalGoNoGoItem = {
  id: string;
  domain: PunjabiCanadaSurvivalGoNoGoDomain;
  use: PunjabiCanadaSurvivalGoNoGoUse;
  decision_vi: string;
  decision_en: string;
  goal_vi: string;
  goal_en: string;
  ...
  meaning_en: string;
  support_pa: string[];
  decision_check_vi: string;
  decision_check_en: string;
...
export type PunjabiCanadaSurvivalGoNoGoScope = {
  name: string;
  audience: string[];
  scriptPolicy: string;
  reviewStatus: string;
...
export const PUNJABI_CANADA_SURVIVAL_GO_NO_GO_SCOPE: PunjabiCanadaSurvivalGoNoGoScope = {
  name: "Punjabi Canada Survival Go No-Go Samples",
  ...
  boundaries: [
    "Language support only for Canada survival go-no-go samples.",
    "No medical, legal, financial, tenancy, or workplace safety advice.",
  ],
};

export const PUNJABI_CANADA_SURVIVAL_GO_NO_GO_SAMPLES: PunjabiCanadaSurvivalGoNoGoItem[] = [
  {
    id: "pa-ca-gonogo-clinic-001",
    domain: "clinic",
    use: "go_no_go",
    decision_vi: "Đóng kiểm câu phòng khám khi người học cần xin giải thích chậm trước khi trả lời.",
    decision_en: "Close-check the clinic line when the learner needs slower explanation before answering.",
    ...
    decision_check_vi: "Go-no-go giữ câu ở mức hỗ trợ ngôn ngữ, không đưa lời khuyên y tế.",
    decision_check_en: "Go no-go keeps this as language support, not medical advice.",
  ...
  {
    id: "pa-ca-gonogo-pharmacy-002",
    domain: "pharmacy",
    use: "closure_validation",
    decision_vi: "Đóng kiểm câu nhà thuốc để người học nêu dị ứng và xin ghi lại thông tin.",
    decision_en: "Close-check the pharmacy line so the learner can state an allergy and ask for writing.",
    ...
    decision_check_vi: "Closure-validation xác nhận câu không thêm liều lượng hoặc hướng dẫn thuốc.",
    decision_check_en: "The closure validation confirms the line does not add dosage or medicine instructions.",
  ...
  {
    id: "pa-ca-gonogo-school-003",
    domain: "school_childcare",
    use: "pre_integration",
    decision_vi: "Đóng kiểm câu form dùng được cho trường và childcare khi người học bị kẹt.",
    decision_en: "Close-check the form line for school and childcare when the learner is stuck.",
    ...
    decision_check_vi: "Pre-integration xác nhận câu nối được với trường, childcare, và form.",
    decision_check_en: "Pre-integration confirms the line connects to school, childcare, and form flows.",
  ...
  {
    id: "pa-ca-gonogo-bank-004",
    domain: "bank",
    use: "handoff_check",
    decision_vi: "Đóng kiểm câu ngân hàng giữ mục tiêu mở tài khoản và hỏi phí.",
    decision_en: "Close-check the bank line so it keeps the account-opening and fee goal.",
    ...
    decision_check_vi: "Handoff check xác nhận câu không trôi sang thẻ, vay, hoặc lời khuyên tiền bạc.",
    decision_check_en: "The handoff check confirms the line does not drift to cards, loans, or money advice.",
  ...
  {
    id: "pa-ca-gonogo-housing-005",
    domain: "housing",
    use: "go_no_go",
    decision_vi: "Đóng kiểm câu nhà thuê khi cần thời gian sửa và phản hồi bằng văn bản.",
    decision_en: "Close-check the rental line when repair timing and a written reply are needed.",
    ...
    decision_check_vi: "Go-no-go không biến câu sửa chữa thành tư vấn luật thuê nhà.",
    decision_check_en: "Go no-go does not turn the repair line into tenancy advice.",
  ...
  {
    id: "pa-ca-gonogo-transport-006",
    domain: "transport",
    use: "pre_integration",
    decision_vi: "Đóng kiểm câu giao thông khi người học cần hỏi tuyến xe và điểm xuống.",
    decision_en: "Close-check the transport line when the learner needs route and stop confirmation.",
    ...
    decision_check_vi: "Pre-integration xác nhận câu nối được với phần chỉ đường và lịch trình.",
    decision_check_en: "Pre-integration confirms the line connects to directions and schedule content.",
  ...
  {
    id: "pa-ca-gonogo-public-office-007",
    domain: "public_office",
    use: "closure_validation",
    decision_vi: "Đóng kiểm câu cơ quan công khi người học cần biết quầy và giấy tờ.",
    decision_en: "Close-check the public-office line when the learner needs the right counter and documents.",
    ...
    decision_check_vi: "Closure-validation xác nhận câu nối được với form và quầy dịch vụ.",
    decision_check_en: "The closure validation confirms the line connects to form and service-counter flows.",
  ...
  {
    id: "pa-ca-gonogo-forms-008",
    domain: "forms_service_desk",
    use: "go_no_go",
    decision_vi: "Đóng kiểm câu bàn dịch vụ khi người học cần chỉ phần form chưa hiểu.",
    decision_en: "Close-check the service-desk line when the learner needs to show the unclear form section.",
    ...
    decision_check_vi: "Go-no-go xác nhận câu form đủ rõ trước khi ghép vào luồng cuối.",
    decision_check_en: "Go no-go confirms the form line is clear before final flow linking.",
  ...
  {
    id: "pa-ca-gonogo-interpreter-009",
    domain: "interpreter_request",
    use: "handoff_check",
    decision_vi: "Đóng kiểm câu xin thông dịch viên khi tình huống vượt quá mức hiểu.",
    decision_en: "Close-check the interpreter request when the situation exceeds the learner's understanding.",
    ...
    decision_check_vi: "Handoff check xác nhận Shahmukhi chỉ là nhận biết, không phải khóa học đầy đủ.",
    decision_check_en: "The handoff check confirms Shahmukhi is awareness only, not a full course.",
  ...
  {
    id: "pa-ca-gonogo-emergency-010",
    domain: "emergency_boundary",
    use: "closure_validation",
    decision_vi: "Đóng kiểm câu khẩn cấp khi có nguy hiểm thật sự và cần gọi 911.",
    decision_en: "Close-check the emergency line when there is real danger and 911 is needed.",
    ...
    decision_check_vi: "Closure-validation giữ câu khẩn cấp rõ và không thay thế dịch vụ khẩn cấp.",
    decision_check_en: "The closure validation keeps the emergency line clear and does not replace emergency services.",
  ...
  {
    id: "pa-ca-gonogo-recovery-011",
    domain: "service_recovery",
    use: "go_no_go",
    decision_vi: "Đóng kiểm câu phục hồi dịch vụ khi thông tin sai hoặc chưa khớp.",
    decision_en: "Close-check the service-recovery line when information is wrong or does not match.",
    ...
    decision_check_vi: "Go-no-go xác nhận câu sửa lỗi vẫn lịch sự và thực tế.",
    decision_check_en: "Go no-go confirms the correction line stays polite and practical.",
  ...
  {
    id: "pa-ca-gonogo-workplace-012",
    domain: "workplace_safety",
    use: "pre_integration",
    decision_vi: "Đóng kiểm câu nơi làm việc khi người học chưa hiểu hướng dẫn an toàn.",
    decision_en: "Close-check the workplace line when the learner did not understand a safety instruction.",
    ...
    decision_check_vi: "Pre-integration giữ câu ở mức xin làm rõ ngôn ngữ, không đưa hướng dẫn kỹ thuật.",
    decision_check_en: "Pre-integration keeps this as language clarification, not technical instruction.",
...
export default PUNJABI_CANADA_SURVIVAL_GO_NO_GO_SAMPLES;
