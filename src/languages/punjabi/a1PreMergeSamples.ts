// Punjabi A1 pre-merge samples for Vietnamese-speaking and English-speaking learners.
// Gurmukhi is primary; romanization supports recognition. Native review is deferred.

export type PunjabiA1PreMergeDomain =
  | "greetings"
  | "identity"
  | "family"
  | "numbers"
...
export type PunjabiA1PreMergeStyle =
  | "pre_merge"
  | "pre_a11_checksum"
  | "runner_readiness"
  | "pipeline_readiness"
...
export type PunjabiA1PreMergeSample = {
  id: string;
  domain: PunjabiA1PreMergeDomain;
  style: PunjabiA1PreMergeStyle;
  prompt_vi: string;
  prompt_en: string;
  cue_pa: string;
  romanization?: string;
  ...
  meaning_en: string;
  expected_pa: string;
  pre_merge_check_vi: string;
  pre_merge_check_en: string;
  readiness_vi: string;
  readiness_en: string;
  trap?: {
    audience: "vi" | "en" | "both";
...
export const preMergeScriptAwareness =
  "Gurmukhi is the primary script for this Punjabi A1 pre-merge set. Shahmukhi is awareness only, not a full course track.";

export const punjabiA1PreMergeSamples: PunjabiA1PreMergeSample[] = [
  {
    id: "pa_a1_pre_merge_greeting_001",
    domain: "greetings",
    style: "pre_merge",
    ...
    pre_merge_check_vi: "Câu chào phải giữ Gurmukhi làm nội dung chính.",
    pre_merge_check_en: "The greeting must keep Gurmukhi as the primary content.",
  ...
  {
    id: "pa_a1_pre_merge_identity_001",
    domain: "identity",
    ...
    pre_merge_check_vi: "Mẫu ਮੇਰਾ ਨਾਮ ... ਹੈ phải còn nguyên trước khi hỏi lại.",
    pre_merge_check_en: "The ਮੇਰਾ ਨਾਮ ... ਹੈ frame must stay intact before asking back.",
  ...
  },
  {
    ...
    pre_merge_check_vi: "Mẫu gia đình phải kiểm tra cả giới thiệu người thân và 'tôi có'.",
    pre_merge_check_en: "The family sample must check both introducing a relative and 'I have'.",
  ...
  {
    id: "pa_a1_pre_merge_numbers_001",
    domain: "numbers",
    ...
    pre_merge_check_vi: "Số phải đọc được bằng Gurmukhi trước khi nối với giá.",
    pre_merge_check_en: "The number must be readable in Gurmukhi before linking to prices.",
  ...
  },
  {
    ...
    pre_merge_check_vi: "Câu giá phải dùng được ở quầy hoặc cửa hàng Canada.",
    pre_merge_check_en: "The price question must work at a Canada counter or shop.",
  ...
  },
  {
    ...
    pre_merge_check_vi: "Mẫu nhu cầu phải rõ chủ thể và vật cần.",
    pre_merge_check_en: "The need frame must clearly show who needs what.",
  ...
  {
    id: "pa_a1_pre_merge_directions_001",
    domain: "directions",
    ...
    pre_merge_check_vi: "Câu hỏi vị trí phải giữ ਕਿੱਥੇ ਹੈ ở cuối.",
    pre_merge_check_en: "The location question must keep ਕਿੱਥੇ ਹੈ at the end.",
  ...
  },
  {
    ...
    pre_merge_check_vi: "Đây là câu cứu nguy A1 và phải luôn có trong bản đóng băng cuối.",
    pre_merge_check_en: "This is the A1 rescue line and must remain in the final freeze.",
  ...
  {
    id: "pa_a1_pre_merge_repetition_001",
    domain: "repetition",
    style: "pipeline_readiness",
    ...
    pre_merge_check_vi: "Câu này phải hỗ trợ khi nghe thiếu số, giá hoặc hướng dẫn.",
    pre_merge_check_en: "This must support missed numbers, prices, or directions.",
  ...
  {
    id: "pa_a1_pre_merge_politeness_001",
    domain: "politeness",
    style: "readiness_check",
    ...
    pre_merge_check_vi: "Lịch sự phải còn trong luồng dịch vụ ngắn.",
    pre_merge_check_en: "Politeness must remain in the short service flow.",
  ...
  {
    id: "pa_a1_pre_merge_gurmukhi_001",
    ...
    pre_merge_check_vi: "Nhóm chữ phải kiểm tra Gurmukhi trước romanization.",
    pre_merge_check_en: "The word set must check Gurmukhi before romanization.",
  ...
  {
    id: "pa_a1_pre_merge_romanization_001",
    ...
    meaning_en: "again",
    expected_pa: "ਦੁਬਾਰਾ",
    pre_merge_check_vi: "Romanization hỗ trợ đọc âm, nhưng đáp án đóng băng là Gurmukhi.",
    pre_merge_check_en: "Romanization supports sound, but the frozen answer is Gurmukhi.",
  ...
  {
    id: "pa_a1_pre_merge_canada_counter_001",
    ...
    pre_merge_check_vi: "Câu này phải giữ mức A1, không biến thành bài giấy tờ nâng cao.",
    pre_merge_check_en: "This must stay A1 and not become an advanced document lesson.",
...
export default punjabiA1PreMergeSamples;
