// Punjabi C2 register safety guards for Vietnamese- and English-speaking learners.
// Gurmukhi is primary; romanization is a reading aid.
//
// Scope/status: study-support safety guards, not certification, official
...
export type PunjabiC2RegisterSafetyFocus =
...
export type PunjabiC2RegisterSafetyStyle = "final_safety" | "quality" | "export_readiness" | "regression";

export type PunjabiC2RegisterSafetyPhrase = {
  gurmukhi: string;
  romanization: string;
  vi: string;
  en: string;
...
export type PunjabiC2RegisterSafetyCheck = {
  check_vi: string;
  check_en: string;
  signal_vi: string;
  signal_en: string;
...
export type PunjabiC2RegisterSafetyTrap = {
  trap_vi: string;
  trap_en: string;
  repair_vi: string;
  repair_en: string;
...
export type PunjabiC2RegisterSafetyGuard = {
  id: string;
  focus: PunjabiC2RegisterSafetyFocus;
  style: PunjabiC2RegisterSafetyStyle;
  title_vi: string;
  title_en: string;
  scenario_vi: string;
  scenario_en: string;
  guard_goal_vi: string;
  guard_goal_en: string;
  sample_gurmukhi: string;
  sample_romanization: string;
  sample_vi: string;
  sample_en: string;
  guard_phrases: PunjabiC2RegisterSafetyPhrase[];
  checks: PunjabiC2RegisterSafetyCheck[];
  learner_trap?: PunjabiC2RegisterSafetyTrap;
  canada_practical?: boolean;
};

export const C2_REGISTER_SAFETY_GUARDS_DISCLAIMER = {
  vi: "Gói bảo vệ đăng ký Punjabi C2 này chỉ hỗ trợ học tập, không phải chứng nhận hay xếp lớp chính thức. Gurmukhi là chính; phiên âm chỉ giúp đọc. Thẩm định bản xứ được hoãn lại. Shahmukhi chỉ được nhắc để nhận biết hệ chữ.",
  en: "This C2 Punjabi register safety guard pack supports study only, not certification or official placement. Gurmukhi is primary; romanization only supports reading. Native review is deferred. Shahmukhi is noted only for script awareness.",
} as const;

export const registerSafetyGuardsC2: PunjabiC2RegisterSafetyGuard[] = [
  {
    id: "pa_c2_register_guard_nuanced_disagreement",
    focus: "nuanced_disagreement",
    style: "quality",
    title_vi: "An toàn cho bất đồng tinh tế",
    title_en: "Safety for nuanced disagreement",
    scenario_vi: "Bạn muốn phản biện mà không làm mất mặt người nghe.",
    scenario_en: "You want to challenge a point without causing the listener to lose face.",
    guard_goal_vi: "Công nhận trước, rồi mới thu hẹp phản biện vào dữ liệu.",
    guard_goal_en: "Validate first, then narrow the critique to data.",
    sample_gurmukhi:
    ...
    checks: [
      {
        check_vi: "Có validation trước critique không?",
        check_en: "Is validation present before critique?",
        signal_vi: "Có công nhận và dữ liệu.",
        signal_en: "Includes validation and data.",
      },
    ],
    learner_trap: {
      trap_vi: "Mở đầu bằng phủ định trực diện.",
      trap_en: "Opening with a direct rejection.",
      repair_vi: "Công nhận mục tiêu trước rồi nói về số liệu.",
      repair_en: "Validate the goal first, then discuss numbers.",
    },
  },
  {
    id: "pa_c2_register_guard_negotiation_canada",
    focus: "negotiation",
    style: "final_safety",
    title_vi: "An toàn cho đàm phán dịch vụ công Canada",
    title_en: "Safety for Canadian public-service negotiation",
    ...
    guard_goal_vi: "Nêu cái có, hỏi bước tiếp theo, không đòi ngoại lệ.",
    guard_goal_en: "State what you have, ask for the next step, and do not demand an exception.",
    sample_gurmukhi:
    ...
    checks: [
      {
        check_vi: "Có tránh xin ngoại lệ không?",
        check_en: "Does it avoid asking for an exception?",
        signal_vi: "Có quy định trước câu hỏi.",
        signal_en: "Rule comes before the question.",
      },
    ],
    learner_trap: {
      trap_vi: "Chỉ than thiếu giấy tờ.",
      trap_en: "Only complaining about missing paperwork.",
  ...
  {
    id: "pa_c2_register_guard_diplomacy",
    focus: "diplomacy",
    style: "export_readiness",
    title_vi: "Đăng ký an toàn cho từ chối ngoại giao",
    title_en: "Safety for diplomatic refusal",
    ...
    guard_goal_vi: "Cảm ơn, giới hạn hiện tại, và để mở khả năng sau.",
    guard_goal_en: "Thank, set the current limit, and leave future possibility open.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_register_guard_mediation",
    focus: "mediation",
    style: "quality",
    title_vi: "An toàn cho hòa giải",
    title_en: "Safety for mediation",
    ...
    guard_goal_vi: "Nêu cả hai phía theo cấu trúc song song và quay lại tiêu chí chung.",
    guard_goal_en: "State both sides in parallel and return to shared criteria.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_register_guard_deescalation",
    focus: "deescalation",
    style: "regression",
    title_vi: "Thụt lùi an toàn cho hạ nhiệt",
    title_en: "Safe regression for de-escalation",
    ...
    guard_goal_vi: "Đưa cuộc nói chuyện về lượt nói và mục tiêu chung.",
    guard_goal_en: "Bring the conversation back to turn-taking and the shared goal.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_register_guard_sensitive_topic",
    focus: "sensitive_topic_framing",
    style: "quality",
    title_vi: "An toàn khi nêu chủ đề nhạy cảm",
    title_en: "Safety when framing a sensitive topic",
    ...
    guard_goal_vi: "Dùng tiêu chí trung tính và tránh định kiến.",
    guard_goal_en: "Use neutral criteria and avoid stereotypes.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_register_guard_community",
    focus: "community_discourse",
    style: "final_safety",
    title_vi: "Bảo vệ giọng cộng đồng",
    title_en: "Protect community tone",
    ...
    guard_goal_vi: "Giữ ấm áp, rõ ràng, và không làm khó người đọc.",
    guard_goal_en: "Stay warm, clear, and not burdensome to the reader.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_register_guard_professional",
    focus: "professional_discourse",
    style: "export_readiness",
    title_vi: "Bảo vệ giọng chuyên nghiệp",
    title_en: "Protect professional tone",
    ...
    guard_goal_vi: "Thừa nhận tác động, làm rõ ý định, và đề xuất sửa.",
    guard_goal_en: "Acknowledge impact, clarify intent, and propose a repair.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_register_guard_public_service",
    focus: "public_service",
    style: "final_safety",
    title_vi: "An toàn cho quầy dịch vụ công",
    title_en: "Safety for a public-service desk",
    ...
    guard_goal_vi: "Lịch sự, nêu cái có, và hỏi bước tiếp theo thay vì đòi ngoại lệ.",
    guard_goal_en: "Be polite, state what you have, and ask for the next step instead of demanding an exception.",
    sample_gurmukhi:
      "ਮੈਨੂੰ ਨਿਯਮ ਦੀ ਸਮਝ ਹੈ। ਇਸ ਵੇਲੇ ਮੇਰੇ ਕੋਲ ਕਾਪੀ ਅਤੇ ਪੁਸ਼ਟੀ ਵਾਲਾ ਈਮੇਲ ਹੈ; ਅਗਲਾ ਕਦਮ ਕੀ ਹੋ ਸਕਦਾ ਹੈ?",
    sample_romanization:
      "mainu niyam di samajh hai. is vele mere kol copy ate pushti wala email hai; agla kadam ki ho sakda hai?",
  ...
  {
    id: "pa_c2_register_guard_public",
    focus: "public_discourse",
    style: "final_safety",
    title_vi: "Bảo vệ giọng công khai",
    title_en: "Protect public tone",
    ...
    guard_goal_vi: "Ngắn, rõ, có thời gian và hành động.",
    guard_goal_en: "Short, clear, with time and action.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_register_guard_audience",
    focus: "audience_adaptation",
    style: "regression",
    title_vi: "Thụt lùi an toàn cho điều chỉnh theo người nghe",
    title_en: "Safe regression for audience adaptation",
    ...
    guard_goal_vi: "Kính trọng trước, góc nhìn sau, không sửa lưng.",
    guard_goal_en: "Respect first, perspective after, without sounding corrective.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_register_guard_advanced",
    focus: "advanced_register",
    style: "quality",
    title_vi: "Bảo vệ đăng ký nâng cao",
    title_en: "Protect advanced register",
    ...
    guard_goal_vi: "Trang trọng, tập trung vào ràng buộc và phương án.",
    guard_goal_en: "Formal, focused on constraint and option.",
    sample_gurmukhi:
...
export const registerSafetyGuardsC2ByFocus = (
  focus: PunjabiC2RegisterSafetyFocus,
): PunjabiC2RegisterSafetyGuard[] => registerSafetyGuardsC2.filter((item) => item.focus === focus);
