// src/languages/punjabi/a2FinalFreezeSamples.ts
//
// Punjabi A2 final-freeze samples for Vietnamese-speaking and English-speaking
...
export type PunjabiA2FinalFreezeScenario =
  | "daily_routine"
  | "appointments"
  | "transport"
  | "housing"
...
export type PunjabiA2FinalFreezeStyle =
  | "final_freeze"
  | "final_lock"
  | "owner_acceptance"
  | "pre_integration";

export type PunjabiA2FinalFreezeLine = {
  pa: string;
  romanization: string;
  vi: string;
  en: string;
...
export type PunjabiA2FinalFreezeTrap = {
  trap_vi: string;
  trap_en: string;
  fix_pa: string;
...
export type PunjabiA2FinalFreezeItem = {
  id: string;
  scenario: PunjabiA2FinalFreezeScenario;
  style: PunjabiA2FinalFreezeStyle;
  title_vi: string;
  title_en: string;
  ...
  lines: PunjabiA2FinalFreezeLine[];
  checks: {
    q_vi: string;
    q_en: string;
    answer_pa: string;
  ...
  traps: PunjabiA2FinalFreezeTrap[];
};

const scriptAwarenessVi =
  "Gurmukhi là chữ chính trong final-freeze samples; Shahmukhi chỉ được nhắc để nhận biết, không phải khóa riêng.";
const scriptAwarenessEn =
  "Gurmukhi is the main script in these final-freeze samples; Shahmukhi is mentioned only for awareness, not as a separate course.";

const baseSignals = {
  return_signal_vi: "Trả lại nếu thiếu dữ kiện chính hoặc đổi ý giữa các câu.",
  return_signal_en: "Return if a key detail is missing or the meaning changes between lines.",
};

export const a2FinalFreezeSamples: PunjabiA2FinalFreezeItem[] = [
  {
    id: "pa_a2_freeze_daily_routine",
    scenario: "daily_routine",
    style: "final_freeze",
    title_vi: "Final freeze: thói quen hằng ngày",
    title_en: "Final freeze: daily routine",
    freeze_goal_vi: "Đóng băng mẫu nếu giờ, thói quen sáng, và một câu quá khứ ngắn ổn định.",
    freeze_goal_en: "Freeze the sample if time, morning routine, and one short past sentence are stable.",
    stable_signal_vi: "Ổn định nếu giờ thức dậy và giờ ra khỏi nhà không bị lẫn.",
  ...
  {
    id: "pa_a2_freeze_appointments",
    scenario: "appointments",
    style: "final_lock",
    title_vi: "Final lock: lịch hẹn",
    title_en: "Final lock: appointments",
    freeze_goal_vi: "Đóng băng mẫu nếu lịch, giấy tờ, và câu đổi lịch nếu cần đều rõ.",
    freeze_goal_en: "Freeze the sample if appointment, documents, and optional reschedule sentence are clear.",
    stable_signal_vi: "Ổn định nếu lịch hiện tại và đồ cần mang đều có.",
  ...
  {
    id: "pa_a2_freeze_transport",
    scenario: "transport",
    style: "pre_integration",
    title_vi: "Pre-integration: đi lại",
    title_en: "Pre-integration: transport",
    freeze_goal_vi: "Đóng băng mẫu nếu tuyến, điểm xuống, và báo trễ nhất quán.",
    freeze_goal_en: "Freeze the sample if route, stop, and delay notice are consistent.",
    stable_signal_vi: "Ổn định nếu điểm đến, điểm xuống, và thời lượng trễ đều rõ.",
  ...
  {
    id: "pa_a2_freeze_housing",
    scenario: "housing",
    style: "final_freeze",
    title_vi: "Final freeze: nhà ở",
    title_en: "Final freeze: housing",
    freeze_goal_vi: "Đóng băng mẫu nếu opener lịch sự, sự cố, thời điểm, và yêu cầu sửa đầy đủ.",
    freeze_goal_en: "Freeze the sample if polite opener, problem, timing, and repair request are complete.",
    stable_signal_vi: "Ổn định nếu sự cố giữ nguyên từ mô tả đến yêu cầu.",
  ...
  {
    id: "pa_a2_freeze_school",
    scenario: "school",
    style: "owner_acceptance",
    title_vi: "Owner acceptance: trường học",
    title_en: "Owner acceptance: school",
    freeze_goal_vi: "Đóng băng mẫu nếu vắng học, lý do, và yêu cầu homework rõ.",
    freeze_goal_en: "Freeze the sample if absence, reason, and homework request are clear.",
    stable_signal_vi: "Ổn định nếu người bị bệnh là trẻ và yêu cầu gửi bài rõ.",
  ...
  {
    id: "pa_a2_freeze_childcare",
    scenario: "childcare",
    style: "final_lock",
    title_vi: "Final lock: childcare pickup",
    title_en: "Final lock: childcare pickup",
    freeze_goal_vi: "Đóng băng mẫu nếu người đón thay, thời gian, và pickup list rõ.",
    freeze_goal_en: "Freeze the sample if alternate pickup person, time, and pickup list are clear.",
    stable_signal_vi: "Ổn định nếu tên người đón và list khớp.",
  ...
  {
    id: "pa_a2_freeze_workplace_small_talk",
    scenario: "workplace_small_talk",
    style: "final_freeze",
    title_vi: "Final freeze: small talk nơi làm",
    title_en: "Final freeze: workplace small talk",
    freeze_goal_vi: "Đóng băng mẫu nếu chào hỏi, trả lời ngắn, và chuyển sang nhiệm vụ rõ.",
    freeze_goal_en: "Freeze the sample if greeting, short reply, and task transition are clear.",
    stable_signal_vi: "Ổn định nếu small talk lịch sự và task rõ.",
  ...
  {
    id: "pa_a2_freeze_forms",
    scenario: "forms",
    style: "owner_acceptance",
    title_vi: "Owner acceptance: forms",
    title_en: "Owner acceptance: forms",
    freeze_goal_vi: "Đóng băng mẫu nếu tên, địa chỉ, và giấy tờ thiếu giữ nguyên.",
    freeze_goal_en: "Freeze the sample if name, address, and missing document stay consistent.",
    stable_signal_vi: "Ổn định nếu các field form không đổi giữa các câu.",
  ...
  {
    id: "pa_a2_freeze_short_messages",
    scenario: "short_messages",
    style: "pre_integration",
    title_vi: "Pre-integration: tin nhắn ngắn",
    title_en: "Pre-integration: short messages",
    freeze_goal_vi: "Đóng băng mẫu nếu giờ, nơi, và vật cần mang được tách đúng.",
    freeze_goal_en: "Freeze the sample if time, place, and item to bring are extracted correctly.",
    stable_signal_vi: "Ổn định nếu giữ đủ thời gian, địa điểm, và vật cần mang.",
  ...
  {
    id: "pa_a2_freeze_service_flow",
    scenario: "service_flow",
    style: "final_lock",
    title_vi: "Final lock: luồng dịch vụ",
    title_en: "Final lock: service flow",
    freeze_goal_vi: "Đóng băng mẫu nếu opener, nhu cầu, và câu hỏi giấy tờ đầy đủ.",
    freeze_goal_en: "Freeze the sample if opener, need, and document question are complete.",
    stable_signal_vi: "Ổn định nếu nhu cầu và câu hỏi giấy tờ nối nhau rõ.",
  ...
  {
    id: "pa_a2_freeze_polite_problem",
    scenario: "polite_problem_descriptions",
    style: "final_freeze",
    title_vi: "Final freeze: mô tả vấn đề lịch sự",
    title_en: "Final freeze: polite problem descriptions",
    freeze_goal_vi: "Đóng băng mẫu nếu opener lịch sự, vấn đề, và câu hỏi bước tiếp theo rõ.",
    freeze_goal_en: "Freeze the sample if polite opener, problem, and next-step question are clear.",
    stable_signal_vi: "Ổn định nếu vấn đề được nêu và được yêu cầu kiểm tra rõ.",
  ...
  {
    id: "pa_a2_freeze_interaction_repair",
    scenario: "interaction_repair",
    style: "pre_integration",
    title_vi: "Pre-integration: sửa chữa tương tác",
    title_en: "Pre-integration: interaction repair",
    freeze_goal_vi: "Đóng băng mẫu nếu báo chưa hiểu, xin nhắc lại, và xác nhận nghĩa đầy đủ.",
    freeze_goal_en: "Freeze the sample if non-understanding signal, repetition request, and meaning confirmation are complete.",
    stable_signal_vi: "Ổn định nếu có đủ ba bước repair.",
