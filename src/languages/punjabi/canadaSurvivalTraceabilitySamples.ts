// Punjabi Canada survival traceability samples for Vietnamese-speaking and
...
export type PunjabiCanadaSurvivalTraceabilityDomain =
  | "clinic"
  | "pharmacy"
  | "school_childcare"
  | "bank"
...
export type PunjabiCanadaSurvivalTraceabilityCheck =
  | "pre_a11_traceability"
  | "evidence_receipt"
  | "completion_record"
  | "pre_integration";

export type PunjabiCanadaSurvivalTraceabilitySample = {
  id: string;
  domain: PunjabiCanadaSurvivalTraceabilityDomain;
  check: PunjabiCanadaSurvivalTraceabilityCheck;
  phrase_pa: string;
  romanization: string;
  meaning_vi: string;
  meaning_en: string;
  ...
  traceability_note_vi: string;
  traceability_note_en: string;
...
export type PunjabiCanadaSurvivalTraceabilityScope = {
  name: string;
  audience: string[];
  scriptPolicy: string;
  reviewStatus: string;
...
export const PUNJABI_CANADA_SURVIVAL_TRACEABILITY_SCOPE: PunjabiCanadaSurvivalTraceabilityScope = {
  name: "Punjabi Canada Survival Traceability Samples",
  ...
  traceabilityBoundary:
    "Pre-A11-traceability, evidence receipt, completion record, and pre-integration content samples for Canadian survival communication; not A11 integration, not legal advice, not medical advice, and not financial advice. These samples connect practical survival items to learner goals for later review.",
};

export const PUNJABI_CANADA_SURVIVAL_TRACEABILITY_DOMAINS: PunjabiCanadaSurvivalTraceabilityDomain[] = [
  "clinic",
  "pharmacy",
  "school_childcare",
  "bank",
...
export const PUNJABI_CANADA_SURVIVAL_TRACEABILITY_SAMPLES: PunjabiCanadaSurvivalTraceabilitySample[] = [
  {
    id: "pa-ca-traceability-clinic-001",
    domain: "clinic",
    check: "pre_a11_traceability",
    ...
    traceability_note_vi: "Pre-A11-traceability giữ phrase, repair request, và next-step handoff mà không tích hợp A11.",
    traceability_note_en: "The pre-A11-traceability keeps phrase, repair request, and next-step handoff without A11 integration.",
    readiness_signal_vi: "Completion Record ổn nếu có Gurmukhi, romanization, Vietnamese, English, và clinic context.",
    readiness_signal_en: "Completion Record is stable if it has Gurmukhi, romanization, Vietnamese, English, and clinic context.",
  ...
  {
    id: "pa-ca-traceability-pharmacy-002",
    domain: "pharmacy",
    ...
    traceability_note_vi: "Completion Record sample chứng minh pharmacy content không tự đưa liều hoặc chẩn đoán.",
    traceability_note_en: "The completion record sample proves pharmacy content does not provide dose or diagnosis.",
    readiness_signal_vi: "Evidence Receipt ổn nếu learner xin pharmacist viết số lần/ngày thay vì đoán.",
    readiness_signal_en: "Evidence Receipt is stable if the learner asks the pharmacist to write times per day instead of guessing.",
  ...
  {
    id: "pa-ca-traceability-school-childcare-003",
    domain: "school_childcare",
    check: "evidence_receipt",
    ...
    traceability_note_vi: "Evidence Receipt traceability đóng gói child, date, action, và optional pickup detail.",
    traceability_note_en: "The evidence receipt traceability packages child, date, action, and optional pickup detail.",
  ...
  {
    id: "pa-ca-traceability-bank-004",
    domain: "bank",
    check: "pre_a11_traceability",
    ...
    traceability_note_vi: "Pre-A11-traceability giữ bank sample ở mức service information, không khuyến nghị sản phẩm.",
    traceability_note_en: "The pre-A11-traceability keeps the bank sample at service information level, not product recommendation.",
    readiness_signal_vi: "Completion Record ổn nếu fee request và financial boundary đều có mặt.",
    readiness_signal_en: "Completion Record is stable if fee request and financial boundary are both present.",
  ...
  {
    id: "pa-ca-traceability-housing-005",
    domain: "housing",
    ...
    traceability_note_vi: "Pre-integration traceability có unit, issue, repair time, và written confirmation.",
    traceability_note_en: "The pre-integration traceability has unit, issue, repair time, and written confirmation.",
    readiness_signal_vi: "Evidence Receipt ổn nếu housing task không chuyển thành tenancy advice.",
    readiness_signal_en: "Evidence Receipt is stable if the housing task does not become tenancy advice.",
  ...
  {
    id: "pa-ca-traceability-transport-006",
    domain: "transport",
    check: "completion_record",
    ...
    traceability_note_vi: "Completion Record traceability có route, direction, transfer, và delay repair line.",
    traceability_note_en: "The completion record traceability has route, direction, transfer, and delay repair line.",
    readiness_signal_vi: "Pre-A11-traceability ổn nếu transport content dùng transit/bus nhưng không hứa schedule.",
    readiness_signal_en: "Pre-A11-traceability is stable if transport content uses transit/bus but does not promise schedule.",
  ...
  {
    id: "pa-ca-traceability-public-office-007",
    ...
    traceability_note_vi: "Evidence Receipt traceability đóng gói counter, documents, checklist, và next step.",
    traceability_note_en: "The evidence receipt traceability packages counter, documents, checklist, and next step.",
    readiness_signal_vi: "Completion Record ổn nếu public office flow không thành legal advice.",
    readiness_signal_en: "Completion Record is stable if public office flow does not become legal advice.",
  ...
  {
    id: "pa-ca-traceability-forms-008",
    domain: "forms",
    check: "pre_a11_traceability",
    ...
    traceability_note_vi: "Pre-A11-traceability sample chứng minh forms coverage, correction request, và official-process boundary.",
    traceability_note_en: "The pre-A11-traceability sample proves forms coverage, correction request, and official-process boundary.",
  ...
  {
    id: "pa-ca-traceability-interpreter-009",
    ...
    traceability_note_vi: "Pre-integration traceability đóng gói pause line, interpreter request, và no-signing-until-clear boundary.",
    traceability_note_en: "The pre-integration traceability packages pause line, interpreter request, and no-signing-until-clear boundary.",
    readiness_signal_vi: "Completion Record ổn nếu interpreter request chỉ là language support, không phải professional decision.",
    readiness_signal_en: "Completion Record is stable if interpreter request is language support, not professional decision.",
  ...
  {
    id: "pa-ca-traceability-emergency-010",
    ...
    traceability_note_vi: "Completion Record traceability có immediate need, address, service type, và interpreter option.",
    traceability_note_en: "The completion record traceability has immediate need, address, service type, and interpreter option.",
    readiness_signal_vi: "Pre-A11-traceability ổn nếu emergency boundary không thay thế emergency services.",
    readiness_signal_en: "Pre-A11-traceability is stable if emergency boundary does not replace emergency services.",
  ...
  {
    id: "pa-ca-traceability-service-recovery-011",
    ...
    traceability_note_vi: "Evidence Receipt traceability có repair phrase, written next step, và polite follow-up.",
    traceability_note_en: "The evidence receipt traceability has repair phrase, written next step, and polite follow-up.",
    readiness_signal_vi: "Completion Record ổn nếu service recovery giúp learner không im lặng.",
    readiness_signal_en: "Completion Record is stable if service recovery helps the learner avoid silence.",
  ...
  {
    id: "pa-ca-traceability-workplace-012",
    ...
    traceability_note_vi: "Pre-integration traceability đóng gói safety issue, supervisor handoff, và written report step.",
    traceability_note_en: "The pre-integration traceability packages safety issue, supervisor handoff, and written report step.",
    readiness_signal_vi: "Pre-A11-traceability ổn nếu workplace task không chuyển thành claim guidance.",
    readiness_signal_en: "Pre-A11-traceability is stable if the workplace task does not become claim guidance.",
...
export default PUNJABI_CANADA_SURVIVAL_TRACEABILITY_SAMPLES;
