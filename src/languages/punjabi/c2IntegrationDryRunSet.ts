// Punjabi C2 integration dry run set for Vietnamese- and English-speaking learners.
// Gurmukhi is primary; romanization is a reading aid.
//
// Scope/status: study-support dry-run selectors only, not certification,
...
export type PunjabiC2DryRunFocus =
...
export type PunjabiC2DryRunStyle = "dry_run" | "pre_integration" | "final_readiness" | "regression";

export type PunjabiC2DryRunPhrase = {
  gurmukhi: string;
  romanization: string;
  vi: string;
  en: string;
...
export type PunjabiC2DryRunCheck = {
  check_vi: string;
  check_en: string;
  signal_vi: string;
  signal_en: string;
...
export type PunjabiC2DryRunTrap = {
  trap_vi: string;
  trap_en: string;
  repair_vi: string;
  repair_en: string;
...
export type PunjabiC2IntegrationDryRunItem = {
  id: string;
  focus: PunjabiC2DryRunFocus;
  style: PunjabiC2DryRunStyle;
  title_vi: string;
  title_en: string;
  scenario_vi: string;
  scenario_en: string;
  ...
  sample_vi: string;
  sample_en: string;
  dry_run_phrases: PunjabiC2DryRunPhrase[];
  checks: PunjabiC2DryRunCheck[];
  learner_trap?: PunjabiC2DryRunTrap;
  canada_practical?: boolean;
};

export const C2_INTEGRATION_DRY_RUN_SET_DISCLAIMER = {
  vi: "Bộ dry-run tích hợp Punjabi C2 này chỉ hỗ trợ học tập, không phải chứng nhận hay xếp lớp chính thức. Gurmukhi là chính; phiên âm chỉ giúp đọc. Thẩm định bản xứ được hoãn lại. Shahmukhi chỉ được nhắc để nhận biết hệ chữ.",
  en: "This C2 Punjabi integration dry-run set supports study only, not certification or official placement. Gurmukhi is primary; romanization only supports reading. Native review is deferred. Shahmukhi is noted only for script awareness.",
} as const;

export const c2IntegrationDryRunSet: PunjabiC2IntegrationDryRunItem[] = [
  {
    id: "pa_c2_dryrun_nuanced_disagreement",
    focus: "nuanced_disagreement",
    style: "dry_run",
    title_vi: "Dry-run cho bất đồng tinh tế",
    title_en: "Dry-run for nuanced disagreement",
    scenario_vi: "Bạn đồng ý với mục tiêu chung nhưng còn một điểm chưa rõ.",
    scenario_en: "You agree with the shared goal but still have one unclear point.",
    dry_run_goal_vi: "Giữ công nhận trước rồi mới góp ý.",
    dry_run_goal_en: "Keep validation first and critique second.",
    sample_gurmukhi:
      "ਮੈਂ ਮੁੱਢਲੇ ਮਕਸਦ ਨਾਲ ਸਹਿਮਤ ਹਾਂ, ਪਰ ਡਾਟੇ ਨੂੰ ਇੱਕ ਵਾਰੀ ਹੋਰ ਵੇਖਣਾ ਚਾਹੀਦਾ ਹੈ।",
    sample_romanization:
      "main muddle maqsad naal sahimat haan, par date nu ikk vari hor vekhna chahida hai.",
    sample_vi:
      "Tôi đồng ý với mục tiêu chính, nhưng dữ liệu nên được xem lại một lần nữa.",
    sample_en:
      "I agree with the main goal, but the data should be reviewed once more.",
    dry_run_phrases: [
      {
  ...
  {
    id: "pa_c2_dryrun_audience_adaptation_canada",
    ...
    dry_run_goal_vi: "Giữ ý chính nhưng đổi mức lịch sự cho phù hợp.",
    dry_run_goal_en: "Keep the core message while adjusting politeness to fit.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_dryrun_mediation",
    focus: "mediation",
    style: "dry_run",
    title_vi: "Dry-run cho trung gian không thiên vị",
    title_en: "Dry-run for neutral mediation",
    ...
    dry_run_goal_vi: "Giữ hai phía song song rồi quay về tiêu chí chung.",
    dry_run_goal_en: "Keep both sides parallel and return to shared criteria.",
    sample_gurmukhi:
  ...
  },
  {
    ...
    dry_run_goal_vi: "Chọn câu đưa cuộc họp về quy trình thay vì cảm xúc.",
    dry_run_goal_en: "Choose wording that returns the meeting to process instead of emotion.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_dryrun_register_safety",
    focus: "advanced_register",
    style: "pre_integration",
    title_vi: "An toàn đăng ký nâng cao",
    title_en: "Advanced register safety",
    ...
    dry_run_goal_vi: "Giữ lịch sự, rõ ý, và đủ ấm.",
    dry_run_goal_en: "Keep it polite, clear, and warm enough.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_dryrun_public_communication",
    ...
    dry_run_goal_vi: "Giữ cùng giọng, cùng mức lịch sự, và cùng ý chính.",
    dry_run_goal_en: "Keep the same tone, the same politeness level, and the same main point.",
    sample_gurmukhi:
  ...
  },
  {
    ...
    dry_run_goal_vi: "Từ chối mềm, có cảm ơn, và mở khả năng sau.",
    dry_run_goal_en: "Decline softly with thanks and a future opening.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_dryrun_sensitive_topics",
    focus: "sensitive_topic_framing",
    style: "dry_run",
    title_vi: "Dry-run cho chủ đề nhạy cảm",
    title_en: "Dry-run for sensitive-topic framing",
    ...
    dry_run_goal_vi: "Nhận ra độ nhạy cảm rồi kéo lại phần liên quan đến nhiệm vụ.",
    dry_run_goal_en: "Recognize the sensitivity and bring the discussion back to the task part.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_dryrun_community_discourse",
    focus: "community_discourse",
    style: "dry_run",
    title_vi: "Dry-run cho nói chuyện cộng đồng",
    title_en: "Dry-run for community discourse",
    ...
    dry_run_goal_vi: "Mời chọn việc theo thời gian, kỹ năng, và mức thoải mái.",
    dry_run_goal_en: "Invite choices based on availability, skill, and comfort.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_dryrun_professional_discourse",
    focus: "professional_discourse",
    style: "pre_integration",
    title_vi: "Dry-run góp ý chuyên nghiệp",
    title_en: "Dry-run for professional feedback",
    ...
    dry_run_goal_vi: "Công nhận nỗ lực, nêu điểm cần chỉnh, rồi đưa hướng tiếp.",
    dry_run_goal_en: "Acknowledge effort, name the adjustment, then give the next step.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_dryrun_public_service",
    ...
    dry_run_goal_vi: "Nói theo quy trình: cái có, cái cần, và bước kế tiếp.",
    dry_run_goal_en: "Follow the process: what you have, what you need, and the next step.",
    sample_gurmukhi:
...
export const c2IntegrationDryRunSetByFocus = (
  focus: PunjabiC2DryRunFocus,
): PunjabiC2IntegrationDryRunItem[] => c2IntegrationDryRunSet.filter((item) => item.focus === focus);
