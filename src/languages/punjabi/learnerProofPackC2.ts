// Punjabi C2 learner-proof statements for Vietnamese- and English-speaking learners.
...
export type PunjabiC2LearnerProofPackFocus =
...
export type PunjabiC2LearnerProofPackEvidence = "spoken" | "written" | "mediation" | "checkpoint";

export type PunjabiC2LearnerProofPackStatus = "ready" | "near_ready" | "needs_practice";

export type PunjabiC2LearnerProofPackPhrase = {
  gurmukhi: string;
  romanization: string;
  vi: string;
  en: string;
...
export type PunjabiC2LearnerProofPackCheckpoint = {
  can_do_vi: string;
  can_do_en: string;
  evidence_vi: string;
  evidence_en: string;
...
export type PunjabiC2LearnerProofPackTrap = {
  trap_vi: string;
  trap_en: string;
  better_vi: string;
  better_en: string;
...
export type PunjabiC2LearnerProofPackReadiness = {
  self_check_vi: string;
  self_check_en: string;
  ready_signal_vi: string;
  ready_signal_en: string;
  status_if_missing: PunjabiC2LearnerProofPackStatus;
};

export type PunjabiC2LearnerProofPackStatement = {
  id: string;
  focus: PunjabiC2LearnerProofPackFocus;
  evidence_type: PunjabiC2LearnerProofPackEvidence;
  title_vi: string;
  title_en: string;
  statement_vi: string;
  statement_en: string;
  ...
  sample_phrases: PunjabiC2LearnerProofPackPhrase[];
  model_gurmukhi: string;
  model_romanization: string;
  model_vi: string;
  model_en: string;
  checkpoints: PunjabiC2LearnerProofPackCheckpoint[];
  readiness: PunjabiC2LearnerProofPackReadiness;
  learner_trap?: PunjabiC2LearnerProofPackTrap;
  canada_practical?: boolean;
};

export const C2_LEARNER_PROOF_PACK_STATEMENTS_DISCLAIMER = {
  ...
  en: "These C2 Punjabi learner-proof statements support self-study only, not certification or official placement. Gurmukhi is primary; romanization only supports reading. Native review is deferred. Shahmukhi is noted only for script awareness.",
} as const;

export const LearnerProofPackStatementsC2: PunjabiC2LearnerProofPackStatement[] = [
  {
...
export const LearnerProofPackStatementsC2ByFocus = (
  focus: PunjabiC2LearnerProofPackFocus,
): PunjabiC2LearnerProofPackStatement[] =>
  LearnerProofPackStatementsC2.filter((statement) => statement.focus === focus);
