// Punjabi Canada survival owner-acceptance samples for Vietnamese-speaking
...
export type PunjabiCanadaSurvivalOwnerAcceptanceDomain =
  | "clinic"
  | "pharmacy"
  | "school_childcare"
  | "bank"
...
export type PunjabiCanadaSurvivalOwnerAcceptanceUse =
  | "owner_acceptance"
  | "final_acceptance"
  | "ship_candidate"
  | "pre_integration";

export type PunjabiCanadaSurvivalOwnerAcceptanceItem = {
  id: string;
  domain: PunjabiCanadaSurvivalOwnerAcceptanceDomain;
  use: PunjabiCanadaSurvivalOwnerAcceptanceUse;
  ...
  meaning_en: string;
  support_pa: string[];
  owner_acceptance_check_vi: string;
  owner_acceptance_check_en: string;
...
export type PunjabiCanadaSurvivalOwnerAcceptanceScope = {
  name: string;
  audience: string[];
  scriptPolicy: string;
  reviewStatus: string;
...
export const PUNJABI_CANADA_SURVIVAL_OWNER_ACCEPTANCE_SCOPE: PunjabiCanadaSurvivalOwnerAcceptanceScope = {
  name: "Punjabi Canada Survival Owner Acceptance Samples",
  ...
  boundaries: [
    "Language support only for Canada survival owner-acceptance samples.",
    "No medical, legal, financial, tenancy, or workplace safety advice.",
  ],
};

export const PUNJABI_CANADA_SURVIVAL_OWNER_ACCEPTANCE_SAMPLES: PunjabiCanadaSurvivalOwnerAcceptanceItem[] = [
  {
    id: "pa-ca-owneracceptance-clinic-001",
    domain: "clinic",
    use: "owner_acceptance",
    owner_acceptance_vi: "Đóng kiểm câu phòng khám khi người học cần xin giải thích chậm trước khi trả lời.",
    owner_acceptance_en: "Close-check the clinic line when the learner needs slower explanation before answering.",
    ...
    owner_acceptance_check_vi: "Owner Acceptance giữ câu ở mức hỗ trợ ngôn ngữ, không đưa lời khuyên y tế.",
    owner_acceptance_check_en: "Owner Acceptance keeps this as language support, not medical advice.",
  ...
  {
    id: "pa-ca-owneracceptance-pharmacy-002",
    domain: "pharmacy",
    use: "final_acceptance",
    owner_acceptance_vi: "Đóng kiểm câu nhà thuốc để người học nêu dị ứng và xin ghi lại thông tin.",
    owner_acceptance_en: "Close-check the pharmacy line so the learner can state an allergy and ask for writing.",
    ...
    owner_acceptance_check_vi: "Final-acceptance xác nhận câu không thêm liều lượng hoặc hướng dẫn thuốc.",
    owner_acceptance_check_en: "The final acceptance confirms the line does not add dosage or medicine instructions.",
  ...
  {
    id: "pa-ca-owneracceptance-school-003",
    domain: "school_childcare",
    use: "pre_integration",
    owner_acceptance_vi: "Đóng kiểm câu form dùng được cho trường và childcare khi người học bị kẹt.",
    owner_acceptance_en: "Close-check the form line for school and childcare when the learner is stuck.",
    ...
    owner_acceptance_check_vi: "Pre-integration xác nhận câu nối được với trường, childcare, và form.",
    owner_acceptance_check_en: "Pre-integration confirms the line connects to school, childcare, and form flows.",
  ...
  {
    id: "pa-ca-owneracceptance-bank-004",
    domain: "bank",
    use: "ship_candidate",
    owner_acceptance_vi: "Đóng kiểm câu ngân hàng giữ mục tiêu mở tài khoản và hỏi phí.",
    owner_acceptance_en: "Close-check the bank line so it keeps the account-opening and fee goal.",
    ...
    owner_acceptance_check_vi: "Ship-candidate xác nhận câu không trôi sang thẻ, vay, hoặc lời khuyên tiền bạc.",
    owner_acceptance_check_en: "The ship candidate check confirms the line does not drift to cards, loans, or money advice.",
  ...
  {
    id: "pa-ca-owneracceptance-housing-005",
    domain: "housing",
    use: "owner_acceptance",
    owner_acceptance_vi: "Đóng kiểm câu nhà thuê khi cần thời gian sửa và phản hồi bằng văn bản.",
    owner_acceptance_en: "Close-check the rental line when repair timing and a written reply are needed.",
    ...
    owner_acceptance_check_vi: "Owner Acceptance không biến câu sửa chữa thành tư vấn luật thuê nhà.",
    owner_acceptance_check_en: "Owner Acceptance does not turn the repair line into tenancy advice.",
  ...
  {
    id: "pa-ca-owneracceptance-transport-006",
    domain: "transport",
    use: "pre_integration",
    owner_acceptance_vi: "Đóng kiểm câu giao thông khi người học cần hỏi tuyến xe và điểm xuống.",
    owner_acceptance_en: "Close-check the transport line when the learner needs route and stop confirmation.",
    ...
    owner_acceptance_check_vi: "Pre-integration xác nhận câu nối được với phần chỉ đường và lịch trình.",
    owner_acceptance_check_en: "Pre-integration confirms the line connects to directions and schedule content.",
  ...
  {
    id: "pa-ca-owneracceptance-public-office-007",
    domain: "public_office",
    use: "final_acceptance",
    owner_acceptance_vi: "Đóng kiểm câu cơ quan công khi người học cần biết quầy và giấy tờ.",
    owner_acceptance_en: "Close-check the public-office line when the learner needs the right counter and documents.",
    ...
    owner_acceptance_check_vi: "Final-acceptance xác nhận câu nối được với form và quầy dịch vụ.",
    owner_acceptance_check_en: "The final acceptance confirms the line connects to form and service-counter flows.",
  ...
  {
    id: "pa-ca-owneracceptance-forms-008",
    domain: "forms_service_desk",
    use: "owner_acceptance",
    owner_acceptance_vi: "Đóng kiểm câu bàn dịch vụ khi người học cần chỉ phần form chưa hiểu.",
    owner_acceptance_en: "Close-check the service-desk line when the learner needs to show the unclear form section.",
    ...
    owner_acceptance_check_vi: "Owner Acceptance xác nhận câu form đủ rõ trước khi ghép vào luồng cuối.",
    owner_acceptance_check_en: "Owner Acceptance confirms the form line is clear before final flow linking.",
  ...
  {
    id: "pa-ca-owneracceptance-interpreter-009",
    domain: "interpreter_request",
    use: "ship_candidate",
    owner_acceptance_vi: "Đóng kiểm câu xin thông dịch viên khi tình huống vượt quá mức hiểu.",
    owner_acceptance_en: "Close-check the interpreter request when the situation exceeds the learner's understanding.",
    ...
    owner_acceptance_check_vi: "Ship-candidate xác nhận Shahmukhi chỉ là nhận biết, không phải khóa học đầy đủ.",
    owner_acceptance_check_en: "The ship candidate check confirms Shahmukhi is awareness only, not a full course.",
  ...
  {
    id: "pa-ca-owneracceptance-emergency-010",
    domain: "emergency_boundary",
    use: "final_acceptance",
    owner_acceptance_vi: "Đóng kiểm câu khẩn cấp khi có nguy hiểm thật sự và cần gọi 911.",
    owner_acceptance_en: "Close-check the emergency line when there is real danger and 911 is needed.",
    ...
    owner_acceptance_check_vi: "Final-acceptance giữ câu khẩn cấp rõ và không thay thế dịch vụ khẩn cấp.",
    owner_acceptance_check_en: "The final acceptance keeps the emergency line clear and does not replace emergency services.",
  ...
  {
    id: "pa-ca-owneracceptance-recovery-011",
    domain: "service_recovery",
    use: "owner_acceptance",
    owner_acceptance_vi: "Đóng kiểm câu phục hồi dịch vụ khi thông tin sai hoặc chưa khớp.",
    owner_acceptance_en: "Close-check the service-recovery line when information is wrong or does not match.",
    ...
    owner_acceptance_check_vi: "Owner Acceptance xác nhận câu sửa lỗi vẫn lịch sự và thực tế.",
    owner_acceptance_check_en: "Owner Acceptance confirms the correction line stays polite and practical.",
  ...
  {
    id: "pa-ca-owneracceptance-workplace-012",
    domain: "workplace_safety",
    use: "pre_integration",
    owner_acceptance_vi: "Đóng kiểm câu nơi làm việc khi người học chưa hiểu hướng dẫn an toàn.",
    owner_acceptance_en: "Close-check the workplace line when the learner did not understand a safety instruction.",
    ...
    owner_acceptance_check_vi: "Pre-integration giữ câu ở mức xin làm rõ ngôn ngữ, không đưa hướng dẫn kỹ thuật.",
    owner_acceptance_check_en: "Pre-integration keeps this as language clarification, not technical instruction.",
...
export default PUNJABI_CANADA_SURVIVAL_OWNER_ACCEPTANCE_SAMPLES;
