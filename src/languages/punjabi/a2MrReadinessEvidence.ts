// src/languages/punjabi/a2MrReadinessEvidence.ts
//
// Punjabi A2 MR-readiness evidence for Vietnamese-speaking and English-speaking
...
export type PunjabiA2MrReadinessScenario =
  | "daily_routine"
  | "appointments"
  | "transport"
  | "housing"
...
export type PunjabiA2MrReadinessStyle =
  | "mr_readiness"
  | "final_freeze"
  | "final_lock"
  | "pre_integration";

export type PunjabiA2MrReadinessLine = {
  pa: string;
  romanization: string;
  vi: string;
  en: string;
...
export type PunjabiA2MrReadinessTrap = {
  trap_vi: string;
  trap_en: string;
  fix_pa: string;
...
export type PunjabiA2MrReadinessItem = {
  id: string;
  scenario: PunjabiA2MrReadinessScenario;
  style: PunjabiA2MrReadinessStyle;
  title_vi: string;
  title_en: string;
  evidence_goal_vi: string;
  evidence_goal_en: string;
  mr_ready_signal_vi: string;
  mr_ready_signal_en: string;
  ...
  lines: PunjabiA2MrReadinessLine[];
  checks: {
    q_vi: string;
    q_en: string;
    answer_pa: string;
  ...
  traps: PunjabiA2MrReadinessTrap[];
};

const scriptAwarenessVi =
  "Gurmukhi là chữ chính trong MR-readiness evidence; Shahmukhi chỉ được nhắc để nhận biết, không phải khóa riêng.";
const scriptAwarenessEn =
  "Gurmukhi is the main script in this MR-readiness evidence; Shahmukhi is mentioned only for awareness, not as a separate course.";

const returnSignalVi = "Trả lại nếu thiếu dữ kiện chính hoặc đổi ý giữa các câu.";
const returnSignalEn = "Return if a key detail is missing or the meaning changes between lines.";

export const a2MrReadinessEvidence: PunjabiA2MrReadinessItem[] = [
  {
    id: "pa_a2_mr_daily_routine",
    scenario: "daily_routine",
    style: "mr_readiness",
    title_vi: "MR-readiness: thói quen hằng ngày",
    title_en: "MR-readiness: daily routine",
    evidence_goal_vi: "Chứng minh giờ, thói quen sáng, và một câu quá khứ ngắn đã ổn định.",
    evidence_goal_en: "Prove time, morning routine, and one short past sentence are stable.",
    mr_ready_signal_vi: "MR-ready nếu giờ thức dậy và giờ ra khỏi nhà không bị lẫn.",
    mr_ready_signal_en: "MR-ready if wake-up and leaving-home times are not confused.",
    return_signal_vi: returnSignalVi,
    return_signal_en: returnSignalEn,
  ...
  {
    id: "pa_a2_mr_appointments",
    scenario: "appointments",
    style: "final_freeze",
    title_vi: "Final-freeze evidence: lịch hẹn",
    title_en: "Final-freeze evidence: appointments",
    evidence_goal_vi: "Chứng minh lịch, giấy tờ, và câu đổi lịch nếu cần đều giữ nguyên.",
    evidence_goal_en: "Prove appointment, documents, and optional reschedule sentence stay intact.",
    mr_ready_signal_vi: "MR-ready nếu lịch hiện tại và đồ cần mang đều có.",
    mr_ready_signal_en: "MR-ready if current appointment and items to bring are both present.",
    return_signal_vi: returnSignalVi,
    return_signal_en: returnSignalEn,
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  {
    id: "pa_a2_mr_transport",
    scenario: "transport",
    style: "pre_integration",
    title_vi: "Pre-integration evidence: đi lại",
    title_en: "Pre-integration evidence: transport",
    evidence_goal_vi: "Chứng minh tuyến, điểm xuống, và báo trễ nhất quán.",
    evidence_goal_en: "Prove route, stop, and delay notice are consistent.",
    mr_ready_signal_vi: "MR-ready nếu điểm đến, điểm xuống, và thời lượng trễ đều rõ.",
    mr_ready_signal_en: "MR-ready if destination, stop, and delay length are all clear.",
    return_signal_vi: returnSignalVi,
    return_signal_en: returnSignalEn,
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  },
  {
    ...
    evidence_goal_vi: "Chứng minh opener lịch sự, sự cố, thời điểm, và yêu cầu sửa đầy đủ.",
    evidence_goal_en: "Prove polite opener, problem, timing, and repair request are complete.",
    mr_ready_signal_vi: "MR-ready nếu sự cố giữ nguyên từ mô tả đến yêu cầu.",
    mr_ready_signal_en: "MR-ready if the problem stays the same from description to request.",
    return_signal_vi: returnSignalVi,
    return_signal_en: returnSignalEn,
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  },
  {
    ...
    scenario: "school",
    style: "final_lock",
    title_vi: "Final-lock evidence: trường học",
    title_en: "Final-lock evidence: school",
    evidence_goal_vi: "Chứng minh vắng học, lý do, và yêu cầu homework rõ.",
    evidence_goal_en: "Prove absence, reason, and homework request are clear.",
    mr_ready_signal_vi: "MR-ready nếu người bị bệnh là trẻ và yêu cầu gửi bài rõ.",
    mr_ready_signal_en: "MR-ready if the sick person is the child and the work request is clear.",
    return_signal_vi: returnSignalVi,
    return_signal_en: returnSignalEn,
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  {
    id: "pa_a2_mr_childcare",
    scenario: "childcare",
    style: "final_freeze",
    title_vi: "Final-freeze evidence: childcare pickup",
    title_en: "Final-freeze evidence: childcare pickup",
    evidence_goal_vi: "Chứng minh người đón thay, thời gian, và pickup list rõ.",
    evidence_goal_en: "Prove alternate pickup person, time, and pickup list are clear.",
    mr_ready_signal_vi: "MR-ready nếu tên người đón và list khớp.",
    mr_ready_signal_en: "MR-ready if pickup name and list match.",
    return_signal_vi: returnSignalVi,
    return_signal_en: returnSignalEn,
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  {
    id: "pa_a2_mr_workplace_small_talk",
    scenario: "workplace_small_talk",
    style: "mr_readiness",
    title_vi: "MR-readiness: small talk nơi làm",
    title_en: "MR-readiness: workplace small talk",
    evidence_goal_vi: "Chứng minh chào hỏi, trả lời ngắn, và chuyển sang nhiệm vụ rõ.",
    evidence_goal_en: "Prove greeting, short reply, and task transition are clear.",
    mr_ready_signal_vi: "MR-ready nếu small talk lịch sự và task rõ.",
    mr_ready_signal_en: "MR-ready if small talk is polite and the task is clear.",
    return_signal_vi: returnSignalVi,
    return_signal_en: returnSignalEn,
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  },
  {
    ...
    scenario: "forms",
    style: "final_lock",
    title_vi: "Final-lock evidence: forms",
    title_en: "Final-lock evidence: forms",
    evidence_goal_vi: "Chứng minh tên, địa chỉ, và giấy tờ thiếu giữ nguyên.",
    evidence_goal_en: "Prove name, address, and missing document stay consistent.",
    mr_ready_signal_vi: "MR-ready nếu các field form không đổi giữa các câu.",
    mr_ready_signal_en: "MR-ready if form fields stay consistent across lines.",
    return_signal_vi: returnSignalVi,
    return_signal_en: returnSignalEn,
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  {
    id: "pa_a2_mr_short_messages",
    scenario: "short_messages",
    style: "pre_integration",
    title_vi: "Pre-integration evidence: tin nhắn ngắn",
    title_en: "Pre-integration evidence: short messages",
    evidence_goal_vi: "Chứng minh giờ, nơi, và vật cần mang được tách đúng.",
    evidence_goal_en: "Prove time, place, and item to bring are extracted correctly.",
    mr_ready_signal_vi: "MR-ready nếu giữ đủ thời gian, địa điểm, và vật cần mang.",
    mr_ready_signal_en: "MR-ready if time, place, and item to bring are all kept.",
    return_signal_vi: returnSignalVi,
    return_signal_en: returnSignalEn,
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  {
    id: "pa_a2_mr_service_flow",
    scenario: "service_flow",
    style: "final_freeze",
    title_vi: "Final-freeze evidence: luồng dịch vụ",
    title_en: "Final-freeze evidence: service flow",
    evidence_goal_vi: "Chứng minh opener, nhu cầu, và câu hỏi giấy tờ đầy đủ.",
    evidence_goal_en: "Prove opener, need, and document question are complete.",
    mr_ready_signal_vi: "MR-ready nếu nhu cầu và câu hỏi giấy tờ nối nhau rõ.",
    mr_ready_signal_en: "MR-ready if the need and document question clearly connect.",
    return_signal_vi: returnSignalVi,
    return_signal_en: returnSignalEn,
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  },
  {
    ...
    evidence_goal_vi: "Chứng minh opener lịch sự, vấn đề, và câu hỏi bước tiếp theo rõ.",
    evidence_goal_en: "Prove polite opener, problem, and next-step question are clear.",
    mr_ready_signal_vi: "MR-ready nếu vấn đề được nêu và được yêu cầu kiểm tra rõ.",
    mr_ready_signal_en: "MR-ready if the problem is stated and clearly requested for checking.",
    return_signal_vi: returnSignalVi,
    return_signal_en: returnSignalEn,
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
  ...
  {
    id: "pa_a2_mr_interaction_repair",
    scenario: "interaction_repair",
    style: "pre_integration",
    title_vi: "Pre-integration evidence: sửa chữa tương tác",
    title_en: "Pre-integration evidence: interaction repair",
    evidence_goal_vi: "Chứng minh báo chưa hiểu, xin nhắc lại, và xác nhận nghĩa đầy đủ.",
    evidence_goal_en: "Prove non-understanding signal, repetition request, and meaning confirmation are complete.",
    mr_ready_signal_vi: "MR-ready nếu có đủ ba bước repair.",
    mr_ready_signal_en: "MR-ready if all three repair steps are present.",
    return_signal_vi: returnSignalVi,
    return_signal_en: returnSignalEn,
    script_awareness_vi: scriptAwarenessVi,
    script_awareness_en: scriptAwarenessEn,
