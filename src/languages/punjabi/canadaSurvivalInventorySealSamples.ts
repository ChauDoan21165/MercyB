// Punjabi Canada survival inventory seal samples for Vietnamese-speaking and
...
export type PunjabiCanadaSurvivalInventorySealDomain =
  | "clinic"
  | "pharmacy"
  | "school_childcare"
  | "bank"
...
export type PunjabiCanadaSurvivalInventorySealCheck =
  | "pre_a11_inventory_seal"
  | "catalog"
  | "bundle"
  | "pre_integration";

export type PunjabiCanadaSurvivalInventorySealSample = {
  id: string;
  domain: PunjabiCanadaSurvivalInventorySealDomain;
  check: PunjabiCanadaSurvivalInventorySealCheck;
  phrase_pa: string;
  romanization: string;
  meaning_vi: string;
  meaning_en: string;
  ...
  inventorySeal_note_vi: string;
  inventorySeal_note_en: string;
...
export type PunjabiCanadaSurvivalInventorySealScope = {
  name: string;
  audience: string[];
  scriptPolicy: string;
  reviewStatus: string;
  inventorySealBoundary: string;
};

export const PUNJABI_CANADA_SURVIVAL_INVENTORY_SEAL_SCOPE: PunjabiCanadaSurvivalInventorySealScope = {
  name: "Punjabi Canada Survival Inventory Seal Samples",
  ...
  inventorySealBoundary:
    "Pre-A11-inventory-seal, catalog, bundle, and pre-integration content samples for Canadian survival communication; not A11 integration, not legal advice, not medical advice, and not financial advice.",
};

export const PUNJABI_CANADA_SURVIVAL_INVENTORY_SEAL_DOMAINS: PunjabiCanadaSurvivalInventorySealDomain[] = [
  "clinic",
  "pharmacy",
  "school_childcare",
  "bank",
...
export const PUNJABI_CANADA_SURVIVAL_INVENTORY_SEAL_SAMPLES: PunjabiCanadaSurvivalInventorySealSample[] = [
  {
    id: "pa-ca-inventory-seal-clinic-001",
    domain: "clinic",
    check: "pre_a11_inventory_seal",
    ...
    inventorySeal_note_vi: "Pre-A11-inventory-seal giữ phrase, repair request, và next-step handoff mà không tích hợp A11.",
    inventorySeal_note_en: "The pre-A11-inventorySeal keeps phrase, repair request, and next-step handoff without A11 integration.",
    readiness_signal_vi: "Bundle ổn nếu có Gurmukhi, romanization, Vietnamese, English, và clinic context.",
    readiness_signal_en: "Bundle is stable if it has Gurmukhi, romanization, Vietnamese, English, and clinic context.",
  ...
  {
    id: "pa-ca-inventory-seal-pharmacy-002",
    domain: "pharmacy",
    check: "bundle",
    ...
    inventorySeal_note_vi: "Bundle sample chứng minh pharmacy content không tự đưa liều hoặc chẩn đoán.",
    inventorySeal_note_en: "The bundle sample proves pharmacy content does not provide dose or diagnosis.",
    readiness_signal_vi: "Catalog ổn nếu learner xin pharmacist viết số lần/ngày thay vì đoán.",
    readiness_signal_en: "Catalog is stable if the learner asks the pharmacist to write times per day instead of guessing.",
  ...
  {
    id: "pa-ca-inventory-seal-school-childcare-003",
    ...
    inventorySeal_note_vi: "Catalog inventorySeal đóng gói child, date, action, và optional pickup detail.",
    inventorySeal_note_en: "The catalog inventorySeal packages child, date, action, and optional pickup detail.",
  ...
  {
    id: "pa-ca-inventory-seal-bank-004",
    domain: "bank",
    check: "pre_a11_inventory_seal",
    ...
    inventorySeal_note_vi: "Pre-A11-inventory-seal giữ bank sample ở mức service information, không khuyến nghị sản phẩm.",
    inventorySeal_note_en: "The pre-A11-inventorySeal keeps the bank sample at service information level, not product recommendation.",
    readiness_signal_vi: "Bundle ổn nếu fee request và financial boundary đều có mặt.",
    readiness_signal_en: "Bundle is stable if fee request and financial boundary are both present.",
  ...
  {
    id: "pa-ca-inventory-seal-housing-005",
    domain: "housing",
    ...
    inventorySeal_note_vi: "Pre-integration inventorySeal có unit, issue, repair time, và written confirmation.",
    inventorySeal_note_en: "The pre-integration inventorySeal has unit, issue, repair time, and written confirmation.",
    readiness_signal_vi: "Catalog ổn nếu housing task không chuyển thành tenancy advice.",
    readiness_signal_en: "Catalog is stable if the housing task does not become tenancy advice.",
  ...
  {
    id: "pa-ca-inventory-seal-transport-006",
    domain: "transport",
    check: "bundle",
    ...
    inventorySeal_note_vi: "Bundle inventorySeal có route, direction, transfer, và delay repair line.",
    inventorySeal_note_en: "The bundle inventorySeal has route, direction, transfer, and delay repair line.",
    readiness_signal_vi: "Pre-A11-inventory-seal ổn nếu transport content dùng transit/bus nhưng không hứa schedule.",
    readiness_signal_en: "Pre-A11-inventory-seal is stable if transport content uses transit/bus but does not promise schedule.",
  ...
  {
    id: "pa-ca-inventory-seal-public-office-007",
    ...
    inventorySeal_note_vi: "Catalog inventorySeal đóng gói counter, documents, checklist, và next step.",
    inventorySeal_note_en: "The catalog inventorySeal packages counter, documents, checklist, and next step.",
    readiness_signal_vi: "Bundle ổn nếu public office flow không thành legal advice.",
    readiness_signal_en: "Bundle is stable if public office flow does not become legal advice.",
  ...
  {
    id: "pa-ca-inventory-seal-forms-008",
    domain: "forms",
    check: "pre_a11_inventory_seal",
    ...
    inventorySeal_note_vi: "Pre-A11-inventory-seal sample chứng minh forms coverage, correction request, và official-process boundary.",
    inventorySeal_note_en: "The pre-A11-inventorySeal sample proves forms coverage, correction request, and official-process boundary.",
  ...
  {
    id: "pa-ca-inventory-seal-interpreter-009",
    ...
    inventorySeal_note_vi: "Pre-integration inventorySeal đóng gói pause line, interpreter request, và no-signing-until-clear boundary.",
    inventorySeal_note_en: "The pre-integration inventorySeal packages pause line, interpreter request, and no-signing-until-clear boundary.",
    readiness_signal_vi: "Bundle ổn nếu interpreter request chỉ là language support, không phải professional decision.",
    readiness_signal_en: "Bundle is stable if interpreter request is language support, not professional decision.",
  ...
  {
    id: "pa-ca-inventory-seal-emergency-010",
    ...
    inventorySeal_note_vi: "Bundle inventorySeal có immediate need, address, service type, và interpreter option.",
    inventorySeal_note_en: "The bundle inventorySeal has immediate need, address, service type, and interpreter option.",
    readiness_signal_vi: "Pre-A11-inventory-seal ổn nếu emergency boundary không thay thế emergency services.",
    readiness_signal_en: "Pre-A11-inventory-seal is stable if emergency boundary does not replace emergency services.",
  ...
  {
    id: "pa-ca-inventory-seal-service-recovery-011",
    ...
    inventorySeal_note_vi: "Catalog inventorySeal có repair phrase, written next step, và polite follow-up.",
    inventorySeal_note_en: "The catalog inventorySeal has repair phrase, written next step, and polite follow-up.",
    readiness_signal_vi: "Bundle ổn nếu service recovery giúp learner không im lặng.",
    readiness_signal_en: "Bundle is stable if service recovery helps the learner avoid silence.",
  ...
  {
    id: "pa-ca-inventory-seal-workplace-012",
    ...
    inventorySeal_note_vi: "Pre-integration inventorySeal đóng gói safety issue, supervisor handoff, và written report step.",
    inventorySeal_note_en: "The pre-integration inventorySeal packages safety issue, supervisor handoff, and written report step.",
    readiness_signal_vi: "Pre-A11-inventory-seal ổn nếu workplace task không chuyển thành claim guidance.",
    readiness_signal_en: "Pre-A11-inventory-seal is stable if the workplace task does not become claim guidance.",
...
export default PUNJABI_CANADA_SURVIVAL_INVENTORY_SEAL_SAMPLES;
