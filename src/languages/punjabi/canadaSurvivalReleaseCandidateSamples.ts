// Punjabi Canada survival release-candidate samples for Vietnamese-speaking
...
export type PunjabiCanadaSurvivalReleaseCandidateDomain =
  | "clinic"
  | "pharmacy"
  | "school_childcare"
  | "bank"
...
export type PunjabiCanadaSurvivalReleaseCandidateUse =
  | "release_candidate"
  | "closure_validation"
  | "pre_integration"
  | "handoff_check";

export type PunjabiCanadaSurvivalReleaseCandidateItem = {
  id: string;
  domain: PunjabiCanadaSurvivalReleaseCandidateDomain;
  use: PunjabiCanadaSurvivalReleaseCandidateUse;
  candidate_vi: string;
  candidate_en: string;
  goal_vi: string;
  goal_en: string;
  ...
  meaning_en: string;
  support_pa: string[];
  candidate_check_vi: string;
  candidate_check_en: string;
...
export type PunjabiCanadaSurvivalReleaseCandidateScope = {
  name: string;
  audience: string[];
  scriptPolicy: string;
  reviewStatus: string;
...
export const PUNJABI_CANADA_SURVIVAL_RELEASE_CANDIDATE_SCOPE: PunjabiCanadaSurvivalReleaseCandidateScope = {
  name: "Punjabi Canada Survival Release Candidate Samples",
  ...
  boundaries: [
    "Language support only for Canada survival release-candidate samples.",
    "No medical, legal, financial, tenancy, or workplace safety advice.",
  ],
};

export const PUNJABI_CANADA_SURVIVAL_RELEASE_CANDIDATE_SAMPLES: PunjabiCanadaSurvivalReleaseCandidateItem[] = [
  {
    id: "pa-ca-candidate-clinic-001",
    domain: "clinic",
    use: "release_candidate",
    candidate_vi: "Đóng kiểm câu phòng khám khi người học cần xin giải thích chậm trước khi trả lời.",
    candidate_en: "Close-check the clinic line when the learner needs slower explanation before answering.",
    ...
    candidate_check_vi: "Release-candidate giữ câu ở mức hỗ trợ ngôn ngữ, không đưa lời khuyên y tế.",
    candidate_check_en: "Release candidate keeps this as language support, not medical advice.",
  ...
  {
    id: "pa-ca-candidate-pharmacy-002",
    domain: "pharmacy",
    use: "closure_validation",
    candidate_vi: "Đóng kiểm câu nhà thuốc để người học nêu dị ứng và xin ghi lại thông tin.",
    candidate_en: "Close-check the pharmacy line so the learner can state an allergy and ask for writing.",
    ...
    candidate_check_vi: "Closure-validation xác nhận câu không thêm liều lượng hoặc hướng dẫn thuốc.",
    candidate_check_en: "The closure validation confirms the line does not add dosage or medicine instructions.",
  ...
  {
    id: "pa-ca-candidate-school-003",
    domain: "school_childcare",
    use: "pre_integration",
    candidate_vi: "Đóng kiểm câu form dùng được cho trường và childcare khi người học bị kẹt.",
    candidate_en: "Close-check the form line for school and childcare when the learner is stuck.",
    ...
    candidate_check_vi: "Pre-integration xác nhận câu nối được với trường, childcare, và form.",
    candidate_check_en: "Pre-integration confirms the line connects to school, childcare, and form flows.",
  ...
  {
    id: "pa-ca-candidate-bank-004",
    domain: "bank",
    use: "handoff_check",
    candidate_vi: "Đóng kiểm câu ngân hàng giữ mục tiêu mở tài khoản và hỏi phí.",
    candidate_en: "Close-check the bank line so it keeps the account-opening and fee goal.",
    ...
    candidate_check_vi: "Handoff check xác nhận câu không trôi sang thẻ, vay, hoặc lời khuyên tiền bạc.",
    candidate_check_en: "The handoff check confirms the line does not drift to cards, loans, or money advice.",
  ...
  {
    id: "pa-ca-candidate-housing-005",
    domain: "housing",
    use: "release_candidate",
    candidate_vi: "Đóng kiểm câu nhà thuê khi cần thời gian sửa và phản hồi bằng văn bản.",
    candidate_en: "Close-check the rental line when repair timing and a written reply are needed.",
    ...
    candidate_check_vi: "Release-candidate không biến câu sửa chữa thành tư vấn luật thuê nhà.",
    candidate_check_en: "Release candidate does not turn the repair line into tenancy advice.",
  ...
  {
    id: "pa-ca-candidate-transport-006",
    domain: "transport",
    use: "pre_integration",
    candidate_vi: "Đóng kiểm câu giao thông khi người học cần hỏi tuyến xe và điểm xuống.",
    candidate_en: "Close-check the transport line when the learner needs route and stop confirmation.",
    ...
    candidate_check_vi: "Pre-integration xác nhận câu nối được với phần chỉ đường và lịch trình.",
    candidate_check_en: "Pre-integration confirms the line connects to directions and schedule content.",
  ...
  {
    id: "pa-ca-candidate-public-office-007",
    domain: "public_office",
    use: "closure_validation",
    candidate_vi: "Đóng kiểm câu cơ quan công khi người học cần biết quầy và giấy tờ.",
    candidate_en: "Close-check the public-office line when the learner needs the right counter and documents.",
    ...
    candidate_check_vi: "Closure-validation xác nhận câu nối được với form và quầy dịch vụ.",
    candidate_check_en: "The closure validation confirms the line connects to form and service-counter flows.",
  ...
  {
    id: "pa-ca-candidate-forms-008",
    domain: "forms_service_desk",
    use: "release_candidate",
    candidate_vi: "Đóng kiểm câu bàn dịch vụ khi người học cần chỉ phần form chưa hiểu.",
    candidate_en: "Close-check the service-desk line when the learner needs to show the unclear form section.",
    ...
    candidate_check_vi: "Release-candidate xác nhận câu form đủ rõ trước khi ghép vào luồng cuối.",
    candidate_check_en: "Release candidate confirms the form line is clear before final flow linking.",
  ...
  {
    id: "pa-ca-candidate-interpreter-009",
    domain: "interpreter_request",
    use: "handoff_check",
    candidate_vi: "Đóng kiểm câu xin thông dịch viên khi tình huống vượt quá mức hiểu.",
    candidate_en: "Close-check the interpreter request when the situation exceeds the learner's understanding.",
    ...
    candidate_check_vi: "Handoff check xác nhận Shahmukhi chỉ là nhận biết, không phải khóa học đầy đủ.",
    candidate_check_en: "The handoff check confirms Shahmukhi is awareness only, not a full course.",
  ...
  {
    id: "pa-ca-candidate-emergency-010",
    domain: "emergency_boundary",
    use: "closure_validation",
    candidate_vi: "Đóng kiểm câu khẩn cấp khi có nguy hiểm thật sự và cần gọi 911.",
    candidate_en: "Close-check the emergency line when there is real danger and 911 is needed.",
    ...
    candidate_check_vi: "Closure-validation giữ câu khẩn cấp rõ và không thay thế dịch vụ khẩn cấp.",
    candidate_check_en: "The closure validation keeps the emergency line clear and does not replace emergency services.",
  ...
  {
    id: "pa-ca-candidate-recovery-011",
    domain: "service_recovery",
    use: "release_candidate",
    candidate_vi: "Đóng kiểm câu phục hồi dịch vụ khi thông tin sai hoặc chưa khớp.",
    candidate_en: "Close-check the service-recovery line when information is wrong or does not match.",
    ...
    candidate_check_vi: "Release-candidate xác nhận câu sửa lỗi vẫn lịch sự và thực tế.",
    candidate_check_en: "Release candidate confirms the correction line stays polite and practical.",
  ...
  {
    id: "pa-ca-candidate-workplace-012",
    domain: "workplace_safety",
    use: "pre_integration",
    candidate_vi: "Đóng kiểm câu nơi làm việc khi người học chưa hiểu hướng dẫn an toàn.",
    candidate_en: "Close-check the workplace line when the learner did not understand a safety instruction.",
    ...
    candidate_check_vi: "Pre-integration giữ câu ở mức xin làm rõ ngôn ngữ, không đưa hướng dẫn kỹ thuật.",
    candidate_check_en: "Pre-integration keeps this as language clarification, not technical instruction.",
...
export default PUNJABI_CANADA_SURVIVAL_RELEASE_CANDIDATE_SAMPLES;
