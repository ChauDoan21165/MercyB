// Punjabi A1 final-freeze samples for Vietnamese-speaking and English-speaking learners.
// Gurmukhi is primary; romanization supports recognition. Native review is deferred.

export type PunjabiA1FinalFreezeDomain =
  | "greetings"
  | "identity"
  | "family"
  | "numbers"
...
export type PunjabiA1FinalFreezeStyle =
  | "final_freeze"
  | "final_lock"
  | "owner_acceptance"
  | "final_acceptance"
...
export type PunjabiA1FinalFreezeSample = {
  id: string;
  domain: PunjabiA1FinalFreezeDomain;
  style: PunjabiA1FinalFreezeStyle;
  prompt_vi: string;
  prompt_en: string;
  cue_pa: string;
  romanization?: string;
...
export const finalFreezeScriptAwareness =
  "Gurmukhi is the primary script for this Punjabi A1 final-freeze set. Shahmukhi is awareness only, not a full course track.";

export const punjabiA1FinalFreezeSamples: PunjabiA1FinalFreezeSample[] = [
  {
    id: "pa_a1_final_freeze_greeting_001",
    domain: "greetings",
    style: "final_freeze",
    ...
    final_freeze_check_vi: "Câu chào phải giữ Gurmukhi làm nội dung chính.",
    final_freeze_check_en: "The greeting must keep Gurmukhi as the primary content.",
  ...
  {
    id: "pa_a1_final_freeze_identity_001",
    domain: "identity",
    style: "final_lock",
    ...
    final_freeze_check_vi: "Mẫu ਮੇਰਾ ਨਾਮ ... ਹੈ phải còn nguyên trước khi hỏi lại.",
    final_freeze_check_en: "The ਮੇਰਾ ਨਾਮ ... ਹੈ frame must stay intact before asking back.",
  ...
  {
    id: "pa_a1_final_freeze_family_001",
    domain: "family",
    ...
    final_freeze_check_vi: "Mẫu gia đình phải kiểm tra cả giới thiệu người thân và 'tôi có'.",
    final_freeze_check_en: "The family sample must check both introducing a relative and 'I have'.",
  ...
  {
    id: "pa_a1_final_freeze_numbers_001",
    domain: "numbers",
    ...
    final_freeze_check_vi: "Số phải đọc được bằng Gurmukhi trước khi nối với giá.",
    final_freeze_check_en: "The number must be readable in Gurmukhi before linking to prices.",
  ...
  {
    id: "pa_a1_final_freeze_prices_001",
    domain: "prices",
    style: "qa",
    ...
    final_freeze_check_vi: "Câu giá phải dùng được ở quầy hoặc cửa hàng Canada.",
    final_freeze_check_en: "The price question must work at a Canada counter or shop.",
  ...
  {
    id: "pa_a1_final_freeze_food_001",
    domain: "food",
    ...
    final_freeze_check_vi: "Mẫu nhu cầu phải rõ chủ thể và vật cần.",
    final_freeze_check_en: "The need frame must clearly show who needs what.",
  ...
  {
    id: "pa_a1_final_freeze_directions_001",
    domain: "directions",
    ...
    final_freeze_check_vi: "Câu hỏi vị trí phải giữ ਕਿੱਥੇ ਹੈ ở cuối.",
    final_freeze_check_en: "The location question must keep ਕਿੱਥੇ ਹੈ at the end.",
  ...
  {
    id: "pa_a1_final_freeze_help_001",
    domain: "help",
    style: "final_freeze",
    ...
    final_freeze_check_vi: "Đây là câu cứu nguy A1 và phải luôn có trong bản đóng băng cuối.",
    final_freeze_check_en: "This is the A1 rescue line and must remain in the final freeze.",
  ...
  {
    id: "pa_a1_final_freeze_repetition_001",
    domain: "repetition",
    ...
    final_freeze_check_vi: "Câu này phải hỗ trợ khi nghe thiếu số, giá hoặc hướng dẫn.",
    final_freeze_check_en: "This must support missed numbers, prices, or directions.",
  ...
  {
    id: "pa_a1_final_freeze_politeness_001",
    domain: "politeness",
    style: "final_acceptance",
    ...
    final_freeze_check_vi: "Lịch sự phải còn trong luồng dịch vụ ngắn.",
    final_freeze_check_en: "Politeness must remain in the short service flow.",
  ...
  {
    id: "pa_a1_final_freeze_gurmukhi_001",
    ...
    final_freeze_check_vi: "Nhóm chữ phải kiểm tra Gurmukhi trước romanization.",
    final_freeze_check_en: "The word set must check Gurmukhi before romanization.",
  ...
  {
    id: "pa_a1_final_freeze_romanization_001",
    ...
    meaning_en: "again",
    expected_pa: "ਦੁਬਾਰਾ",
    final_freeze_check_vi: "Romanization hỗ trợ đọc âm, nhưng đáp án đóng băng là Gurmukhi.",
    final_freeze_check_en: "Romanization supports sound, but the frozen answer is Gurmukhi.",
  ...
  {
    id: "pa_a1_final_freeze_canada_counter_001",
    ...
    final_freeze_check_vi: "Câu này phải giữ mức A1, không biến thành bài giấy tờ nâng cao.",
    final_freeze_check_en: "This must stay A1 and not become an advanced document lesson.",
...
export default punjabiA1FinalFreezeSamples;
