// Punjabi Canada survival receipt samples for Vietnamese-speaking and
...
export type PunjabiCanadaSurvivalReceiptDomain =
  | "clinic"
  | "pharmacy"
  | "school_childcare"
  | "bank"
...
export type PunjabiCanadaSurvivalReceiptCheck =
  | "pre_a11_receipt"
  | "ledger"
  | "archive"
  | "pre_integration";

export type PunjabiCanadaSurvivalReceiptSample = {
  id: string;
  domain: PunjabiCanadaSurvivalReceiptDomain;
  check: PunjabiCanadaSurvivalReceiptCheck;
  phrase_pa: string;
  romanization: string;
  meaning_vi: string;
  meaning_en: string;
...
export type PunjabiCanadaSurvivalReceiptScope = {
  name: string;
  audience: string[];
  scriptPolicy: string;
  reviewStatus: string;
...
export const PUNJABI_CANADA_SURVIVAL_RECEIPT_SCOPE: PunjabiCanadaSurvivalReceiptScope = {
  name: "Punjabi Canada Survival Receipt Samples",
  ...
  receiptBoundary:
    "Pre-A11-receipt, ledger, archive, and pre-integration content samples for Canadian survival communication; not A11 integration, not legal advice, not medical advice, and not financial advice.",
};

export const PUNJABI_CANADA_SURVIVAL_RECEIPT_DOMAINS: PunjabiCanadaSurvivalReceiptDomain[] = [
  "clinic",
  "pharmacy",
  "school_childcare",
  "bank",
...
export const PUNJABI_CANADA_SURVIVAL_RECEIPT_SAMPLES: PunjabiCanadaSurvivalReceiptSample[] = [
  {
    id: "pa-ca-receipt-clinic-001",
    domain: "clinic",
    check: "pre_a11_receipt",
    ...
    receipt_note_vi: "Pre-A11-receipt giữ phrase, repair request, và next-step handoff mà không tích hợp A11.",
    receipt_note_en: "The pre-A11-receipt keeps phrase, repair request, and next-step handoff without A11 integration.",
    readiness_signal_vi: "Archive ổn nếu có Gurmukhi, romanization, Vietnamese, English, và clinic context.",
    readiness_signal_en: "Archive is stable if it has Gurmukhi, romanization, Vietnamese, English, and clinic context.",
  ...
  },
  {
    ...
    receipt_note_vi: "Archive sample chứng minh pharmacy content không tự đưa liều hoặc chẩn đoán.",
    receipt_note_en: "The archive sample proves pharmacy content does not provide dose or diagnosis.",
    readiness_signal_vi: "Ledger ổn nếu learner xin pharmacist viết số lần/ngày thay vì đoán.",
    readiness_signal_en: "Ledger is stable if the learner asks the pharmacist to write times per day instead of guessing.",
  ...
  {
    id: "pa-ca-receipt-school-childcare-003",
    ...
    receipt_note_vi: "Ledger receipt đóng gói child, date, action, và optional pickup detail.",
    receipt_note_en: "The ledger receipt packages child, date, action, and optional pickup detail.",
  ...
  },
  {
    ...
    receipt_note_vi: "Pre-A11-receipt giữ bank sample ở mức service information, không khuyến nghị sản phẩm.",
    receipt_note_en: "The pre-A11-receipt keeps the bank sample at service information level, not product recommendation.",
    readiness_signal_vi: "Archive ổn nếu fee request và financial boundary đều có mặt.",
    readiness_signal_en: "Archive is stable if fee request and financial boundary are both present.",
  ...
  },
  {
    ...
    receipt_note_vi: "Pre-integration receipt có unit, issue, repair time, và written confirmation.",
    receipt_note_en: "The pre-integration receipt has unit, issue, repair time, and written confirmation.",
    readiness_signal_vi: "Ledger ổn nếu housing task không chuyển thành tenancy advice.",
    readiness_signal_en: "Ledger is stable if the housing task does not become tenancy advice.",
  ...
  {
    id: "pa-ca-receipt-transport-006",
    domain: "transport",
    check: "archive",
    ...
    receipt_note_vi: "Archive receipt có route, direction, transfer, và delay repair line.",
    receipt_note_en: "The archive receipt has route, direction, transfer, and delay repair line.",
    readiness_signal_vi: "Pre-A11-receipt ổn nếu transport content dùng transit/bus nhưng không hứa schedule.",
    readiness_signal_en: "Pre-A11-receipt is stable if transport content uses transit/bus but does not promise schedule.",
  ...
  {
    id: "pa-ca-receipt-public-office-007",
    ...
    receipt_note_vi: "Ledger receipt đóng gói counter, documents, checklist, và next step.",
    receipt_note_en: "The ledger receipt packages counter, documents, checklist, and next step.",
    readiness_signal_vi: "Archive ổn nếu public office flow không thành legal advice.",
    readiness_signal_en: "Archive is stable if public office flow does not become legal advice.",
  ...
  },
  {
    ...
    receipt_note_vi: "Pre-A11-receipt sample chứng minh forms coverage, correction request, và official-process boundary.",
    receipt_note_en: "The pre-A11-receipt sample proves forms coverage, correction request, and official-process boundary.",
  ...
  {
    id: "pa-ca-receipt-interpreter-009",
    ...
    receipt_note_vi: "Pre-integration receipt đóng gói pause line, interpreter request, và no-signing-until-clear boundary.",
    receipt_note_en: "The pre-integration receipt packages pause line, interpreter request, and no-signing-until-clear boundary.",
    readiness_signal_vi: "Archive ổn nếu interpreter request chỉ là language support, không phải professional decision.",
    readiness_signal_en: "Archive is stable if interpreter request is language support, not professional decision.",
  ...
  {
    id: "pa-ca-receipt-emergency-010",
    ...
    receipt_note_vi: "Archive receipt có immediate need, address, service type, và interpreter option.",
    receipt_note_en: "The archive receipt has immediate need, address, service type, and interpreter option.",
    readiness_signal_vi: "Pre-A11-receipt ổn nếu emergency boundary không thay thế emergency services.",
    readiness_signal_en: "Pre-A11-receipt is stable if emergency boundary does not replace emergency services.",
  ...
  {
    id: "pa-ca-receipt-service-recovery-011",
    ...
    receipt_note_vi: "Ledger receipt có repair phrase, written next step, và polite follow-up.",
    receipt_note_en: "The ledger receipt has repair phrase, written next step, and polite follow-up.",
    readiness_signal_vi: "Archive ổn nếu service recovery giúp learner không im lặng.",
    readiness_signal_en: "Archive is stable if service recovery helps the learner avoid silence.",
  ...
  {
    id: "pa-ca-receipt-workplace-012",
    ...
    receipt_note_vi: "Pre-integration receipt đóng gói safety issue, supervisor handoff, và written report step.",
    receipt_note_en: "The pre-integration receipt packages safety issue, supervisor handoff, and written report step.",
    readiness_signal_vi: "Pre-A11-receipt ổn nếu workplace task không chuyển thành claim guidance.",
    readiness_signal_en: "Pre-A11-receipt is stable if the workplace task does not become claim guidance.",
...
export default PUNJABI_CANADA_SURVIVAL_RECEIPT_SAMPLES;
