// Punjabi Canada survival snapshot samples for Vietnamese-speaking and
...
export type PunjabiCanadaSurvivalSnapshotDomain =
  | "clinic"
  | "pharmacy"
  | "school_childcare"
  | "bank"
...
export type PunjabiCanadaSurvivalSnapshotCheck =
  | "pre_a11_snapshot"
  | "closure_packet"
  | "pre_merge"
  | "pre_integration";

export type PunjabiCanadaSurvivalSnapshotSample = {
  id: string;
  domain: PunjabiCanadaSurvivalSnapshotDomain;
  check: PunjabiCanadaSurvivalSnapshotCheck;
  phrase_pa: string;
  romanization: string;
  meaning_vi: string;
  meaning_en: string;
  ...
  snapshot_note_vi: string;
  snapshot_note_en: string;
...
export type PunjabiCanadaSurvivalSnapshotScope = {
  name: string;
  audience: string[];
  scriptPolicy: string;
  reviewStatus: string;
...
export const PUNJABI_CANADA_SURVIVAL_SNAPSHOT_SCOPE: PunjabiCanadaSurvivalSnapshotScope = {
  name: "Punjabi Canada Survival Snapshot Samples",
  ...
  snapshotBoundary:
    "Pre-A11-snapshot, closure-packet, pre-merge, and pre-integration content samples for Canadian survival communication; not A11 integration, not legal advice, not medical advice, and not financial advice.",
};

export const PUNJABI_CANADA_SURVIVAL_SNAPSHOT_DOMAINS: PunjabiCanadaSurvivalSnapshotDomain[] = [
  "clinic",
  "pharmacy",
  "school_childcare",
  "bank",
...
export const PUNJABI_CANADA_SURVIVAL_SNAPSHOT_SAMPLES: PunjabiCanadaSurvivalSnapshotSample[] = [
  {
    id: "pa-ca-snapshot-clinic-001",
    domain: "clinic",
    check: "pre_a11_snapshot",
    ...
    snapshot_note_vi: "Pre-A11-snapshot giữ phrase, repair request, và next-step handoff mà không tích hợp A11.",
    snapshot_note_en: "The pre-A11-snapshot keeps phrase, repair request, and next-step handoff without A11 integration.",
    readiness_signal_vi: "Closure-packet ổn nếu có Gurmukhi, romanization, Vietnamese, English, và clinic context.",
    readiness_signal_en: "Closure-packet is stable if it has Gurmukhi, romanization, Vietnamese, English, and clinic context.",
  ...
  {
    id: "pa-ca-snapshot-pharmacy-002",
    domain: "pharmacy",
    check: "closure_packet",
    ...
    snapshot_note_vi: "Closure-packet sample chứng minh pharmacy content không tự đưa liều hoặc chẩn đoán.",
    snapshot_note_en: "The closure-packet sample proves pharmacy content does not provide dose or diagnosis.",
  ...
  {
    id: "pa-ca-snapshot-school-childcare-003",
    ...
    snapshot_note_vi: "Pre-merge snapshot đóng gói child, date, action, và optional pickup detail.",
    snapshot_note_en: "The pre-merge snapshot packages child, date, action, and optional pickup detail.",
  ...
  },
  {
    ...
    snapshot_note_vi: "Pre-A11-snapshot giữ bank sample ở mức service information, không khuyến nghị sản phẩm.",
    snapshot_note_en: "The pre-A11-snapshot keeps the bank sample at service information level, not product recommendation.",
    readiness_signal_vi: "Closure-packet ổn nếu fee request và financial boundary đều có mặt.",
    readiness_signal_en: "Closure-packet is stable if fee request and financial boundary are both present.",
  ...
  },
  {
    ...
    snapshot_note_vi: "Pre-integration snapshot có unit, issue, repair time, và written confirmation.",
    snapshot_note_en: "The pre-integration snapshot has unit, issue, repair time, and written confirmation.",
  ...
  {
    id: "pa-ca-snapshot-transport-006",
    domain: "transport",
    check: "closure_packet",
    ...
    snapshot_note_vi: "Closure-packet snapshot có route, direction, transfer, và delay repair line.",
    snapshot_note_en: "The closure-packet snapshot has route, direction, transfer, and delay repair line.",
    readiness_signal_vi: "Pre-A11-snapshot ổn nếu transport content dùng transit/bus nhưng không hứa schedule.",
    readiness_signal_en: "Pre-A11-snapshot is stable if transport content uses transit/bus but does not promise schedule.",
  ...
  {
    id: "pa-ca-snapshot-public-office-007",
    ...
    snapshot_note_vi: "Pre-merge snapshot đóng gói counter, documents, checklist, và next step.",
    snapshot_note_en: "The pre-merge snapshot packages counter, documents, checklist, and next step.",
    readiness_signal_vi: "Closure-packet ổn nếu public office flow không thành legal advice.",
    readiness_signal_en: "Closure-packet is stable if public office flow does not become legal advice.",
  ...
  },
  {
    ...
    snapshot_note_vi: "Pre-A11-snapshot sample chứng minh forms coverage, correction request, và official-process boundary.",
    snapshot_note_en: "The pre-A11-snapshot sample proves forms coverage, correction request, and official-process boundary.",
  ...
  {
    id: "pa-ca-snapshot-interpreter-009",
    ...
    snapshot_note_vi: "Pre-integration snapshot đóng gói pause line, interpreter request, và no-signing-until-clear boundary.",
    snapshot_note_en: "The pre-integration snapshot packages pause line, interpreter request, and no-signing-until-clear boundary.",
    readiness_signal_vi: "Closure-packet ổn nếu interpreter request chỉ là language support, không phải professional decision.",
    readiness_signal_en: "Closure-packet is stable if interpreter request is language support, not professional decision.",
  ...
  {
    id: "pa-ca-snapshot-emergency-010",
    ...
    snapshot_note_vi: "Closure-packet snapshot có immediate need, address, service type, và interpreter option.",
    snapshot_note_en: "The closure-packet snapshot has immediate need, address, service type, and interpreter option.",
    readiness_signal_vi: "Pre-A11-snapshot ổn nếu emergency boundary không thay thế emergency services.",
    readiness_signal_en: "Pre-A11-snapshot is stable if emergency boundary does not replace emergency services.",
  ...
  {
    id: "pa-ca-snapshot-service-recovery-011",
    ...
    snapshot_note_vi: "Pre-merge snapshot có repair phrase, written next step, và polite follow-up.",
    snapshot_note_en: "The pre-merge snapshot has repair phrase, written next step, and polite follow-up.",
    readiness_signal_vi: "Closure-packet ổn nếu service recovery giúp learner không im lặng.",
    readiness_signal_en: "Closure-packet is stable if service recovery helps the learner avoid silence.",
  ...
  {
    id: "pa-ca-snapshot-workplace-012",
    ...
    snapshot_note_vi: "Pre-integration snapshot đóng gói safety issue, supervisor handoff, và written report step.",
    snapshot_note_en: "The pre-integration snapshot packages safety issue, supervisor handoff, and written report step.",
    readiness_signal_vi: "Pre-A11-snapshot ổn nếu workplace task không chuyển thành claim guidance.",
    readiness_signal_en: "Pre-A11-snapshot is stable if the workplace task does not become claim guidance.",
...
export default PUNJABI_CANADA_SURVIVAL_SNAPSHOT_SAMPLES;
