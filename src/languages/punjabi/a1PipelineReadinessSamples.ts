// Punjabi A1 pipeline-readiness samples for Vietnamese-speaking and English-speaking learners.
// Gurmukhi is primary; romanization supports recognition. Native review is deferred.

export type PunjabiA1PipelineReadinessDomain =
  | "greetings"
  | "identity"
  | "family"
  | "numbers"
...
export type PunjabiA1PipelineReadinessStyle =
  | "pipeline_readiness"
  | "ci_readiness"
  | "mr_readiness"
  | "final_freeze"
...
export type PunjabiA1PipelineReadinessSample = {
  id: string;
  domain: PunjabiA1PipelineReadinessDomain;
  style: PunjabiA1PipelineReadinessStyle;
  prompt_vi: string;
  prompt_en: string;
  cue_pa: string;
  romanization?: string;
...
export const pipelineReadinessScriptAwareness =
  "Gurmukhi is the primary script for this Punjabi A1 pipeline-readiness set. Shahmukhi is awareness only, not a full course track.";

export const punjabiA1PipelineReadinessSamples: PunjabiA1PipelineReadinessSample[] = [
  {
    id: "pa_a1_pipeline_readiness_greeting_001",
    domain: "greetings",
    ...
    pipeline_readiness_check_vi: "Câu chào phải giữ Gurmukhi làm nội dung chính.",
    pipeline_readiness_check_en: "The greeting must keep Gurmukhi as the primary content.",
  ...
  {
    id: "pa_a1_pipeline_readiness_identity_001",
    domain: "identity",
    style: "mr_readiness",
    ...
    pipeline_readiness_check_vi: "Mẫu ਮੇਰਾ ਨਾਮ ... ਹੈ phải còn nguyên trước khi hỏi lại.",
    pipeline_readiness_check_en: "The ਮੇਰਾ ਨਾਮ ... ਹੈ frame must stay intact before asking back.",
  ...
  {
    id: "pa_a1_pipeline_readiness_family_001",
    domain: "family",
    style: "ci_readiness",
    ...
    pipeline_readiness_check_vi: "Mẫu gia đình phải kiểm tra cả giới thiệu người thân và 'tôi có'.",
    pipeline_readiness_check_en: "The family sample must check both introducing a relative and 'I have'.",
  ...
  {
    id: "pa_a1_pipeline_readiness_numbers_001",
    domain: "numbers",
    ...
    pipeline_readiness_check_vi: "Số phải đọc được bằng Gurmukhi trước khi nối với giá.",
    pipeline_readiness_check_en: "The number must be readable in Gurmukhi before linking to prices.",
  ...
  {
    id: "pa_a1_pipeline_readiness_prices_001",
    domain: "prices",
    style: "qa",
    ...
    pipeline_readiness_check_vi: "Câu giá phải dùng được ở quầy hoặc cửa hàng Canada.",
    pipeline_readiness_check_en: "The price question must work at a Canada counter or shop.",
  ...
  {
    id: "pa_a1_pipeline_readiness_food_001",
    domain: "food",
    ...
    pipeline_readiness_check_vi: "Mẫu nhu cầu phải rõ chủ thể và vật cần.",
    pipeline_readiness_check_en: "The need frame must clearly show who needs what.",
  ...
  {
    id: "pa_a1_pipeline_readiness_directions_001",
    domain: "directions",
    style: "mr_readiness",
    ...
    pipeline_readiness_check_vi: "Câu hỏi vị trí phải giữ ਕਿੱਥੇ ਹੈ ở cuối.",
    pipeline_readiness_check_en: "The location question must keep ਕਿੱਥੇ ਹੈ at the end.",
  ...
  {
    id: "pa_a1_pipeline_readiness_help_001",
    domain: "help",
    style: "pipeline_readiness",
    ...
    pipeline_readiness_check_vi: "Đây là câu cứu nguy A1 và phải luôn có trong bản đóng băng cuối.",
    pipeline_readiness_check_en: "This is the A1 rescue line and must remain in the final freeze.",
  ...
  {
    id: "pa_a1_pipeline_readiness_repetition_001",
    domain: "repetition",
    style: "mr_readiness",
    ...
    pipeline_readiness_check_vi: "Câu này phải hỗ trợ khi nghe thiếu số, giá hoặc hướng dẫn.",
    pipeline_readiness_check_en: "This must support missed numbers, prices, or directions.",
  ...
  {
    id: "pa_a1_pipeline_readiness_politeness_001",
    domain: "politeness",
    style: "readiness_check",
    ...
    pipeline_readiness_check_vi: "Lịch sự phải còn trong luồng dịch vụ ngắn.",
    pipeline_readiness_check_en: "Politeness must remain in the short service flow.",
  ...
  {
    id: "pa_a1_pipeline_readiness_gurmukhi_001",
    ...
    pipeline_readiness_check_vi: "Nhóm chữ phải kiểm tra Gurmukhi trước romanization.",
    pipeline_readiness_check_en: "The word set must check Gurmukhi before romanization.",
  ...
  {
    id: "pa_a1_pipeline_readiness_romanization_001",
    ...
    meaning_en: "again",
    expected_pa: "ਦੁਬਾਰਾ",
    pipeline_readiness_check_vi: "Romanization hỗ trợ đọc âm, nhưng đáp án đóng băng là Gurmukhi.",
    pipeline_readiness_check_en: "Romanization supports sound, but the frozen answer is Gurmukhi.",
  ...
  {
    id: "pa_a1_pipeline_readiness_canada_counter_001",
    ...
    pipeline_readiness_check_vi: "Câu này phải giữ mức A1, không biến thành bài giấy tờ nâng cao.",
    pipeline_readiness_check_en: "This must stay A1 and not become an advanced document lesson.",
...
export default punjabiA1PipelineReadinessSamples;
