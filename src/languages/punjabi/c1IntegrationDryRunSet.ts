// Punjabi C1 integration dry run set for Vietnamese-speaking and English-speaking learners.
//
...
export type PunjabiC1IntegrationDryRunArea =
  | "academic_frames"
  | "formal_writing"
  | "source_summary"
  | "cautious_claim"
...
export type PunjabiC1IntegrationDryRunMode =
  | "selector"
  | "dry_run"
  | "pre_integration"
  | "final_readiness";

export type PunjabiC1IntegrationDryRunPhrase = {
  pa: string;
  rom: string;
  vi: string;
  en: string;
...
export type PunjabiC1IntegrationDryRunCard = {
  id: string;
  level: "C1";
  area: PunjabiC1IntegrationDryRunArea;
  mode: PunjabiC1IntegrationDryRunMode;
  title_pa: string;
  title_rom: string;
  title_vi: string;
  title_en: string;
  dry_run_prompt_vi: string;
  dry_run_prompt_en: string;
  response_frame: PunjabiC1IntegrationDryRunPhrase;
  ...
  canada_example: PunjabiC1IntegrationDryRunPhrase & {
    context_vi: string;
    context_en: string;
  };
...
export const c1IntegrationDryRunSetScriptAwareness = {
...
export const c1IntegrationDryRunSet: PunjabiC1IntegrationDryRunCard[] = [
  {
    id: "pa_c1_dryrun_academic_frames",
    level: "C1",
    area: "academic_frames",
    mode: "dry_run",
    title_pa: "ਅਕਾਦਮਿਕ frame dry run",
    title_rom: "academic frame dry run",
    title_vi: "Dry run cho khung học thuật",
    title_en: "Academic frame dry run",
    dry_run_prompt_vi: "Kiểm tra khung học thuật có giữ claim, evidence và logic mà không bị nói quá không.",
    dry_run_prompt_en: "Check whether the academic frame keeps claim, evidence, and logic without overstatement.",
    response_frame: {
  ...
  {
    id: "pa_c1_dryrun_formal_writing",
    level: "C1",
    area: "formal_writing",
    mode: "pre_integration",
    title_pa: "ਰਸਮੀ ਲਿਖਤ dry run",
    title_rom: "rasmi likhat dry run",
    title_vi: "Dry run văn phong trang trọng",
    title_en: "Formal writing dry run",
    dry_run_prompt_vi: "Chọn cách viết mở trang trọng nhưng không nặng tay.",
    dry_run_prompt_en: "Choose a formal opening that is polished without sounding heavy.",
    response_frame: {
  ...
  {
    id: "pa_c1_dryrun_source_summary",
    level: "C1",
    area: "source_summary",
    mode: "dry_run",
    title_pa: "ਸਰੋਤ ਸਾਰ dry run",
    title_rom: "sarot saar dry run",
    title_vi: "Dry run tóm tắt nguồn",
    title_en: "Source summary dry run",
    dry_run_prompt_vi: "Chọn summary giữ claim chính và evidence mà không trượt sang nhận xét.",
    dry_run_prompt_en: "Choose the summary that keeps the main claim and evidence without sliding into commentary.",
    response_frame: {
  ...
  {
    id: "pa_c1_dryrun_cautious_claim",
    level: "C1",
    area: "cautious_claim",
    mode: "final_readiness",
    title_pa: "ਸਾਵਧਾਨ ਦਾਅਵਾ dry run",
    title_rom: "savdhan daava dry run",
    title_vi: "Dry run claim thận trọng",
    title_en: "Cautious claim dry run",
    dry_run_prompt_vi: "Chọn câu claim có lực nhưng vẫn giữ giới hạn dữ liệu rõ ràng.",
    dry_run_prompt_en: "Choose the claim that has force while keeping the data limits explicit.",
    response_frame: {
  ...
  {
    id: "pa_c1_dryrun_professional_correspondence",
    level: "C1",
    area: "professional_correspondence",
    mode: "pre_integration",
    title_pa: "ਪੇਸ਼ਾਵਰ ਪੱਤਰਚਾਰ dry run",
    title_rom: "peshavar patar-vihar dry run",
    title_vi: "Dry run thư tín chuyên nghiệp",
    title_en: "Professional correspondence dry run",
    dry_run_prompt_vi: "Chọn email follow-up lịch sự, rõ request và không giống chat.",
    dry_run_prompt_en: "Choose the follow-up email that is polite, clear in its request, and not chat-like.",
    response_frame: {
  ...
  {
    id: "pa_c1_dryrun_executive_summary",
    level: "C1",
    area: "executive_summary",
    mode: "dry_run",
    title_pa: "ਕਾਰਜਕਾਰੀ ਸੰਖੇਪ dry run",
    title_rom: "karjakari sankhep dry run",
    title_vi: "Dry run executive summary",
    title_en: "Executive summary dry run",
    dry_run_prompt_vi: "Chọn bản tóm tắt có issue, finding, recommendation và đủ ngắn để ra quyết định.",
    dry_run_prompt_en: "Choose the summary with issue, finding, recommendation, and enough brevity for a decision.",
    response_frame: {
  ...
  {
    id: "pa_c1_dryrun_register_calibration",
    level: "C1",
    area: "register_calibration",
    mode: "final_readiness",
    title_pa: "ਰਜਿਸਟਰ calibration dry run",
    title_rom: "register calibration dry run",
    title_vi: "Dry run điều chỉnh giọng văn",
    title_en: "Register calibration dry run",
    dry_run_prompt_vi: "Chọn cách giữ giọng phù hợp giữa học thuật, chuyên nghiệp và công vụ.",
    dry_run_prompt_en: "Choose the phrasing that keeps the right balance between academic, professional, and public-service tone.",
    response_frame: {
  ...
  {
    id: "pa_c1_dryrun_presentation_response",
    level: "C1",
    area: "presentation_response",
    mode: "pre_integration",
    title_pa: "ਪੇਸ਼ਕਾਰੀ ਜਵਾਬ dry run",
    title_rom: "peshkari jawab dry run",
    title_vi: "Dry run phản hồi thuyết trình",
    title_en: "Presentation response dry run",
    dry_run_prompt_vi: "Chọn câu trả lời sau thuyết trình vừa chắc vừa nhận diện giới hạn dữ liệu.",
    dry_run_prompt_en: "Choose the post-presentation answer that is confident yet recognizes data limits.",
    response_frame: {
