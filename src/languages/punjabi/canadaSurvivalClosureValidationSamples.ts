// Punjabi Canada survival closure-validation samples for Vietnamese-speaking
...
export type PunjabiCanadaSurvivalClosureValidationDomain =
  | "clinic"
  | "pharmacy"
  | "school_childcare"
  | "bank"
...
export type PunjabiCanadaSurvivalClosureValidationUse =
  | "closure_validation"
  | "final_cross_check"
  | "pre_integration"
  | "handoff_check";

export type PunjabiCanadaSurvivalClosureValidationItem = {
  id: string;
  domain: PunjabiCanadaSurvivalClosureValidationDomain;
  use: PunjabiCanadaSurvivalClosureValidationUse;
  closure_vi: string;
  closure_en: string;
  goal_vi: string;
  goal_en: string;
...
export type PunjabiCanadaSurvivalClosureValidationScope = {
  name: string;
  audience: string[];
  scriptPolicy: string;
  reviewStatus: string;
...
export const PUNJABI_CANADA_SURVIVAL_CLOSURE_VALIDATION_SCOPE: PunjabiCanadaSurvivalClosureValidationScope = {
  name: "Punjabi Canada Survival Closure Validation Samples",
  ...
  boundaries: [
    "Language support only for Canada survival closure-validation samples.",
    "No medical, legal, financial, tenancy, or workplace safety advice.",
  ],
};

export const PUNJABI_CANADA_SURVIVAL_CLOSURE_VALIDATION_SAMPLES: PunjabiCanadaSurvivalClosureValidationItem[] = [
  {
    id: "pa-ca-closure-clinic-001",
    domain: "clinic",
    use: "closure_validation",
    closure_vi: "Đóng kiểm câu phòng khám khi người học cần xin giải thích chậm trước khi trả lời.",
    closure_en: "Close-check the clinic line when the learner needs slower explanation before answering.",
    ...
    closure_check_vi: "Closure-validation giữ câu ở mức hỗ trợ ngôn ngữ, không đưa lời khuyên y tế.",
    closure_check_en: "Closure validation keeps this as language support, not medical advice.",
  ...
  {
    id: "pa-ca-closure-pharmacy-002",
    domain: "pharmacy",
    use: "final_cross_check",
    closure_vi: "Đóng kiểm câu nhà thuốc để người học nêu dị ứng và xin ghi lại thông tin.",
    closure_en: "Close-check the pharmacy line so the learner can state an allergy and ask for writing.",
    ...
    closure_check_vi: "Final-cross-check xác nhận câu không thêm liều lượng hoặc hướng dẫn thuốc.",
    closure_check_en: "The final cross-check confirms the line does not add dosage or medicine instructions.",
  ...
  {
    id: "pa-ca-closure-school-003",
    domain: "school_childcare",
    use: "pre_integration",
    closure_vi: "Đóng kiểm câu form dùng được cho trường và childcare khi người học bị kẹt.",
    closure_en: "Close-check the form line for school and childcare when the learner is stuck.",
    ...
    closure_check_vi: "Pre-integration xác nhận câu nối được với trường, childcare, và form.",
    closure_check_en: "Pre-integration confirms the line connects to school, childcare, and form flows.",
  ...
  {
    id: "pa-ca-closure-bank-004",
    domain: "bank",
    use: "handoff_check",
    closure_vi: "Đóng kiểm câu ngân hàng giữ mục tiêu mở tài khoản và hỏi phí.",
    closure_en: "Close-check the bank line so it keeps the account-opening and fee goal.",
    ...
    closure_check_vi: "Handoff check xác nhận câu không trôi sang thẻ, vay, hoặc lời khuyên tiền bạc.",
    closure_check_en: "The handoff check confirms the line does not drift to cards, loans, or money advice.",
  ...
  {
    id: "pa-ca-closure-housing-005",
    domain: "housing",
    use: "closure_validation",
    closure_vi: "Đóng kiểm câu nhà thuê khi cần thời gian sửa và phản hồi bằng văn bản.",
    closure_en: "Close-check the rental line when repair timing and a written reply are needed.",
    ...
    closure_check_vi: "Closure-validation không biến câu sửa chữa thành tư vấn luật thuê nhà.",
    closure_check_en: "Closure validation does not turn the repair line into tenancy advice.",
  ...
  {
    id: "pa-ca-closure-transport-006",
    domain: "transport",
    use: "pre_integration",
    closure_vi: "Đóng kiểm câu giao thông khi người học cần hỏi tuyến xe và điểm xuống.",
    closure_en: "Close-check the transport line when the learner needs route and stop confirmation.",
    ...
    closure_check_vi: "Pre-integration xác nhận câu nối được với phần chỉ đường và lịch trình.",
    closure_check_en: "Pre-integration confirms the line connects to directions and schedule content.",
  ...
  {
    id: "pa-ca-closure-public-office-007",
    domain: "public_office",
    use: "final_cross_check",
    closure_vi: "Đóng kiểm câu cơ quan công khi người học cần biết quầy và giấy tờ.",
    closure_en: "Close-check the public-office line when the learner needs the right counter and documents.",
    ...
    closure_check_vi: "Final-cross-check xác nhận câu nối được với form và quầy dịch vụ.",
    closure_check_en: "The final cross-check confirms the line connects to form and service-counter flows.",
  ...
  {
    id: "pa-ca-closure-forms-008",
    domain: "forms_service_desk",
    use: "closure_validation",
    closure_vi: "Đóng kiểm câu bàn dịch vụ khi người học cần chỉ phần form chưa hiểu.",
    closure_en: "Close-check the service-desk line when the learner needs to show the unclear form section.",
    ...
    closure_check_vi: "Closure-validation xác nhận câu form đủ rõ trước khi ghép vào luồng cuối.",
    closure_check_en: "Closure validation confirms the form line is clear before final flow linking.",
  ...
  {
    id: "pa-ca-closure-interpreter-009",
    domain: "interpreter_request",
    use: "handoff_check",
    closure_vi: "Đóng kiểm câu xin thông dịch viên khi tình huống vượt quá mức hiểu.",
    closure_en: "Close-check the interpreter request when the situation exceeds the learner's understanding.",
    ...
    closure_check_vi: "Handoff check xác nhận Shahmukhi chỉ là nhận biết, không phải khóa học đầy đủ.",
    closure_check_en: "The handoff check confirms Shahmukhi is awareness only, not a full course.",
  ...
  {
    id: "pa-ca-closure-emergency-010",
    domain: "emergency_boundary",
    use: "final_cross_check",
    closure_vi: "Đóng kiểm câu khẩn cấp khi có nguy hiểm thật sự và cần gọi 911.",
    closure_en: "Close-check the emergency line when there is real danger and 911 is needed.",
    ...
    closure_check_vi: "Final-cross-check giữ câu khẩn cấp rõ và không thay thế dịch vụ khẩn cấp.",
    closure_check_en: "The final cross-check keeps the emergency line clear and does not replace emergency services.",
  ...
  {
    id: "pa-ca-closure-recovery-011",
    domain: "service_recovery",
    use: "closure_validation",
    closure_vi: "Đóng kiểm câu phục hồi dịch vụ khi thông tin sai hoặc chưa khớp.",
    closure_en: "Close-check the service-recovery line when information is wrong or does not match.",
    ...
    closure_check_vi: "Closure-validation xác nhận câu sửa lỗi vẫn lịch sự và thực tế.",
    closure_check_en: "Closure validation confirms the correction line stays polite and practical.",
  ...
  {
    id: "pa-ca-closure-workplace-012",
    domain: "workplace_safety",
    use: "pre_integration",
    closure_vi: "Đóng kiểm câu nơi làm việc khi người học chưa hiểu hướng dẫn an toàn.",
    closure_en: "Close-check the workplace line when the learner did not understand a safety instruction.",
    ...
    closure_check_vi: "Pre-integration giữ câu ở mức xin làm rõ ngôn ngữ, không đưa hướng dẫn kỹ thuật.",
    closure_check_en: "Pre-integration keeps this as language clarification, not technical instruction.",
...
export default PUNJABI_CANADA_SURVIVAL_CLOSURE_VALIDATION_SAMPLES;
