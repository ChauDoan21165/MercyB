// Punjabi A1 runner-readiness samples for Vietnamese-speaking and English-speaking learners.
// Gurmukhi is primary; romanization supports recognition. Native review is deferred.

export type PunjabiA1RunnerReadinessDomain =
  | "greetings"
  | "identity"
  | "family"
  | "numbers"
...
export type PunjabiA1RunnerReadinessStyle =
  | "runner_readiness"
  | "pipeline_readiness"
  | "ci_readiness"
  | "final_freeze"
...
export type PunjabiA1RunnerReadinessSample = {
  id: string;
  domain: PunjabiA1RunnerReadinessDomain;
  style: PunjabiA1RunnerReadinessStyle;
  prompt_vi: string;
  prompt_en: string;
  cue_pa: string;
  romanization?: string;
...
export const runnerReadinessScriptAwareness =
  "Gurmukhi is the primary script for this Punjabi A1 runner-readiness set. Shahmukhi is awareness only, not a full course track.";

export const punjabiA1RunnerReadinessSamples: PunjabiA1RunnerReadinessSample[] = [
  {
    id: "pa_a1_runner_readiness_greeting_001",
    domain: "greetings",
    ...
    runner_readiness_check_vi: "Câu chào phải giữ Gurmukhi làm nội dung chính.",
    runner_readiness_check_en: "The greeting must keep Gurmukhi as the primary content.",
  ...
  {
    id: "pa_a1_runner_readiness_identity_001",
    domain: "identity",
    ...
    runner_readiness_check_vi: "Mẫu ਮੇਰਾ ਨਾਮ ... ਹੈ phải còn nguyên trước khi hỏi lại.",
    runner_readiness_check_en: "The ਮੇਰਾ ਨਾਮ ... ਹੈ frame must stay intact before asking back.",
  ...
  {
    id: "pa_a1_runner_readiness_family_001",
    domain: "family",
    style: "ci_readiness",
    ...
    runner_readiness_check_vi: "Mẫu gia đình phải kiểm tra cả giới thiệu người thân và 'tôi có'.",
    runner_readiness_check_en: "The family sample must check both introducing a relative and 'I have'.",
  ...
  {
    id: "pa_a1_runner_readiness_numbers_001",
    domain: "numbers",
    ...
    runner_readiness_check_vi: "Số phải đọc được bằng Gurmukhi trước khi nối với giá.",
    runner_readiness_check_en: "The number must be readable in Gurmukhi before linking to prices.",
  ...
  {
    id: "pa_a1_runner_readiness_prices_001",
    domain: "prices",
    style: "qa",
    ...
    runner_readiness_check_vi: "Câu giá phải dùng được ở quầy hoặc cửa hàng Canada.",
    runner_readiness_check_en: "The price question must work at a Canada counter or shop.",
  ...
  {
    id: "pa_a1_runner_readiness_food_001",
    domain: "food",
    ...
    runner_readiness_check_vi: "Mẫu nhu cầu phải rõ chủ thể và vật cần.",
    runner_readiness_check_en: "The need frame must clearly show who needs what.",
  ...
  {
    id: "pa_a1_runner_readiness_directions_001",
    domain: "directions",
    style: "pipeline_readiness",
    ...
    runner_readiness_check_vi: "Câu hỏi vị trí phải giữ ਕਿੱਥੇ ਹੈ ở cuối.",
    runner_readiness_check_en: "The location question must keep ਕਿੱਥੇ ਹੈ at the end.",
  ...
  {
    id: "pa_a1_runner_readiness_help_001",
    domain: "help",
    style: "runner_readiness",
    ...
    runner_readiness_check_vi: "Đây là câu cứu nguy A1 và phải luôn có trong bản đóng băng cuối.",
    runner_readiness_check_en: "This is the A1 rescue line and must remain in the final freeze.",
  ...
  {
    id: "pa_a1_runner_readiness_repetition_001",
    domain: "repetition",
    style: "pipeline_readiness",
    ...
    runner_readiness_check_vi: "Câu này phải hỗ trợ khi nghe thiếu số, giá hoặc hướng dẫn.",
    runner_readiness_check_en: "This must support missed numbers, prices, or directions.",
  ...
  {
    id: "pa_a1_runner_readiness_politeness_001",
    domain: "politeness",
    style: "readiness_check",
    ...
    runner_readiness_check_vi: "Lịch sự phải còn trong luồng dịch vụ ngắn.",
    runner_readiness_check_en: "Politeness must remain in the short service flow.",
  ...
  {
    id: "pa_a1_runner_readiness_gurmukhi_001",
    ...
    runner_readiness_check_vi: "Nhóm chữ phải kiểm tra Gurmukhi trước romanization.",
    runner_readiness_check_en: "The word set must check Gurmukhi before romanization.",
  ...
  {
    id: "pa_a1_runner_readiness_romanization_001",
    ...
    meaning_en: "again",
    expected_pa: "ਦੁਬਾਰਾ",
    runner_readiness_check_vi: "Romanization hỗ trợ đọc âm, nhưng đáp án đóng băng là Gurmukhi.",
    runner_readiness_check_en: "Romanization supports sound, but the frozen answer is Gurmukhi.",
  ...
  {
    id: "pa_a1_runner_readiness_canada_counter_001",
    ...
    runner_readiness_check_vi: "Câu này phải giữ mức A1, không biến thành bài giấy tờ nâng cao.",
    runner_readiness_check_en: "This must stay A1 and not become an advanced document lesson.",
...
export default punjabiA1RunnerReadinessSamples;
