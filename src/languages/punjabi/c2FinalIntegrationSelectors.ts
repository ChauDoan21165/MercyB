// Punjabi C2 final integration selectors for Vietnamese- and English-speaking learners.
// Gurmukhi is primary; romanization is a reading aid.
//
// Scope/status: study-support selectors only, not certification, official
...
export type PunjabiC2FinalSelectorFocus =
...
export type PunjabiC2FinalSelectorStyle = "selector" | "pre_integration" | "final_readiness" | "regression";

export type PunjabiC2FinalSelectorPhrase = {
  gurmukhi: string;
  romanization: string;
  vi: string;
  en: string;
...
export type PunjabiC2FinalSelectorCheck = {
  check_vi: string;
  check_en: string;
  signal_vi: string;
  signal_en: string;
...
export type PunjabiC2FinalSelectorTrap = {
  trap_vi: string;
  trap_en: string;
  repair_vi: string;
  repair_en: string;
...
export type PunjabiC2FinalIntegrationSelector = {
  id: string;
  focus: PunjabiC2FinalSelectorFocus;
  style: PunjabiC2FinalSelectorStyle;
  title_vi: string;
  title_en: string;
  scenario_vi: string;
  scenario_en: string;
  ...
  sample_vi: string;
  sample_en: string;
  selector_phrases: PunjabiC2FinalSelectorPhrase[];
  checks: PunjabiC2FinalSelectorCheck[];
  learner_trap?: PunjabiC2FinalSelectorTrap;
  canada_practical?: boolean;
};

export const C2_FINAL_INTEGRATION_SELECTORS_DISCLAIMER = {
  vi: "Bộ selector tích hợp cuối Punjabi C2 này chỉ hỗ trợ học tập, không phải chứng nhận hay xếp lớp chính thức. Gurmukhi là chính; phiên âm chỉ giúp đọc. Thẩm định bản xứ được hoãn lại. Shahmukhi chỉ được nhắc để nhận biết hệ chữ.",
  en: "This C2 Punjabi final integration selector pack supports study only, not certification or official placement. Gurmukhi is primary; romanization only supports reading. Native review is deferred. Shahmukhi is noted only for script awareness.",
} as const;

export const c2FinalIntegrationSelectors: PunjabiC2FinalIntegrationSelector[] = [
  {
    id: "pa_c2_final_selector_nuanced_disagreement",
    focus: "nuanced_disagreement",
    style: "selector",
    title_vi: "Bộ chọn bất đồng tinh tế",
    title_en: "Selector for nuanced disagreement",
    scenario_vi: "Bạn đồng ý với mục tiêu chung nhưng muốn giữ lại một điểm còn mơ hồ.",
    scenario_en: "You agree with the shared goal but want to retain one unclear point.",
    selector_goal_vi: "Chọn mẫu có công nhận trước rồi mới góp ý.",
    selector_goal_en: "Choose a pattern that validates first and critiques second.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_final_selector_audience_adaptation_canada",
    focus: "audience_adaptation",
    style: "pre_integration",
    title_vi: "Chọn mức trang trọng theo người nghe",
    title_en: "Select formality by audience",
    ...
    selector_goal_vi: "Giữ ý chính nhưng đổi mức lịch sự cho phù hợp.",
    selector_goal_en: "Keep the core message while adjusting politeness to fit.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_final_selector_mediation",
    focus: "mediation",
    style: "selector",
    title_vi: "Chọn mẫu trung gian không thiên vị",
    title_en: "Selector for neutral mediation",
    ...
    selector_goal_vi: "Giữ hai phía song song rồi quay về tiêu chí chung.",
    selector_goal_en: "Keep both sides parallel and return to shared criteria.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_final_selector_deescalation",
    focus: "deescalation",
    ...
    selector_goal_vi: "Chọn câu đưa cuộc họp về quy trình thay vì cảm xúc.",
    selector_goal_en: "Choose wording that returns the meeting to process instead of emotion.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_final_selector_register_safety",
    focus: "advanced_register",
    style: "pre_integration",
    title_vi: "Chọn mẫu an toàn cho đăng ký nâng cao",
    title_en: "Selector for safe advanced register",
    ...
    selector_goal_vi: "Giữ lịch sự, rõ ý, và đủ ấm.",
    selector_goal_en: "Keep it polite, clear, and warm enough.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_final_selector_public_communication",
    focus: "public_communication",
    style: "regression",
    title_vi: "Quay lại mạch rõ trong phát biểu công khai",
    ...
    selector_goal_vi: "Giữ cùng giọng, cùng mức lịch sự, và cùng ý chính.",
    selector_goal_en: "Keep the same tone, the same politeness level, and the same main point.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_final_selector_diplomacy",
    focus: "diplomacy",
    style: "final_readiness",
    ...
    selector_goal_vi: "Từ chối mềm, có cảm ơn, và mở khả năng sau.",
    selector_goal_en: "Decline softly with thanks and a future opening.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_final_selector_sensitive_topics",
    focus: "sensitive_topic_framing",
    style: "selector",
    title_vi: "Chọn khung an toàn cho chủ đề nhạy cảm",
    title_en: "Selector for safe sensitive-topic framing",
    ...
    selector_goal_vi: "Nhận ra độ nhạy cảm rồi kéo lại phần liên quan đến nhiệm vụ.",
    selector_goal_en: "Recognize the sensitivity and bring the discussion back to the task part.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_final_selector_community_discourse",
    focus: "community_discourse",
    style: "selector",
    title_vi: "Chọn mẫu nói chuyện cộng đồng",
    title_en: "Selector for community discourse",
    ...
    selector_goal_vi: "Mời chọn việc theo thời gian, kỹ năng, và mức thoải mái.",
    selector_goal_en: "Invite choices based on availability, skill, and comfort.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_final_selector_professional_discourse",
    focus: "professional_discourse",
    style: "pre_integration",
    title_vi: "Chọn mẫu góp ý chuyên nghiệp",
    title_en: "Selector for professional feedback",
    ...
    selector_goal_vi: "Công nhận nỗ lực, nêu điểm cần chỉnh, rồi đưa hướng tiếp.",
    selector_goal_en: "Acknowledge effort, name the adjustment, then give the next step.",
    sample_gurmukhi:
  ...
  {
    id: "pa_c2_final_selector_public_service",
    ...
    selector_goal_vi: "Nói theo quy trình: cái có, cái cần, và bước kế tiếp.",
    selector_goal_en: "Follow the process: what you have, what you need, and the next step.",
    sample_gurmukhi:
...
export const c2FinalIntegrationSelectorsByFocus = (
  focus: PunjabiC2FinalSelectorFocus,
): PunjabiC2FinalIntegrationSelector[] => c2FinalIntegrationSelectors.filter((item) => item.focus === focus);
