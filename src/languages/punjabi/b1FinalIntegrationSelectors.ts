export type PunjabiB1FinalIntegrationSelectorFocus =
  | "scenario_packs"
  | "service_recovery"
  | "issue_resolution"
  | "follow_up_message"
...
export type PunjabiFinalIntegrationSelectorLine = {
  pa: string;
  romanization: string;
  en: string;
  vi: string;
...
export type PunjabiFinalIntegrationSelectorTrap = {
  trap_en: string;
  trap_vi: string;
  better: PunjabiFinalIntegrationSelectorLine;
};

export type PunjabiFinalIntegrationSelectorPack = {
  preIntegrationPrompt_en: string;
  preIntegrationPrompt_vi: string;
  selectorLine: PunjabiFinalIntegrationSelectorLine;
  selectorSignals_en: string[];
  selectorSignals_vi: string[];
};

export type PunjabiB1FinalIntegrationSelectorCard = {
  id: string;
  level: "B1";
  focus: PunjabiB1FinalIntegrationSelectorFocus;
  title_en: string;
  title_vi: string;
  scenario_en: string;
  scenario_vi: string;
  canadaContext: string;
  selectorPack: PunjabiFinalIntegrationSelectorPack;
  commonTraps: PunjabiFinalIntegrationSelectorTrap[];
...
export const punjabiB1FinalIntegrationSelectors: PunjabiB1FinalIntegrationSelectorCard[] = [
  {
    id: "b1-selector-scenario-packs",
    level: "B1",
    focus: "scenario_packs",
    title_en: "Select a scenario pack",
    title_vi: "Chọn một bộ tình huống",
    scenario_en:
      "You want to pick the right B1 pack before the next practice session.",
    scenario_vi:
      "Bạn muốn chọn bộ B1 phù hợp trước buổi luyện tiếp theo.",
    canadaContext:
      "Useful for Canadian language classes, newcomer centres, and self-study planning.",
    selectorPack: {
      preIntegrationPrompt_en:
        "Choose the scenario pack that best matches the conversation goal.",
      preIntegrationPrompt_vi:
    ...
    commonTraps: [
      {
        trap_en: "Choosing a pack by topic alone instead of the conversation goal.",
        trap_vi: "Chọn bộ theo chủ đề בלבד thay vì mục tiêu hội thoại.",
        better: {
    ...
    finalReadiness_en:
      "Language practice only, not medical advice. Language practice only, not legal or financial advice. Final readiness is ready when the selector is short, stable, and easy to map.",
    finalReadiness_vi:
      "Chỉ luyện ngôn ngữ, không phải tư vấn y tế. Chỉ luyện ngôn ngữ, không phải tư vấn pháp lý hoặc tài chính. Sẵn sàng cuối khi bộ chọn ngắn, ổn định và dễ ánh xạ.",
    integrationRoute_en:
      "Route to B2 integrated packs if the goal is stable; otherwise stay in B1 selector review.",
    integrationRoute_vi:
      "Chuyển sang bộ tích hợp B2 nếu mục tiêu ổn định; nếu chưa thì ở lại rà soát bộ chọn B1.",
  },
  {
    id: "b1-selector-service-recovery",
    level: "B1",
    focus: "service_recovery",
    title_en: "Select a service recovery pack",
    title_vi: "Chọn bộ phục hồi dịch vụ",
    scenario_en:
    ...
    selectorPack: {
      preIntegrationPrompt_en:
        "Select the service recovery pack that keeps the request clear.",
      preIntegrationPrompt_vi:
        "Chọn bộ phục hồi dịch vụ giữ cho yêu cầu rõ ràng.",
      selectorLine: {
  ...
  {
    id: "b1-selector-issue-resolution",
    level: "B1",
    focus: "issue_resolution",
    title_en: "Select an issue-resolution pack",
    title_vi: "Chọn bộ giải quyết vấn đề",
    scenario_en:
  ...
  {
    id: "b1-selector-follow-up-message",
    level: "B1",
    focus: "follow_up_message",
    title_en: "Select a follow-up message pack",
    title_vi: "Chọn bộ tin nhắn theo dõi",
    scenario_en:
  ...
  {
    id: "b1-selector-conversation-recovery",
    level: "B1",
    focus: "conversation_recovery",
    title_en: "Select a conversation recovery pack",
    title_vi: "Chọn bộ phục hồi cuộc trò chuyện",
    scenario_en:
  ...
  {
    id: "b1-selector-workplace-task",
    level: "B1",
    focus: "workplace_task",
    title_en: "Select a workplace-task pack",
    title_vi: "Chọn bộ nhiệm vụ nơi làm việc",
    scenario_en:
  ...
  {
    id: "b1-selector-housing-task",
    level: "B1",
    focus: "housing_task",
    title_en: "Select a housing-task pack",
    title_vi: "Chọn bộ nhiệm vụ nhà ở",
    scenario_en:
  ...
  {
    id: "b1-selector-school-community-task",
    level: "B1",
    focus: "school_community_task",
    title_en: "Select a school/community-task pack",
    title_vi: "Chọn bộ nhiệm vụ trường học/cộng đồng",
    scenario_en:
  ...
  {
    id: "b1-selector-register-safe-repair",
    level: "B1",
    focus: "register_safe_repair",
    title_en: "Select a register-safe repair pack",
    title_vi: "Chọn bộ sửa sắc thái an toàn",
    scenario_en:
