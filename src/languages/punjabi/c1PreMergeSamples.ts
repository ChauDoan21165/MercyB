// Punjabi C1 pre-merge samples for Vietnamese-speaking and English-speaking learners.
//
...
export type PunjabiC1PreMergeArea =
  | "source_summary"
  | "cautious_claim"
  | "evidence_comparison"
...
export type PunjabiC1PreMergeMode =
  | "pre_merge"
  | "pre_a11_checksum"
  | "runner_readiness"
  | "pre_integration";

export type PunjabiC1PreMergePhrase = {
  pa: string;
  rom: string;
  vi: string;
  en: string;
...
export type PunjabiC1PreMergeSample = {
  id: string;
  level: "C1";
  area: PunjabiC1PreMergeArea;
  mode: PunjabiC1PreMergeMode;
  title_pa: string;
  title_rom: string;
  title_vi: string;
  title_en: string;
  ...
  sample: PunjabiC1PreMergePhrase;
  pre_merge_checks_vi: readonly string[];
  pre_merge_checks_en: readonly string[];
  ...
  canada_example: PunjabiC1PreMergePhrase & {
    context_vi: string;
    context_en: string;
  };
...
export const c1PreMergeSamplesScriptAwareness = {
  vi: "Bộ pre-merge này dùng Gurmukhi làm chữ chính. Shahmukhi chỉ được nhắc để nhận biết một hệ chữ Punjabi khác, không phải phần luyện chính.",
  en: "This pre-merge pack uses Gurmukhi as the primary script. Shahmukhi is mentioned only to recognize another Punjabi script, not as the main practice script.",
} as const;

export const c1PreMergeSamples: PunjabiC1PreMergeSample[] = [
  {
    id: "pa_c1_pre_merge_source_summary",
    level: "C1",
    area: "source_summary",
    mode: "pre_merge",
    title_pa: "ਸਰੋਤ ਸਾਰ pre-merge",
    title_rom: "sarot saar pre-merge",
    title_vi: "Tóm tắt nguồn cho pre-merge",
    title_en: "Source summary for pre-merge",
    ...
    pre_merge_checks_vi: ["Claim trung tâm rõ.", "Evidence không bị thêm thắt.", "Tone vẫn trung lập."],
    pre_merge_checks_en: ["Central claim is clear.", "Evidence is not embellished.", "Tone remains neutral."],
    pre_a11_checksum_checks_vi: ["Có thể checksum claim.", "Có thể checksum evidence.", "Không cần dữ liệu live."],
    pre_a11_checksum_checks_en: ["Claim can be checksummed.", "Evidence can be checksummed.", "No live data needed."],
  ...
  {
    id: "pa_c1_pre_merge_cautious_claim",
    level: "C1",
    area: "cautious_claim",
    mode: "pre_a11_checksum",
    title_pa: "ਸਾਵਧਾਨ ਦਾਅਵਾ pre-A11 checksum",
    title_rom: "savdhan daava pre-A11 checksum",
    title_vi: "Claim thận trọng cho pre-A11 checksum",
    title_en: "Cautious claim for pre-A11 checksum",
    ...
    pre_merge_checks_vi: ["Hedge rõ.", "Không phóng đại.", "Vẫn có luận điểm."],
    pre_merge_checks_en: ["Clear hedging.", "No exaggeration.", "Still has a point."],
    pre_a11_checksum_checks_vi: ["Checksum được mức độ chắc chắn.", "Checksum được limitation.", "Không có claim tuyệt đối."],
    pre_a11_checksum_checks_en: ["Certainty level can be checksummed.", "Limitation can be checksummed.", "No absolute claim."],
  ...
  {
    id: "pa_c1_pre_merge_evidence_comparison",
    level: "C1",
    area: "evidence_comparison",
    mode: "runner_readiness",
    title_pa: "ਸਬੂਤ ਤੁਲਨਾ runner-readiness",
    title_rom: "sabut tulna runner-readiness",
    title_vi: "So sánh bằng chứng cho runner-readiness",
    title_en: "Evidence comparison for runner readiness",
    merge_prompt_vi: "Dùng sample này để runner kiểm tra so sánh giữa số liệu và phản hồi định tính.",
    merge_prompt_en: "Use this sample so the runner can check comparison between figures and qualitative feedback.",
    sample: {
    ...
    pre_merge_checks_vi: ["Phân biệt loại evidence.", "Kết luận vừa mức.", "Không chọn phe sớm."],
    pre_merge_checks_en: ["Distinguishes evidence types.", "Measured conclusion.", "Does not choose a side early."],
    pre_a11_checksum_checks_vi: ["Có số liệu.", "Có phản hồi.", "Có lý do đọc chung."],
    pre_a11_checksum_checks_en: ["Has figures.", "Has feedback.", "Has a reason to read them together."],
  ...
  {
    id: "pa_c1_pre_merge_formal_correspondence",
    level: "C1",
    ...
    pre_merge_checks_vi: ["Request trực tiếp nhưng lịch sự.", "Có lý do request.", "Không trách móc."],
    pre_merge_checks_en: ["Request is direct but polite.", "Has a reason for the request.", "No blaming."],
    pre_a11_checksum_checks_vi: ["Có phrase lịch sự.", "Có mục đích.", "Không gửi email thật."],
    pre_a11_checksum_checks_en: ["Has a polite phrase.", "Has a purpose.", "No real email is sent."],
  ...
  {
    id: "pa_c1_pre_merge_executive_summary",
    level: "C1",
    area: "executive_summary",
    mode: "pre_merge",
    title_pa: "ਕਾਰਜਕਾਰੀ ਸੰਖੇਪ pre-merge",
    title_rom: "karjakari sankhep pre-merge",
    title_vi: "Executive summary cho pre-merge",
    title_en: "Executive summary for pre-merge",
    ...
    pre_merge_checks_vi: ["Có priority.", "Có risk.", "Có next step."],
    pre_merge_checks_en: ["Has a priority.", "Has a risk.", "Has a next step."],
    pre_a11_checksum_checks_vi: ["Compact.", "Checksum được action.", "Không thành report dài."],
    pre_a11_checksum_checks_en: ["Compact.", "Action can be checksummed.", "Does not become a long report."],
  ...
  {
    id: "pa_c1_pre_merge_register_calibration",
    level: "C1",
    ...
    pre_merge_checks_vi: ["Register formal.", "Không quá casual.", "Không làm mất nghĩa."],
    pre_merge_checks_en: ["Formal register.", "Not too casual.", "Does not lose meaning."],
    pre_a11_checksum_checks_vi: ["Claim cautious.", "Có limitation.", "Không phóng đại."],
    pre_a11_checksum_checks_en: ["Cautious claim.", "Has a limitation.", "No exaggeration."],
  ...
  {
    id: "pa_c1_pre_merge_presentation_response",
    level: "C1",
    area: "presentation_response",
    mode: "pre_a11_checksum",
    title_pa: "ਪ੍ਰਜ਼ੈਂਟੇਸ਼ਨ ਜਵਾਬ pre-A11 checksum",
    title_rom: "presentation jawab pre-A11 checksum",
    title_vi: "Phản hồi presentation cho pre-A11 checksum",
    title_en: "Presentation response for pre-A11 checksum",
    ...
    pre_merge_checks_vi: ["Ghi nhận câu hỏi.", "Có cấu trúc.", "Tone không phòng thủ."],
    pre_merge_checks_en: ["Acknowledges the question.", "Structured.", "Tone is not defensive."],
    pre_a11_checksum_checks_vi: ["Có limitation.", "Không overstated.", "Có evidence boundary."],
    pre_a11_checksum_checks_en: ["Has a limitation.", "Not overstated.", "Has an evidence boundary."],
  ...
  {
    id: "pa_c1_pre_merge_public_professional_tone",
    level: "C1",
    ...
    pre_merge_checks_vi: ["Thông báo rõ.", "Tone tôn trọng.", "Có next action."],
    pre_merge_checks_en: ["Clear notice.", "Respectful tone.", "Has a next action."],
    pre_a11_checksum_checks_vi: ["Không đổ lỗi.", "Không quá dài.", "Sẵn sàng freeze."],
    pre_a11_checksum_checks_en: ["No blaming.", "Not too long.", "Ready to freeze."],
