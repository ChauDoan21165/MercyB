...
},
{
  ...
  level: "C2",
  vocabulary: [
    { japanese: "受容史 (じゅようし)", english: "reception history" },
    { japanese: "正典 (せいてん)", english: "canon" },
    { japanese: "正典化 (せいてんか)", english: "canonization" },
    { japanese: "脱正典化 (だつせいてんか)", english: "decanonization" },
    { japanese: "読者反応 (どくしゃはんのう)", english: "reader response" },
    { japanese: "解釈共同体 (かいしゃくきょうどうたい)", english: "interpretive community" },
    { japanese: "期待の地平 (きたいのちへい)", english: "horizon of expectations" },
    { japanese: "古典化 (こてんか)", english: "classicization" },
    { japanese: "再評価 (さいひょうか)", english: "revaluation" },
    { japanese: "周縁化 (しゅうえんか)", english: "marginalization" }
  ],
  examples: [
    { japanese: "ヤウスの受容美学は、テクストの意味を作者の意図にも内在的構造にも還元せず、読者の歴史的読みの蓄積として捉える試みである。", english: "Jauss's reception aesthetics is an attempt to grasp the meaning of a text not by reducing it to authorial intention or to immanent structure but as an accumulation of readers' historical readings." },
    { japanese: "「源氏物語」の正典化は、平安期の即時的価値ではなく、中世以降の注釈学・近世の国学・近代の文学史記述という長い受容過程の所産である。", english: "The canonization of 'The Tale of Genji' is the product not of immediate Heian-era valuation but of the long reception process of medieval commentary scholarship, early modern kokugaku, and modern literary historiography." },
    { japanese: "宮沢賢治は生前ほとんど無名であったが、戦後の受容過程を通じて国民的作家へと変貌を遂げた。", english: "Miyazawa Kenji was nearly unknown in his lifetime but, through the postwar reception process, achieved transformation into a national writer." },
    { japanese: "正典は固定された目録ではなく、各時代の解釈共同体が不断に再構築する動的な構成体である。", english: "The canon is not a fixed inventory but a dynamic formation that the interpretive community of each era continuously reconstructs." },
    { japanese: "近代日本文学史の正典構成は、明治期の文学者たち自身による文学史記述によって、相当程度規定されてきた。", english: "The canonical formation of modern Japanese literary history has been considerably regulated by literary historiography written by Meiji-era literati themselves." },
    { japanese: "脱正典化の運動は、これまで周縁化されてきた女性作家・植民地出身作家・大衆文学を、文学史の中心へと引き入れる試みである。", english: "The movement of decanonization is an attempt to draw into the center of literary history women writers, writers from colonial origins, and popular literature that have been marginalized until now." }
  ],
  dialogue: [
    { speaker: "院生", japanese: "本論文では、樋口一葉の受容史を整理しようと考えております。", english: "In this paper, I am considering organizing the reception history of Higuchi Ichiyō." },
    { speaker: "指導教員", japanese: "良い対象です。一葉の受容は、いくつかの転換点を経ています。明治期の同時代評価、大正・昭和期の女流作家としての位置づけ、戦後フェミニズム批評以降の再評価——それぞれの位相を識別する必要があります。", english: "A good object. Ichiyō's reception has gone through several turning points. Contemporary evaluation in the Meiji era, positioning as a 'female writer' in the Taishō-Shōwa era, revaluation after postwar feminist criticism — each phase needs to be distinguished." },
    { speaker: "院生", japanese: "「女流」というカテゴリー自体が、受容史の中で構築された制度的概念である、という観点でしょうか。", english: "Is the standpoint that the very category of 'female writer' is an institutional concept constructed within the reception history?" },
    { speaker: "指導教員", japanese: "そのとおり。受容史研究は、テクストの「真の価値」を発掘する作業ではなく、価値そのものが歴史的に構成される過程を解明する作業です。", english: "Exactly. Reception history research is not the work of excavating the 'true value' of a text but the work of elucidating the process by which value itself is historically constituted." }
  ],
  dialogue_long: [
    { speaker: "院生", japanese: "本日は、近代日本文学正典の構成過程について、ご教示いただきたく存じます。漱石が「国民作家」として確立される過程を辿りたいのですが、出発点を見出せずにおります。", english: "Today I would like to receive instruction on the formation process of the modern Japanese literary canon. I want to trace the process by which Sōseki was established as a 'national writer,' but I have not been able to find a starting point." },
    { speaker: "指導教員", japanese: "良い問いです。漱石の正典化は、単一の出来事ではなく、複数の歴史的契機の重なりによって達成されています。少なくとも四つの契機を考えるべきでしょう。", english: "A good question. Sōseki's canonization is achieved not by a single event but by the overlapping of multiple historical occasions. At least four occasions should be considered." },
    { speaker: "院生", japanese: "ぜひお聞かせください。", english: "Please do tell me." },
    { speaker: "指導教員", japanese: "第一に、生前の朝日新聞連載という大衆的流通基盤。第二に、死後の弟子達——内田百閒、寺田寅彦、阿部能成——による「漱石神話」の構築。第三に、岩波書店「漱石全集」の出版が、大正期教養主義の中で正典的地位を確立した経緯。第四に、戦後教育における国語教科書への組み込み——これが現代に至るまで漱石を国民的作家として再生産している。", english: "First, the popular circulation base of newspaper serialization in the Asahi Shimbun during his lifetime. Second, the construction of 'Sōseki myth' after his death by disciples — Uchida Hyakken, Terada Torahiko, Abe Yoshishige. Third, the circumstances by which the publication of Iwanami Shoten's 'Sōseki Complete Works' established canonical status within Taishō-era cultivation-ism. Fourth, incorporation into national language textbooks in postwar education — which reproduces Sōseki as national writer down to the present." },
    { speaker: "院生", japanese: "正典化が、テクスト内在的価値ではなく、複数の制度的契機の集積であるということが、明瞭に見えてまいりました。", english: "It has become clear that canonization is not text-immanent value but the accumulation of multiple institutional occasions." },
    { speaker: "指導教員", japanese: "ピエール・ブルデューの「文学場」概念が、この種の分析に有効です。文学的価値は、文学場——出版社、批評家、教育機関、賞、文学史家——の総体において生産・流通・再生産されている。", english: "Pierre Bourdieu's concept of 'literary field' is effective for this kind of analysis. Literary value is produced, circulated, and reproduced in the totality of the literary field — publishers, critics, educational institutions, prizes, literary historians." },
    { speaker: "院生", japanese: "ブルデュー的視座を踏まえつつ、しかしながら、正典化の批判的検討は、必然的に脱正典化の問題系へと展開していくと存じます。漱石が中心化されることで、誰が周縁化されてきたか——という問いでございます。", english: "Building on the Bourdieusian standpoint, however, critical examination of canonization, I believe, necessarily develops into the problematic of decanonization. The question — by Sōseki being centered, who has been marginalized?" },
    { speaker: "指導教員", japanese: "鋭いご指摘です。漱石中心の正典構成は、同時代の女性作家——田村俊子、宮本百合子の前世代——を周縁化し、植民地出身の日本語作家——朝鮮出身の張赫宙、台湾出身の楊逵——を不可視化し、大衆文学——岡本綺堂、中里介山——を「文学」の外部に追いやってきた。これらの周縁化を批判的に問い直すのが、現代の脱正典化運動です。", english: "An incisive observation. Sōseki-centered canonical formation has marginalized contemporaneous women writers — Tamura Toshiko, the generation before Miyamoto Yuriko — invisibilized Japanese-language writers from colonial origins — Chang Hyŏk-chu from Korea, Yang Kui from Taiwan — and pushed popular literature — Okamoto Kidō, Nakazato Kaizan — outside of 'literature.' Critically reinterrogating these marginalizations is the contemporary decanonization movement." },
    { speaker: "院生", japanese: "脱正典化を、漱石への否定としてではなく、正典そのものの構成原理への批判的反省として位置づけるべき、ということですね。", english: "So decanonization should be positioned not as negation of Sōseki but as critical reflection on the constitutive principles of the canon itself." },
    { speaker: "指導教員", japanese: "そのとおり。漱石の文学的達成を否定するのではなく、漱石を頂点とする正典構成が何を見えなくしてきたかを問う——これが知的に誠実な脱正典化の作業です。", english: "Exactly. Not negating Sōseki's literary achievement but asking what the canonical formation with Sōseki at the apex has rendered invisible — this is the intellectually sincere work of decanonization." },
    { speaker: "院生", japanese: "論文の構想が見えてまいりました。漱石正典化の四契機を整理した上で、各契機が同時に行った周縁化を検討し、両者を総合して近代日本文学正典の構成原理そのものを批判的に解明する——という三段構成を考えております。", english: "The conception of the paper has come into view. After organizing the four occasions of Sōseki's canonization, I will examine the marginalizations each occasion simultaneously performed, and synthesize the two to critically elucidate the constitutive principles of the modern Japanese literary canon itself — I am considering a three-part composition." },
  ...
  idiom_glosses: [
    { idiom: "三十年河東、三十年河西 (さんじゅうねんかとう、さんじゅうねんかせい)", literal: "30 năm bờ đông, 30 năm bờ tây", meaning: "[文語・硬い] Chinese-derived saying — fortunes shift over generations; apt for describing canon flux: works rise and fall.", example: "三十年河東、三十年河西と申すように、正典の地位もまた歴史的変動を免れない。" },
    { idiom: "判官贔屓 (ほうがんびいき)", literal: "Yêu mến vị quan thẩm phán (Yoshitsune)", meaning: "[書き言葉・話し言葉] Sympathy for the underdog/loser — Japanese cultural pattern; can analyze how 判官贔屓 sentiment shapes which marginalized writers get rediscovered.", example: "宮沢賢治の戦後の再評価には、判官贔屓的読者心理の作用も見て取れよう。" },
    { idiom: "栄枯盛衰 (えいこせいすい)", literal: "Hưng và suy", meaning: "[文語・書き言葉] Rise and fall — phrase cho describing how once-celebrated authors fade and once-marginal authors rise.", example: "明治大正の文学者たちの栄枯盛衰を辿ることは、近代日本文学正典の構成原理を解明する作業に直結する。" },
    { idiom: "玉石混淆 (ぎょくせきこんこう)", literal: "Ngọc và đá lẫn lộn", meaning: "[書き言葉] Mix of gems and stones — phrase often deployed by canon defenders against decanonization (claim canonical works are gems, popular works stones); itself worth interrogating.", example: "「玉石混淆」という常套句は、しばしば正典擁護の言説として動員されるが、その「玉」と「石」の弁別自体が歴史的構築物に他ならない。" }
  ],
  ...
  exercises: [
    { type: "fill-blank", question: "正典は固定された目録ではなく、各時代の解釈共同体が不断に___する動的な構成体である。", answer: "再構築" },
    { type: "matching", instruction: "Ghép concept với theorist / Japanese reference.", pairs: [
      { japanese: "期待の地平", english: "Jauss — horizon of expectations" },
      { japanese: "文学場", english: "Bourdieu — literary field" },
      { japanese: "「日本文学」の成立", english: "Suzuki Sadami — modern construction of 'Japanese literature'" },
      { japanese: "解釈共同体", english: "Stanley Fish — interpretive community" }
    ] },
    { type: "translation", vietnamese: "Phong trào phi-điển-phạm-hóa là một nỗ lực kéo các tác giả nữ, các tác giả gốc thuộc địa, và văn học đại chúng — vốn bị đẩy ra ngoại vi — vào trung tâm của lịch sử văn học.", japanese: "脱正典化の運動は、これまで周縁化されてきた女性作家・植民地出身作家・大衆文学を、文学史の中心へと引き入れる試みである。" }
  ]
},
{
  id: 109,
  ...
  level: "C2",
  vocabulary: [
    { japanese: "理論的視座 (りろんてきしざ)", english: "theoretical standpoint" },
    { japanese: "形式主義 (けいしきしゅぎ)", english: "formalism" },
    { japanese: "新批評 (しんひひょう)", english: "New Criticism" },
    { japanese: "フェミニズム批評 (フェミニズムひひょう)", english: "feminist criticism" },
    { japanese: "ポストコロニアル批評 (ポストコロニアルひひょう)", english: "postcolonial criticism" },
    { japanese: "ジェンダー", english: "gender" },
    { japanese: "他者性 (たしゃせい)", english: "alterity" },
    { japanese: "オリエンタリズム", english: "Orientalism" },
    { japanese: "サバルタン", english: "subaltern" },
    { japanese: "差異 (さい)", english: "difference" }
  ],
  examples: [
    { japanese: "理論的視座の選択は中立的ではない。それ自体が政治的・倫理的決定である。", english: "The choice of theoretical standpoint is not neutral. It is itself a political and ethical decision." },
    { japanese: "ロシア・フォルマリズムの異化作用 (オストラネーニエ) 概念は、文学性の核を「日常的知覚の自動化からの解放」に求めた。", english: "The concept of estrangement (ostranenie) of Russian Formalism located the core of literariness in 'liberation from the automation of everyday perception.'" },
    { japanese: "ショーウォルターの「ガイノクリティシズム」は、女性作家の伝統そのものを独立した分析対象として確立する試みであった。", english: "Showalter's 'gynocriticism' was an attempt to establish the tradition of women writers itself as an independent object of analysis." },
    { japanese: "サイードの「オリエンタリズム」は、西欧による東洋表象が知と権力の癒着の所産であることを暴いた。", english: "Said's 'Orientalism' exposed that Western representations of the Orient are the product of the adhesion between knowledge and power." },
    { japanese: "スピヴァクの「サバルタンは語ることができるか」という問いは、被抑圧者の声を媒介する者の立場性を厳しく問題化する。", english: "Spivak's question 'Can the subaltern speak?' rigorously problematizes the positionality of those who mediate the voices of the oppressed." },
    { japanese: "理論を機械的にテクストに当てはめる読み方は、テクストの具体性を消去し、理論の例証に堕する危険がある。", english: "A reading that mechanically applies theory to text harbors the danger of erasing the concreteness of the text and degenerating into mere illustration of theory." }
  ],
  dialogue: [
    { speaker: "院生", japanese: "ジェンダー批評で「人間失格」を読みたいのですが、太宰の自伝的内容と、ジェンダー分析とを、いかに接合すればよろしいでしょうか。", english: "I want to read 'No Longer Human' through gender criticism, but how should I join Dazai's autobiographical content and gender analysis?" },
    { speaker: "指導教員", japanese: "二段階で考えるとよい。第一に、テクスト内の女性人物造形——「葉蔵」が関わる女性たちの描かれ方——のジェンダー分析。第二に、それを支える私小説形式自体のジェンダー的政治性——「告白する男性主体」と「告白される女性他者」という非対称構造——への批判。", english: "Think in two stages. First, gender analysis of the female character construction within the text — the way the women that 'Yōzō' relates to are depicted. Second, criticism of the gender politics of the I-novel form itself supporting it — the asymmetric structure of 'confessing male subject' and 'confessed female other.'" },
    { speaker: "院生", japanese: "後者の方が、より構造的な分析になりますね。", english: "The latter would become a more structural analysis." },
    { speaker: "指導教員", japanese: "そう。形式自体のジェンダー的政治性を問うことが、フェミニズム批評の真価が発揮される場面です。内容批評にとどまる読みは、表面的に終わりがちです。", english: "Yes. Asking after the gender politics of form itself is the scene where the true value of feminist criticism is demonstrated. Readings that stop at content criticism tend to end up superficial." }
  ],
  dialogue_long: [
    { speaker: "院生", japanese: "本日は、複数の理論的視座を一つの論文で扱う際の方法論について、ご相談させていただきたく存じます。私の論文では、植民地期日本語文学を、ポストコロニアル批評とフェミニズム批評の両面から論じたいと考えておりますが、二つの理論を並列するのか、一方を主軸にするのか、判断がついておりません。", english: "Today I would like to consult about methodology when dealing with multiple theoretical standpoints in one paper. In my paper, I want to discuss colonial-era Japanese-language literature from both postcolonial criticism and feminist criticism, but I have not been able to judge whether to place the two theories in parallel or to make one the main axis." },
    { speaker: "指導教員", japanese: "重要な問題系です。複数理論の扱いには、概ね三つのアプローチがあります。第一に、並列適用——一つの対象に対して複数の理論を順次適用する。第二に、階層的統合——一つの理論を主軸とし、他を補助的に位置づける。第三に、交差点分析——複数の理論が交差する地点を分析対象として設定する。", english: "An important problematic. There are broadly three approaches to handling multiple theories. First, parallel application — sequentially applying multiple theories to one object. Second, hierarchical integration — making one theory the main axis and positioning others auxiliarily. Third, intersection analysis — setting the point where multiple theories intersect as the object of analysis." },
    { speaker: "院生", japanese: "並列適用は、いかなる弊害がございますでしょうか。", english: "What kind of drawback does parallel application have?" },
    { speaker: "指導教員", japanese: "並列適用は、論文の見かけは「総合的」ですが、実際には各理論が独立に動くため、相互照射が起こりません。「ポストコロニアル的にはこう読める、フェミニズム的にはこう読める」と並べるだけでは、知的進歩がない。", english: "Parallel application appears 'comprehensive' on the surface in the paper, but in reality, since each theory moves independently, mutual illumination does not occur. Merely lining up 'postcolonially it can be read this way, feminist-wise it can be read this way' brings no intellectual progress." },
    { speaker: "院生", japanese: "では、交差点分析が、私の対象には適切でしょうか。植民地期日本語文学における女性作家——朝鮮人女性作家、台湾人女性作家——を扱う場合、ジェンダーと植民地性が二重に作用しているわけですから。", english: "Then, would intersection analysis be appropriate for my object? When dealing with women writers in colonial-era Japanese-language literature — Korean women writers, Taiwanese women writers — gender and coloniality are operating doubly." },
    { speaker: "指導教員", japanese: "そのとおり。スピヴァクが論じた通り、植民地化された女性は二重の沈黙化を被る。被植民者として、そして女性として。この二重性そのものを分析対象とすれば、二つの理論を機械的に並列するのではなく、両者の交差点に独自の問題系を見出すことができます。", english: "Exactly. As Spivak argued, colonized women suffer double silencing. As the colonized, and as women. If you make this very doubleness the object of analysis, instead of mechanically placing the two theories in parallel, you can find an original problematic at their intersection." },
    { speaker: "院生", japanese: "クレンショーの「インターセクショナリティ」概念を、東アジア植民地文脈に適用する形でしょうか。", english: "Would it be in the form of applying Crenshaw's concept of 'intersectionality' to the East Asian colonial context?" },
    { speaker: "指導教員", japanese: "クレンショーは出発点として有効ですが、彼女の理論は北米黒人女性の経験に基づいて構築されたため、東アジア植民地文脈にそのまま適用すると、文脈の特異性が見失われる。スピヴァクの方が、植民地状況の複雑性により敏感です。さらに日本語圏に絞れば、金石範、李恢成らの研究を踏まえた上で、新たな概念枠組みを構築する必要が出てきます。", english: "Crenshaw is effective as a starting point, but since her theory was constructed based on the experience of Black women in North America, applying it directly to the East Asian colonial context loses the specificity of context. Spivak is more sensitive to the complexity of colonial situations. Furthermore, narrowing to the Japanese-language sphere, after taking into account the research of Kim Sŏkpŏm and Yi Hoesŏng, the need arises to construct a new conceptual framework." },
    { speaker: "院生", japanese: "理論を移植するのではなく、対象に応じて理論自体を再構築する——という方向ですね。", english: "Not transplanting theory but reconstructing theory itself in accordance with the object — that direction." },
    { speaker: "指導教員", japanese: "そう。これが理論的視座の応用における成熟した態度です。理論はテクストに当てはめるための道具ではなく、テクストとの対話を通じて自身が変容する仮説的枠組みである。", english: "Yes. This is the mature attitude in applying theoretical standpoints. Theory is not a tool to be applied to a text but a hypothetical framework that itself transforms through dialogue with the text." },
    { speaker: "院生", japanese: "肝に銘じます。スピヴァク、クレンショーを批判的に踏まえつつ、東アジア植民地状況の特異性に応じて理論枠組みを再構築する形で、論文を進めてまいります。", english: "I take that to heart. Critically taking into account Spivak and Crenshaw while reconstructing the theoretical framework in accordance with the specificity of the East Asian colonial situation, I will advance the paper." },
    { speaker: "指導教員", japanese: "結構です。野心的な構想ですが、十分に達成可能です。次回までに、章立て案をお持ちください。", english: "Very well. An ambitious conception, but sufficiently achievable. Please bring a chapter outline draft by next time." }
  ],
  roleplay_prompts: [
  ...
  idiom_glosses: [
    { idiom: "差異と反復 (さいとはんぷく)", literal: "Khác biệt và lặp lại", meaning: "[書き言葉] Difference and repetition — Deleuzian phrase, deeply influential trong Japanese theory; meta-concept for analyzing patterns of similarity-with-variation.", example: "本研究は、複数の植民地状況における差異と反復の構造を分析する試みである。" },
    { idiom: "両刃の剣 (もろはのつるぎ)", literal: "Gươm hai lưỡi", meaning: "[書き言葉・話し言葉] Double-edged sword — apt cho theory: powerful illumination but also risk of forced reading. Self-aware deployment.", example: "理論的視座は両刃の剣である。鋭い分析を可能にする一方、テクストの固有性を消去する危険を伴う。" },
    { idiom: "不偏不党 (ふへんふとう)", literal: "Không thiên không đảng", meaning: "[文語・硬い] Impartial, non-partisan — sometimes claimed as scholarly virtue, but C2 critic knows pure neutrality impossible; ideological position must be acknowledged.", example: "「不偏不党」を標榜する読みもまた、それ自体が一つの政治的立場性を含意する。" },
    { idiom: "我が意を得たり (わがいをえたり)", literal: "Đắc ý của ta", meaning: "[文語] Found my own intent expressed — phrase for finding theoretical framework that captures what one was already thinking; useful at moment of theoretical commitment.", example: "サイードの所論に接した時、我が意を得たりとの感を抱いた。" }
  ],
  ...
  exercises: [
    { type: "fill-blank", question: "理論を機械的にテクストに当てはめる読み方は、テクストの___性を消去し、理論の例証に堕する危険がある。", answer: "具体" },
    { type: "matching", instruction: "Ghép concept với theorist.", pairs: [
      { japanese: "異化作用", english: "Russian Formalism — Shklovsky's ostranenie" },
      { japanese: "ガイノクリティシズム", english: "Showalter — gynocriticism" },
      { japanese: "オリエンタリズム", english: "Said — Orientalism" },
      { japanese: "サバルタンは語ることができるか", english: "Spivak — 'Can the Subaltern Speak?'" }
    ] },
    { type: "translation", vietnamese: "Việc lựa chọn lăng kính lý thuyết không trung lập. Nó tự thân là một quyết định chính trị và đạo đức.", japanese: "理論的視座の選択は中立的ではない。それ自体が政治的・倫理的決定である。" }
  ]
},
{
  id: 110,
  ...
  level: "C2",
  vocabulary: [
    { japanese: "冒頭 (ぼうとう)", english: "opening" },
    { japanese: "問題提起 (もんだいていき)", english: "problem-setting" },
    { japanese: "問題系 (もんだいけい)", english: "problematic" },
    { japanese: "通説 (つうせつ)", english: "received view / consensus" },
    { japanese: "通念 (つうねん)", english: "common notion" },
    { japanese: "再検討 (さいけんとう)", english: "reexamination" },
    { japanese: "立論 (りつろん)", english: "constructing argument" },
    { japanese: "射程 (しゃてい)", english: "scope / reach" },
    { japanese: "切り口 (きりくち)", english: "angle / approach" },
    { japanese: "問いの設定 (といのせってい)", english: "framing the question" }
  ],
  examples: [
    { japanese: "優れた批評の冒頭は、読者に「なぜ、いま、この問いか」を即座に納得させる力を持つ。", english: "The opening of an excellent critical essay possesses the power to instantly persuade the reader 'why, now, this question.'" },
    { japanese: "通説に挑む論文においては、冒頭で通説を正確に再構成することが、批判の前提となる。", english: "In papers challenging received view, accurately reconstructing the received view at the opening becomes the premise of the critique." },
    { japanese: "問題提起は、抽象的命題ではなく、具体的テクストの細部から立ち上げるのが肝要である。", english: "Problem-setting — it is essential to raise it not from an abstract proposition but from the details of a concrete text." },
    { japanese: "「〜が論じられてきた。しかし、〜の点については、十分な検討がなされてこなかった」——この構文は、学術論文冒頭の最も基本的な型である。", english: "'X has been discussed. However, regarding Y, sufficient examination has not been carried out.' This syntax is the most fundamental form of the academic paper opening." },
    { japanese: "蓮實重彦の評論冒頭は、しばしば一つの細部の指摘から、長大な論を立ち上げる手法を取る。", english: "Hasumi Shigehiko's critical essay openings often take a method of raising a long argument from the indication of a single detail." },
    { japanese: "批評文の冒頭は、論文の地図であると同時に、読者を読みへと誘う門である。", english: "The opening of a critical essay is simultaneously the map of the paper and the gate inviting the reader into reading." }
  ],
  dialogue: [
    { speaker: "院生", japanese: "論文の冒頭が、何度書き直しても定まりません。背景説明が長くなり、問題提起にたどり着く前に読者を疲れさせてしまいます。", english: "The opening of my paper, no matter how many times I rewrite it, will not settle. Background explanation grows long, and I tire the reader before reaching the problem-setting." },
    { speaker: "指導教員", japanese: "背景の長さが原因ですね。三段階を試みなさい。第一文で対象テクストの細部を提示。第二文でその細部が呼び起こす疑問を述べる。第三文で本論文の問いを設定する。背景説明はその後でよい。", english: "The length of the background is the cause. Try three stages. In the first sentence, present a detail of the target text. In the second, state the question that detail raises. In the third, set the question of this paper. Background explanation can come after." },
    { speaker: "院生", japanese: "細部から問いへ、問いから本論へ、という展開でしょうか。", english: "Is it the development from detail to question, from question to main argument?" },
    { speaker: "指導教員", japanese: "そのとおり。蓮實重彦が好んで用いる手法です。一字一句から論を立ち上げる。冒頭で読者の精読的注意を喚起できれば、論文全体への信頼が確保されます。", english: "Exactly. A method that Hasumi Shigehiko favors. Raising an argument from a single word or phrase. If you can call forth the reader's close-reading attention at the opening, trust in the entire paper is secured." }
  ],
  dialogue_long: [
    { speaker: "院生", japanese: "本日は、批評論文の冒頭部分について、ご指導いただきたく存じます。私の論文の冒頭を読んでいただいたところ、「対象が見えない」とのご指摘をいただきましたが、いかに改善すべきか、判断がついておりません。", english: "Today I would like to receive guidance on the opening section of a critical essay. When I had you read the opening of my paper, you indicated 'the object is not visible.' But I have not been able to judge how to improve it." },
    { speaker: "指導教員", japanese: "現在の冒頭では、戦後文学の一般的状況の説明が三段落続いています。これは「本論文は何について論じるのか」を読者から隠してしまう構造です。読者は、なぜこの背景説明を読まされているか分からず、注意を失います。", english: "In the current opening, explanation of the general state of postwar literature continues for three paragraphs. This is a structure that hides 'what is this paper discussing' from the reader. The reader does not understand why they are being made to read this background explanation, and loses attention." },
    { speaker: "院生", japanese: "背景から具体的対象へと、読者を導入する古典的順序のつもりだったのですが。", english: "I intended the classical order of leading the reader from background to concrete object." },
    ...
    { speaker: "院生", japanese: "具体的に、いかなる冒頭が望ましいでしょうか。", english: "Concretely, what kind of opening would be desirable?" },
    { speaker: "指導教員", japanese: "三つの型があります。第一に、対象テクストからの引用を冒頭に置き、その引用が孕む問題を即座に指摘する型。第二に、対象テクストの細部——一語、一句、一場面——を提示し、その細部の意外性から論を立ち上げる型。第三に、対象テクストをめぐる通説を要約し、その通説への疑問を即座に提起する型。いずれも、冒頭の数行で「対象は何か、問いは何か」を明示します。", english: "There are three forms. First, the form of placing a quotation from the target text at the opening and immediately indicating the problem the quotation harbors. Second, the form of presenting a detail of the target text — one word, one phrase, one scene — and raising the argument from the unexpectedness of that detail. Third, the form of summarizing the received view surrounding the target text and immediately raising doubt about that received view. Each form, in the first few lines, makes explicit 'what is the object, what is the question.'" },
    { speaker: "院生", japanese: "私の論文の場合は、村上春樹「ねじまき鳥クロニクル」における満州・モンゴル戦争記憶の問題を扱っております。いずれの型が適切でございましょうか。", english: "In the case of my paper, I am dealing with the problem of memory of the Manchuria-Mongolia war in Murakami Haruki's 'The Wind-Up Bird Chronicle.' Which form would be appropriate?" },
    { speaker: "指導教員", japanese: "あなたの対象であれば、第二の型——細部から立ち上げる型——が最も効果的でしょう。例えば、井戸の底でノモンハンの記憶が語られるという構造の異常性を、冒頭で指摘する。「なぜ、戦争の記憶は、井戸の底という形象を必要としたのか」——この問いを冒頭で立ち上げれば、読者は即座に論文の核心へと引き込まれます。", english: "For your object, the second form — the form raising from detail — would be most effective. For example, indicate at the opening the abnormality of the structure that the memory of Nomonhan is narrated at the bottom of a well. 'Why did the memory of war require the figuration of the bottom of a well?' — if you raise this question at the opening, the reader is instantly drawn into the core of the paper." },
    { speaker: "院生", japanese: "通説の要約は、いつ提示すればよろしいでしょうか。", english: "When should I present the summary of received view?" },
    { speaker: "指導教員", japanese: "問いを立ち上げた後、第二段落で先行研究の要約に入る形が定石です。「〜については、これまで〜と論じられてきた。しかし、〜の点については、十分な検討がなされてこなかった」——この構文で、通説の確認と本論文の差別化を同時に行います。", english: "After raising the question, entering into the summary of prior research in the second paragraph is the standard form. 'Regarding X, it has been discussed as Y until now. However, regarding Z, sufficient examination has not been carried out' — with this syntax, you simultaneously confirm the received view and differentiate this paper." },
    { speaker: "院生", japanese: "理論的視座の提示は、いつ行うべきでしょうか。", english: "When should I present the theoretical standpoint?" },
    { speaker: "指導教員", japanese: "第三段落で、本論文の理論的視座と方法論を簡潔に提示する。理論をテクストに先行させるのではなく、テクストの読みから要請される理論を選んだ、という形で提示するのが望ましい。", english: "In the third paragraph, briefly present the theoretical standpoint and methodology of this paper. It is desirable to present them not by making theory precede the text but in the form of having selected theory demanded by the reading of the text." },
    { speaker: "院生", japanese: "つまり、細部からの問題提起、先行研究の整理、理論的視座の提示——この三段構成を、論文冒頭三段落に圧縮する、ということでございますね。", english: "In other words, problem-setting from detail, organization of prior research, presentation of theoretical standpoint — to compress this three-part composition into the first three paragraphs of the paper." },
    { speaker: "指導教員", japanese: "そう。冒頭三段落で、読者は本論文の対象、問い、立場を把握できる。これが批評論文冒頭の理想的構造です。書き直してお見せください。", english: "Yes. In the first three paragraphs, the reader can grasp the object, question, and stance of this paper. This is the ideal structure of a critical essay opening. Rewrite it and show me." },
    { speaker: "院生", japanese: "肝に銘じます。来週までに、井戸とノモンハンの細部から立ち上げる新たな冒頭を、ご持参いたします。", english: "I take that to heart. By next week, I will bring a new opening that raises from the detail of the well and Nomonhan." }
  ],
  roleplay_prompts: [
  ...
  idiom_glosses: [
    { idiom: "起承転結 (きしょうてんけつ)", literal: "Khởi - thừa - chuyển - kết", meaning: "[書き言葉・話し言葉] Classical 4-part composition (Chinese poetics origin); often invoked but C2 critic knows mature critical writing transcends formula.", example: "起承転結の図式は便利だが、批評論文の冒頭は、起の部分のみで読者を惹きつける必要がある。" },
    { idiom: "単刀直入 (たんとうちょくにゅう)", literal: "Đao đơn xông thẳng vào", meaning: "[書き言葉・話し言葉] Get straight to the point — virtue cho critical essay opening; opposite of meandering preamble.", example: "批評論文の冒頭は、単刀直入を旨とすべきであり、長大な背景説明は読者の集中を削ぐ。" },
    { idiom: "口火を切る (くちびをきる)", literal: "Khai hỏa", meaning: "[書き言葉・話し言葉] Light the fuse / start the discussion — apt cho opening that initiates major debate; high-energy framing.", example: "本論文は、〜をめぐる長年の通説に再考を促す議論の口火を切ることを目指すものである。" },
    { idiom: "枕 (まくら)", literal: "Cái gối — phần dạo đầu", meaning: "[書き言葉・話し言葉] 落語 origin — opening throat-clearing or anecdote; modern critical essay should minimize 枕, get to substance.", example: "枕にあたる部分が長すぎる論文は、読者の信頼を失いがちである。" }
  ],
  ...
  exercises: [
    { type: "fill-blank", question: "問題提起は、抽象的命題ではなく、具体的テクストの___から立ち上げるのが肝要である。", answer: "細部" },
    { type: "matching", instruction: "Ghép opening device với function.", pairs: [
      { japanese: "〜については、これまで〜と論じられてきた。しかし、〜の点については、十分な検討がなされてこなかった", english: "standard challenge-to-received-view opening" },
      { japanese: "〜の冒頭部における〜という細部は、しばしば看過されてきた", english: "Hasumi-style detail-driven opening" },
      { japanese: "もし〜ならば、〜という結論が必然的に導かれる", english: "Karatani-style hypothetical-conditional opening" },
      { japanese: "本研究は、〜の視座から接近する", english: "theoretical stance announcement" }
    ] },
    { type: "translation", vietnamese: "Phần mở đầu của một bài phê bình xuất sắc có sức mạnh thuyết phục người đọc tức thì rằng 'tại sao, ngay bây giờ, chính câu hỏi này.'", japanese: "優れた批評の冒頭は、読者に「なぜ、いま、この問いか」を即座に納得させる力を持つ。" }
  ]
},
{
  id: 111,
  ...
  vocabulary: [
    { japanese: "異論 (いろん)", english: "dissenting view" },
    { japanese: "異読 (いどく)", english: "alternative reading" },
    { japanese: "通説への挑戦 (つうせつへのちょうせん)", english: "challenge to received view" },
    { japanese: "傍証 (ぼうしょう)", english: "corroborating evidence" },
    { japanese: "反証 (はんしょう)", english: "counter-evidence" },
    { japanese: "弁証 (べんしょう)", english: "argumentation / defense" },
    { japanese: "立証責任 (りっしょうせきにん)", english: "burden of proof" },
    { japanese: "論駁 (ろんばく)", english: "refutation" },
    { japanese: "蓋然性 (がいぜんせい)", english: "probability / plausibility" },
    { japanese: "解釈学的循環 (かいしゃくがくてきじゅんかん)", english: "hermeneutic circle" }
  ],
  examples: [
    { japanese: "通説に挑む読みは、通説を提示する論者以上に、テクストへの精緻な参照と論理的厳密性を要求される。", english: "A reading that challenges received view is demanded textual reference more meticulous and logical rigor more rigorous than even the proponents of the received view." },
    { japanese: "「ノルウェイの森」の語り手「僕」を信頼できない語り手として読むことは、十分な傍証なくして主張すれば、無謀な解釈と退けられかねない。", english: "Reading the narrator 'boku' of 'Norwegian Wood' as an unreliable narrator — if asserted without sufficient corroborating evidence, may be dismissed as a reckless interpretation." },
    { japanese: "異読を提起する論者は、想定される反論を予め論文内で展開し、論駁する責任を負う。", english: "A scholar proposing an alternative reading bears the responsibility of developing and refuting anticipated counter-arguments in advance within the paper itself." },
    { japanese: "「漱石は実は厭世主義者ではない」と主張するならば、厭世主義的読みの根拠となってきた具体的箇所を、一つ一つ別解釈で再検討する必要がある。", english: "If one asserts that 'Sōseki is in fact not a pessimist,' there is a need to reexamine, one by one with alternative interpretations, the concrete passages that have been the grounds for pessimistic readings." },
    { japanese: "論争的読みの提示においては、自身の立場の蓋然性のみならず、対立解釈の蓋然性をも公正に評価することが、知的誠実の証である。", english: "In presenting a controversial reading, fairly evaluating not only the plausibility of one's own position but also the plausibility of opposing interpretations is the proof of intellectual sincerity." },
    { japanese: "解釈の正当性は、単一の決定的証拠ではなく、複数の傍証の収束によって支えられる。", english: "The validity of an interpretation is supported not by a single decisive piece of evidence but by the convergence of multiple corroborating pieces." }
  ],
  dialogue: [
    { speaker: "院生", japanese: "「ノルウェイの森」の「僕」を信頼できない語り手として読む論を、学会で発表する予定です。しかし、反論への準備が整いません。", english: "I plan to present at the conference an argument reading 'boku' of 'Norwegian Wood' as an unreliable narrator. However, my preparation for counter-arguments is not in order." },
    { speaker: "指導教員", japanese: "想定される最強の反論を、自身で予め定式化しなさい。それに答えられなければ、論文として未熟です。", english: "Formulate the strongest anticipated counter-argument yourself in advance. If you cannot answer it, the paper is immature." },
    { speaker: "院生", japanese: "最強の反論は、「僕」の語りには明白な不一致や誤りがなく、信頼できない語り手と読む積極的根拠を欠く、というものでございましょう。", english: "The strongest counter-argument would be that 'boku's' narration has no clear inconsistency or error, lacking active grounds for reading as unreliable." },
    { speaker: "指導教員", japanese: "それに対するあなたの応答は。", english: "Your response to that?" },
    { speaker: "院生", japanese: "明示的不一致ではなく、自身の感情への異常なまでの距離感、登場人物の死への非常に冷静な反応、これらの「不在」が、別種の不信頼性を構成する——という形で答えるつもりでございます。", english: "Not explicit inconsistency, but an abnormally extreme distance from his own emotions, an extraordinarily calm reaction to characters' deaths — these 'absences' constitute a different type of unreliability — I intend to answer in that form." },
    { speaker: "指導教員", japanese: "「不在による不信頼性」という概念は、それ自体に立証責任が伴います。先行研究で類似概念が提唱されているか、調べた上で位置づけなさい。", english: "The concept of 'unreliability through absence' itself bears burden of proof. Investigate whether similar concepts are proposed in prior research, and position yours accordingly." }
  ],
  dialogue_long: [
    { speaker: "院生", japanese: "本日は、論争的読みの提示と防衛について、ご教示いただきたく存じます。私の論文は、谷崎潤一郎の「春琴抄」の語り手「私」が、実は信頼できない語り手であり、佐助・春琴関係の表象を歪めている可能性を提起するものです。しかし、これは長年の谷崎研究の通説に挑むものであり、不安を覚えております。", english: "Today I would like to receive instruction on presenting and defending controversial readings. My paper proposes the possibility that the narrator 'I' of Tanizaki Jun'ichirō's 'A Portrait of Shunkin' is actually an unreliable narrator and distorts the representation of the Sasuke-Shunkin relationship. However, this challenges the long-standing received view of Tanizaki studies, and I feel anxiety." },
    { speaker: "指導教員", japanese: "意欲的な読みです。しかしながら、通説に挑む論文は、通常の論文よりも遥かに高い論理的厳密性が要求されます。三つの点を確認させてください。第一に、あなたの読みは、テクストのどの具体的箇所に基づいていますか。第二に、想定される最強の反論を、いかに展開しますか。第三に、あなたの読みが採用された場合、谷崎研究全体にいかなる帰結をもたらしますか。", english: "An ambitious reading. However, papers challenging received view are demanded logical rigor far higher than ordinary papers. Let me confirm three points. First, on what concrete passages of the text is your reading based? Second, how will you develop the strongest anticipated counter-argument? Third, if your reading were adopted, what consequences would it bring to Tanizaki studies as a whole?" },
    { speaker: "院生", japanese: "第一の点につきまして。語り手「私」は冒頭で、佐助の伝記を編む立場として登場しますが、自身の佐助評価において、繰り返し「美しい」「敬うべき」という形容詞を用いる。これは、第三者的記述者にしては過剰な評価的姿勢であり、語り手自身の感情移入を示唆します。", english: "Regarding the first point. The narrator 'I' appears at the opening as one compiling Sasuke's biography, but in his own evaluation of Sasuke, he repeatedly uses the adjectives 'beautiful' and 'reverence-worthy.' This is an excessive evaluative stance for a third-party describer, suggesting the narrator's own emotional involvement." },
    { speaker: "指導教員", japanese: "良い観察です。しかし、それのみでは「信頼できない」結論には届きません。語り手の感情移入は、必ずしも信頼性を損なうとは限らない。むしろ、感情移入の方向性が、語りの内容を歪めている具体的箇所を示す必要があります。", english: "A good observation. However, that alone does not reach the conclusion of 'unreliable.' The narrator's emotional involvement does not necessarily impair reliability. Rather, you need to show concrete passages where the direction of emotional involvement distorts the content of the narration." },
    { speaker: "院生", japanese: "ご指摘の通りでございます。具体的箇所として、佐助による春琴の容貌描写を、語り手が無批判に受け入れている点が挙げられます。佐助の主観的描写を「事実」として伝えることで、春琴像が佐助の幻想化された像へと固定化されている。", english: "As you indicate. As a concrete passage, the point that the narrator uncritically accepts Sasuke's description of Shunkin's appearance can be cited. By transmitting Sasuke's subjective description as 'fact,' the image of Shunkin is fixed into Sasuke's idealized image." },
    { speaker: "指導教員", japanese: "ここから論を立ち上げるのは可能です。語り手が佐助の主観的描写を批判的距離なく受け入れているという読みは、テクスト的に立証可能でしょう。第二の点——想定される反論——に進みましょう。", english: "It is possible to raise the argument from here. The reading that the narrator accepts Sasuke's subjective description without critical distance is textually demonstrable. Let us proceed to the second point — anticipated counter-arguments." },
    { speaker: "院生", japanese: "最強の反論は、「『春琴抄』全体が、佐助の春琴幻想を主題化する作品であり、語り手の佐助への共感はテクストの主題と整合的である」というものでございます。つまり、語り手の不信頼性ではなく、作品全体の主題的選択である、という反論です。", english: "The strongest counter-argument is that ''A Portrait of Shunkin' as a whole is a work that thematizes Sasuke's idealization of Shunkin, and the narrator's empathy with Sasuke is consistent with the work's theme.' In other words, not the narrator's unreliability but the thematic choice of the work as a whole — that counter-argument." },
    { speaker: "指導教員", japanese: "その反論は強力です。あなたの応答は。", english: "That counter-argument is powerful. Your response?" },
    { speaker: "院生", japanese: "二段の応答を準備しております。第一に、主題的選択であったとしても、それを認識する装置として、語り手の不信頼性が機能している、という構造的読み。第二に、谷崎自身の他作品——「痴人の愛」「卍」など——における語り手の信頼性問題と比較し、谷崎が一貫して信頼できない語り手を用いる作家である、という外的傍証。", english: "I am preparing a two-stage response. First, even if it were a thematic choice, the structural reading that the narrator's unreliability functions as the device that makes one recognize that. Second, comparing with the narrator's reliability problem in Tanizaki's other works — 'Naomi,' 'Quicksand' — the external corroboration that Tanizaki is consistently a writer who uses unreliable narrators." },
    { speaker: "指導教員", japanese: "二段の応答、有効です。第三の点——谷崎研究全体への帰結——についてはいかがですか。", english: "The two-stage response is effective. What about the third point — the consequences for Tanizaki studies as a whole?" },
    { speaker: "院生", japanese: "もし「春琴抄」が信頼できない語り手による作品と認識されれば、谷崎の語りの戦略全体に対する再評価が要請されます。長年「客観的描写」「フェティシズムの主題化」と読まれてきた谷崎作品が、実は「語りの不信頼性そのものを主題化する」より自己反省的な文学として読み直される可能性が開けます。", english: "If 'A Portrait of Shunkin' is recognized as a work by an unreliable narrator, reevaluation of Tanizaki's entire narrative strategy is demanded. The possibility opens that Tanizaki's works, which have long been read as 'objective description' or 'thematization of fetishism,' may be reread as more self-reflexive literature that 'thematizes the unreliability of narration itself.'" },
    { speaker: "指導教員", japanese: "野心的な含意です。論文として、十分に展開可能です。ただし、最後にお伝えしたいのは、論争的読みは、提示の仕方によって受容が大きく異なる、ということです。同じ内容でも、傲慢な口調で書けば反発を招き、知的に謙虚な口調で書けば真剣に検討される。論争的内容ほど、修辞的慎重さが要請されます。", english: "Ambitious implications. As a paper, fully developable. However, what I want to convey at the end is that the reception of controversial readings differs greatly according to the manner of presentation. Even with the same content, written in an arrogant tone, it invites repulsion; written in an intellectually humble tone, it is seriously considered. The more controversial the content, the more rhetorical caution is demanded." },
    { speaker: "院生", japanese: "肝に銘じます。「通説を覆す」のではなく、「通説の前提そのものを再検討する」という枠組みで、修辞的に位置づけてまいります。", english: "I take that to heart. Not 'overturning the received view' but 'reexamining the very premises of the received view' — within that framework, I will position it rhetorically." }
  ],
  roleplay_prompts: [
  ...
  idiom_glosses: [
    { idiom: "石橋を叩いて渡る (いしばしをたたいてわたる)", literal: "Đập cầu đá rồi mới qua", meaning: "[書き言葉・話し言葉] Test stone bridge before crossing — extreme caution; apt cho preparation of controversial readings: test every step before presentation.", example: "通説に挑む論文は、石橋を叩いて渡るほどの慎重さで論証を組み立てる必要がある。" },
    { idiom: "孤軍奮闘 (こぐんふんとう)", literal: "Đơn quân chiến đấu hết mình", meaning: "[書き言葉] Lone army fighting hard — apt cho minority position holder; signals respect for solitary intellectual courage.", example: "数十年にわたって少数派の読みを擁護し続けた氏の孤軍奮闘ぶりは、近年ようやく正当に評価されつつある。" },
    { idiom: "両論併記 (りょうろんへいき)", literal: "Đặt hai luận điểm song hành", meaning: "[書き言葉] Presenting both views in parallel — sometimes proper response to genuine disagreement; signals intellectual fairness.", example: "現段階では、両論併記の上で読者の判断に委ねるのが妥当であろう。" },
    { idiom: "前車の覆るは後車の戒め (ぜんしゃのくつがえるはこうしゃのいましめ)", literal: "Xe trước lật là bài học cho xe sau", meaning: "[文語・硬い] Predecessor's failure as warning — apt cho learning from prior controversial-reading failures before mounting your own.", example: "過去の通説挑戦が失敗に終わった経緯を踏まえずに同種の論を立てれば、前車の覆るは後車の戒めという譏りを免れまい。" }
  ],
  ...
  exercises: [
    { type: "fill-blank", question: "通説に挑む読みは、通説を提示する論者以上に、テクストへの精緻な参照と論理的___性を要求される。", answer: "厳密" },
    { type: "matching", instruction: "Ghép cụm với rhetorical function.", pairs: [
      { japanese: "通説の前提そのものを再検討する", english: "humble framing of radical content" },
      { japanese: "想定される反論として、〜があり得よう", english: "preemptive engagement with counter-argument" },
      { japanese: "〜氏の読みを最大限に評価しつつ", english: "respectful engagement with opposing scholar" },
      { japanese: "本論文の読みは〜を説明する反面、〜については別途の検討を要する", english: "honest acknowledgment of reading's limitations" }
    ] },
    { type: "translation", vietnamese: "Tính chính đáng của một cách giải thích được nâng đỡ không phải bởi một bằng chứng quyết định đơn nhất, mà bởi sự hội tụ của nhiều bằng chứng phụ trợ.", japanese: "解釈の正当性は、単一の決定的証拠ではなく、複数の傍証の収束によって支えられる。" }
  ]
}
];
