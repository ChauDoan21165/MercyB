...
export const lessons: ItalianLesson[] = [
  {
    ...
    vocabulary: [
      { word: "secondo me", en: "in my opinion", vi: "theo tôi", pos: "espr.", pronunciation_vi: "xê-CON-đô mê", pronunciation_en: "seh-KOHN-doh meh — literally 'according to me'; the go-to opinion opener" },
      { word: "il motivo", en: "reason", vi: "lý do", pos: "n.m.", pronunciation_vi: "il mô-TI-vô", pronunciation_en: "eel moh-TEE-voh — stress 'TEE'; pairs with 'il motivo principale' (the main reason)" },
      { word: "l'esempio", en: "example", vi: "ví dụ", pos: "n.m.", pronunciation_vi: "lê-DEM-pi-ô", pronunciation_en: "leh-ZEM-pyoh — s→'z' between vowels; 'per esempio' = for example" },
      { word: "il vantaggio", en: "advantage", vi: "lợi ích", pos: "n.m.", pronunciation_vi: "il van-TÁT-giô", pronunciation_en: "eel van-TAHD-joh — double-g is 'dj' and held; -ggio is one beat" },
      { word: "lo svantaggio", en: "disadvantage", vi: "bất lợi", pos: "n.m.", pronunciation_vi: "lô dvan-TÁT-giô", pronunciation_en: "loh zvan-TAHD-joh — 'lo' (not 'il') before s+consonant; sv- blends to 'zv'" },
      { word: "essere d'accordo", en: "to agree", vi: "đồng ý", pos: "v.", pronunciation_vi: "ét-xê-rê đác-COR-đô", pronunciation_en: "ES-seh-reh dak-KOR-doh — hold the double-c; 'sono d'accordo' = I agree" },
      { word: "però", en: "however / but", vi: "nhưng", pos: "cong.", pronunciation_vi: "pe-RÒ", pronunciation_en: "peh-ROH — final stress; softer/more conversational than 'ma'" },
      { word: "quindi", en: "therefore", vi: "vì vậy", pos: "cong.", pronunciation_vi: "QUIN-đi", pronunciation_en: "KWEEN-dee — 'qu' is 'kw'; stress the first syllable; links a conclusion" },
      { word: "anche se", en: "even though", vi: "mặc dù", pos: "cong.", pronunciation_vi: "AN-kê xê", pronunciation_en: "AHN-keh seh — 'che' here is 'keh'; introduces a concession" },
      { word: "infatti", en: "in fact / indeed", vi: "thật vậy", pos: "avv.", pronunciation_vi: "in-FÁT-ti", pronunciation_en: "een-FAHT-tee — hold the double-t; confirms what was just said" },
    ],
    dialogue: [
      { speaker: "A", text: "Secondo te, è importante imparare l'italiano?", en: "In your opinion, is it important to learn Italian?", vi: "Theo bạn, học tiếng Ý có quan trọng không?" },
      { speaker: "B", text: "Sì, secondo me è essenziale, perché aiuta al lavoro.", en: "Yes, in my opinion it's essential, because it helps at work.", vi: "Có, theo mình là cần thiết, vì nó giúp ích cho công việc." },
      { speaker: "A", text: "Però all'inizio è difficile, no?", en: "But at the start it's hard, right?", vi: "Nhưng lúc đầu khó nhỉ?" },
      { speaker: "B", text: "Sono d'accordo in parte, quindi consiglio di studiare ogni giorno.", en: "I partly agree, so I recommend studying every day.", vi: "Mình đồng ý một phần, vì vậy mình khuyên nên học mỗi ngày." },
    ],
    exercises: [
  ...
  },
  {
    ...
    vocabulary: [
      { word: "quando", en: "when", vi: "khi", pos: "cong.", pronunciation_vi: "QUAN-đô", pronunciation_en: "KWAHN-doh — 'qu' = 'kw'; opens a time clause" },
      { word: "all'inizio", en: "at first", vi: "ban đầu", pos: "espr.", pronunciation_vi: "al-li-NI-DZI-ô", pronunciation_en: "al-lee-NEE-tsyoh — double-l held; 'z' is 'ts'" },
      { word: "prima", en: "before", vi: "trước đây", pos: "avv.", pronunciation_vi: "PRI-ma", pronunciation_en: "PREE-mah — often pairs with imperfetto: 'prima lavoravo…'" },
      { word: "poi", en: "then", vi: "rồi, sau đó", pos: "avv.", pronunciation_vi: "pôi", pronunciation_en: "poy — single syllable; sequences events" },
      { word: "dopo", en: "after", vi: "sau", pos: "avv./prep.", pronunciation_vi: "ĐÔ-pô", pronunciation_en: "DOH-poh — 'dopo alcuni mesi' = after a few months" },
      { word: "alla fine", en: "in the end", vi: "cuối cùng", pos: "espr.", pronunciation_vi: "al-la FI-nê", pronunciation_en: "AL-lah FEE-neh — closes the story" },
      { word: "decidere", en: "to decide", vi: "quyết định", pos: "v.", pronunciation_vi: "đê-CI-đê-rê", pronunciation_en: "deh-CHEE-deh-reh — 'ho deciso di…' = I decided to…; takes 'di' + infinitive" },
      { word: "capire", en: "to understand", vi: "hiểu", pos: "v.", pronunciation_vi: "ca-PI-rê", pronunciation_en: "kah-PEE-reh — 'ho capito che…' = I understood that…" },
      { word: "rendersi conto", en: "to realize", vi: "nhận ra", pos: "v.", pronunciation_vi: "REN-đer-xi CON-tô", pronunciation_en: "REN-der-see KOHN-toh — 'mi sono reso/a conto che…' = I realized that…" },
      { word: "migliorare", en: "to improve", vi: "tiến bộ, cải thiện", pos: "v.", pronunciation_vi: "mi-li-ô-RA-rê", pronunciation_en: "mee-lyoh-RAH-reh — 'gli' soft 'ly'; stress 'RAH'" },
    ],
    dialogue: [
      { speaker: "A", text: "Com'è stato il tuo primo mese in Italia?", en: "How was your first month in Italy?", vi: "Tháng đầu ở Ý của bạn thế nào?" },
      { speaker: "B", text: "All'inizio avevo paura, non capivo niente.", en: "At first I was afraid, I didn't understand anything.", vi: "Ban đầu mình sợ, chẳng hiểu gì." },
      { speaker: "A", text: "E poi cosa hai fatto?", en: "And then what did you do?", vi: "Rồi bạn làm gì?" },
      { speaker: "B", text: "Ho deciso di studiare ogni giorno, e alla fine sono migliorato molto.", en: "I decided to study every day, and in the end I improved a lot.", vi: "Mình quyết định học mỗi ngày, và cuối cùng tiến bộ nhiều." },
    ],
    exercises: [
  ...
  },
  {
    ...
    vocabulary: [
      { word: "la residenza", en: "residency", vi: "nơi cư trú", pos: "n.f.", pronunciation_vi: "la rê-xi-ĐEN-dza", pronunciation_en: "lah reh-zee-DEN-tsah — official registered address" },
      { word: "il permesso di soggiorno", en: "residence permit", vi: "giấy phép cư trú", pos: "n.m.", pronunciation_vi: "il per-MÉS-xô đi xôt-GIOR-nô", pronunciation_en: "eel per-MES-soh dee sod-JOR-noh — the key immigration document" },
      { word: "il documento", en: "document", vi: "giấy tờ", pos: "n.m.", pronunciation_vi: "il đô-cu-MEN-tô", pronunciation_en: "eel doh-koo-MEN-toh — plural 'documenti'" },
      { word: "la domanda", en: "application / request", vi: "đơn", pos: "n.f.", pronunciation_vi: "la đô-MAN-đa", pronunciation_en: "lah doh-MAHN-dah — 'fare domanda' = to apply; also means 'question'" },
      { word: "la scadenza", en: "deadline / expiry", vi: "hạn chót", pos: "n.f.", pronunciation_vi: "la xca-ĐEN-dza", pronunciation_en: "lah skah-DEN-tsah — 'scade' = it expires" },
      { word: "aggiornare", en: "to update", vi: "cập nhật", pos: "v.", pronunciation_vi: "at-giôr-NA-rê", pronunciation_en: "ad-johr-NAH-reh — double-g held 'dj'" },
      { word: "servire", en: "to be needed", vi: "cần", pos: "v.", pronunciation_vi: "xer-VI-rê", pronunciation_en: "ser-VEE-reh — 'cosa serve?' = what's needed?" },
      { word: "compilare il modulo", en: "to fill in the form", vi: "điền mẫu", pos: "v.", pronunciation_vi: "côm-pi-LA-rê il MÔ-đu-lô", pronunciation_en: "kom-pee-LAH-reh eel MOH-doo-loh — 'modulo' = form, stress first syllable" },
      { word: "l'appuntamento", en: "appointment", vi: "lịch hẹn", pos: "n.m.", pronunciation_vi: "láp-pun-ta-MEN-tô", pronunciation_en: "lap-poon-tah-MEN-toh — double-p held; 'ho un appuntamento'" },
      { word: "il Comune", en: "town hall", vi: "ủy ban xã/phường", pos: "n.m.", pronunciation_vi: "il cô-MU-nê", pronunciation_en: "eel koh-MOO-neh — the municipal office for residency, certificates" },
    ],
    dialogue: [
      { speaker: "A", text: "Buongiorno, vorrei aggiornare la residenza.", en: "Good morning, I'd like to update my residency.", vi: "Chào anh/chị, tôi muốn cập nhật cư trú." },
      { speaker: "B", text: "Va bene. Ha portato i documenti?", en: "All right. Did you bring the documents?", vi: "Được. Anh/chị mang giấy tờ chưa?" },
      { speaker: "A", text: "Quali documenti servono esattamente?", en: "Which documents are needed exactly?", vi: "Cần chính xác giấy tờ nào ạ?" },
      { speaker: "B", text: "Carta d'identità, contratto d'affitto e una marca da bollo.", en: "ID card, rental contract and a tax stamp.", vi: "Thẻ căn cước, hợp đồng thuê nhà và một tem thuế." },
    ],
    exercises: [
  ...
  },
  {
    ...
    vocabulary: [
      { word: "il proprietario", en: "landlord / owner", vi: "chủ nhà", pos: "n.m.", pronunciation_vi: "il prô-pri-ê-TA-ri-ô", pronunciation_en: "eel proh-pryeh-TAH-ryoh — also 'il padrone di casa'" },
      { word: "il contratto d'affitto", en: "rental contract", vi: "hợp đồng thuê nhà", pos: "n.m.", pronunciation_vi: "il côn-TRÁT-tô đáf-FIT-tô", pronunciation_en: "eel kon-TRAHT-toh daf-FEET-toh — two held double-t's" },
      { word: "la perdita d'acqua", en: "water leak", vi: "rò nước", pos: "n.f.", pronunciation_vi: "la PER-đi-ta ĐAC-qua", pronunciation_en: "lah PER-dee-tah DAHK-kwah — 'acqua' has a hard 'kw'" },
      { word: "segnalare", en: "to report (a fault)", vi: "báo (sự cố)", pos: "v.", pronunciation_vi: "xê-nha-LA-rê", pronunciation_en: "seh-nyah-LAH-reh — 'gn' = 'nh'; 'Le segnalo…' = I'm reporting to you" },
      { word: "il tecnico", en: "technician", vi: "kỹ thuật viên", pos: "n.m.", pronunciation_vi: "il TEC-ni-cô", pronunciation_en: "eel TEK-nee-koh — stress first syllable" },
      { word: "riparare", en: "to repair", vi: "sửa", pos: "v.", pronunciation_vi: "ri-pa-RA-rê", pronunciation_en: "ree-pah-RAH-reh — 'la riparazione' = the repair" },
      { word: "la caparra", en: "deposit", vi: "tiền cọc", pos: "n.f.", pronunciation_vi: "la ca-PÁR-ra", pronunciation_en: "lah kah-PAHR-rah — hold the double-r" },
      { word: "l'affitto", en: "rent", vi: "tiền thuê", pos: "n.m.", pronunciation_vi: "láf-FIT-tô", pronunciation_en: "laf-FEET-toh — double-f and double-t both held" },
      { word: "il bagno", en: "bathroom", vi: "phòng tắm", pos: "n.m.", pronunciation_vi: "il BA-nhô", pronunciation_en: "eel BAH-nyoh — 'gn' = 'nh'" },
      { word: "la soluzione", en: "solution", vi: "giải pháp", pos: "n.f.", pronunciation_vi: "la xô-lu-DZI-ô-nê", pronunciation_en: "lah soh-loo-TSYOH-neh — -zione = 'tsyoh-neh'" },
    ],
    dialogue: [
      { speaker: "A", text: "Buonasera, Le segnalo una perdita d'acqua in bagno.", en: "Good evening, I'm reporting a water leak in the bathroom.", vi: "Chào buổi tối, tôi báo anh/chị một chỗ rò nước trong phòng tắm." },
      { speaker: "B", text: "Da quando succede?", en: "Since when has it been happening?", vi: "Bị từ khi nào vậy?" },
      { speaker: "A", text: "Da ieri sera. Potrebbe mandare un tecnico?", en: "Since last night. Could you send a technician?", vi: "Từ tối qua. Anh/chị gửi kỹ thuật viên được không?" },
      { speaker: "B", text: "Va bene, mando qualcuno domani mattina.", en: "All right, I'll send someone tomorrow morning.", vi: "Được, mai sáng tôi cho người tới." },
    ],
    exercises: [
  ...
  },
  {
    ...
    vocabulary: [
      { word: "la procedura", en: "procedure", vi: "quy trình", pos: "n.f.", pronunciation_vi: "la prô-cê-ĐU-ra", pronunciation_en: "lah proh-cheh-DOO-rah — 'ce' is soft 'cheh'" },
      { word: "il malinteso", en: "misunderstanding", vi: "hiểu lầm", pos: "n.m.", pronunciation_vi: "il ma-lin-TÊ-dô", pronunciation_en: "eel mah-leen-TEH-zoh — the polite face-saving word" },
      { word: "il rischio", en: "risk", vi: "rủi ro", pos: "n.m.", pronunciation_vi: "il RI-xki-ô", pronunciation_en: "eel REES-kyoh — 'schi' = 'skyoh'" },
      { word: "la sicurezza", en: "safety", vi: "an toàn", pos: "n.f.", pronunciation_vi: "la xi-cu-RÉT-tsa", pronunciation_en: "lah see-koo-RET-tsah — double-z is held 'tts'" },
      { word: "il responsabile", en: "supervisor / person in charge", vi: "người phụ trách", pos: "n.m.", pronunciation_vi: "il ré-xpon-XA-bi-lê", pronunciation_en: "eel res-pon-SAH-bee-leh — stress 'SAH'" },
      { word: "il turno", en: "shift", vi: "ca làm", pos: "n.m.", pronunciation_vi: "il TUR-nô", pronunciation_en: "eel TOOR-noh — 'lavorare su turni' = to work shifts" },
      { word: "la mansione", en: "task / job duty", vi: "nhiệm vụ", pos: "n.f.", pronunciation_vi: "la man-XI-ô-nê", pronunciation_en: "lah man-SYOH-neh — -sione = 'syoh-neh'" },
      { word: "affidabile", en: "reliable", vi: "đáng tin", pos: "agg.", pronunciation_vi: "af-fi-ĐA-bi-lê", pronunciation_en: "af-fee-DAH-bee-leh — hold the double-f" },
      { word: "puntuale", en: "punctual", vi: "đúng giờ", pos: "agg.", pronunciation_vi: "pun-tu-A-lê", pronunciation_en: "poon-too-AH-leh — four syllables, stress 'AH'" },
      { word: "chiarire", en: "to clarify", vi: "làm rõ", pos: "v.", pronunciation_vi: "ki-a-RI-rê", pronunciation_en: "kyah-REE-reh — 'chi' is hard 'ky'" },
    ],
    dialogue: [
      { speaker: "A", text: "Scusi, vorrei chiarire la procedura per gli ordini.", en: "Excuse me, I'd like to clarify the procedure for the orders.", vi: "Xin lỗi, tôi muốn làm rõ quy trình cho đơn hàng." },
      { speaker: "B", text: "Certo. Cosa non è chiaro?", en: "Of course. What isn't clear?", vi: "Được chứ. Chỗ nào chưa rõ?" },
      { speaker: "A", text: "Credo ci sia stato un malinteso sul turno di domani.", en: "I think there's been a misunderstanding about tomorrow's shift.", vi: "Tôi nghĩ có hiểu lầm về ca ngày mai." },
      { speaker: "B", text: "Hai ragione, parliamone con il responsabile.", en: "You're right, let's discuss it with the supervisor.", vi: "Bạn nói đúng, mình bàn với người phụ trách nhé." },
    ],
    exercises: [
  ...
  },
  {
    ...
    vocabulary: [
      { word: "il medico di base", en: "family doctor", vi: "bác sĩ gia đình", pos: "n.m.", pronunciation_vi: "il MÊ-đi-cô đi BA-dê", pronunciation_en: "eel MEH-dee-koh dee BAH-zeh — your registered GP" },
      { word: "il sintomo", en: "symptom", vi: "triệu chứng", pos: "n.m.", pronunciation_vi: "il XIN-tô-mô", pronunciation_en: "eel SEEN-toh-moh — stress first syllable; plural 'sintomi'" },
      { word: "la febbre", en: "fever", vi: "sốt", pos: "n.f.", pronunciation_vi: "la FÉB-brê", pronunciation_en: "lah FEB-breh — 'ho la febbre'; hold the double-b" },
      { word: "il dolore", en: "pain", vi: "cơn đau", pos: "n.m.", pronunciation_vi: "il đô-LÔ-rê", pronunciation_en: "eel doh-LOH-reh — stress 'LOH'" },
      { word: "la ricetta", en: "prescription", vi: "đơn thuốc", pos: "n.f.", pronunciation_vi: "la ri-CHÉT-ta", pronunciation_en: "lah ree-CHET-tah — 'ce' soft 'cheh'; hold double-t. Also means 'recipe'!" },
      { word: "la medicina", en: "medicine", vi: "thuốc", pos: "n.f.", pronunciation_vi: "la mê-đi-CI-na", pronunciation_en: "lah meh-dee-CHEE-nah — also 'il farmaco'" },
      { word: "la farmacia", en: "pharmacy", vi: "hiệu thuốc", pos: "n.f.", pronunciation_vi: "la far-ma-CI-a", pronunciation_en: "lah far-mah-CHEE-ah — green-cross sign on the street" },
      { word: "prescrivere", en: "to prescribe", vi: "kê (đơn)", pos: "v.", pronunciation_vi: "pré-XCRI-vê-rê", pronunciation_en: "pres-KREE-veh-reh — 'scr' = 'skr'" },
      { word: "il Pronto Soccorso", en: "A&E / emergency room", vi: "phòng cấp cứu", pos: "n.m.", pronunciation_vi: "il PRON-tô xôc-COR-xô", pronunciation_en: "eel PRON-toh sok-KOR-soh — hospital emergency unit" },
      { word: "guarire", en: "to recover / heal", vi: "khỏi bệnh", pos: "v.", pronunciation_vi: "gua-RI-rê", pronunciation_en: "gwah-REE-reh — 'gu' is 'gw'; stress 'REE'" },
    ],
    dialogue: [
      { speaker: "Medico", text: "Buongiorno, mi dica. Quali sintomi ha?", en: "Good morning, tell me. What symptoms do you have?", vi: "Chào anh/chị, nói tôi nghe. Anh/chị có triệu chứng gì?" },
      { speaker: "Paziente", text: "Da tre giorni ho mal di schiena e ho la febbre.", en: "For three days I've had a backache and a fever.", vi: "Ba ngày nay tôi đau lưng và bị sốt." },
      { speaker: "Medico", text: "Le prescrivo una medicina. La prenda due volte al giorno.", en: "I'll prescribe you a medicine. Take it twice a day.", vi: "Tôi kê thuốc cho anh/chị. Uống ngày hai lần." },
      { speaker: "Paziente", text: "Grazie. Dov'è la farmacia più vicina?", en: "Thank you. Where is the nearest pharmacy?", vi: "Cảm ơn. Hiệu thuốc gần nhất ở đâu ạ?" },
    ],
    exercises: [
  ...
  },
  {
    ...
    vocabulary: [
      { word: "il colloquio", en: "interview", vi: "buổi phỏng vấn", pos: "n.m.", pronunciation_vi: "il côl-LÔ-qui-ô", pronunciation_en: "eel kol-LOH-kwyoh — hold double-l; 'qui' is 'kwee'" },
      { word: "l'esperienza", en: "experience", vi: "kinh nghiệm", pos: "n.f.", pronunciation_vi: "lé-xpê-RI-en-dza", pronunciation_en: "les-peh-RYEN-tsah — 'esperienza IN' + sector" },
      { word: "il contratto", en: "contract", vi: "hợp đồng", pos: "n.m.", pronunciation_vi: "il côn-TRÁT-tô", pronunciation_en: "eel kon-TRAHT-toh — hold the double-t" },
      { word: "disponibile", en: "available", vi: "sẵn sàng, rảnh", pos: "agg.", pronunciation_vi: "đi-xpô-NI-bi-lê", pronunciation_en: "dee-spoh-NEE-bee-leh — 'da subito' = from right now" },
      { word: "il punto di forza", en: "strength", vi: "điểm mạnh", pos: "n.m.", pronunciation_vi: "il PUN-tô đi FOR-tsa", pronunciation_en: "eel POON-toh dee FOR-tsah — 'forza' = strength; 'z' is 'ts'" },
      { word: "assumere", en: "to hire", vi: "tuyển dụng", pos: "v.", pronunciation_vi: "ás-XU-mê-rê", pronunciation_en: "as-SOO-meh-reh — hold double-s; stress 'SOO'" },
      { word: "lo stipendio", en: "salary", vi: "lương", pos: "n.m.", pronunciation_vi: "lô xti-PEN-đi-ô", pronunciation_en: "loh stee-PEN-dyoh — 'lo' before s+consonant" },
      { word: "il curriculum", en: "CV / résumé", vi: "sơ yếu lý lịch", pos: "n.m.", pronunciation_vi: "il cur-RI-cu-lum", pronunciation_en: "eel koor-REE-koo-loom — Latin loan, kept as is" },
      { word: "crescere", en: "to grow / develop", vi: "phát triển", pos: "v.", pronunciation_vi: "CRÊ-xê-rê", pronunciation_en: "KREH-sheh-reh — 'sce' is 'sheh'" },
      { word: "puntuale", en: "punctual", vi: "đúng giờ", pos: "agg.", pronunciation_vi: "pun-tu-A-lê", pronunciation_en: "poon-too-AH-leh — stress 'AH'" },
    ],
    dialogue: [
      { speaker: "Intervistatore", text: "Buongiorno, mi parli un po' di lei.", en: "Good morning, tell me a bit about yourself.", vi: "Chào anh/chị, kể tôi nghe đôi chút về anh/chị." },
      { speaker: "Candidato", text: "Mi chiamo Minh, ho esperienza in magazzino e sono affidabile.", en: "My name is Minh, I have warehouse experience and I'm reliable.", vi: "Tôi tên Minh, có kinh nghiệm ở kho và tôi đáng tin." },
      { speaker: "Intervistatore", text: "Quando può iniziare?", en: "When can you start?", vi: "Anh/chị bắt đầu được khi nào?" },
      { speaker: "Candidato", text: "Sono disponibile da subito e posso lavorare su turni.", en: "I'm available immediately and I can work shifts.", vi: "Tôi sẵn sàng ngay và có thể làm theo ca." },
    ],
    exercises: [
  ...
  },
  {
    ...
    vocabulary: [
      { word: "vorrei", en: "I would like", vi: "tôi muốn (lịch sự)", pos: "v.", pronunciation_vi: "vôr-RÊI", pronunciation_en: "vor-RAY — conditional of 'volere'; the politeness workhorse" },
      { word: "potrebbe", en: "could you (formal)", vi: "anh/chị có thể", pos: "v.", pronunciation_vi: "pô-TRÉB-bê", pronunciation_en: "poh-TREB-beh — conditional of 'potere'; hold double-b" },
      { word: "per favore", en: "please", vi: "làm ơn", pos: "espr.", pronunciation_vi: "per fa-VÔ-rê", pronunciation_en: "per fah-VOH-reh — also 'per cortesia' in formal settings" },
      { word: "il malinteso", en: "misunderstanding", vi: "hiểu lầm", pos: "n.m.", pronunciation_vi: "il ma-lin-TÊ-dô", pronunciation_en: "eel mah-leen-TEH-zoh — defuses blame" },
      { word: "la soluzione", en: "solution", vi: "giải pháp", pos: "n.f.", pronunciation_vi: "la xô-lu-DZI-ô-nê", pronunciation_en: "lah soh-loo-TSYOH-neh — 'trovare una soluzione'" },
      { word: "non va bene", en: "it doesn't work / isn't ok", vi: "không ổn", pos: "espr.", pronunciation_vi: "non va BÊ-nê", pronunciation_en: "non vah BEH-neh — add 'per me' to make it about you, not the person" },
      { word: "appena possibile", en: "as soon as possible", vi: "sớm nhất có thể", pos: "espr.", pronunciation_vi: "ap-PÊ-na pôs-XI-bi-lê", pronunciation_en: "ap-PEH-nah pos-SEE-bee-leh — hold both double consonants" },
      { word: "scortese", en: "rude / impolite", vi: "bất lịch sự", pos: "agg.", pronunciation_vi: "xcor-TÊ-dê", pronunciation_en: "skor-TEH-zeh — 'non volevo essere scortese' = I didn't mean to be rude" },
      { word: "chiarire", en: "to clarify", vi: "làm rõ", pos: "v.", pronunciation_vi: "ki-a-RI-rê", pronunciation_en: "kyah-REE-reh — 'chi' hard 'ky'" },
      { word: "quindi", en: "so / therefore", vi: "vậy thì", pos: "cong.", pronunciation_vi: "QUIN-đi", pronunciation_en: "KWEEN-dee — 'Quindi devo…?' confirms a recap" },
    ],
    dialogue: [
      { speaker: "A", text: "Mi può dare il modulo, per favore?", en: "Could you give me the form, please?", vi: "Anh/chị đưa tôi tờ mẫu được không ạ?" },
      { speaker: "B", text: "Certo. Però manca la sua firma.", en: "Of course. But your signature is missing.", vi: "Được. Nhưng còn thiếu chữ ký của anh/chị." },
      { speaker: "A", text: "Mi scusi, non sono sicuro di aver capito. Quindi devo firmare qui?", en: "Sorry, I'm not sure I understood. So I have to sign here?", vi: "Xin lỗi, tôi không chắc đã hiểu. Vậy tôi ký ở đây phải không?" },
      { speaker: "B", text: "Esatto. Poi me lo riporti appena possibile.", en: "Exactly. Then bring it back to me as soon as possible.", vi: "Chính xác. Rồi mang lại cho tôi sớm nhất có thể nhé." },
    ],
    exercises: [
