...
const FLUENCY: GermanLesson[] = [
  ...
  },
  {
    ...
    sentences: [
      { en: "Ich möchte eine Anzeige wegen Taschendiebstahls erstatten.", vi: "Em muốn trình báo về việc bị móc túi.", pronunciation_focus: ["Anzeige → ÁN-tsai-gê", "Taschendiebstahls → TA-shần-dip-shtals", "erstatten → e-SHTÁ-tần"] },
      { en: "Der Vorfall hat sich heute gegen 14 Uhr in der U-Bahn-Linie 8 ereignet.", vi: "Sự việc xảy ra hôm nay khoảng 14h trên tuyến U8.", pronunciation_focus: ["Vorfall → FÔ-fal", "ereignet → e-AI-gnết", "U-Bahn → U-BAN"] },
      { en: "Gestohlen wurden mein Reisepass, mein Portemonnaie und mein Smartphone.", vi: "Đồ bị mất gồm hộ chiếu, ví và điện thoại của em.", pronunciation_focus: ["Gestohlen → gê-SHTÔ-lần", "Portemonnaie → port-mô-NÊ", "Reisepass → RAI-zê-pass"] },
      { en: "Könnten Sie mir bitte eine schriftliche Bestätigung der Anzeige aushändigen?", vi: "Anh/chị có thể cấp xác nhận trình báo bằng văn bản không?", pronunciation_focus: ["schriftliche → SHRIFT-li-khê", "Bestätigung → bê-SHTÊ-ti-gung", "aushändigen → AOS-hen-đi-gần"] },
      { en: "Ich brauche das Dokument für die Versicherung und für meine Botschaft.", vi: "Em cần giấy đó cho bảo hiểm và cho đại sứ quán.", pronunciation_focus: ["Versicherung → fe-ZÍ-khê-rung", "Botschaft → BÔT-shaft", "Dokument → đô-ku-MEN-t"] },
    ],
    ...
    vocabulary: [
      { word: "die Anzeige", en: "police report (formal complaint)", vi: "đơn trình báo", pos: "noun (f)", pronunciation_vi: "đi ÁN-tsai-gê" },
      { word: "Anzeige erstatten", en: "to file a police report", vi: "trình báo (động từ ghép)", pos: "verb phrase", pronunciation_vi: "ÁN-tsai-gê e-SHTÁ-tần" },
      { word: "der Taschendieb", en: "pickpocket", vi: "kẻ móc túi", pos: "noun (m)", pronunciation_vi: "đe TA-shần-đip" },
      { word: "der Vorfall", en: "incident", vi: "sự việc", pos: "noun (m)", pronunciation_vi: "đe FÔ-fal" },
      { word: "der Tatort", en: "crime scene", vi: "hiện trường", pos: "noun (m)", pronunciation_vi: "đe TÁT-ot" },
      { word: "der/die Verdächtige", en: "suspect", vi: "đối tượng nghi vấn", pos: "noun (m/f)", pronunciation_vi: "đe fe-ĐÉC-ti-gê" },
      { word: "die Personenbeschreibung", en: "description of a person", vi: "mô tả nhân dạng", pos: "noun (f)", pronunciation_vi: "đi pe-ZÔ-nần-bê-shrai-bung" },
      { word: "das Aktenzeichen", en: "case file number", vi: "số hồ sơ vụ việc", pos: "noun (n)", pronunciation_vi: "đát ÁK-tần-tsai-khần" },
      { word: "der/die Zeuge/-in", en: "witness", vi: "nhân chứng", pos: "noun (m/f)", pronunciation_vi: "đe TSOI-gê" },
      { word: "die Bestätigung", en: "confirmation", vi: "xác nhận", pos: "noun (f)", pronunciation_vi: "đi bê-SHTÊ-ti-gung" },
    ],
    dialogue: [
      { speaker: "Polizist", text: "Guten Tag, was kann ich für Sie tun?", vi: "Chào, em có thể giúp gì?" },
      { speaker: "Linh", text: "Ich möchte eine Anzeige wegen Taschendiebstahls erstatten.", vi: "Em muốn trình báo bị móc túi." },
      { speaker: "Polizist", text: "Wann und wo ist es passiert?", vi: "Việc đó xảy ra khi nào và ở đâu?" },
      { speaker: "Linh", text: "Heute gegen 14 Uhr in der U8 zwischen Alexanderplatz und Kottbusser Tor.", vi: "Hôm nay khoảng 14h trên U8 giữa Alexanderplatz và Kottbusser Tor." },
    ],
    dialogue_long: [
      { speaker: "Polizist", text: "Guten Tag, willkommen auf der Wache. Was kann ich für Sie tun?", vi: "Chào, hoan nghênh đến trạm. Em có thể giúp gì?" },
      { speaker: "Linh", text: "Guten Tag. Ich möchte eine Anzeige wegen Taschendiebstahls erstatten.", vi: "Chào anh. Em muốn trình báo bị móc túi." },
      { speaker: "Polizist", text: "Sind Sie verletzt? Brauchen Sie einen Arzt?", vi: "Anh có bị thương không? Cần bác sĩ không?" },
      { speaker: "Linh", text: "Nein, ich bin unverletzt, nur ziemlich schockiert.", vi: "Không, em không bị thương, chỉ hơi sốc thôi." },
      { speaker: "Polizist", text: "Verstanden. Bitte schildern Sie mir den Vorfall genau.", vi: "Em hiểu. Anh tả lại sự việc thật chi tiết." },
      { speaker: "Linh", text: "Heute gegen 14 Uhr fuhr ich mit der U8 Richtung Hermannstraße. Zwischen Alexanderplatz und Kottbusser Tor war es sehr voll.", vi: "Hôm nay khoảng 14h em đi U8 hướng Hermannstraße. Đoạn giữa Alexanderplatz và Kottbusser Tor đông kinh khủng." },
      { speaker: "Polizist", text: "Wann genau haben Sie den Diebstahl bemerkt?", vi: "Anh phát hiện bị mất lúc nào chính xác?" },
      { speaker: "Linh", text: "Erst beim Aussteigen. Plötzlich war meine Umhängetasche offen — Reisepass, Portemonnaie und Handy waren weg.", vi: "Lúc xuống tàu mới biết. Đột nhiên thấy túi đeo mở toang — hộ chiếu, ví, điện thoại đều mất." },
      { speaker: "Polizist", text: "Können Sie eine Person beschreiben, die Ihnen aufgefallen ist?", vi: "Anh có thể tả ai đó đáng nghi không?" },
      { speaker: "Linh", text: "Zwei Männer drängten sich ungewöhnlich nah an mich heran — etwa Mitte zwanzig, mittlere Größe, dunkle Jacken, einer trug eine schwarze Kappe.", vi: "Có hai người đàn ông áp sát em bất thường — khoảng đầu hai mươi, chiều cao trung bình, áo khoác sẫm màu, một người đội mũ lưỡi trai đen." },
      { speaker: "Polizist", text: "Hat jemand etwas beobachtet, der als Zeuge in Frage kommt?", vi: "Có ai chứng kiến có thể làm nhân chứng không?" },
      { speaker: "Linh", text: "Eine ältere Dame stand gleich neben mir, aber wir haben keine Kontaktdaten ausgetauscht.", vi: "Có một bà lớn tuổi đứng cạnh em, nhưng tụi em chưa kịp trao đổi liên lạc." },
      { speaker: "Polizist", text: "Haben Sie Ihre Bankkarten schon sperren lassen?", vi: "Anh đã khóa thẻ ngân hàng chưa?" },
      { speaker: "Linh", text: "Ja, ich habe sofort über die Sperrhotline 116 116 angerufen.", vi: "Rồi, em gọi tổng đài khóa thẻ 116 116 ngay." },
      { speaker: "Polizist", text: "Sehr gut. Ich nehme jetzt Ihre Personalien auf und stelle Ihnen anschließend eine Bestätigung mit Aktenzeichen aus.", vi: "Rất tốt. Em ghi thông tin cá nhân, sau đó cấp giấy xác nhận có số hồ sơ." },
      { speaker: "Linh", text: "Vielen Dank. Diese Bestätigung brauche ich für die Versicherung und für die vietnamesische Botschaft, um einen Notpass zu beantragen.", vi: "Em cám ơn. Tờ xác nhận này em cần cho bảo hiểm và đại sứ quán Việt Nam để xin Notpass." },
      { speaker: "Polizist", text: "Verständlich. Ein Tipp: Notieren Sie heute noch alle Inhalte des Portemonnaies — das hilft der Versicherung.", vi: "Em hiểu. Mẹo nhỏ: hôm nay ghi lại hết nội dung trong ví — sẽ giúp bảo hiểm xử lý." },
    ],
    roleplay_prompts: [
    ...
    idiom_glosses: [
      { idiom: "jemandem das Fell über die Ohren ziehen", literal: "kéo da qua tai ai đó", meaning: "lừa lọc trắng trợn ai đó", example: "Der Taxifahrer wollte mir das Fell über die Ohren ziehen — er wollte 95 Euro für eine 60-Euro-Strecke." },
      { idiom: "mit heiler Haut davonkommen", literal: "thoát đi với da còn lành", meaning: "thoát nạn an toàn, không bị thương", example: "Beim Taschendiebstahl bin ich mit heiler Haut davongekommen — nur das Portemonnaie ist weg." },
      { idiom: "die Spur ist kalt", literal: "dấu vết đã nguội", meaning: "không còn manh mối, khó tìm ra thủ phạm", example: "Der Polizist sagte, die Spur sei kalt — die Täter sind längst über alle Berge." },
      { idiom: "auf der Hut sein", literal: "đứng trên cái mũ bảo hộ", meaning: "đề cao cảnh giác, đề phòng", example: "In der U-Bahn muss man auf der Hut sein — Taschendiebe sind dort aktiv." },
    ],
    exercises: [
      {
        type: "fill_blank",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Ich möchte eine ___ wegen Taschendiebstahls erstatten.", answer: "Anzeige" },
          { prompt: "Der ___ hat sich gegen 14 Uhr ereignet.", answer: "Vorfall" },
          { prompt: "Können Sie mir eine ___ Bestätigung aushändigen?", answer: "schriftliche" },
          { prompt: "Ich brauche das Dokument für die ___ und die Botschaft.", answer: "Versicherung" },
        ],
      },
      {
        type: "matching",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Anzeige erstatten", answer: "Trình báo cảnh sát" },
          { prompt: "Aktenzeichen", answer: "Số hồ sơ vụ việc" },
          { prompt: "Sperrhotline 116 116", answer: "Khóa thẻ ngân hàng" },
          { prompt: "Notpass", answer: "Hộ chiếu khẩn cấp ĐSQ cấp" },
        ],
      },
      {
        type: "translation",
        instruction_vi: "Dịch sang tiếng Đức formal:",
        pronunciation_focus: ["police report"],
        items: [
          { prompt: "Em muốn trình báo bị móc túi trên U8.", answer: "Ich möchte eine Anzeige wegen Taschendiebstahls in der U8 erstatten." },
          { prompt: "Đồ bị mất: hộ chiếu, ví và điện thoại.", answer: "Gestohlen wurden mein Reisepass, mein Portemonnaie und mein Handy." },
          { prompt: "Em cần xác nhận có số hồ sơ.", answer: "Ich brauche eine Bestätigung mit Aktenzeichen." },
          { prompt: "Em đã khóa thẻ qua hotline 116 116 rồi.", answer: "Ich habe meine Karten über die Sperrhotline 116 116 sperren lassen." },
        ],
      },
    ],
  },
  {
    ...
    sentences: [
      { en: "Entschuldigung, könnten Sie mir bitte den Weg zum Deutschen Museum erklären?", vi: "Xin lỗi, anh/chị có thể chỉ đường đến Bảo tàng Đức cho em được không?", pronunciation_focus: ["Entschuldigung → ent-SHUL-đi-gung", "erklären → e-KLE-rần", "Deutschen Museum → ĐOI-tshần mu-ZÊ-um"] },
      { en: "Wäre es schneller, mit der U-Bahn zu fahren oder zu Fuß zu gehen?", vi: "Đi U-Bahn nhanh hơn hay đi bộ nhanh hơn ạ?", pronunciation_focus: ["schneller → SHNẾ-lờ", "U-Bahn → U-BAN", "zu Fuß → tsu FUS"] },
      { en: "Könnten Sie das bitte langsamer wiederholen? Ich habe es nicht ganz verstanden.", vi: "Anh/chị có thể nhắc lại chậm hơn không? Em chưa hiểu hết.", pronunciation_focus: ["langsamer → LANG-za-mờ", "wiederholen → VI-đờ-hô-lần", "verstanden → fe-SHTAN-đần"] },
      { en: "Heißt das, ich muss an der zweiten Ampel rechts abbiegen?", vi: "Tức là em phải rẽ phải ở đèn giao thông thứ hai đúng không?", pronunciation_focus: ["Ampel → AM-pệl", "abbiegen → ÁB-bi-gần", "zweiten → TSVAI-tần"] },
      { en: "Vielen Dank für die ausführliche Wegbeschreibung — das war sehr hilfreich.", vi: "Cám ơn anh/chị chỉ đường chi tiết — em thấy rất hữu ích.", pronunciation_focus: ["ausführliche → AOS-fuy-li-khê", "Wegbeschreibung → VÊK-bê-shrai-bung", "hilfreich → HIL-fraikh"] },
    ],
    ...
    vocabulary: [
      { word: "die Wegbeschreibung", en: "directions, route description", vi: "lời chỉ đường", pos: "noun (f)", pronunciation_vi: "đi VÊK-bê-shrai-bung" },
      { word: "abbiegen", en: "to turn (off the road)", vi: "rẽ (vào đường khác)", pos: "verb (sep.)", pronunciation_vi: "ÁB-bi-gần" },
      { word: "geradeaus", en: "straight ahead", vi: "đi thẳng", pos: "adverb", pronunciation_vi: "gê-RA-đê-aos" },
      { word: "die Ampel", en: "traffic light", vi: "đèn giao thông", pos: "noun (f)", pronunciation_vi: "đi AM-pệl" },
      { word: "die Kreuzung", en: "intersection, crossroads", vi: "ngã tư", pos: "noun (f)", pronunciation_vi: "đi KROI-tsung" },
      { word: "der Bürgersteig", en: "sidewalk, pavement", vi: "vỉa hè", pos: "noun (m)", pronunciation_vi: "đe BUY-gờ-shtaik" },
      { word: "die Fußgängerzone", en: "pedestrian zone", vi: "khu vực đi bộ", pos: "noun (f)", pronunciation_vi: "đi FUS-gen-gờ-tsô-nê" },
      { word: "gegenüber", en: "opposite, across from", vi: "đối diện", pos: "preposition", pronunciation_vi: "gê-gần-UY-bờ" },
      { word: "in der Nähe von", en: "near, close to", vi: "gần với", pos: "phrase", pronunciation_vi: "in đe NÊ-ê fôn" },
      { word: "die Sehenswürdigkeit", en: "tourist attraction, sight", vi: "địa điểm tham quan", pos: "noun (f)", pronunciation_vi: "đi ZÊ-ần-vuy-đikh-kait" },
    ],
    dialogue: [
      { speaker: "Linh", text: "Entschuldigung, könnten Sie mir den Weg zum Deutschen Museum erklären?", vi: "Xin lỗi, anh chỉ đường đến Bảo tàng Đức giúp em với?" },
      { speaker: "Münchner", text: "Klar, gerne. Sie sind hier am Marienplatz, oder?", vi: "Vâng, được. Anh đang ở Marienplatz đúng không?" },
      { speaker: "Linh", text: "Ja, genau. Ist es zu Fuß machbar?", vi: "Vâng, đúng rồi. Đi bộ tới được không ạ?" },
      { speaker: "Münchner", text: "Etwa 15 Minuten zu Fuß — gehen Sie Richtung Isar, dann immer am Fluss entlang.", vi: "Khoảng 15 phút đi bộ — đi hướng sông Isar rồi men theo sông." },
    ],
    dialogue_long: [
      { speaker: "Linh", text: "Entschuldigen Sie bitte, darf ich Sie kurz stören?", vi: "Cho em xin lỗi, có thể làm phiền anh một chút không?" },
      { speaker: "Münchner", text: "Aber natürlich. Was kann ich für Sie tun?", vi: "Tất nhiên, em cần gì?" },
      { speaker: "Linh", text: "Ich suche das Deutsche Museum — könnten Sie mir bitte den Weg erklären?", vi: "Em đang tìm Bảo tàng Đức — anh chỉ đường giúp em được không?" },
      { speaker: "Münchner", text: "Sie sind hier am Marienplatz. Das Museum liegt auf einer Insel in der Isar — etwa 15 bis 20 Minuten zu Fuß.", vi: "Anh đang ở Marienplatz. Bảo tàng nằm trên đảo trong sông Isar — đi bộ khoảng 15-20 phút." },
      { speaker: "Linh", text: "Wäre es schneller mit der U-Bahn?", vi: "Đi U-Bahn nhanh hơn không?" },
      { speaker: "Münchner", text: "Nicht wirklich. Mit der U-Bahn müssten Sie umsteigen — zu Fuß ist es sogar angenehmer.", vi: "Không hơn đáng kể. Đi U-Bahn phải đổi tàu — đi bộ thậm chí dễ chịu hơn." },
      { speaker: "Linh", text: "Verstehe. Wie komme ich denn zu Fuß dorthin?", vi: "Em hiểu rồi. Đi bộ thì đi đường nào ạ?" },
      { speaker: "Münchner", text: "Gehen Sie hier vom Marienplatz aus geradeaus die Dienerstraße entlang Richtung Hofgarten.", vi: "Từ Marienplatz đi thẳng theo phố Dienerstraße hướng Hofgarten." },
      { speaker: "Linh", text: "Geradeaus die Dienerstraße — und dann?", vi: "Đi thẳng phố Dienerstraße — rồi sao ạ?" },
      { speaker: "Münchner", text: "An der zweiten Kreuzung biegen Sie rechts ab in die Maximilianstraße. Das ist die elegante Einkaufsstraße.", vi: "Đến ngã tư thứ hai, rẽ phải vào Maximilianstraße. Đó là phố mua sắm sang trọng." },
      { speaker: "Linh", text: "An der zweiten Kreuzung rechts in die Maximilianstraße. Heißt das, ich gehe an der ersten Kreuzung geradeaus weiter?", vi: "Ngã tư thứ hai rẽ phải vào Maximilianstraße. Tức là ngã tư thứ nhất em vẫn đi thẳng?" },
      { speaker: "Münchner", text: "Genau richtig. Auf der Maximilianstraße folgen Sie ihr bis zur Isar — über die Maximiliansbrücke.", vi: "Chính xác. Trên Maximilianstraße đi đến sông Isar — qua cầu Maximiliansbrücke." },
      { speaker: "Linh", text: "Könnten Sie das bitte langsamer wiederholen? Über welche Brücke?", vi: "Anh nhắc lại chậm hơn được không? Qua cầu nào ạ?" },
      { speaker: "Münchner", text: "Maximiliansbrücke. Nach der Brücke sehen Sie schon das Maximilianeum — das große Parlamentsgebäude. Davor halblinks.", vi: "Maximiliansbrücke. Qua cầu sẽ thấy Maximilianeum — tòa nhà nghị viện lớn. Trước nó rẽ chếch trái." },
      { speaker: "Linh", text: "Halblinks am Maximilianeum. Und dann?", vi: "Chếch trái ở Maximilianeum. Rồi tiếp?" },
      { speaker: "Münchner", text: "Folgen Sie dem Fluss flussaufwärts etwa fünf Minuten — das Museum ist nicht zu übersehen.", vi: "Đi men theo sông ngược dòng khoảng 5 phút — bảo tàng to không thể nhìn nhầm được." },
      { speaker: "Linh", text: "Wunderbar — ich fasse zusammen: Dienerstraße geradeaus, zweite Kreuzung rechts in die Maximilianstraße, über die Brücke, halblinks und am Fluss entlang.", vi: "Tuyệt — em tóm tắt: Dienerstraße đi thẳng, ngã tư hai rẽ phải Maximilianstraße, qua cầu, chếch trái rồi men sông." },
      { speaker: "Münchner", text: "Perfekt zusammengefasst. Viel Spaß im Museum!", vi: "Tóm tắt chuẩn luôn. Chúc anh tham quan vui vẻ!" },
    ],
    roleplay_prompts: [
    ...
    idiom_glosses: [
      { idiom: "jemanden auf den richtigen Weg bringen", literal: "đưa ai đó đi đúng đường", meaning: "định hướng đúng cho ai đó (cả nghĩa đen + bóng)", example: "Der Münchner hat mich auf den richtigen Weg gebracht — ohne ihn wäre ich verloren gewesen." },
      { idiom: "vom Weg abkommen", literal: "lệch khỏi đường đi", meaning: "bị lạc đường, đi sai hướng", example: "Ich bin in der Altstadt vom Weg abgekommen — die kleinen Gassen sehen alle gleich aus." },
      { idiom: "auf halbem Weg stehen bleiben", literal: "dừng giữa đường", meaning: "bỏ dở giữa chừng, không hoàn thành", example: "Ich kann das Projekt nicht auf halbem Weg stehen lassen." },
      { idiom: "alle Wege führen nach Rom", literal: "mọi con đường đều dẫn đến Roma", meaning: "có nhiều cách để đến cùng đích", example: "Ob U-Bahn oder zu Fuß — alle Wege führen nach Rom." },
    ],
    exercises: [
      {
        type: "fill_blank",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Biegen Sie an der zweiten Kreuzung ___ ab.", answer: "rechts" },
          { prompt: "Gehen Sie ___ die Dienerstraße entlang.", answer: "geradeaus" },
          { prompt: "Über die Brücke, dann ___ am Fluss entlang.", answer: "halblinks" },
          { prompt: "Das Museum liegt ___ einer Insel.", answer: "auf" },
        ],
      },
      {
        type: "matching",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "abbiegen", answer: "rẽ (vào đường khác)" },
          { prompt: "geradeaus", answer: "đi thẳng" },
          { prompt: "die Kreuzung", answer: "ngã tư" },
          { prompt: "gegenüber", answer: "đối diện" },
        ],
      },
      {
        type: "translation",
        instruction_vi: "Dịch sang tiếng Đức lịch sự (Konjunktiv II khi cần):",
        pronunciation_focus: ["asking directions"],
        items: [
          { prompt: "Anh/chị có thể chỉ đường đến bảo tàng được không?", answer: "Könnten Sie mir bitte den Weg zum Museum erklären?" },
          { prompt: "Đi bộ nhanh hơn hay đi U-Bahn nhanh hơn?", answer: "Wäre es schneller, zu Fuß zu gehen oder mit der U-Bahn zu fahren?" },
          { prompt: "Anh/chị nhắc lại chậm hơn được không?", answer: "Könnten Sie das bitte langsamer wiederholen?" },
          { prompt: "Tức là em rẽ phải ở ngã tư thứ hai đúng không?", answer: "Heißt das, ich biege an der zweiten Kreuzung rechts ab?" },
        ],
      },
    ],
  },
  {
    ...
    sentences: [
      { en: "Entschuldigung, könnten Sie bitte den Kellner rufen? Es gibt ein Problem mit meiner Bestellung.", vi: "Xin lỗi, anh/chị gọi giúp em phục vụ được không? Có vấn đề với món em gọi.", pronunciation_focus: ["Kellner → KEL-nờ", "Bestellung → bê-SHTÊL-lung", "Problem → prô-BLÊM"] },
      { en: "Ich hatte das Schnitzel gut durch bestellt — das hier ist innen noch roh.", vi: "Em gọi schnitzel chín kỹ — miếng này bên trong còn sống.", pronunciation_focus: ["Schnitzel → SHNI-tsệl", "gut durch → GUT đurkh", "innen → IN-nần"] },
      { en: "Bei der Bestellung habe ich ausdrücklich auf meine Nussallergie hingewiesen.", vi: "Lúc gọi món em đã nói rõ em bị dị ứng hạt rồi.", pronunciation_focus: ["ausdrücklich → AOS-đrúk-likh", "Nussallergie → NUS-a-le-gi", "hingewiesen → HIN-gê-vi-zần"] },
      { en: "Auf der Rechnung sehe ich ein Getränk, das wir nicht bestellt haben.", vi: "Em thấy trong bill có một món uống tụi em không gọi.", pronunciation_focus: ["Rechnung → REKH-nung", "Getränk → gê-TRENK", "bestellt → bê-SHTÊL-t"] },
      { en: "Ich erwarte, dass dieses Gericht von der Rechnung gestrichen wird.", vi: "Em mong rằng món này sẽ được xóa khỏi bill.", pronunciation_focus: ["erwarte → e-VA-tê", "Gericht → gê-RIKHT", "gestrichen → gê-SHTRI-khần"] },
    ],
    ...
    vocabulary: [
      { word: "die Beschwerde", en: "complaint, grievance", vi: "lời khiếu nại", pos: "noun (f)", pronunciation_vi: "đi bê-SHVÊ-đê" },
      { word: "der/die Kellner/-in", en: "waiter / waitress", vi: "phục vụ nam/nữ", pos: "noun (m/f)", pronunciation_vi: "đe KEL-nờ" },
      { word: "die Bestellung", en: "order", vi: "đơn gọi món", pos: "noun (f)", pronunciation_vi: "đi bê-SHTÊL-lung" },
      { word: "die Rechnung", en: "bill, invoice", vi: "bill / hóa đơn", pos: "noun (f)", pronunciation_vi: "đi REKH-nung" },
      { word: "roh / durchgebraten", en: "raw / well-done", vi: "sống / chín kỹ", pos: "adjective", pronunciation_vi: "RÔ / đurkh-gê-BRA-tần" },
      { word: "die Allergie", en: "allergy", vi: "dị ứng", pos: "noun (f)", pronunciation_vi: "đi a-LE-gi" },
      { word: "der/die Geschäftsführer/-in", en: "manager", vi: "quản lý nhà hàng", pos: "noun (m/f)", pronunciation_vi: "đe gê-SHEFTS-fuy-rờ" },
      { word: "das Trinkgeld", en: "tip", vi: "tiền tip", pos: "noun (n)", pronunciation_vi: "đát TRINK-gelt" },
      { word: "von der Rechnung streichen", en: "to remove from the bill", vi: "xóa khỏi bill", pos: "verb phrase", pronunciation_vi: "fôn đe REKH-nung SHTRAI-khần" },
      { word: "der Ersatz", en: "replacement", vi: "món/đồ thay thế", pos: "noun (m)", pronunciation_vi: "đe e-ZÁTS" },
    ],
    dialogue: [
      { speaker: "Linh", text: "Entschuldigung, könnten Sie bitte kommen? Es gibt ein Problem.", vi: "Xin lỗi, anh có thể qua đây được không? Có vấn đề." },
      { speaker: "Kellner", text: "Selbstverständlich. Was kann ich für Sie tun?", vi: "Tất nhiên. Em có thể giúp gì?" },
      { speaker: "Linh", text: "Mein Schnitzel ist innen noch roh — ich hatte gut durch bestellt.", vi: "Schnitzel của em bên trong còn sống — em gọi chín kỹ rồi." },
      { speaker: "Kellner", text: "Das tut mir aufrichtig leid. Ich bringe es sofort zurück in die Küche.", vi: "Em thật sự xin lỗi. Em mang xuống bếp ngay." },
    ],
    dialogue_long: [
      { speaker: "Linh", text: "Entschuldigen Sie bitte, könnten Sie kurz zu unserem Tisch kommen?", vi: "Xin lỗi, anh có thể qua bàn tụi em một lát được không?" },
      { speaker: "Kellner", text: "Aber natürlich, ich komme sofort. Ist alles in Ordnung?", vi: "Tất nhiên, em qua ngay. Mọi thứ ổn chứ ạ?" },
      { speaker: "Linh", text: "Leider nicht. Ich habe das Schnitzel ‚gut durch' bestellt, aber es ist innen noch deutlich roh.", vi: "Không ổn lắm. Em gọi schnitzel 'chín kỹ' mà bên trong còn sống rõ ràng." },
      { speaker: "Kellner", text: "Das tut mir aufrichtig leid. Darf ich kurz schauen?", vi: "Em thật sự xin lỗi. Em xem một chút được không?" },
      { speaker: "Linh", text: "Bitte. Sehen Sie — hier in der Mitte ist es rosa, fast roh.", vi: "Anh xem đi. Anh nhìn này — chỗ giữa hồng, gần như sống." },
      { speaker: "Kellner", text: "Sie haben völlig recht. Das hätte so nicht serviert werden dürfen. Ich bringe es zurück und lasse Ihnen ein neues zubereiten.", vi: "Anh nói đúng hoàn toàn. Đáng lẽ không được mang lên như vậy. Em mang lại bếp và làm lại cho anh." },
      { speaker: "Linh", text: "Außerdem hätte ich gerne den Geschäftsführer gesprochen — bei der Bestellung habe ich auf meine Nussallergie hingewiesen, und in der Soße schmecke ich Haselnuss.", vi: "Ngoài ra em muốn gặp quản lý — lúc gọi em đã nói em dị ứng hạt mà trong sốt em vẫn nếm thấy hạt phỉ." },
      { speaker: "Kellner", text: "Oh nein, das ist sehr ernst. Geht es Ihnen gut? Soll ich einen Notarzt rufen?", vi: "Ôi không, chuyện này nghiêm trọng. Anh có sao không? Em gọi cấp cứu nhé?" },
      { speaker: "Linh", text: "Nein danke, ich habe nur einen Bissen genommen. Aber das hätte gefährlich werden können.", vi: "Không, cám ơn — em chỉ cắn một miếng. Nhưng có thể đã rất nguy hiểm." },
      { speaker: "Kellner", text: "Ich rufe sofort die Geschäftsführerin. Bitte entschuldigen Sie diesen schwerwiegenden Fehler.", vi: "Em gọi quản lý ngay. Xin lỗi anh về lỗi nghiêm trọng này." },
      { speaker: "Frau Schuster", text: "Guten Abend. Mein Name ist Frau Schuster. Mir wurde berichtet, dass es Probleme mit Ihrer Bestellung und mit Ihrer Allergiekennzeichnung gab.", vi: "Chào anh. Tôi tên là bà Schuster. Tôi được báo có vấn đề với đơn gọi món và với việc đánh dấu dị ứng." },
      { speaker: "Linh", text: "Genau. Das Schnitzel war roh, und in der Soße war eine Zutat, die ich ausdrücklich ausgeschlossen hatte.", vi: "Chính xác. Schnitzel thì sống, còn trong sốt có thành phần em đã loại trừ rõ ràng." },
      { speaker: "Frau Schuster", text: "Das ist absolut inakzeptabel. Ich werde das mit der Küche besprechen. Selbstverständlich gehen die beiden Hauptgerichte und die Getränke heute Abend auf das Haus.", vi: "Chuyện này hoàn toàn không chấp nhận được. Tôi sẽ làm việc với bếp. Tất nhiên, hai món chính và đồ uống tối nay nhà hàng mời." },
      { speaker: "Linh", text: "Das ist eine angemessene Geste. Ich möchte allerdings auch, dass das Allergieprotokoll der Küche überprüft wird.", vi: "Đó là cử chỉ phù hợp. Tuy nhiên em cũng mong quy trình dị ứng của bếp được kiểm tra lại." },
      { speaker: "Frau Schuster", text: "Ich verspreche Ihnen, das passiert noch heute Abend. Hier ist meine Visitenkarte — falls Sie morgen Beschwerden haben, melden Sie sich bitte direkt bei mir.", vi: "Tôi hứa với anh, sẽ làm ngay tối nay. Đây là danh thiếp của tôi — nếu mai có triệu chứng, anh liên lạc trực tiếp với tôi." },
      { speaker: "Linh", text: "Vielen Dank für Ihre professionelle Reaktion — so ist es zumindest fair gelöst.", vi: "Cám ơn chị về cách xử lý chuyên nghiệp — ít nhất cũng giải quyết công bằng." },
    ],
    roleplay_prompts: [
    ...
    idiom_glosses: [
      { idiom: "jemandem schmeckt etwas nicht", literal: "ai đó thấy gì đó không ngon", meaning: "không hài lòng (cả nghĩa đen + bóng)", example: "Das Schnitzel schmeckt mir nicht — es ist innen roh." },
      { idiom: "die Suppe auslöffeln, die man sich eingebrockt hat", literal: "múc cạn món súp mình đã chế", meaning: "tự gánh hậu quả mình gây ra", example: "Die Küche muss jetzt die Suppe auslöffeln, die sie sich eingebrockt hat." },
      { idiom: "etwas auf die Karte setzen", literal: "đặt cái gì đó vào thực đơn", meaning: "đưa món vào menu (cả nghĩa đen + bóng: đặt cược)", example: "Das Restaurant hat ein neues vegetarisches Gericht auf die Karte gesetzt." },
      { idiom: "Hand und Fuß haben", literal: "có tay và chân", meaning: "có lý có cơ sở, có căn cứ chắc", example: "Meine Beschwerde hat Hand und Fuß — ich habe sogar Fotos." },
    ],
    exercises: [
      {
        type: "fill_blank",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Ich hatte das Schnitzel ___ ___ bestellt.", answer: "gut durch" },
          { prompt: "Bei der Bestellung habe ich auf meine ___ hingewiesen.", answer: "Nussallergie" },
          { prompt: "Ich erwarte, dass das Gericht von der ___ gestrichen wird.", answer: "Rechnung" },
          { prompt: "Ich hätte gerne den ___ gesprochen.", answer: "Geschäftsführer" },
        ],
      },
      {
        type: "matching",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Es gibt ein Problem mit meiner Bestellung.", answer: "Mở đầu khiếu nại" },
          { prompt: "Das hätte so nicht serviert werden dürfen.", answer: "Kết tội passive" },
          { prompt: "Auf das Haus.", answer: "Nhà hàng mời (free)" },
          { prompt: "Hand und Fuß haben.", answer: "Có lý có cơ sở (idiom)" },
        ],
      },
      {
        type: "translation",
        instruction_vi: "Dịch sang tiếng Đức formal:",
        pronunciation_focus: ["restaurant complaint"],
        items: [
          { prompt: "Schnitzel của em bên trong còn sống — em gọi chín kỹ.", answer: "Mein Schnitzel ist innen noch roh — ich hatte gut durch bestellt." },
          { prompt: "Em đã nói rõ em dị ứng hạt khi gọi món.", answer: "Bei der Bestellung habe ich auf meine Nussallergie hingewiesen." },
          { prompt: "Em muốn gặp quản lý nhà hàng.", answer: "Ich hätte gerne den Geschäftsführer gesprochen." },
          { prompt: "Em mong món này được xóa khỏi bill.", answer: "Ich erwarte, dass dieses Gericht von der Rechnung gestrichen wird." },
        ],
      },
    ],
  },
  {
    ...
    sentences: [
      { en: "Entschuldigung, der angezeigte Tarif scheint mir deutlich überhöht zu sein.", vi: "Xin lỗi, mức cước hiển thị có vẻ cao bất thường.", pronunciation_focus: ["angezeigte → ÁN-gê-tsai-gê-tê", "Tarif → ta-RIF", "überhöht → uy-bờ-HƠT"] },
      { en: "Könnten Sie mir bitte erklären, warum wir nicht die direkte Strecke gefahren sind?", vi: "Anh giải thích giúp em tại sao mình không đi đường trực tiếp ạ?", pronunciation_focus: ["direkte Strecke → đi-RÉK-tê SHTRÊ-kê", "gefahren → gê-FA-rần", "erklären → e-KLE-rần"] },
      { en: "Ich bestehe auf einer ordnungsgemäßen Quittung mit Taxameter-Stand.", vi: "Em yêu cầu hóa đơn đúng quy cách có ghi số đồng hồ taxi.", pronunciation_focus: ["bestehe → bê-SHTÊ-ê", "ordnungsgemäßen → OD-nungs-gê-mê-sần", "Quittung → KVI-tung"] },
      { en: "Ich habe die Konzessionsnummer Ihres Taxis bereits notiert.", vi: "Em đã ghi lại số giấy phép taxi của anh rồi.", pronunciation_focus: ["Konzessionsnummer → kôn-tse-SI-ôns-num-ờ", "notiert → nô-TI-ợt", "bereits → bê-RAITS"] },
      { en: "Sollten wir keine Einigung finden, werde ich die Verbraucherzentrale informieren.", vi: "Nếu không thỏa thuận được, em sẽ báo Hiệp hội Bảo vệ Người tiêu dùng.", pronunciation_focus: ["Einigung → AI-ni-gung", "Verbraucherzentrale → fe-BRAO-khờ-tsen-tra-lê", "informieren → in-fo-MI-rần"] },
    ],
    ...
    vocabulary: [
      { word: "der Fahrpreis", en: "fare, taxi price", vi: "tiền cước taxi", pos: "noun (m)", pronunciation_vi: "đe FA-prais" },
      { word: "der Taxameter", en: "taximeter", vi: "đồng hồ tính cước", pos: "noun (m)", pronunciation_vi: "đe ta-xa-MÊ-tờ" },
      { word: "der Tarif", en: "tariff, rate", vi: "biểu giá", pos: "noun (m)", pronunciation_vi: "đe ta-RIF" },
      { word: "die Konzessionsnummer", en: "taxi license number", vi: "số giấy phép taxi", pos: "noun (f)", pronunciation_vi: "đi kôn-tse-SI-ôns-num-ờ" },
      { word: "die Quittung", en: "receipt", vi: "hóa đơn / biên lai", pos: "noun (f)", pronunciation_vi: "đi KVI-tung" },
      { word: "der Festpreis", en: "fixed price (airport/station)", vi: "giá cố định", pos: "noun (m)", pronunciation_vi: "đe FÉST-prais" },
      { word: "die Verbraucherzentrale", en: "consumer protection association", vi: "hiệp hội bảo vệ người tiêu dùng", pos: "noun (f)", pronunciation_vi: "đi fe-BRAO-khờ-tsen-tra-lê" },
      { word: "das Ordnungsamt", en: "regulatory office (handles taxi violations)", vi: "cơ quan quản lý trật tự", pos: "noun (n)", pronunciation_vi: "đát OD-nungs-amt" },
      { word: "überhöht", en: "excessive, inflated", vi: "quá cao (giá)", pos: "adjective", pronunciation_vi: "uy-bờ-HƠT" },
      { word: "der Umweg", en: "detour", vi: "đường vòng", pos: "noun (m)", pronunciation_vi: "đe UM-vêk" },
    ],
    dialogue: [
      { speaker: "Linh", text: "Entschuldigung, der Preis erscheint mir zu hoch — wie kommen 95 Euro zustande?", vi: "Xin lỗi, giá có vẻ cao — sao lại 95 euro vậy?" },
      { speaker: "Taxifahrer", text: "Stau auf der A5 — ich musste den Umweg nehmen.", vi: "Kẹt xe trên A5 — tôi phải đi đường vòng." },
      { speaker: "Linh", text: "Auf Google Maps sehe ich keinen Stau. Bitte zeigen Sie mir den Taxameter-Verlauf.", vi: "Trên Google Maps em không thấy kẹt. Anh cho em xem lịch sử Taxameter." },
      { speaker: "Taxifahrer", text: "Moment, ich drucke Ihnen die Quittung aus.", vi: "Khoan, tôi in hóa đơn cho anh." },
    ],
    dialogue_long: [
      { speaker: "Linh", text: "So, wir sind angekommen. Ich bezahle gerne — aber bitte erklären Sie mir den Preis.", vi: "Đến nơi rồi. Em sẵn sàng trả — nhưng anh giải thích giá giúp em." },
      { speaker: "Taxifahrer", text: "95 Euro. Steht alles auf dem Taxameter.", vi: "95 euro. Đồng hồ ghi hết rồi." },
      { speaker: "Linh", text: "Vom Frankfurter Flughafen ins Hotel Steigenberger sind es laut Google Maps etwa 18 Kilometer und 25 Minuten — der übliche Preis liegt bei 55 bis 65 Euro.", vi: "Từ sân bay Frankfurt đến khách sạn Steigenberger theo Google Maps là khoảng 18 km và 25 phút — giá thường là 55-65 euro." },
      { speaker: "Taxifahrer", text: "Es war Stau auf der A5 — ich musste über die A3 ausweichen.", vi: "Kẹt xe trên A5 — tôi phải đi vòng qua A3." },
      { speaker: "Linh", text: "Auf meiner App zeigt die Strecke A5 zur Ankunftszeit keinen Stau. Wäre eine Erklärung mit dem Taxameter-Beleg möglich?", vi: "App của em báo A5 lúc đó không kẹt. Anh đưa cho em xem giấy chứng minh từ Taxameter được không?" },
      { speaker: "Taxifahrer", text: "Was wollen Sie damit andeuten?", vi: "Anh muốn ám chỉ gì?" },
      { speaker: "Linh", text: "Ich möchte nur Klarheit. Bitte drucken Sie mir eine ordnungsgemäße Quittung mit Taxameter-Stand und Strecke aus.", vi: "Em chỉ muốn rõ ràng. Anh in hóa đơn đúng quy cách có Taxameter và lộ trình giúp em." },
      { speaker: "Taxifahrer", text: "Eine Quittung kostet extra.", vi: "Hóa đơn tốn thêm phí." },
      { speaker: "Linh", text: "Das stimmt nicht. Nach deutschem Personenbeförderungsgesetz haben Sie die Quittung kostenlos auszuhändigen.", vi: "Không đúng. Theo Luật Vận chuyển Hành khách Đức, anh phải đưa hóa đơn miễn phí." },
      { speaker: "Taxifahrer", text: "Na gut. Hier ist die Quittung.", vi: "Thôi được. Đây là hóa đơn." },
      { speaker: "Linh", text: "Vielen Dank. Ich sehe hier 95 Euro, aber keine Aufschlüsselung der Kilometer. Ich notiere mir Ihre Konzessionsnummer F-TX 4582.", vi: "Cám ơn. Em thấy 95 euro nhưng không có chia chi tiết kilomét. Em ghi lại số giấy phép của anh F-TX 4582." },
      { speaker: "Taxifahrer", text: "Was machen Sie da?", vi: "Anh làm gì vậy?" },
      { speaker: "Linh", text: "Ich werde den Vorfall der Verbraucherzentrale Hessen melden, falls wir uns nicht auf einen marktüblichen Preis einigen können.", vi: "Em sẽ báo Hiệp hội Tiêu dùng Hessen nếu mình không thỏa thuận được giá hợp lý." },
      { speaker: "Taxifahrer", text: "Das ist nicht nötig. Ich runde auf 65 Euro ab — ist das fair?", vi: "Không cần đâu. Tôi giảm xuống 65 euro — vậy công bằng chứ?" },
      { speaker: "Linh", text: "Das entspricht dem üblichen Tarif. Ich akzeptiere — bitte drucken Sie eine korrigierte Quittung über 65 Euro aus.", vi: "Đó là mức cước thông thường. Em chấp nhận — anh in lại hóa đơn 65 euro giúp em." },
      { speaker: "Taxifahrer", text: "In Ordnung. Hier ist die korrigierte Quittung.", vi: "Được. Đây là hóa đơn đã chỉnh." },
      { speaker: "Linh", text: "Vielen Dank. Einen schönen Tag noch.", vi: "Cám ơn. Chúc anh ngày tốt lành." },
    ],
    roleplay_prompts: [
    ...
    idiom_glosses: [
      { idiom: "jemanden über den Tisch ziehen", literal: "kéo ai đó qua bàn", meaning: "lừa lọc, chặt chém ai đó", example: "Der Taxifahrer wollte mich über den Tisch ziehen — 95 Euro für eine 60-Euro-Strecke." },
      { idiom: "den Hals nicht voll genug bekommen", literal: "cổ không bao giờ đầy đủ", meaning: "tham lam vô đáy, không bao giờ đủ", example: "Manche Taxifahrer können den Hals nicht voll genug bekommen — sie nehmen Touristen aus." },
      { idiom: "Tacheles reden", literal: "nói tacheles (gốc Yiddish)", meaning: "nói thẳng thắn, không vòng vo", example: "Mit dem Taxifahrer musste ich Tacheles reden — sonst hätte er nicht eingelenkt." },
      { idiom: "die Karten auf den Tisch legen", literal: "đặt bài lên bàn", meaning: "minh bạch hết, không giấu giếm", example: "Bitte legen Sie die Karten auf den Tisch — wie kommt der Preis zustande?" },
    ],
    exercises: [
      {
        type: "fill_blank",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Der angezeigte ___ scheint mir überhöht zu sein.", answer: "Tarif" },
          { prompt: "Ich bestehe auf einer ordnungsgemäßen ___.", answer: "Quittung" },
          { prompt: "Ich habe die ___ Ihres Taxis notiert.", answer: "Konzessionsnummer" },
          { prompt: "Ich werde die ___ informieren.", answer: "Verbraucherzentrale" },
        ],
      },
      {
        type: "matching",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Taxameter", answer: "Đồng hồ tính cước" },
          { prompt: "Festpreis", answer: "Giá cố định (sân bay/ga)" },
          { prompt: "Personenbeförderungsgesetz", answer: "Luật vận chuyển hành khách" },
          { prompt: "Ordnungsamt", answer: "Cơ quan xử phạt taxi" },
        ],
      },
      {
        type: "translation",
        instruction_vi: "Dịch sang tiếng Đức formal:",
        pronunciation_focus: ["taxi dispute"],
        items: [
          { prompt: "Mức cước có vẻ cao bất thường.", answer: "Der Tarif scheint mir deutlich überhöht zu sein." },
          { prompt: "Anh giải thích sao mình không đi đường trực tiếp?", answer: "Könnten Sie erklären, warum wir nicht die direkte Strecke gefahren sind?" },
          { prompt: "Em yêu cầu hóa đơn đúng quy cách có Taxameter.", answer: "Ich bestehe auf einer ordnungsgemäßen Quittung mit Taxameter-Stand." },
          { prompt: "Nếu không thỏa thuận được, em sẽ báo Hiệp hội Tiêu dùng.", answer: "Sollten wir keine Einigung finden, werde ich die Verbraucherzentrale informieren." },
        ],
      },
    ],
  },
  {
    ...
    sentences: [
      { en: "Frau Schneider, ich würde gerne mit Ihnen offen über etwas sprechen, das mich seit Wochen beschäftigt.", vi: "Cô Schneider, em muốn nói chuyện cởi mở với cô về điều mà em đã suy nghĩ mấy tuần nay.", pronunciation_focus: ["Schneider → SHNAI-đờ", "offen → ÔF-fần", "beschäftigt → bê-SHEFT-ti-gờt"] },
      { en: "Ich habe das Gefühl, dass meine Pläne und Markus' Wünsche manchmal nicht ganz mit Ihren Erwartungen übereinstimmen.", vi: "Em cảm thấy kế hoạch của em và mong muốn của Markus đôi khi không hoàn toàn trùng với kỳ vọng của cô.", pronunciation_focus: ["Erwartungen → e-VA-tun-gần", "übereinstimmen → uy-bờ-AIN-shtim-mần", "Wünsche → VUYN-shê"] },
      { en: "Tết ist für meine Familie nicht nur ein Feiertag — es ist der wichtigste Moment des Jahres.", vi: "Tết với gia đình em không chỉ là ngày lễ — đó là khoảnh khắc quan trọng nhất trong năm.", pronunciation_focus: ["Feiertag → FAI-ờ-tak", "wichtigste → VIKH-tikh-stê", "Moment → mô-MENT"] },
      { en: "Ich verstehe, dass Sie sich Enkelkinder wünschen — aber Markus und ich brauchen noch Zeit für unsere Karrieren.", vi: "Em hiểu cô mong có cháu — nhưng Markus và em vẫn cần thời gian cho sự nghiệp.", pronunciation_focus: ["Enkelkinder → EN-kệl-kin-đờ", "Karrieren → ka-RI-rần", "wünschen → VUYN-shần"] },
      { en: "Es würde mir viel bedeuten, wenn wir einen Mittelweg finden könnten.", vi: "Việc tìm được điểm dung hòa sẽ rất có ý nghĩa với em.", pronunciation_focus: ["bedeuten → bê-ĐOI-tần", "Mittelweg → MI-tệl-vêk", "könnten → KƠN-tần"] },
    ],
    ...
    vocabulary: [
      { word: "die Schwiegereltern", en: "in-laws (parents-in-law)", vi: "bố mẹ chồng/vợ", pos: "noun (pl)", pronunciation_vi: "đi SHVÍ-gờ-en-tờn" },
      { word: "die Schwiegermutter", en: "mother-in-law", vi: "mẹ chồng/vợ", pos: "noun (f)", pronunciation_vi: "đi SHVÍ-gờ-mu-tờ" },
      { word: "die Erwartung", en: "expectation", vi: "kỳ vọng", pos: "noun (f)", pronunciation_vi: "đi e-VA-tung" },
      { word: "der Mittelweg", en: "middle ground, compromise", vi: "điểm dung hòa", pos: "noun (m)", pronunciation_vi: "đe MI-tệl-vêk" },
      { word: "die Grenze setzen", en: "to set a boundary", vi: "đặt ranh giới", pos: "verb phrase", pronunciation_vi: "đi GREN-tsê ZÉT-tsần" },
      { word: "siezen / duzen", en: "to address as Sie / Du", vi: "xưng hô Sie / Du", pos: "verb", pronunciation_vi: "ZI-tsần / ĐU-tsần" },
      { word: "die Karriere", en: "career", vi: "sự nghiệp", pos: "noun (f)", pronunciation_vi: "đi ka-RI-rê" },
      { word: "das Enkelkind", en: "grandchild", vi: "cháu", pos: "noun (n)", pronunciation_vi: "đát EN-kệl-kint" },
      { word: "der Druck", en: "pressure", vi: "áp lực", pos: "noun (m)", pronunciation_vi: "đe ĐRUK" },
      { word: "die Wertschätzung", en: "appreciation, respect", vi: "sự trân trọng", pos: "noun (f)", pronunciation_vi: "đi VÊT-shê-tsung" },
    ],
    dialogue: [
      { speaker: "Frau Schneider", text: "Linh, du wolltest mit mir sprechen?", vi: "Linh, con muốn nói chuyện với mẹ à?" },
      { speaker: "Linh", text: "Ja, Frau Schneider. Ich würde gerne offen über etwas sprechen, das mich beschäftigt.", vi: "Vâng, cô Schneider. Em muốn nói thẳng về một việc đang khiến em suy nghĩ." },
      { speaker: "Frau Schneider", text: "Bitte — und sag ruhig Hannelore. Wir müssen nicht mehr siezen.", vi: "Cứ nói — và gọi mẹ là Hannelore. Mình không cần xưng Sie nữa." },
      { speaker: "Linh", text: "Sehr gerne, Hannelore. Das bedeutet mir viel.", vi: "Vâng, Hannelore. Điều đó có ý nghĩa lớn với em." },
    ],
    dialogue_long: [
      { speaker: "Linh", text: "Frau Schneider, hätten Sie nächste Woche kurz Zeit für ein Gespräch zwischen uns beiden?", vi: "Cô Schneider, tuần sau cô có thời gian cho một cuộc trò chuyện riêng giữa hai mình không?" },
      { speaker: "Frau Schneider", text: "Natürlich, Linh. Ist alles in Ordnung mit dir und Markus?", vi: "Tất nhiên, Linh. Mọi chuyện giữa con và Markus ổn không?" },
      { speaker: "Linh", text: "Ja, Markus und mir geht es gut — es ist mehr ein Familienthema, das ich offen ansprechen möchte.", vi: "Vâng, em và Markus ổn — là một chủ đề gia đình em muốn nói thẳng." },
      { speaker: "Frau Schneider", text: "Das schätze ich. Sag ruhig, was dich bewegt.", vi: "Mẹ trân trọng điều đó. Cứ nói cái gì làm con suy nghĩ." },
      { speaker: "Linh", text: "Ich habe das Gefühl, dass meine Pläne und Markus' Wünsche manchmal nicht ganz mit Ihren Erwartungen übereinstimmen — besonders beim Thema Kinder und beim Thema Familienfeiern.", vi: "Em có cảm giác kế hoạch của em và mong muốn của Markus đôi khi không trùng với kỳ vọng của cô — đặc biệt về chủ đề con cái và lễ gia đình." },
      { speaker: "Frau Schneider", text: "Das ist ein wichtiges Thema. Was beschäftigt dich konkret?", vi: "Đó là chủ đề quan trọng. Cụ thể điều gì làm con suy nghĩ?" },
      { speaker: "Linh", text: "Beim letzten Familientreffen haben Sie mehrfach erwähnt, dass Sie sich Enkelkinder wünschen. Markus und ich brauchen aber noch Zeit für unsere Karrieren — wir würden gerne erst in zwei, drei Jahren darüber nachdenken.", vi: "Lần họp gia đình vừa rồi cô có nhắc nhiều lần về chuyện cháu. Nhưng Markus và em cần thời gian cho sự nghiệp — tụi em muốn nghĩ về chuyện đó sau 2-3 năm nữa." },
      { speaker: "Frau Schneider", text: "Ich verstehe. Ich gebe zu — meine Generation hat anders entschieden. Aber das ist eure Entscheidung als Paar.", vi: "Mẹ hiểu. Mẹ phải thừa nhận — thế hệ mẹ đã quyết định khác. Nhưng đó là quyết định của con và Markus." },
      { speaker: "Linh", text: "Vielen Dank — das bedeutet mir wirklich viel. Es gibt noch ein zweites Thema: Tết.", vi: "Cám ơn cô — điều đó có ý nghĩa lớn. Còn chủ đề thứ hai: Tết." },
      { speaker: "Frau Schneider", text: "Tết — das vietnamesische Neujahr, oder?", vi: "Tết — là Tết Nguyên đán Việt Nam đúng không?" },
      { speaker: "Linh", text: "Genau. Tết ist für meine Familie nicht nur ein Feiertag — es ist der wichtigste Moment des Jahres, ähnlich wie Weihnachten für Sie.", vi: "Chính xác. Tết với gia đình em không chỉ là ngày lễ — đó là khoảnh khắc quan trọng nhất trong năm, tương tự như Giáng sinh với cô." },
      { speaker: "Frau Schneider", text: "Das war mir nicht so bewusst. Wann fällt Tết denn?", vi: "Mẹ không hề biết. Tết thường rơi vào lúc nào?" },
      { speaker: "Linh", text: "Ende Januar oder Anfang Februar — der Termin verschiebt sich nach dem Mondkalender. Ich würde sehr gerne mit Markus dieses Jahr nach Vietnam fliegen.", vi: "Cuối tháng 1 hoặc đầu tháng 2 — ngày thay đổi theo âm lịch. Em rất muốn cùng Markus về Việt Nam năm nay." },
      { speaker: "Frau Schneider", text: "Das versteht sich von selbst. Wir feiern Weihnachten — also feiert ihr Tết. Das ist nur fair.", vi: "Điều đó là hiển nhiên. Tụi mẹ ăn Giáng sinh — thì các con ăn Tết. Như vậy mới công bằng." },
      { speaker: "Linh", text: "Es würde mir bedeuten, wenn Sie und Karl uns nächstes Jahr zu einem Tết-Essen bei uns einladen würden — wir möchten Ihnen unsere Tradition zeigen.", vi: "Có ý nghĩa với em nếu cô và bác Karl nhận lời mời ăn Tết ở nhà tụi con năm sau — tụi con muốn cho cô bác xem truyền thống của tụi con." },
      { speaker: "Frau Schneider", text: "Mit Freude. Und Linh — danke, dass du das so offen angesprochen hast. Genau das brauchen wir in der Familie.", vi: "Vui lòng. Và Linh — cám ơn con đã nói thẳng như vậy. Đó chính là điều gia đình mình cần." },
    ],
    roleplay_prompts: [
    ...
    idiom_glosses: [
      { idiom: "den Stier bei den Hörnern packen", literal: "nắm bò mộng ở hai sừng", meaning: "đối mặt thẳng với vấn đề khó", example: "Ich habe den Stier bei den Hörnern gepackt und das Thema mit meiner Schwiegermutter offen angesprochen." },
      { idiom: "auf einen grünen Zweig kommen", literal: "đến được cành xanh", meaning: "đạt được sự đồng thuận, tiến bộ trong quan hệ", example: "Nach dem Gespräch sind wir endlich auf einen grünen Zweig gekommen." },
      { idiom: "Öl ins Feuer gießen", literal: "đổ dầu vào lửa", meaning: "làm tình hình căng thẳng hơn", example: "Vermeide diesen Tonfall — das gießt nur Öl ins Feuer." },
      { idiom: "die Kirche im Dorf lassen", literal: "để nhà thờ ở trong làng", meaning: "không làm to chuyện, giữ tỷ lệ phù hợp", example: "Lass die Kirche im Dorf — es geht nur um einen Familienurlaub, nicht ums Erbe." },
    ],
    exercises: [
      {
        type: "fill_blank",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Ich würde gerne ___ mit Ihnen sprechen.", answer: "offen" },
          { prompt: "Ich habe das ___, dass meine Pläne nicht übereinstimmen.", answer: "Gefühl" },
          { prompt: "Können wir einen ___ finden?", answer: "Mittelweg" },
          { prompt: "Es ___ mir viel bedeuten, wenn ...", answer: "würde" },
        ],
      },
      {
        type: "matching",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Wir müssen nicht mehr siezen.", answer: "Lời mời chuyển sang Du" },
          { prompt: "Ich-messages", answer: "Nói cảm xúc của bản thân, không kết tội" },
          { prompt: "auf einen grünen Zweig kommen", answer: "Đạt sự đồng thuận (idiom)" },
          { prompt: "die Kirche im Dorf lassen", answer: "Không làm to chuyện (idiom)" },
        ],
      },
      {
        type: "translation",
        instruction_vi: "Dịch sang tiếng Đức formal (Konjunktiv II khi cần):",
        pronunciation_focus: ["family conversation"],
        items: [
          { prompt: "Em muốn nói thẳng với cô về một việc.", answer: "Ich würde gerne offen mit Ihnen über etwas sprechen." },
          { prompt: "Em có cảm giác kỳ vọng của cô và kế hoạch của em không trùng.", answer: "Ich habe das Gefühl, dass Ihre Erwartungen und meine Pläne nicht übereinstimmen." },
          { prompt: "Tết với gia đình em quan trọng như Giáng sinh với cô.", answer: "Tết ist für meine Familie so wichtig wie Weihnachten für Sie." },
          { prompt: "Sẽ có ý nghĩa với em nếu mình tìm được điểm dung hòa.", answer: "Es würde mir bedeuten, wenn wir einen Mittelweg finden könnten." },
        ],
      },
    ],
  },
  {
    ...
    sentences: [
      { en: "Anna, ich höre, was du sagst — aber ich sehe das ehrlich gesagt anders.", vi: "Anna, mình nghe cậu nói rồi — nhưng nói thật là mình thấy khác.", pronunciation_focus: ["ehrlich → ÊR-likh", "gesagt → gê-ZAK-t", "anders → AN-đờs"] },
      { en: "Diese Verallgemeinerung über vietnamesische Migrant:innen entspricht nicht meiner Erfahrung.", vi: "Khái quát hóa đó về người Việt nhập cư không khớp với trải nghiệm của mình.", pronunciation_focus: ["Verallgemeinerung → fe-AL-gê-mai-nê-rung", "Migrant:innen → mi-GRAN-tin-nần", "Erfahrung → e-FA-rung"] },
      { en: "Ich verstehe, woher die Wut kommt — gleichzeitig finde ich die Schlussfolgerung problematisch.", vi: "Mình hiểu sự bức xúc đó từ đâu — đồng thời mình thấy kết luận có vấn đề.", pronunciation_focus: ["Wut → VUT", "Schlussfolgerung → SHLUS-fôl-gê-rung", "problematisch → prô-blê-MA-tish"] },
      { en: "Können wir uns darauf einigen, dass wir hier unterschiedlicher Meinung sind?", vi: "Mình có thể đồng ý rằng tụi mình có quan điểm khác nhau ở chỗ này không?", pronunciation_focus: ["einigen → AI-ni-gần", "unterschiedlicher → UN-tờ-shi-đe-li-khờ", "Meinung → MAI-nung"] },
      { en: "Unsere Freundschaft ist mir wichtiger als die Frage, wer Recht hat.", vi: "Tình bạn của tụi mình quan trọng với mình hơn câu hỏi ai đúng.", pronunciation_focus: ["Freundschaft → FROIN-shaft", "wichtiger → VIKH-ti-gờ", "Recht → REKHT"] },
    ],
    ...
    vocabulary: [
      { word: "die Verallgemeinerung", en: "generalization", vi: "khái quát hóa", pos: "noun (f)", pronunciation_vi: "đi fe-AL-gê-mai-nê-rung" },
      { word: "die Schlussfolgerung", en: "conclusion (in argument)", vi: "kết luận", pos: "noun (f)", pronunciation_vi: "đi SHLUS-fôl-gê-rung" },
      { word: "die Streitkultur", en: "culture of debate", vi: "văn hóa tranh luận", pos: "noun (f)", pronunciation_vi: "đi SHTRAIT-kul-tu" },
      { word: "die Meinung", en: "opinion", vi: "quan điểm", pos: "noun (f)", pronunciation_vi: "đi MAI-nung" },
      { word: "der Eindruck", en: "impression", vi: "ấn tượng", pos: "noun (m)", pronunciation_vi: "đe AIN-đruk" },
      { word: "nachvollziehen", en: "to understand, follow (someone's reasoning)", vi: "hiểu được, follow logic", pos: "verb (sep.)", pronunciation_vi: "NAKH-fôl-tsi-ần" },
      { word: "problematisch", en: "problematic", vi: "có vấn đề", pos: "adjective", pronunciation_vi: "prô-blê-MA-tish" },
      { word: "rassistisch", en: "racist", vi: "phân biệt chủng tộc", pos: "adjective", pronunciation_vi: "RA-sis-tish" },
      { word: "die Migrationspolitik", en: "immigration policy", vi: "chính sách di cư", pos: "noun (f)", pronunciation_vi: "đi mi-gra-tsi-ÔNS-pô-li-tik" },
      { word: "Recht haben", en: "to be right", vi: "đúng", pos: "verb phrase", pronunciation_vi: "REKHT HA-bần" },
    ],
    dialogue: [
      { speaker: "Anna", text: "Diese ganzen Migrant:innen — die kommen doch nur, um sich vom Sozialstaat tragen zu lassen.", vi: "Mấy người nhập cư đó — họ chỉ đến để được nhà nước phúc lợi nuôi thôi." },
      { speaker: "Linh", text: "Anna, ich höre, was du sagst — aber ich sehe das ehrlich gesagt anders. Diese Verallgemeinerung entspricht nicht meiner Erfahrung.", vi: "Anna, mình nghe cậu rồi — nhưng nói thật mình thấy khác. Khái quát đó không khớp với trải nghiệm của mình." },
      { speaker: "Anna", text: "Du nimmst das gleich so persönlich.", vi: "Cậu cứ coi nó là chuyện cá nhân." },
      { speaker: "Linh", text: "Es ist auch persönlich — meine Familie ist Teil dieser 'Migrant:innen'. Aber lass uns über die Sache reden, nicht übereinander.", vi: "Đúng là chuyện cá nhân — gia đình mình thuộc nhóm 'người nhập cư' đó. Nhưng tụi mình bàn về vấn đề, không bàn về nhau." },
    ],
    dialogue_long: [
      { speaker: "Anna", text: "Hast du gestern die Talkshow gesehen? Diese ganzen Migrant:innen — die kommen doch nur, um sich vom Sozialstaat tragen zu lassen.", vi: "Hôm qua cậu xem talkshow chưa? Mấy người nhập cư đó — họ chỉ đến để được nhà nước nuôi thôi." },
      { speaker: "Linh", text: "Anna, ich höre, was du sagst — aber ich sehe das ehrlich gesagt anders. Können wir kurz innehalten?", vi: "Anna, mình nghe cậu rồi — nhưng nói thật mình thấy khác. Tụi mình dừng lại một chút được không?" },
      { speaker: "Anna", text: "Ja, klar. Was meinst du?", vi: "Ừ, được. Cậu nghĩ sao?" },
      { speaker: "Linh", text: "Diese Verallgemeinerung über 'die Migrant:innen' entspricht nicht meiner Erfahrung. Meine Eltern sind in den 80ern aus Vietnam gekommen — sie haben jahrzehntelang gearbeitet, Steuern gezahlt und drei Kinder großgezogen.", vi: "Khái quát hóa về 'người nhập cư' đó không khớp với trải nghiệm của mình. Bố mẹ mình đến Đức từ những năm 80 — họ làm việc hàng chục năm, đóng thuế và nuôi ba con." },
      { speaker: "Anna", text: "Ich habe deine Eltern doch gar nicht gemeint.", vi: "Mình không nói về bố mẹ cậu đâu." },
      { speaker: "Linh", text: "Genau das ist mein Punkt: 'die Migrant:innen' als pauschale Gruppe gibt es nicht. Wenn du das so generalisierst, sind meine Eltern automatisch mit drin.", vi: "Đó chính là điểm của mình: 'người nhập cư' như một nhóm chung không tồn tại. Cậu khái quát hóa như vậy, bố mẹ mình tự động bị gộp vào." },
      { speaker: "Anna", text: "Hm. Das habe ich so nicht bedacht.", vi: "Hừm. Mình chưa nghĩ như vậy." },
      { speaker: "Linh", text: "Ich verstehe auch, woher die Wut kommt — Sozialsystem, Wohnungsmarkt, alles ist angespannt. Gleichzeitig finde ich die Schlussfolgerung problematisch.", vi: "Mình cũng hiểu sự bức xúc đến từ đâu — hệ thống phúc lợi, thị trường nhà ở, tất cả đều căng thẳng. Đồng thời mình thấy kết luận có vấn đề." },
      { speaker: "Anna", text: "Du nimmst das gleich so persönlich.", vi: "Cậu coi nó là chuyện cá nhân quá." },
      { speaker: "Linh", text: "Es ist auch persönlich — aber lass uns über die Sache reden, nicht übereinander. Welche konkrete Aussage in der Talkshow hat dich denn gestört?", vi: "Đúng là chuyện cá nhân — nhưng tụi mình bàn về vấn đề, không bàn về nhau. Phát biểu cụ thể nào trong talkshow làm cậu bức xúc?" },
      { speaker: "Anna", text: "Da war eine Statistik über Sozialleistungen — ich habe die Zahl jetzt nicht mehr im Kopf.", vi: "Có thống kê về phúc lợi — mình không nhớ con số chính xác." },
      { speaker: "Linh", text: "Ich kenne die Statistik auch nicht auswendig — aber meine Erfahrung sagt etwas anderes. Wir können beide nachschauen und nächste Woche darüber sprechen?", vi: "Mình cũng không thuộc — nhưng trải nghiệm mình nói khác. Hai mình tra cứu và tuần sau bàn lại được không?" },
      { speaker: "Anna", text: "Ja, das ist fair. Tut mir leid, wenn das vorhin zu pauschal war.", vi: "Ừ, công bằng. Xin lỗi nếu nãy mình nói quá khái quát." },
      { speaker: "Linh", text: "Danke, dass du das hörst. Können wir uns darauf einigen, dass wir hier verschiedene Eindrücke haben — und beim nächsten Mal mit Fakten weiterreden?", vi: "Cám ơn cậu lắng nghe. Mình có thể đồng ý rằng tụi mình có ấn tượng khác — và lần tới bàn tiếp với fact không?" },
      { speaker: "Anna", text: "Klar. Unsere Freundschaft ist mir wichtiger als die Frage, wer Recht hat.", vi: "Tất nhiên. Tình bạn quan trọng với mình hơn câu hỏi ai đúng." },
      { speaker: "Linh", text: "Mir geht's genauso. Wollen wir was Anderes machen — Spaziergang am See?", vi: "Mình cũng vậy. Tụi mình làm gì khác đi — đi dạo bên hồ nhé?" },
      { speaker: "Anna", text: "Sehr gerne. Ich hole meine Jacke.", vi: "Vâng, được. Mình lấy áo khoác." },
    ],
    roleplay_prompts: [
    ...
    idiom_glosses: [
      { idiom: "über den eigenen Tellerrand schauen", literal: "nhìn qua mép đĩa của mình", meaning: "mở rộng góc nhìn, không bị giới hạn trong kinh nghiệm bản thân", example: "Manchmal hilft es, über den eigenen Tellerrand zu schauen — meine Erfahrung ist nicht die einzige." },
      { idiom: "Tacheles reden", literal: "nói tacheles (gốc Yiddish 'sự thật')", meaning: "nói thẳng thắn, không vòng vo", example: "Lass uns Tacheles reden — was hat dich an dieser Aussage wirklich gestört?" },
      { idiom: "über einen Kamm scheren", literal: "chải qua một cái lược", meaning: "đánh đồng tất cả, khái quát hóa", example: "Du scherst alle Migrant:innen über einen Kamm — das ist mir zu pauschal." },
      { idiom: "auf einen Nenner kommen", literal: "đến được một mẫu số chung", meaning: "đạt sự đồng thuận", example: "Wir kommen heute Abend nicht auf einen Nenner — und das ist auch okay." },
    ],
    exercises: [
      {
        type: "fill_blank",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Ich ___, was du sagst — aber ich sehe das anders.", answer: "höre" },
          { prompt: "Diese ___ entspricht nicht meiner Erfahrung.", answer: "Verallgemeinerung" },
          { prompt: "Lass uns über die ___ reden, nicht übereinander.", answer: "Sache" },
          { prompt: "Unsere Freundschaft ist mir ___ als die Frage, wer Recht hat.", answer: "wichtiger" },
        ],
      },
      {
        type: "matching",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Sache vs Person", answer: "Tách vấn đề khỏi con người" },
          { prompt: "Ja, und", answer: "Hợp tác (vs 'Ja, aber' phủ nhận)" },
          { prompt: "über einen Kamm scheren", answer: "Khái quát hóa quá (idiom)" },
          { prompt: "auf einen Nenner kommen", answer: "Đạt đồng thuận (idiom)" },
        ],
      },
      {
        type: "translation",
        instruction_vi: "Dịch sang tiếng Đức (Du, Konjunktiv II khi cần):",
        pronunciation_focus: ["respectful disagreement"],
        items: [
          { prompt: "Mình nghe cậu rồi — nhưng nói thật mình thấy khác.", answer: "Ich höre, was du sagst — aber ich sehe das ehrlich gesagt anders." },
          { prompt: "Khái quát hóa đó không khớp với trải nghiệm của mình.", answer: "Diese Verallgemeinerung entspricht nicht meiner Erfahrung." },
          { prompt: "Tụi mình bàn về vấn đề, không bàn về nhau.", answer: "Lass uns über die Sache reden, nicht übereinander." },
          { prompt: "Tình bạn của tụi mình quan trọng hơn câu hỏi ai đúng.", answer: "Unsere Freundschaft ist mir wichtiger als die Frage, wer Recht hat." },
        ],
      },
    ],
  },
  {
    ...
    sentences: [
      { en: "Sophie, mein herzliches Beileid — ich habe gerade von deiner Großmutter erfahren.", vi: "Sophie, mình thật sự chia buồn — mình vừa biết tin về bà của cậu.", pronunciation_focus: ["herzliches → HÊTS-li-khês", "Beileid → BAI-lait", "Großmutter → GRÔS-mu-tờ"] },
      { en: "Ich kann mir nicht vorstellen, wie schwer das gerade ist — und ich muss auch nichts erklären.", vi: "Mình không tưởng tượng được lúc này khó thế nào — và cậu cũng không cần giải thích gì cả.", pronunciation_focus: ["vorstellen → FÔ-shtêl-lần", "schwer → SHVÊ", "erklären → e-KLE-rần"] },
      { en: "Ich bin einfach für dich da — ob du reden möchtest oder lieber schweigen.", vi: "Mình ở đây với cậu — dù cậu muốn nói chuyện hay im lặng.", pronunciation_focus: ["einfach → AIN-fakh", "schweigen → SHVAI-gần", "möchtest → MƠKH-tệst"] },
      { en: "Soll ich morgen vorbeikommen und etwas zu essen mitbringen?", vi: "Mai mình ghé qua và mang đồ ăn được không?", pronunciation_focus: ["vorbeikommen → fô-BAI-kôm-mần", "mitbringen → MIT-bring-ần", "morgen → MO-gần"] },
      { en: "Wenn du an die Beerdigung möchtest, dass ich dabei bin — sag einfach Bescheid.", vi: "Nếu cậu muốn mình đi đám tang cùng — cứ nói nhé.", pronunciation_focus: ["Beerdigung → bê-Ê-đi-gung", "dabei → đa-BAI", "Bescheid → bê-SHAIT"] },
    ],
    ...
    vocabulary: [
      { word: "das Beileid", en: "condolences", vi: "lời chia buồn", pos: "noun (n)", pronunciation_vi: "đát BAI-lait" },
      { word: "die Trauer", en: "grief, mourning", vi: "đau buồn, tang", pos: "noun (f)", pronunciation_vi: "đi TRAU-ờ" },
      { word: "die Beerdigung", en: "funeral, burial", vi: "đám tang", pos: "noun (f)", pronunciation_vi: "đi bê-Ê-đi-gung" },
      { word: "der Verlust", en: "loss", vi: "sự mất mát", pos: "noun (m)", pronunciation_vi: "đe fe-LUS-t" },
      { word: "das Mitgefühl", en: "empathy, compassion", vi: "sự đồng cảm", pos: "noun (n)", pronunciation_vi: "đát MIT-gê-fuyl" },
      { word: "die Anteilnahme", en: "sympathy, sharing in someone's grief", vi: "sự chia sẻ nỗi đau", pos: "noun (f)", pronunciation_vi: "đi AN-tail-na-mê" },
      { word: "die Trauerkarte", en: "condolence card", vi: "thiệp chia buồn", pos: "noun (f)", pronunciation_vi: "đi TRAU-ờ-ka-tê" },
      { word: "kondolieren", en: "to offer condolences", vi: "chia buồn (động từ)", pos: "verb", pronunciation_vi: "kôn-đô-LI-rần" },
      { word: "der Trauerstrauß", en: "funeral bouquet", vi: "bó hoa tang", pos: "noun (m)", pronunciation_vi: "đe TRAU-ờ-shtraos" },
      { word: "trösten", en: "to comfort", vi: "an ủi", pos: "verb", pronunciation_vi: "TRƠS-tần" },
    ],
    dialogue: [
      { speaker: "Linh", text: "Sophie, mein herzliches Beileid — ich habe gerade von deiner Großmutter erfahren.", vi: "Sophie, mình chia buồn từ đáy lòng — mình vừa biết tin về bà của cậu." },
      { speaker: "Sophie", text: "Danke, Linh. Es war erwartet — sie war 92 — und trotzdem kann ich es kaum fassen.", vi: "Cám ơn Linh. Mình đã đoán trước — bà 92 tuổi — vậy mà mình vẫn không tin nổi." },
      { speaker: "Linh", text: "Ich kann mir nicht vorstellen, wie schwer das gerade ist. Du musst nichts erklären — ich bin einfach für dich da.", vi: "Mình không hình dung nổi lúc này khó thế nào. Cậu không cần giải thích — mình ở đây với cậu." },
      { speaker: "Sophie", text: "Das tut gut zu hören.", vi: "Nghe vậy mình thấy nhẹ lòng." },
    ],
    dialogue_long: [
      { speaker: "Linh", text: "Sophie, mein herzliches Beileid — ich habe gerade von deiner Großmutter erfahren. Wie hältst du dich?", vi: "Sophie, mình chia buồn từ đáy lòng — mình vừa biết tin về bà cậu. Cậu chịu đựng thế nào?" },
      { speaker: "Sophie", text: "Danke, Linh. Es war erwartet — sie war 92, lange krank — und trotzdem kann ich es kaum fassen.", vi: "Cám ơn Linh. Mình đã đoán trước — bà 92 tuổi, ốm lâu rồi — vậy mà mình vẫn không tin nổi." },
      { speaker: "Linh", text: "Ich kann mir nicht vorstellen, wie schwer das gerade ist. Du musst auch nichts erklären — ich bin einfach für dich da.", vi: "Mình không hình dung nổi lúc này khó thế nào. Cậu không cần giải thích gì cả — mình ở đây với cậu." },
      { speaker: "Sophie", text: "Komisch — manchmal weine ich plötzlich, dann ist es eine Stunde völlig okay. Ich verstehe mich selbst nicht.", vi: "Lạ — có lúc mình khóc bất chợt, rồi cả tiếng đồng hồ thấy ổn. Mình không hiểu chính mình." },
      { speaker: "Linh", text: "Das gehört zur Trauer dazu, glaube ich. Es kommt in Wellen — niemand muss das verstehen.", vi: "Đó là một phần của đau buồn, mình nghĩ vậy. Nó đến theo từng đợt — không ai phải hiểu cả." },
      { speaker: "Sophie", text: "Ich erinnere mich gerade an so viele kleine Dinge — wie sie immer Pflaumenkuchen gebacken hat.", vi: "Mình đang nhớ rất nhiều chi tiết nhỏ — bà luôn làm bánh mận." },
      { speaker: "Linh", text: "Erzähl mir davon — ich höre gerne zu.", vi: "Kể mình nghe đi — mình muốn nghe." },
      { speaker: "Sophie", text: "Jeden Sonntag, schon um sechs Uhr morgens — der ganze Hausflur hat nach Pflaumen gerochen. Sie hat darauf bestanden, dass ich beim Teigkneten helfe.", vi: "Mỗi Chủ nhật, từ 6 giờ sáng — cả hành lang thơm mùi mận. Bà luôn yêu cầu mình giúp nhào bột." },
      { speaker: "Linh", text: "Das klingt nach einer wunderschönen Erinnerung.", vi: "Nghe có vẻ là một kỷ niệm rất đẹp." },
      { speaker: "Sophie", text: "Ja. Und gleichzeitig tut es weh, weil es nicht mehr passieren wird.", vi: "Đúng. Và đồng thời đau, vì sẽ không xảy ra nữa." },
      { speaker: "Linh", text: "Beides darf da sein — schöne Erinnerung und Schmerz. Soll ich morgen vorbeikommen und etwas zu essen mitbringen?", vi: "Cả hai đều được phép tồn tại — kỷ niệm đẹp và nỗi đau. Mai mình ghé qua và mang đồ ăn được không?" },
      { speaker: "Sophie", text: "Das wäre wirklich nett. Ich habe seit zwei Tagen kaum gegessen.", vi: "Sẽ rất tốt. Hai ngày nay mình hầu như không ăn." },
      { speaker: "Linh", text: "Ich bringe Suppe und etwas Brot. Wann passt es dir?", vi: "Mình sẽ mang súp và bánh mì. Mấy giờ tiện cho cậu?" },
      { speaker: "Sophie", text: "So ab 17 Uhr wäre gut. Und Linh — wenn du an die Beerdigung am Freitag mitkommen möchtest, würde mir das viel bedeuten.", vi: "Khoảng 17h là tốt. Và Linh — nếu cậu muốn đi đám tang thứ Sáu cùng mình, sẽ có ý nghĩa lớn." },
      { speaker: "Linh", text: "Ich komme. Sag mir nur die Uhrzeit und den Ort — ich bin da.", vi: "Mình sẽ đến. Cậu cho mình giờ và địa điểm — mình sẽ có mặt." },
      { speaker: "Sophie", text: "11 Uhr, Friedhof Ohlsdorf. Danke, Linh — danke, dass du da bist.", vi: "11 giờ, nghĩa trang Ohlsdorf. Cám ơn Linh — cám ơn vì đã ở đây." },
      { speaker: "Linh", text: "Immer.", vi: "Luôn luôn." },
    ],
    roleplay_prompts: [
    ...
    idiom_glosses: [
      { idiom: "in stillem Mitgefühl", literal: "trong sự đồng cảm im lặng", meaning: "lời chia buồn formula trên Trauerkarte", example: "In stillem Mitgefühl — Familie Müller. (chuẩn dòng cuối thiệp chia buồn)" },
      { idiom: "jemandem zur Seite stehen", literal: "đứng bên cạnh ai đó", meaning: "support ai đó trong lúc khó khăn", example: "In dieser schweren Zeit stehe ich dir zur Seite." },
      { idiom: "in Wellen kommen", literal: "đến theo từng đợt sóng", meaning: "đau buồn không liên tục, đến rồi đi", example: "Trauer kommt in Wellen — manchmal stark, manchmal ruhig." },
      { idiom: "Abschied nehmen", literal: "nhận lời chia tay", meaning: "nói lời từ biệt (thường khi tang lễ)", example: "Bei der Beerdigung können wir Abschied nehmen — das ist wichtig." },
    ],
    exercises: [
      {
        type: "fill_blank",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Mein ___ Beileid — ich habe von deiner Großmutter erfahren.", answer: "herzliches" },
          { prompt: "Ich bin einfach für dich ___.", answer: "da" },
          { prompt: "Wie ___ du dich?", answer: "hältst" },
          { prompt: "Trauer kommt in ___ — niemand muss das verstehen.", answer: "Wellen" },
        ],
      },
      {
        type: "matching",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Mein herzliches Beileid", answer: "Câu chia buồn formula chuẩn" },
          { prompt: "Erzähl mir davon", answer: "Mời người mất kể kỷ niệm" },
          { prompt: "Soll ich Suppe vorbeibringen?", answer: "Đề nghị support cụ thể" },
          { prompt: "in stillem Mitgefühl", answer: "Câu kết Trauerkarte (idiom)" },
        ],
      },
      {
        type: "translation",
        instruction_vi: "Dịch sang tiếng Đức (Du, formal khi chia buồn):",
        pronunciation_focus: ["condolences"],
        items: [
          { prompt: "Mình chia buồn từ đáy lòng — mình vừa biết tin về bà cậu.", answer: "Mein herzliches Beileid — ich habe gerade von deiner Großmutter erfahren." },
          { prompt: "Mình không hình dung nổi lúc này khó thế nào.", answer: "Ich kann mir nicht vorstellen, wie schwer das gerade ist." },
          { prompt: "Cậu không cần giải thích gì — mình ở đây với cậu.", answer: "Du musst nichts erklären — ich bin einfach für dich da." },
          { prompt: "Mai mình ghé qua và mang đồ ăn được không?", answer: "Soll ich morgen vorbeikommen und etwas zu essen mitbringen?" },
        ],
      },
    ],
  },
  {
    ...
    sentences: [
      { en: "Tobias, ich möchte mich aufrichtig bei dir entschuldigen — und ich möchte mich nicht rausreden.", vi: "Tobias, mình muốn xin lỗi cậu thật lòng — và mình không muốn biện minh.", pronunciation_focus: ["aufrichtig → AOF-rikh-tikh", "entschuldigen → ent-SHUL-đi-gần", "rausreden → RAOS-rê-đần"] },
      { en: "Ich habe vergangenen Freitag dein Vertrauen verletzt, als ich deine Geschichte weitererzählt habe.", vi: "Thứ Sáu tuần trước mình đã làm tổn thương niềm tin của cậu khi mình kể lại câu chuyện của cậu cho người khác.", pronunciation_focus: ["Vertrauen → fe-TRAU-ần", "verletzt → fe-LET-st", "weitererzählt → VAI-tờ-e-tsêl-t"] },
      { en: "Es gibt keine Entschuldigung dafür — ich hätte schweigen müssen, und das ist mein Fehler.", vi: "Không có lý do nào biện minh được — mình lẽ ra nên im lặng, và đó là lỗi của mình.", pronunciation_focus: ["Entschuldigung → ent-SHUL-đi-gung", "Fehler → FÊ-lờ", "schweigen → SHVAI-gần"] },
      { en: "Ich verstehe, wenn du jetzt Abstand brauchst — das nehme ich nicht persönlich.", vi: "Mình hiểu nếu bây giờ cậu cần khoảng cách — mình không coi đó là chuyện cá nhân.", pronunciation_focus: ["Abstand → AB-shtant", "brauchst → BRAOKHST", "persönlich → pe-ZƠN-likh"] },
      { en: "Ich möchte das wiedergutmachen — und ich werde nicht erwarten, dass das schnell geht.", vi: "Mình muốn sửa chữa — và mình sẽ không kỳ vọng việc đó diễn ra nhanh.", pronunciation_focus: ["wiedergutmachen → VI-đờ-gut-makh-ần", "erwarten → e-VA-tần", "schnell → SHNÊL"] },
    ],
    ...
    vocabulary: [
      { word: "die Entschuldigung", en: "apology", vi: "lời xin lỗi", pos: "noun (f)", pronunciation_vi: "đi ent-SHUL-đi-gung" },
      { word: "sich entschuldigen", en: "to apologize", vi: "xin lỗi (động từ phản thân)", pos: "verb (refl.)", pronunciation_vi: "zikh ent-SHUL-đi-gần" },
      { word: "die Verantwortung übernehmen", en: "to take responsibility", vi: "chịu trách nhiệm", pos: "verb phrase", pronunciation_vi: "đi fe-AN-vô-tung uy-bờ-NÊ-mần" },
      { word: "der Fehler", en: "mistake, error", vi: "lỗi sai", pos: "noun (m)", pronunciation_vi: "đe FÊ-lờ" },
      { word: "das Vertrauen", en: "trust", vi: "niềm tin", pos: "noun (n)", pronunciation_vi: "đát fe-TRAU-ần" },
      { word: "die Wiedergutmachung", en: "making amends, reparation", vi: "sự đền bù", pos: "noun (f)", pronunciation_vi: "đi VI-đờ-gut-makh-ung" },
      { word: "sich rausreden", en: "to make excuses", vi: "biện minh, viện cớ", pos: "verb (sep., refl.)", pronunciation_vi: "zikh RAOS-rê-đần" },
      { word: "der Abstand", en: "distance, space", vi: "khoảng cách", pos: "noun (m)", pronunciation_vi: "đe AB-shtant" },
      { word: "die Reue", en: "remorse, regret", vi: "sự hối hận", pos: "noun (f)", pronunciation_vi: "đi ROI-ê" },
      { word: "vergeben", en: "to forgive", vi: "tha thứ", pos: "verb", pronunciation_vi: "fe-GÊ-bần" },
    ],
    dialogue: [
      { speaker: "Linh", text: "Tobias, hast du kurz Zeit? Ich möchte etwas mit dir besprechen — etwas Wichtiges.", vi: "Tobias, cậu có chút thời gian không? Mình muốn nói chuyện — chuyện quan trọng." },
      { speaker: "Tobias", text: "Klar. Was ist los?", vi: "Được. Có chuyện gì?" },
      { speaker: "Linh", text: "Ich möchte mich aufrichtig bei dir entschuldigen — für letzten Freitag. Ich habe deine Geschichte weitererzählt, obwohl sie vertraulich war.", vi: "Mình muốn xin lỗi cậu thật lòng — về thứ Sáu tuần trước. Mình đã kể lại câu chuyện của cậu, dù nó là chuyện riêng." },
      { speaker: "Tobias", text: "Ich habe es schon gehört. Ich war ehrlich gesagt sehr verletzt.", vi: "Mình đã nghe rồi. Nói thật mình rất tổn thương." },
    ],
    dialogue_long: [
      { speaker: "Linh", text: "Tobias, hast du kurz Zeit? Ich möchte etwas mit dir besprechen — etwas Wichtiges. Können wir uns kurz hinsetzen?", vi: "Tobias, cậu có chút thời gian không? Mình muốn nói chuyện — chuyện quan trọng. Tụi mình ngồi xuống được không?" },
      { speaker: "Tobias", text: "Klar. Was ist los?", vi: "Được. Có chuyện gì?" },
      { speaker: "Linh", text: "Ich möchte mich aufrichtig bei dir entschuldigen — und ich möchte mich nicht rausreden. Letzten Freitag habe ich deine Geschichte über deinen Bruder bei Anna und Markus weitererzählt, obwohl du mir gesagt hast, dass das vertraulich ist.", vi: "Mình muốn xin lỗi cậu thật lòng — và mình không muốn biện minh. Thứ Sáu trước mình đã kể chuyện về anh trai cậu với Anna và Markus, dù cậu đã nói với mình đó là chuyện riêng." },
      { speaker: "Tobias", text: "Ich habe es schon gehört. Anna hat mich gestern darauf angesprochen. Ich war ehrlich gesagt sehr verletzt.", vi: "Mình đã nghe rồi. Anna nhắc với mình hôm qua. Nói thật mình rất tổn thương." },
      { speaker: "Linh", text: "Das verstehe ich. Du hattest mir vertraut, und ich habe das Vertrauen verletzt. Es gibt keine Entschuldigung dafür — ich hätte schweigen müssen.", vi: "Mình hiểu. Cậu đã tin mình, và mình đã làm tổn thương niềm tin đó. Không có lý do nào biện minh được — mình lẽ ra phải im lặng." },
      { speaker: "Tobias", text: "Warum hast du es überhaupt erzählt?", vi: "Sao cậu lại kể nữa?" },
      { speaker: "Linh", text: "Ich möchte mich da nicht rausreden — aber ehrlich gesagt: ich habe es im Gespräch nicht bedacht. Das ist kein Grund, das ist nur eine Erklärung. Mein Verhalten war falsch.", vi: "Mình không muốn biện minh — nhưng nói thật: mình không suy nghĩ trong lúc trò chuyện. Đó không phải lý do, chỉ là giải thích. Hành vi của mình sai." },
      { speaker: "Tobias", text: "Ich schätze, dass du den Unterschied machst — zwischen Erklärung und Entschuldigung.", vi: "Mình trân trọng cậu phân biệt được — giữa giải thích và biện minh." },
      { speaker: "Linh", text: "Ich übernehme die volle Verantwortung. Und ich verstehe, wenn du jetzt Abstand brauchst — das nehme ich nicht persönlich.", vi: "Mình chịu trách nhiệm hoàn toàn. Và mình hiểu nếu bây giờ cậu cần khoảng cách — mình không coi đó là chuyện cá nhân." },
      { speaker: "Tobias", text: "Ich brauche tatsächlich etwas Zeit. Es ist nicht das Ende — aber ich kann jetzt nicht so tun, als wäre nichts.", vi: "Mình thực sự cần thời gian. Không phải là kết thúc — nhưng mình không thể giả vờ không có chuyện gì." },
      { speaker: "Linh", text: "Das ist absolut fair. Ich werde nicht erwarten, dass das schnell geht. Wenn du soweit bist zu reden, melde dich.", vi: "Điều đó hoàn toàn công bằng. Mình sẽ không kỳ vọng nó nhanh. Khi cậu sẵn sàng nói chuyện, cứ nhắn mình." },
      { speaker: "Tobias", text: "Was hast du Anna und Markus gesagt — kannst du das korrigieren?", vi: "Cậu đã nói gì với Anna và Markus — cậu có thể đính chính không?" },
      { speaker: "Linh", text: "Ja — und das werde ich. Ich werde Anna und Markus heute Abend kontaktieren und klar sagen, dass das vertraulich war und ich es nicht hätte erzählen dürfen. Wenn du möchtest, kann ich dir den Wortlaut vorher zeigen.", vi: "Có — và mình sẽ làm. Mình sẽ liên lạc Anna và Markus tối nay, nói rõ đó là chuyện riêng và mình không nên kể. Nếu cậu muốn, mình có thể cho cậu xem trước nội dung." },
      { speaker: "Tobias", text: "Ja, das wäre gut. Schick mir den Text vorher.", vi: "Vâng, sẽ tốt. Gửi mình text trước đi." },
      { speaker: "Linh", text: "Mache ich. Tobias — danke, dass du mir zugehört hast. Ich respektiere deine Entscheidung, wie es weitergeht.", vi: "Mình sẽ làm. Tobias — cám ơn cậu đã lắng nghe mình. Mình tôn trọng cậu sẽ quyết định mọi chuyện tiếp theo." },
      { speaker: "Tobias", text: "Okay. Lass mich jetzt erstmal allein damit. Wir reden, wenn ich bereit bin.", vi: "Được. Để mình một mình với chuyện này đã. Tụi mình nói khi mình sẵn sàng." },
    ],
    roleplay_prompts: [
    ...
    idiom_glosses: [
      { idiom: "reinen Tisch machen", literal: "làm sạch bàn", meaning: "làm rõ mọi chuyện, nhận lỗi và bắt đầu lại", example: "Ich möchte mit dir reinen Tisch machen — und dann sehen, ob du mir noch vertrauen kannst." },
      { idiom: "die Karten auf den Tisch legen", literal: "đặt bài lên bàn", meaning: "minh bạch hết, không giấu giếm", example: "Ich lege die Karten auf den Tisch: ich habe deine Geschichte weitererzählt." },
      { idiom: "über den eigenen Schatten springen", literal: "nhảy qua bóng của chính mình", meaning: "vượt qua tự ái, làm điều khó (như xin lỗi thật lòng)", example: "Es kostet mich Überwindung, aber ich muss über meinen eigenen Schatten springen und mich entschuldigen." },
      { idiom: "Asche auf mein Haupt", literal: "tro lên đầu mình (gốc Kinh Thánh)", meaning: "thừa nhận lỗi nặng (formal/dramatic)", example: "Asche auf mein Haupt — ich hätte das niemals weitererzählen dürfen." },
    ],
    exercises: [
      {
        type: "fill_blank",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Ich möchte mich ___ bei dir entschuldigen.", answer: "aufrichtig" },
          { prompt: "Es gibt keine ___ dafür — ich hätte schweigen müssen.", answer: "Entschuldigung" },
          { prompt: "Ich übernehme die volle ___.", answer: "Verantwortung" },
          { prompt: "Ich verstehe, wenn du jetzt ___ brauchst.", answer: "Abstand" },
        ],
      },
      {
        type: "matching",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Erklärung vs Entschuldigung", answer: "Phân biệt giải thích và biện minh" },
          { prompt: "Wiedergutmachung", answer: "Đền bù qua hành động cụ thể" },
          { prompt: "reinen Tisch machen", answer: "Làm sạch chuyện cũ (idiom)" },
          { prompt: "über den eigenen Schatten springen", answer: "Vượt tự ái xin lỗi (idiom)" },
        ],
      },
      {
        type: "translation",
        instruction_vi: "Dịch sang tiếng Đức (Du, Konjunktiv II Vergangenheit khi cần):",
        pronunciation_focus: ["sincere apology"],
        items: [
          { prompt: "Mình muốn xin lỗi cậu thật lòng — và không muốn biện minh.", answer: "Ich möchte mich aufrichtig bei dir entschuldigen — und ich möchte mich nicht rausreden." },
          { prompt: "Mình lẽ ra phải im lặng, và đó là lỗi của mình.", answer: "Ich hätte schweigen müssen, und das ist mein Fehler." },
          { prompt: "Đó không phải lý do, chỉ là giải thích. Hành vi của mình sai.", answer: "Das ist kein Grund, das ist nur eine Erklärung. Mein Verhalten war falsch." },
          { prompt: "Mình hiểu nếu cậu cần khoảng cách — mình không coi đó là chuyện cá nhân.", answer: "Ich verstehe, wenn du Abstand brauchst — das nehme ich nicht persönlich." },
        ],
      },
    ],
  },
  {
    ...
    sentences: [
      { en: "Marie, ich kann gar nicht glauben, dass du nächste Woche schon nach Australien fliegst.", vi: "Marie, mình không thể tin nổi tuần sau cậu đã bay sang Úc rồi.", pronunciation_focus: ["nächste → NEKH-stê", "fliegst → FLI-kst", "Australien → aos-TRA-li-ần"] },
      { en: "Du hast mich in den letzten zehn Jahren mehr geprägt, als du dir vorstellen kannst.", vi: "Mười năm qua cậu đã định hình mình nhiều hơn cậu tưởng tượng.", pronunciation_focus: ["geprägt → gê-PRÊK-t", "vorstellen → FÔ-shtêl-lần", "letzten → LET-stần"] },
      { en: "Ich werde unsere Sonntags-Spaziergänge am See unendlich vermissen.", vi: "Mình sẽ nhớ mãi những buổi đi dạo Chủ nhật bên hồ.", pronunciation_focus: ["Sonntags-Spaziergänge → ZÔN-taks shpa-TSI-gên-gê", "unendlich → un-EN-likh", "vermissen → fe-MI-sần"] },
      { en: "Lass uns versprechen, dass wir den Kontakt halten — auch wenn die Zeitzonen schwierig sind.", vi: "Hai mình hứa giữ liên lạc nhé — dù múi giờ có khó khăn.", pronunciation_focus: ["versprechen → fe-SHPRÊ-khần", "Kontakt → kôn-TAKT", "Zeitzonen → TSAIT-tsô-nần"] },
      { en: "Du wirst mir fehlen — und ich freue mich gleichzeitig riesig für dich.", vi: "Mình sẽ nhớ cậu — và đồng thời mình rất vui cho cậu.", pronunciation_focus: ["fehlen → FÊ-lần", "freue mich → FROI-ê mikh", "riesig → RI-zikh"] },
    ],
    ...
    vocabulary: [
      { word: "der Abschied", en: "farewell, goodbye", vi: "lời chia tay", pos: "noun (m)", pronunciation_vi: "đe AB-shit" },
      { word: "Abschied nehmen", en: "to say goodbye", vi: "chia tay (động từ ghép)", pos: "verb phrase", pronunciation_vi: "AB-shit NÊ-mần" },
      { word: "vermissen", en: "to miss (someone)", vi: "nhớ (ai đó)", pos: "verb", pronunciation_vi: "fe-MI-sần" },
      { word: "fehlen", en: "to be missing, to be missed", vi: "thiếu, được nhớ", pos: "verb", pronunciation_vi: "FÊ-lần" },
      { word: "prägen", en: "to shape, to influence deeply", vi: "định hình, ảnh hưởng sâu sắc", pos: "verb", pronunciation_vi: "PRÊ-gần" },
      { word: "die Erinnerung", en: "memory", vi: "kỷ niệm", pos: "noun (f)", pronunciation_vi: "đi e-IN-nê-rung" },
      { word: "der Kontakt", en: "contact", vi: "liên lạc", pos: "noun (m)", pronunciation_vi: "đe kôn-TAKT" },
      { word: "die Umarmung", en: "hug, embrace", vi: "cái ôm", pos: "noun (f)", pronunciation_vi: "đi um-A-mung" },
      { word: "das Andenken", en: "keepsake, memento", vi: "vật kỷ niệm", pos: "noun (n)", pronunciation_vi: "đát AN-đen-kần" },
      { word: "die Wege trennen sich", en: "the paths separate", vi: "đường đi tách ra", pos: "phrase", pronunciation_vi: "đi VÊ-gê TRÊN-nần zikh" },
    ],
    dialogue: [
      { speaker: "Linh", text: "Marie, ich kann gar nicht glauben, dass du nächste Woche schon nach Australien fliegst.", vi: "Marie, mình không thể tin nổi tuần sau cậu đã bay sang Úc rồi." },
      { speaker: "Marie", text: "Ich kann es selbst kaum fassen. Zehn Jahre Berlin — und jetzt das.", vi: "Mình cũng khó tin nữa. Mười năm Berlin — giờ thế này." },
      { speaker: "Linh", text: "Du hast mich in diesen zehn Jahren mehr geprägt, als du dir vorstellen kannst.", vi: "Mười năm qua cậu đã định hình mình nhiều hơn cậu tưởng tượng." },
      { speaker: "Marie", text: "Du wirst mir auch fehlen, Linh. Lass uns den Kontakt halten — auch wenn die Zeitzonen mörderisch sind.", vi: "Cậu cũng sẽ làm mình nhớ. Hai mình giữ liên lạc nhé — dù múi giờ chết người." },
    ],
    dialogue_long: [
      { speaker: "Linh", text: "Marie, ich kann gar nicht glauben, dass du nächste Woche schon nach Australien fliegst. Hat es sich schon real angefühlt?", vi: "Marie, mình không thể tin nổi tuần sau cậu đã bay sang Úc rồi. Cậu đã cảm thấy nó thực chưa?" },
      { speaker: "Marie", text: "Ehrlich gesagt nicht. Heute Morgen habe ich noch Kartons gepackt — und gleichzeitig denke ich: 'Was, wenn ich das alles bereue?'", vi: "Nói thật là chưa. Sáng nay mình vẫn đang đóng thùng — và đồng thời mình nghĩ: 'Ngộ nhỡ mình hối hận thì sao?'" },
      { speaker: "Linh", text: "Das ist normal. Aber du hast es auch wochenlang durchdacht — Sydney mit deinem Job, das war eine richtige Entscheidung.", vi: "Đó là bình thường. Nhưng cậu đã suy nghĩ hàng tuần — Sydney với công việc của cậu, đó là quyết định đúng." },
      { speaker: "Marie", text: "Ich weiß. Es ist nur — ich verlasse mehr als nur eine Stadt. Ich verlasse zehn Jahre Leben hier.", vi: "Mình biết. Chỉ là — mình rời bỏ nhiều hơn một thành phố. Mình rời bỏ 10 năm cuộc đời ở đây." },
      { speaker: "Linh", text: "Marie, du hast mich in diesen zehn Jahren mehr geprägt, als du dir vorstellen kannst.", vi: "Marie, mười năm qua cậu đã định hình mình nhiều hơn cậu tưởng tượng." },
      { speaker: "Marie", text: "Wirklich?", vi: "Thật không?" },
      { speaker: "Linh", text: "Wirklich. Erinnerst du dich, als ich 2019 mit dem Studium aufhören wollte? Du hast mich gezwungen, mit dir spazieren zu gehen, und einfach zugehört. Drei Stunden lang. Ohne Ratschläge.", vi: "Thật. Cậu nhớ năm 2019 mình muốn bỏ học không? Cậu bắt mình đi dạo cùng, và chỉ lắng nghe. Suốt 3 tiếng. Không khuyên bảo gì." },
      { speaker: "Marie", text: "Das hatte ich vergessen.", vi: "Mình đã quên rồi." },
      { speaker: "Linh", text: "Ich nicht. Das war der Moment, in dem ich gelernt habe, was Freundschaft eigentlich heißt — Da-Sein, nicht Lösungen.", vi: "Mình thì không. Đó là khoảnh khắc mình học được tình bạn thực sự là gì — sự hiện diện, không phải giải pháp." },
      { speaker: "Marie", text: "Linh, jetzt fängst du an, mich zu rühren.", vi: "Linh, cậu bắt đầu làm mình mủi lòng rồi đấy." },
      { speaker: "Linh", text: "Tränen sind okay. Wir verlieren etwas Wichtiges — gleichzeitig fängt etwas Neues an. Beides darf da sein.", vi: "Nước mắt là được. Tụi mình đang mất một thứ quan trọng — đồng thời một điều mới đang bắt đầu. Cả hai đều được phép tồn tại." },
      { speaker: "Marie", text: "Ich werde unsere Sonntags-Spaziergänge am Schlachtensee unendlich vermissen.", vi: "Mình sẽ nhớ mãi những buổi đi dạo Chủ nhật bên hồ Schlachtensee." },
      { speaker: "Linh", text: "Ich auch. Und das Café danach. Und dass du nie deinen Schal mitnimmst und immer meinen klaust.", vi: "Mình cũng vậy. Và quán café sau đó. Và việc cậu không bao giờ mang khăn quàng, luôn cướp khăn của mình." },
      { speaker: "Marie", text: "Ich gebe ihn dir nicht zurück — er kommt mit nach Sydney. Als Andenken.", vi: "Mình sẽ không trả khăn — nó sẽ đi cùng mình tới Sydney. Như vật kỷ niệm." },
      { speaker: "Linh", text: "Behalt ihn. Marie — lass uns versprechen, dass wir den Kontakt halten. Einmal im Monat Videocall, fest abgesprochen?", vi: "Cứ giữ. Marie — hai mình hứa giữ liên lạc nhé. Một lần mỗi tháng video call, hẹn cố định?" },
      { speaker: "Marie", text: "Versprochen. Erster Sonntag im Monat. Sydney-Zeit oder Berlin-Zeit?", vi: "Hứa. Chủ nhật đầu tháng. Giờ Sydney hay giờ Berlin?" },
      { speaker: "Linh", text: "Wir wechseln uns ab. Komm gut an, Marie. Schreib mir, sobald du gelandet bist.", vi: "Hai mình thay phiên. Đến nơi an toàn nhé, Marie. Cậu nhắn mình khi vừa đáp xuống." },
      { speaker: "Marie", text: "Versprochen. Pass auf dich auf, Linh. Du wirst mir fehlen.", vi: "Hứa. Giữ gìn nhé, Linh. Cậu sẽ làm mình nhớ." },
    ],
    roleplay_prompts: [
    ...
    idiom_glosses: [
      { idiom: "die Wege trennen sich", literal: "đường đi tách ra", meaning: "rẽ hướng khác nhau, kết thúc đường chung", example: "Manchmal merken Freunde, dass sich ihre Wege trennen — das ist okay." },
      { idiom: "Komm gut an", literal: "đến nơi tốt đẹp", meaning: "đến nơi an toàn (formula chia tay khi tiễn đi xa)", example: "Komm gut an, Marie — schreib mir, sobald du gelandet bist." },
      { idiom: "etwas im Herzen tragen", literal: "mang điều gì đó trong tim", meaning: "giữ kỷ niệm/người mãi trong lòng", example: "Egal wo du bist — ich trage unsere Freundschaft im Herzen." },
      { idiom: "Spuren hinterlassen", literal: "để lại dấu chân", meaning: "ảnh hưởng lâu dài, để lại dấu ấn", example: "Marie hat in meinem Leben tiefe Spuren hinterlassen." },
    ],
    exercises: [
      {
        type: "fill_blank",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Du hast mich mehr ___, als du dir vorstellen kannst.", answer: "geprägt" },
          { prompt: "Du wirst mir ___ — und ich freue mich gleichzeitig für dich.", answer: "fehlen" },
          { prompt: "Lass uns den ___ halten — auch wenn die Zeitzonen schwierig sind.", answer: "Kontakt" },
          { prompt: "___ gut an, Marie. Pass auf dich auf.", answer: "Komm" },
        ],
      },
      {
        type: "matching",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Komm gut an", answer: "Tiễn đi xa (formula)" },
          { prompt: "Pass auf dich auf", answer: "Giữ gìn (formula)" },
          { prompt: "die Wege trennen sich", answer: "Tình bạn rẽ hướng (idiom)" },
          { prompt: "Spuren hinterlassen", answer: "Để lại dấu ấn (idiom)" },
        ],
      },
      {
        type: "translation",
        instruction_vi: "Dịch sang tiếng Đức (Du, cảm xúc trực tiếp):",
        pronunciation_focus: ["permanent goodbye"],
        items: [
          { prompt: "Mười năm qua cậu đã định hình mình nhiều hơn cậu tưởng tượng.", answer: "Du hast mich in den letzten zehn Jahren mehr geprägt, als du dir vorstellen kannst." },
          { prompt: "Mình sẽ nhớ mãi những buổi đi dạo Chủ nhật bên hồ.", answer: "Ich werde unsere Sonntags-Spaziergänge am See unendlich vermissen." },
          { prompt: "Hai mình hứa giữ liên lạc nhé — dù múi giờ khó khăn.", answer: "Lass uns versprechen, dass wir den Kontakt halten — auch wenn die Zeitzonen schwierig sind." },
          { prompt: "Đến nơi an toàn nhé. Giữ gìn.", answer: "Komm gut an. Pass auf dich auf." },
        ],
      },
    ],
  },
  {
    ...
    sentences: [
      { en: "Lukas, mir ist aufgefallen, dass du in den letzten Wochen ziemlich still geworden bist — wie geht's dir wirklich?", vi: "Lukas, mình thấy mấy tuần nay cậu im lặng đi nhiều — cậu thực sự thế nào?", pronunciation_focus: ["aufgefallen → AOF-gê-fal-lần", "still → SHTIL", "wirklich → VIK-likh"] },
      { en: "Du musst mir nichts erklären — ich frage nur, weil ich da bin, falls du reden möchtest.", vi: "Cậu không cần giải thích gì — mình hỏi chỉ vì mình ở đây nếu cậu muốn nói.", pronunciation_focus: ["erklären → e-KLE-rần", "möchtest → MƠKH-tệst", "falls → FALS"] },
      { en: "Das klingt nach viel — Job-Druck, der Streit mit deiner Schwester und kaum Schlaf.", vi: "Nghe có vẻ nặng — áp lực công việc, cãi nhau với chị, lại thiếu ngủ.", pronunciation_focus: ["klingt → KLINK-t", "Druck → ĐRUK", "Streit → SHTRAIT"] },
      { en: "Ich muss dir keine Lösung geben — manchmal hilft es schon, wenn jemand zuhört.", vi: "Mình không cần đưa giải pháp — đôi khi chỉ cần ai đó lắng nghe đã giúp rồi.", pronunciation_focus: ["Lösung → LƠ-zung", "hilft → HILF-t", "zuhört → TSU-hơt"] },
      { en: "Was würde dir gerade helfen — reden, einen Spaziergang, oder einfach Stille?", vi: "Bây giờ điều gì sẽ giúp cậu — nói chuyện, đi dạo, hay chỉ im lặng?", pronunciation_focus: ["würde → VUY-đê", "Spaziergang → shpa-TSI-gang", "Stille → SHTI-lê"] },
    ],
    ...
    vocabulary: [
      { word: "still werden", en: "to become quiet, withdrawn", vi: "trở nên im lặng (rút khỏi xã hội)", pos: "verb phrase", pronunciation_vi: "SHTIL VÊ-đần" },
      { word: "die Belastung", en: "burden, strain, overload", vi: "gánh nặng, quá tải", pos: "noun (f)", pronunciation_vi: "đi bê-LAS-tung" },
      { word: "der Druck", en: "pressure", vi: "áp lực", pos: "noun (m)", pronunciation_vi: "đe ĐRUK" },
      { word: "die Erschöpfung", en: "exhaustion", vi: "kiệt sức", pos: "noun (f)", pronunciation_vi: "đi e-SHƠ-pfung" },
      { word: "die Einsamkeit", en: "loneliness, isolation", vi: "sự cô đơn", pos: "noun (f)", pronunciation_vi: "đi AIN-zam-kait" },
      { word: "zuhören", en: "to listen actively", vi: "lắng nghe", pos: "verb (sep.)", pronunciation_vi: "TSU-hơ-rần" },
      { word: "die Lösung", en: "solution", vi: "giải pháp", pos: "noun (f)", pronunciation_vi: "đi LƠ-zung" },
      { word: "der/die Therapeut/-in", en: "therapist", vi: "chuyên gia trị liệu tâm lý", pos: "noun (m/f)", pronunciation_vi: "đe tê-ra-PÔI-t" },
      { word: "der/die Hausarzt/-ärztin", en: "general practitioner", vi: "bác sĩ gia đình", pos: "noun (m/f)", pronunciation_vi: "đe HAOS-atst" },
      { word: "professionelle Hilfe", en: "professional help", vi: "sự trợ giúp chuyên môn", pos: "noun phrase", pronunciation_vi: "prô-fê-sô-NÊ-lê HIL-fê" },
    ],
    dialogue: [
      { speaker: "Linh", text: "Lukas, hast du kurz Zeit? Mir ist aufgefallen, dass du in den letzten Wochen ziemlich still geworden bist.", vi: "Lukas, cậu có chút thời gian không? Mình để ý thấy mấy tuần nay cậu im lặng đi nhiều." },
      { speaker: "Lukas", text: "Ach, ist alles okay. Nur viel los.", vi: "À, ổn cả thôi. Chỉ nhiều chuyện thôi." },
      { speaker: "Linh", text: "Du musst mir nichts erklären — ich frage nur, weil ich da bin, falls du reden möchtest.", vi: "Cậu không cần giải thích gì — mình hỏi chỉ vì mình ở đây nếu cậu muốn nói." },
      { speaker: "Lukas", text: "Ehrlich gesagt — es ist mehr als 'viel los'. Es ist ziemlich heftig gerade.", vi: "Nói thật — không chỉ 'nhiều chuyện'. Bây giờ khá nặng." },
    ],
    dialogue_long: [
      { speaker: "Linh", text: "Lukas, hast du Lust auf einen Kaffee? Mir ist aufgefallen, dass du in den letzten Wochen ziemlich still geworden bist — kaum Whatsapp, letzten Sonntag den Brunch abgesagt.", vi: "Lukas, cậu uống cà phê không? Mình để ý thấy mấy tuần nay cậu im lặng — ít nhắn Whatsapp, Chủ nhật trước hủy brunch." },
      { speaker: "Lukas", text: "Ach, ist alles okay. Nur viel los gerade.", vi: "À, ổn cả thôi. Chỉ nhiều chuyện thôi." },
      { speaker: "Linh", text: "Du musst mir nichts erklären — ich frage nur, weil ich da bin, falls du reden möchtest. Wie geht's dir wirklich?", vi: "Cậu không cần giải thích gì — mình hỏi chỉ vì mình ở đây nếu cậu muốn nói. Cậu thực sự thế nào?" },
      { speaker: "Lukas", text: "Ehrlich gesagt — es ist mehr als 'viel los'. Es ist ziemlich heftig gerade.", vi: "Nói thật — không chỉ 'nhiều chuyện'. Bây giờ khá nặng." },
      { speaker: "Linh", text: "Erzähl mir davon — wenn du möchtest.", vi: "Kể mình nghe đi — nếu cậu muốn." },
      { speaker: "Lukas", text: "Es ist eine Mischung aus allem. Bei der Arbeit haben sie zwei Leute aus meinem Team gekürzt, die Arbeit blieb aber. Ich mache 55-Stunden-Wochen seit zwei Monaten.", vi: "Là sự kết hợp của mọi thứ. Ở công ty họ cắt 2 người trong team mình, mà việc thì không giảm. Mình làm 55 tiếng/tuần suốt 2 tháng nay." },
      { speaker: "Linh", text: "Das ist enorm.", vi: "Đó là khủng khiếp." },
      { speaker: "Lukas", text: "Und gleichzeitig habe ich Streit mit meiner Schwester. Es geht ums Erbe nach dem Tod unseres Vaters letztes Jahr — wir reden seit Monaten kaum noch.", vi: "Và đồng thời mình cãi nhau với chị. Là về thừa kế sau khi bố mình mất năm ngoái — tụi mình hầu như không nói chuyện cả mấy tháng." },
      { speaker: "Linh", text: "Das klingt nach sehr viel — Job-Druck, der Streit mit deiner Schwester und vermutlich auch noch Trauer um deinen Vater. Drei Sachen gleichzeitig.", vi: "Nghe có vẻ rất nặng — áp lực công việc, cãi vã với chị, và chắc cả nỗi đau về bố. Ba chuyện cùng lúc." },
      { speaker: "Lukas", text: "Ich schlafe kaum. Ich liege wach und denke an alles gleichzeitig. Und tagsüber bin ich nur müde.", vi: "Mình hầu như không ngủ. Mình nằm thức và nghĩ đến tất cả cùng lúc. Ban ngày thì chỉ mệt." },
      { speaker: "Linh", text: "Lukas — das was du beschreibst, klingt nach Erschöpfung, die ernst ist. Hast du schon mal überlegt, mit deinem Hausarzt zu sprechen? Nicht weil etwas 'falsch' mit dir ist — sondern weil du gerade Unterstützung verdienst.", vi: "Lukas — điều cậu mô tả nghe như sự kiệt sức nghiêm trọng. Cậu đã nghĩ đến nói chuyện với bác sĩ gia đình chưa? Không phải vì cậu 'có vấn đề' — mà vì cậu xứng đáng được hỗ trợ." },
      { speaker: "Lukas", text: "Ich habe daran gedacht. Ich weiß nicht — ich fühle mich, als wäre ich nicht 'krank genug'.", vi: "Mình cũng nghĩ đến rồi. Mình không biết — mình cảm thấy như mình không 'bệnh đủ'." },
      { speaker: "Linh", text: "Das ist ein häufiger Gedanke — und ehrlich gesagt: man muss nicht 'krank genug' sein, um Hilfe zu bekommen. Wenn du möchtest, kann ich dich morgen zum Hausarzt begleiten — du musst nicht alleine hingehen.", vi: "Đó là suy nghĩ phổ biến — và thật ra: không cần 'bệnh đủ' để nhận hỗ trợ. Nếu cậu muốn, mai mình đi cùng cậu đến bác sĩ — cậu không phải đi một mình." },
      { speaker: "Lukas", text: "Das wäre... das würde mir tatsächlich helfen. Ich habe das alleine nicht geschafft.", vi: "Vậy thì... thật sự sẽ giúp mình. Một mình mình không làm nổi." },
      { speaker: "Linh", text: "Dann machen wir das. Ich rufe morgen früh in der Praxis an und mache einen Termin — okay?", vi: "Vậy mình làm thế. Sáng mai mình gọi phòng khám đặt lịch — được không?" },
      { speaker: "Lukas", text: "Ja. Danke, Linh — ich wusste nicht, wie sehr ich das gebraucht habe, einfach mit jemandem zu reden.", vi: "Ừ. Cám ơn Linh — mình không biết mình cần đến mức nào, chỉ cần nói chuyện với ai đó." },
      { speaker: "Linh", text: "Du brauchst dich für nichts zu bedanken. Schreib mir, wann du willst — auch heute Nacht. Ich bin da.", vi: "Cậu không cần cám ơn gì cả. Nhắn mình bất cứ lúc nào — kể cả đêm nay. Mình ở đây." },
    ],
    roleplay_prompts: [
    ...
    idiom_glosses: [
      { idiom: "am Limit sein", literal: "đang ở giới hạn", meaning: "kiệt sức, quá tải", example: "Lukas ist seit zwei Monaten am Limit — 55 Stunden pro Woche." },
      { idiom: "alles wächst über den Kopf", literal: "tất cả lớn vượt đầu", meaning: "mọi thứ vượt khả năng đối phó", example: "Manchmal wächst einem alles über den Kopf — und das ist okay zuzugeben." },
      { idiom: "ein offenes Ohr haben", literal: "có cái tai mở", meaning: "sẵn sàng lắng nghe", example: "Ich habe immer ein offenes Ohr für dich — auch nachts." },
      { idiom: "jemandem den Rücken stärken", literal: "làm mạnh lưng ai đó", meaning: "support ai đó về mặt tinh thần/thực tế", example: "Ich möchte dir den Rücken stärken — was würde dir helfen?" },
    ],
    exercises: [
      {
        type: "fill_blank",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Mir ist ___, dass du in den letzten Wochen still geworden bist.", answer: "aufgefallen" },
          { prompt: "Wie geht's dir ___?", answer: "wirklich" },
          { prompt: "Das ___ nach viel — Job, Streit, kaum Schlaf.", answer: "klingt" },
          { prompt: "Ich muss dir keine ___ geben — ich höre nur zu.", answer: "Lösung" },
        ],
      },
      {
        type: "matching",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Mir ist aufgefallen, dass...", answer: "Mở đầu cụ thể không generic" },
          { prompt: "Das klingt nach...", answer: "Phản ánh cảm xúc, không diagnose" },
          { prompt: "ein offenes Ohr haben", answer: "Sẵn sàng lắng nghe (idiom)" },
          { prompt: "am Limit sein", answer: "Kiệt sức quá tải (idiom)" },
        ],
      },
      {
        type: "translation",
        instruction_vi: "Dịch sang tiếng Đức (Du, gentle hedging):",
        pronunciation_focus: ["empathetic listening"],
        items: [
          { prompt: "Mình để ý thấy mấy tuần nay cậu im lặng đi nhiều.", answer: "Mir ist aufgefallen, dass du in den letzten Wochen ziemlich still geworden bist." },
          { prompt: "Cậu không cần giải thích — mình hỏi chỉ vì mình ở đây.", answer: "Du musst mir nichts erklären — ich frage nur, weil ich da bin." },
          { prompt: "Đôi khi chỉ cần ai đó lắng nghe đã giúp rồi.", answer: "Manchmal hilft es schon, wenn jemand zuhört." },
          { prompt: "Cậu đã nghĩ đến việc nói chuyện với bác sĩ gia đình chưa?", answer: "Hast du schon mal überlegt, mit deinem Hausarzt zu sprechen?" },
        ],
      },
    ],
  },
  {
    ...
    sentences: [
      { en: "Jonas, ich möchte etwas Unangenehmes ansprechen — die 300 Euro, die ich dir im März geliehen habe.", vi: "Jonas, mình muốn nói chuyện về điều khó nói — 300 euro mình cho cậu mượn hồi tháng Ba.", pronunciation_focus: ["Unangenehmes → UN-an-gê-nê-mês", "geliehen → gê-LI-ần", "März → MÊTS"] },
      { en: "Ich brauche das Geld jetzt selbst — meine Versicherung muss ich nächste Woche zahlen.", vi: "Bây giờ mình cần tiền — tuần sau mình phải đóng bảo hiểm.", pronunciation_focus: ["Geld → GELT", "Versicherung → fe-ZÍ-khê-rung", "zahlen → TSA-lần"] },
      { en: "Wäre es möglich, dass wir einen Rückzahlungsplan vereinbaren — meinetwegen in zwei Raten?", vi: "Mình có thể thỏa thuận lịch trả không — chia 2 đợt cũng được?", pronunciation_focus: ["Rückzahlungsplan → RUYK-tsa-lungs-plan", "vereinbaren → fe-AIN-ba-rần", "Raten → RA-tần"] },
      { en: "Ich möchte, dass das zwischen uns klar bleibt — Geld soll unsere Freundschaft nicht belasten.", vi: "Mình muốn chuyện này rõ ràng giữa hai mình — tiền không được làm nặng tình bạn.", pronunciation_focus: ["zwischen → TSVI-shần", "Freundschaft → FROIN-shaft", "belasten → bê-LAS-tần"] },
      { en: "Falls es bei dir gerade schwierig ist — sag's mir bitte ehrlich, dann finden wir eine Lösung.", vi: "Nếu giờ cậu khó khăn — cứ nói thật với mình, tụi mình sẽ tìm cách.", pronunciation_focus: ["schwierig → SHVI-rikh", "ehrlich → ÊR-likh", "Lösung → LƠ-zung"] },
    ],
    ...
    vocabulary: [
      { word: "leihen / verleihen", en: "to borrow / to lend", vi: "mượn / cho mượn", pos: "verb", pronunciation_vi: "LAI-ần / fe-LAI-ần" },
      { word: "die Schuld", en: "debt; guilt (context-dependent)", vi: "khoản nợ; tội (tùy ngữ cảnh)", pos: "noun (f)", pronunciation_vi: "đi SHULT" },
      { word: "der Schuldschein", en: "IOU, written acknowledgment of debt", vi: "giấy nhận nợ", pos: "noun (m)", pronunciation_vi: "đe SHULT-shain" },
      { word: "der Rückzahlungsplan", en: "repayment plan", vi: "lịch trả nợ", pos: "noun (m)", pronunciation_vi: "đe RUYK-tsa-lungs-plan" },
      { word: "die Rate", en: "installment", vi: "đợt trả góp", pos: "noun (f)", pronunciation_vi: "đi RA-tê" },
      { word: "vereinbaren", en: "to agree on, to arrange", vi: "thỏa thuận", pos: "verb", pronunciation_vi: "fe-AIN-ba-rần" },
      { word: "zurückzahlen", en: "to pay back", vi: "trả lại (tiền)", pos: "verb (sep.)", pronunciation_vi: "tsu-RUYK-tsa-lần" },
      { word: "die Mahnung", en: "formal payment reminder", vi: "thư đòi nợ chính thức", pos: "noun (f)", pronunciation_vi: "đi MA-nung" },
      { word: "getrennt zahlen", en: "to split the bill", vi: "chia bill", pos: "verb phrase", pronunciation_vi: "gê-TRÊN-t TSA-lần" },
      { word: "die Auslage", en: "outlay, money advanced for someone", vi: "khoản ứng tiền hộ", pos: "noun (f)", pronunciation_vi: "đi AOS-la-gê" },
    ],
    dialogue: [
      { speaker: "Linh", text: "Jonas, hast du kurz Zeit? Ich möchte etwas Unangenehmes ansprechen.", vi: "Jonas, cậu có chút thời gian không? Mình muốn nói chuyện khó nói." },
      { speaker: "Jonas", text: "Klar — was ist los?", vi: "Được — có chuyện gì?" },
      { speaker: "Linh", text: "Die 300 Euro, die ich dir im März geliehen habe — ich brauche das Geld jetzt selbst.", vi: "300 euro mình cho cậu mượn hồi tháng Ba — bây giờ mình cần tiền." },
      { speaker: "Jonas", text: "Stimmt — das hatte ich verdrängt. Wann brauchst du es spätestens?", vi: "Đúng rồi — mình đã không nhớ. Cậu cần nó muộn nhất khi nào?" },
    ],
    dialogue_long: [
      { speaker: "Linh", text: "Jonas, hast du kurz Zeit? Ich möchte etwas Unangenehmes ansprechen — und ich möchte das auch direkt machen, damit es nicht zwischen uns steht.", vi: "Jonas, cậu có chút thời gian không? Mình muốn nói chuyện khó nói — và mình muốn nói thẳng để chuyện đó không nằm giữa hai mình." },
      { speaker: "Jonas", text: "Klar — was ist los?", vi: "Được — có chuyện gì?" },
      { speaker: "Linh", text: "Die 300 Euro, die ich dir im März geliehen habe, als deine Waschmaschine kaputtgegangen ist. Ich brauche das Geld jetzt selbst.", vi: "300 euro mình cho cậu mượn hồi tháng Ba khi máy giặt cậu hỏng. Bây giờ mình cần tiền." },
      { speaker: "Jonas", text: "Du hast völlig Recht — das hatte ich tatsächlich verdrängt. Es tut mir leid.", vi: "Cậu hoàn toàn đúng — mình thực sự đã không nhớ. Xin lỗi cậu." },
      { speaker: "Linh", text: "Du musst dich nicht entschuldigen — ich hätte auch früher fragen können. Aber jetzt brauche ich es: meine Krankenversicherung muss ich nächste Woche zahlen.", vi: "Cậu không cần xin lỗi — mình cũng có thể hỏi sớm hơn. Nhưng giờ mình cần: tuần sau mình phải đóng bảo hiểm y tế." },
      { speaker: "Jonas", text: "Verstehe. Ehrlich gesagt: 300 auf einmal kann ich gerade nicht. Mein Konto ist diesen Monat etwas knapp.", vi: "Mình hiểu. Nói thật: 300 cùng lúc bây giờ mình không có. Tài khoản tháng này hơi căng." },
      { speaker: "Linh", text: "Danke, dass du das ehrlich sagst. Wäre es möglich, dass wir einen Rückzahlungsplan vereinbaren — meinetwegen in zwei Raten?", vi: "Cám ơn cậu nói thật. Mình có thể thỏa thuận lịch trả không — chia 2 đợt cũng được?" },
      { speaker: "Jonas", text: "Das wäre wirklich hilfreich. Ich könnte dir 150 Euro bis Ende dieser Woche überweisen — und die anderen 150 zum 15. nächsten Monats, wenn mein Gehalt da ist.", vi: "Sẽ thật sự hữu ích. Mình có thể chuyển 150 euro cuối tuần này — và 150 còn lại ngày 15 tháng sau khi lương đến." },
      { speaker: "Linh", text: "Das passt. Lass uns das kurz per Whatsapp festhalten, damit wir beide den gleichen Überblick haben — okay?", vi: "Vậy phù hợp. Tụi mình ghi qua Whatsapp để cả hai có cùng tổng quan — được không?" },
      { speaker: "Jonas", text: "Sehr gerne. Ich finde es übrigens gut, dass du das direkt ansprichst.", vi: "Vâng. Mà mình thấy hay là cậu nói thẳng chuyện này." },
      { speaker: "Linh", text: "Bei Geld hört die Freundschaft sonst manchmal auf — und das wollte ich vermeiden.", vi: "Đến tiền tình bạn đôi khi dừng — và mình muốn tránh điều đó." },
      { speaker: "Jonas", text: "Da hast du Recht. Falls es bei dir nochmal eng wird — gib mir lieber Bescheid, bevor du Stress hast.", vi: "Cậu đúng. Nếu sau này cậu lại căng — báo mình sớm trước khi stress." },
      { speaker: "Linh", text: "Mache ich. Und das gilt auch andersrum — falls du nochmal was brauchst und es bei mir möglich ist.", vi: "Mình sẽ làm. Và ngược lại cũng vậy — nếu cậu lại cần gì mà mình có khả năng." },
      { speaker: "Jonas", text: "Gut. Ich überweise heute Abend die ersten 150 — und schicke dir den Beleg.", vi: "Tốt. Tối nay mình chuyển 150 đầu — và gửi cậu chứng từ." },
      { speaker: "Linh", text: "Perfekt. Danke, Jonas — und danke, dass du das so ruhig genommen hast.", vi: "Tuyệt. Cám ơn Jonas — và cám ơn cậu đã bình tĩnh tiếp nhận." },
      { speaker: "Jonas", text: "Wir sind doch Freunde. Genau dafür macht man so was klar.", vi: "Tụi mình là bạn mà. Chính vì thế mới rõ ràng chuyện này." },
    ],
    roleplay_prompts: [
    ...
    idiom_glosses: [
      { idiom: "Bei Geld hört die Freundschaft auf", literal: "Đến tiền là tình bạn dừng", meaning: "Tiền có thể phá vỡ tình bạn — cảnh báo cần rõ ràng", example: "Bei Geld hört die Freundschaft auf — deshalb möchte ich das jetzt klären, bevor es ein Problem wird." },
      { idiom: "in den roten Zahlen sein", literal: "đang ở số đỏ", meaning: "tài khoản âm, hết tiền", example: "Mein Konto ist diesen Monat in den roten Zahlen — ich kann nicht alles auf einmal zurückzahlen." },
      { idiom: "die Rechnung begleichen", literal: "cân bằng hóa đơn", meaning: "trả nợ, thanh toán", example: "Ich werde die Rechnung in zwei Raten begleichen — ist das okay für dich?" },
      { idiom: "etwas auf die lange Bank schieben", literal: "đẩy điều gì đó lên ghế dài", meaning: "trì hoãn, để lâu", example: "Ich habe das Thema Geld zu lange auf die lange Bank geschoben — heute spreche ich es an." },
    ],
    exercises: [
      {
        type: "fill_blank",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Ich möchte etwas ___ ansprechen.", answer: "Unangenehmes" },
          { prompt: "Die 300 Euro, die ich dir im März ___ habe.", answer: "geliehen" },
          { prompt: "Wäre ein ___ in zwei Raten möglich?", answer: "Rückzahlungsplan" },
          { prompt: "Geld soll unsere Freundschaft nicht ___.", answer: "belasten" },
        ],
      },
      {
        type: "matching",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "der Schuldschein", answer: "Giấy nhận nợ (>500 EUR)" },
          { prompt: "die Mahnung", answer: "Thư đòi nợ formal" },
          { prompt: "Bei Geld hört die Freundschaft auf", answer: "Cảnh báo idiom" },
          { prompt: "in den roten Zahlen sein", answer: "Tài khoản âm (idiom)" },
        ],
      },
      {
        type: "translation",
        instruction_vi: "Dịch sang tiếng Đức (Du, Konjunktiv II khi cần):",
        pronunciation_focus: ["money conversation"],
        items: [
          { prompt: "Mình muốn nói chuyện khó nói — 300 euro mình cho cậu mượn hồi tháng Ba.", answer: "Ich möchte etwas Unangenehmes ansprechen — die 300 Euro, die ich dir im März geliehen habe." },
          { prompt: "Mình có thể thỏa thuận lịch trả không — chia 2 đợt được không?", answer: "Wäre es möglich, dass wir einen Rückzahlungsplan vereinbaren — meinetwegen in zwei Raten?" },
          { prompt: "Nếu giờ cậu khó khăn — cứ nói thật.", answer: "Falls es bei dir gerade schwierig ist — sag's mir bitte ehrlich." },
          { prompt: "Tiền không được làm nặng tình bạn.", answer: "Geld soll unsere Freundschaft nicht belasten." },
        ],
      },
    ],
  },
  {
    ...
    sentences: [
      { en: "Tobias, ich finde es spannend, dass du regelmäßig in die Kirche gehst — was bedeutet dir das eigentlich?", vi: "Tobias, mình thấy thú vị là cậu đi nhà thờ đều — điều đó có ý nghĩa gì với cậu?", pronunciation_focus: ["spannend → SHPÁ-nầnt", "Kirche → KIR-khê", "bedeutet → bê-ĐOI-tệt"] },
      { en: "Bei mir zu Hause war Ahnenverehrung wichtig — wir haben einen Altar für meine Großeltern.", vi: "Ở nhà mình, thờ cúng tổ tiên rất quan trọng — tụi mình có bàn thờ cho ông bà.", pronunciation_focus: ["Ahnenverehrung → A-nần-fe-ê-rung", "Altar → AL-ta", "Großeltern → GRÔS-en-tờn"] },
      { en: "Ich würde mich nicht als religiös bezeichnen — eher als spirituell suchend.", vi: "Mình không gọi mình là người mộ đạo — hơn là người tìm kiếm tâm linh.", pronunciation_focus: ["religiös → rê-li-GIƠS", "bezeichnen → bê-TSAI-khê-nần", "spirituell → shpi-ri-tu-ÊL"] },
      { en: "Ich habe Respekt vor deinem Glauben — auch wenn ich es selbst anders sehe.", vi: "Mình tôn trọng niềm tin của cậu — dù mình tự thấy khác.", pronunciation_focus: ["Respekt → rê-SPÊKT", "Glauben → GLAU-bần", "anders → AN-đờs"] },
      { en: "Können wir darüber reden, ohne dass einer den anderen überzeugen muss?", vi: "Tụi mình có thể nói chuyện mà không bắt nhau thuyết phục được không?", pronunciation_focus: ["überzeugen → uy-bờ-TSOI-gần", "ohne → Ô-nê", "anderen → AN-đê-rần"] },
    ],
    ...
    vocabulary: [
      { word: "der Glaube", en: "faith, belief", vi: "đức tin", pos: "noun (m)", pronunciation_vi: "đe GLAU-bê" },
      { word: "die Religion", en: "religion", vi: "tôn giáo", pos: "noun (f)", pronunciation_vi: "đi rê-li-GI-ôn" },
      { word: "religiös / spirituell", en: "religious / spiritual", vi: "mộ đạo / tâm linh", pos: "adjective", pronunciation_vi: "rê-li-GIƠS / shpi-ri-tu-ÊL" },
      { word: "konfessionslos", en: "without religious affiliation", vi: "không thuộc giáo phái", pos: "adjective", pronunciation_vi: "kôn-fê-si-ÔNS-lôs" },
      { word: "die Kirche", en: "church", vi: "nhà thờ", pos: "noun (f)", pronunciation_vi: "đi KIR-khê" },
      { word: "die Ahnenverehrung", en: "ancestor veneration", vi: "thờ cúng tổ tiên", pos: "noun (f)", pronunciation_vi: "đi A-nần-fe-ê-rung" },
      { word: "der Altar", en: "altar", vi: "bàn thờ", pos: "noun (m)", pronunciation_vi: "đe AL-ta" },
      { word: "überzeugen", en: "to convince", vi: "thuyết phục", pos: "verb", pronunciation_vi: "uy-bờ-TSOI-gần" },
      { word: "der Respekt", en: "respect", vi: "sự tôn trọng", pos: "noun (m)", pronunciation_vi: "đe rê-SPÊKT" },
      { word: "die kulturelle Praxis", en: "cultural practice", vi: "thực hành văn hóa", pos: "noun phrase", pronunciation_vi: "đi kul-tu-RÊ-lê PRA-xis" },
    ],
    dialogue: [
      { speaker: "Linh", text: "Tobias, du gehst sonntags regelmäßig in die Kirche, oder? Was bedeutet dir das eigentlich?", vi: "Tobias, cậu đi nhà thờ Chủ nhật đều đặn đúng không? Điều đó có ý nghĩa gì với cậu?" },
      { speaker: "Tobias", text: "Es ist weniger Theologie, mehr Gemeinschaft. Mein Vater geht seit 40 Jahren in dieselbe Gemeinde — ich bin damit aufgewachsen.", vi: "Ít về thần học, nhiều về cộng đồng. Bố mình đi giáo xứ đó suốt 40 năm — mình lớn lên trong đó." },
      { speaker: "Linh", text: "Bei mir zu Hause war Ahnenverehrung wichtig — wir haben einen Altar für meine Großeltern. Ist mehr eine kulturelle Praxis als eine Religion.", vi: "Ở nhà mình thờ cúng tổ tiên rất quan trọng — tụi mình có bàn thờ cho ông bà. Là thực hành văn hóa hơn là tôn giáo." },
      { speaker: "Tobias", text: "Das finde ich spannend. Ähnlich wie wir am Allerheiligentag aufs Grab gehen?", vi: "Mình thấy thú vị. Tương tự như tụi mình ra mộ ngày Allerheiligen à?" },
    ],
    dialogue_long: [
      { speaker: "Linh", text: "Tobias, ich habe mich gefragt — du gehst sonntags regelmäßig in die Kirche, oder? Was bedeutet dir das eigentlich?", vi: "Tobias, mình tự hỏi — cậu đi nhà thờ Chủ nhật đều đặn đúng không? Điều đó có ý nghĩa gì với cậu?" },
      { speaker: "Tobias", text: "Ehrlich gesagt: es ist weniger Theologie, mehr Gemeinschaft. Mein Vater geht seit 40 Jahren in dieselbe Gemeinde — ich bin damit aufgewachsen, und es gibt mir Ruhe in der Woche.", vi: "Nói thật: ít về thần học, nhiều về cộng đồng. Bố mình đi giáo xứ đó 40 năm rồi — mình lớn lên trong đó, và nó cho mình sự yên tĩnh trong tuần." },
      { speaker: "Linh", text: "Das verstehe ich. Glaubst du an Gott im klassischen Sinn — oder ist es etwas Anderes?", vi: "Mình hiểu. Cậu tin Chúa theo nghĩa cổ điển — hay là điều gì khác?" },
      { speaker: "Tobias", text: "Schwer zu beantworten. Ich würde sagen: ich glaube an etwas — aber nicht unbedingt an einen alten Mann mit Bart auf einer Wolke. Eher an eine Verbindung zwischen Menschen.", vi: "Khó trả lời. Mình sẽ nói: mình tin vào điều gì đó — nhưng không nhất thiết là ông già có râu trên đám mây. Hơn là sự kết nối giữa con người." },
      { speaker: "Linh", text: "Bei mir zu Hause war Ahnenverehrung wichtig — wir haben einen Altar für meine Großeltern. Wir zünden Räucherstäbchen an, an Geburts- und Todestagen.", vi: "Ở nhà mình thờ cúng tổ tiên rất quan trọng — tụi mình có bàn thờ cho ông bà. Tụi mình thắp nhang vào ngày sinh và ngày mất." },
      { speaker: "Tobias", text: "Das finde ich schön. Glaubst du, dass deine Großeltern dich von dort 'sehen'?", vi: "Mình thấy đẹp. Cậu có tin ông bà cậu 'nhìn' cậu từ đó không?" },
      { speaker: "Linh", text: "Es ist mehr eine kulturelle Praxis als eine Religion im westlichen Sinn. Ob ich literal glaube, dass sie zuschauen — schwer zu sagen. Aber wenn ich vor dem Altar stehe, fühle ich Verbindung. Das reicht mir.", vi: "Đó là thực hành văn hóa hơn là tôn giáo theo nghĩa phương Tây. Mình có tin theo nghĩa đen rằng họ đang nhìn — khó nói. Nhưng khi đứng trước bàn thờ, mình cảm thấy có sự kết nối. Như vậy đủ với mình." },
      { speaker: "Tobias", text: "Das klingt ähnlich wie bei mir — Verbindung mehr als Theologie.", vi: "Nghe tương tự như mình — sự kết nối nhiều hơn thần học." },
      { speaker: "Linh", text: "Ja — ich finde es spannend, wie unterschiedlich Menschen das erleben.", vi: "Đúng — mình thấy thú vị là con người trải nghiệm khác nhau như thế nào." },
      { speaker: "Tobias", text: "Darf ich fragen — würdest du dich selbst als religiös bezeichnen?", vi: "Mình hỏi nhé — cậu có gọi mình là người mộ đạo không?" },
      { speaker: "Linh", text: "Ich würde mich nicht als religiös bezeichnen — eher als spirituell suchend. Buddhismus, Ahnenverehrung — Konzepte, mit denen ich aufgewachsen bin, aber ich habe es nicht 'übernommen' im strikten Sinn.", vi: "Mình không gọi mình là mộ đạo — hơn là người tìm kiếm tâm linh. Phật giáo, thờ tổ tiên — những concept mình lớn lên với, nhưng mình không 'tiếp nhận' theo nghĩa nghiêm ngặt." },
      { speaker: "Tobias", text: "Suchend — das gefällt mir als Wort.", vi: "Tìm kiếm — mình thích từ đó." },
      { speaker: "Linh", text: "Hör mal — wenn du möchtest, würde ich dich gerne mal zu Tét einladen, wenn meine Familie kommt. Du würdest sehen, wie wir das machen.", vi: "Nghe này — nếu cậu muốn, mình muốn mời cậu đến Tết khi gia đình mình đến. Cậu sẽ thấy tụi mình làm thế nào." },
      { speaker: "Tobias", text: "Sehr gerne — ich finde so etwas immer bereichernd.", vi: "Vâng — mình luôn thấy điều đó làm phong phú thêm." },
      { speaker: "Linh", text: "Und falls du mich mal zur Christmette einladen willst — ich komme auch mit.", vi: "Và nếu cậu muốn mời mình đi Lễ đêm Giáng sinh — mình cũng đi cùng." },
      { speaker: "Tobias", text: "Abgemacht. Ich respektiere deinen Glauben — auch wenn ich es selbst anders erlebe.", vi: "Đã thỏa thuận. Mình tôn trọng niềm tin của cậu — dù mình tự trải nghiệm khác." },
      { speaker: "Linh", text: "Gleichfalls. Können wir darüber reden, ohne dass einer den anderen überzeugen muss?", vi: "Tương tự. Tụi mình có thể nói chuyện mà không bắt nhau thuyết phục được không?" },
      { speaker: "Tobias", text: "Genau so. Das ist die schönste Art.", vi: "Chính xác như vậy. Đó là cách đẹp nhất." },
    ],
    roleplay_prompts: [
    ...
    idiom_glosses: [
      { idiom: "den Glauben verlieren", literal: "mất đức tin", meaning: "thôi tin (tôn giáo hoặc nói chung)", example: "Manche Menschen verlieren ihren Glauben nach einem schweren Verlust — das ist menschlich." },
      { idiom: "auf Sand bauen", literal: "xây trên cát", meaning: "đặt nền móng trên thứ không vững (gốc Kinh Thánh)", example: "Eine Beziehung auf Lügen ist auf Sand gebaut — sie wird nicht halten." },
      { idiom: "der Glaube versetzt Berge", literal: "đức tin di chuyển núi", meaning: "niềm tin có sức mạnh lớn (gốc Kinh Thánh)", example: "Ich bin nicht religiös — aber 'der Glaube versetzt Berge' stimmt für mich auch in einem säkularen Sinn." },
      { idiom: "leben und leben lassen", literal: "sống và để người khác sống", meaning: "tôn trọng cách sống của người khác", example: "Bei Religion gilt für mich: leben und leben lassen — solange niemand verletzt wird." },
    ],
    exercises: [
      {
        type: "fill_blank",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Was ___ dir das eigentlich?", answer: "bedeutet" },
          { prompt: "Es ist mehr eine kulturelle ___ als eine Religion.", answer: "Praxis" },
          { prompt: "Ich würde mich eher als spirituell ___ bezeichnen.", answer: "suchend" },
          { prompt: "Ich respektiere deinen ___ — auch wenn ich anders sehe.", answer: "Glauben" },
        ],
      },
      {
        type: "matching",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "konfessionslos", answer: "Không thuộc giáo phái (status hành chính)" },
          { prompt: "Ahnenverehrung", answer: "Thờ cúng tổ tiên" },
          { prompt: "leben und leben lassen", answer: "Tôn trọng cách sống khác (idiom)" },
          { prompt: "der Glaube versetzt Berge", answer: "Niềm tin có sức mạnh (idiom)" },
        ],
      },
      {
        type: "translation",
        instruction_vi: "Dịch sang tiếng Đức (Du, hedging Konjunktiv II):",
        pronunciation_focus: ["faith conversation"],
        items: [
          { prompt: "Mình thấy thú vị là cậu đi nhà thờ đều — điều đó có ý nghĩa gì với cậu?", answer: "Ich finde es spannend, dass du regelmäßig in die Kirche gehst — was bedeutet dir das eigentlich?" },
          { prompt: "Ở nhà mình, thờ cúng tổ tiên quan trọng — là thực hành văn hóa hơn tôn giáo.", answer: "Bei mir zu Hause war Ahnenverehrung wichtig — es ist mehr eine kulturelle Praxis als eine Religion." },
          { prompt: "Mình tôn trọng niềm tin của cậu — dù mình thấy khác.", answer: "Ich habe Respekt vor deinem Glauben — auch wenn ich es selbst anders sehe." },
          { prompt: "Tụi mình có thể nói chuyện mà không bắt nhau thuyết phục được không?", answer: "Können wir darüber reden, ohne dass einer den anderen überzeugen muss?" },
        ],
      },
    ],
  },
  {
    ...
    sentences: [
      { en: "Ich höre dir zu — du musst nicht mehr erzählen, als sich gut anfühlt.", vi: "Mình nghe cậu — cậu không cần kể nhiều hơn mức cậu thấy ổn.", pronunciation_focus: ["höre → HƠ-rê", "erzählen → e-TSÊ-lần", "anfühlt → AN-fuyl-t"] },
      { en: "Danke, dass du mir das anvertraust — das ist nicht selbstverständlich.", vi: "Cám ơn cậu đã tin tưởng kể với mình — điều đó không phải mặc nhiên.", pronunciation_focus: ["anvertraust → AN-fe-traost", "selbstverständlich → ZELPS-fe-shten-likh", "danke → ĐAN-kê"] },
      { en: "Du musst es mir nicht erklären — und ich werde nicht versuchen, es zu 'reparieren'.", vi: "Cậu không cần giải thích — và mình sẽ không cố 'sửa chữa' nó.", pronunciation_focus: ["erklären → e-KLE-rần", "versuchen → fe-ZU-khần", "reparieren → rê-pa-RI-rần"] },
      { en: "Was du beschreibst, klingt schwer — ich kann nur ahnen, wie das war.", vi: "Điều cậu mô tả nghe thật nặng — mình chỉ có thể đoán nó như thế nào.", pronunciation_focus: ["beschreibst → bê-SHRAIB-st", "schwer → SHVÊ", "ahnen → A-nần"] },
      { en: "Ich bleibe — und das ändert nichts daran, wie ich dich sehe.", vi: "Mình vẫn ở đây — và điều đó không thay đổi cách mình nhìn cậu.", pronunciation_focus: ["bleibe → BLAI-bê", "ändert → EN-đệt", "sehe → ZÊ-ê"] },
    ],
    ...
    vocabulary: [
      { word: "anvertrauen", en: "to confide in someone", vi: "tin tưởng kể (chuyện riêng)", pos: "verb (sep.)", pronunciation_vi: "AN-fe-trao-ần" },
      { word: "das Vertrauen", en: "trust", vi: "niềm tin", pos: "noun (n)", pronunciation_vi: "đát fe-TRAU-ần" },
      { word: "die Scham", en: "shame", vi: "sự xấu hổ", pos: "noun (f)", pronunciation_vi: "đi SHAM" },
      { word: "die Schuld (Gefühl)", en: "guilt (feeling)", vi: "cảm giác có lỗi", pos: "noun (f)", pronunciation_vi: "đi SHULT" },
      { word: "das Mitgefühl", en: "empathy, compassion", vi: "sự đồng cảm", pos: "noun (n)", pronunciation_vi: "đát MIT-gê-fuyl" },
      { word: "die Vertraulichkeit", en: "confidentiality", vi: "tính bảo mật", pos: "noun (f)", pronunciation_vi: "đi fe-TRAU-likh-kait" },
      { word: "der Zeuge / die Zeugin", en: "witness", vi: "nhân chứng (vai trò người nghe)", pos: "noun (m/f)", pronunciation_vi: "đe TSOI-gê" },
      { word: "der/die Therapeut/-in", en: "therapist", vi: "chuyên gia trị liệu tâm lý", pos: "noun (m/f)", pronunciation_vi: "đe tê-ra-PÔI-t" },
      { word: "professionelle Hilfe", en: "professional help", vi: "sự trợ giúp chuyên môn", pos: "noun phrase", pronunciation_vi: "prô-fê-sô-NÊ-lê HIL-fê" },
      { word: "begleiten", en: "to accompany, to walk alongside", vi: "đồng hành", pos: "verb", pronunciation_vi: "bê-GLAI-tần" },
    ],
    dialogue: [
      { speaker: "Sophie", text: "Linh, ich möchte dir etwas erzählen — etwas, das ich noch nie laut ausgesprochen habe.", vi: "Linh, mình muốn kể cậu chuyện gì đó — chuyện mình chưa bao giờ nói thành tiếng." },
      { speaker: "Linh", text: "Ich höre dir zu. Du musst nicht mehr erzählen, als sich gut anfühlt.", vi: "Mình đang nghe cậu. Cậu không cần kể nhiều hơn mức cậu thấy ổn." },
      { speaker: "Sophie", text: "Es ist etwas Schwieriges aus meiner Jugend — ich weiß nicht, wo ich anfangen soll.", vi: "Là chuyện khó từ thời niên thiếu của mình — mình không biết bắt đầu từ đâu." },
      { speaker: "Linh", text: "Es muss keinen perfekten Anfang geben. Erzähl, was sich anfühlt, als müsste es jetzt heraus.", vi: "Không cần khởi đầu hoàn hảo. Cứ kể điều cảm thấy cần ra ngay bây giờ." },
    ],
    dialogue_long: [
      { speaker: "Sophie", text: "Linh, ich möchte dir etwas erzählen — etwas, das ich noch nie laut ausgesprochen habe. Hast du Zeit?", vi: "Linh, mình muốn kể cậu chuyện gì đó — chuyện mình chưa bao giờ nói thành tiếng. Cậu có thời gian không?" },
      { speaker: "Linh", text: "Ja — ich habe Zeit. Komm rein. Wir setzen uns ins Wohnzimmer.", vi: "Có — mình có thời gian. Vào đi. Tụi mình ngồi phòng khách." },
      { speaker: "Sophie", text: "Ich weiß nicht, wo ich anfangen soll. Es ist etwas Schwieriges aus meiner Jugend.", vi: "Mình không biết bắt đầu từ đâu. Là chuyện khó từ thời niên thiếu của mình." },
      { speaker: "Linh", text: "Es muss keinen perfekten Anfang geben. Erzähl, was sich anfühlt, als müsste es jetzt heraus. Ich höre dir zu — und du musst nicht mehr erzählen, als sich gut anfühlt.", vi: "Không cần khởi đầu hoàn hảo. Cứ kể điều cảm thấy cần ra. Mình đang nghe — và cậu không cần kể nhiều hơn mức ổn." },
      { speaker: "Sophie", text: "Als ich 16 war, ist in meiner Familie etwas Schwieriges passiert. Ich konnte lange nicht darüber reden — auch nicht mit meinen Eltern.", vi: "Năm 16 tuổi, có chuyện khó xảy ra trong gia đình mình. Mình đã không thể nói trong thời gian dài — cả với bố mẹ." },
      { speaker: "Linh", text: "Das klingt einsam — gerade in dem Alter.", vi: "Nghe có vẻ cô đơn — đặc biệt ở tuổi đó." },
      { speaker: "Sophie", text: "Es war einsam. Und ich habe lange gedacht, ich wäre selbst Schuld daran, wie ich reagiert habe.", vi: "Cô đơn thật. Và mình đã nghĩ lâu rằng mình tự có lỗi vì cách phản ứng của mình." },
      { speaker: "Linh", text: "Du hast getan, was du in dem Moment tun konntest. Mit 16 — alleine — ist das viel verlangt von einem Menschen.", vi: "Cậu đã làm điều cậu có thể làm trong khoảnh khắc đó. 16 tuổi — một mình — là quá nhiều với một con người." },
      { speaker: "Sophie", text: "Ich habe gerade Angst, dass du mich anders siehst, wenn ich es ausspreche.", vi: "Mình đang sợ rằng cậu sẽ nhìn mình khác đi nếu mình nói ra." },
      { speaker: "Linh", text: "Ich verspreche dir: was du mir erzählst, ändert nichts daran, wie ich dich sehe. Du bist und bleibst die Sophie, die ich kenne.", vi: "Mình hứa: điều cậu kể không thay đổi cách mình nhìn cậu. Cậu vẫn là và sẽ là Sophie mình biết." },
      { speaker: "Sophie", text: "[erzählt langsam, mit Pausen — ohne grafische Details]", vi: "[kể chậm, có quãng nghỉ — không chi tiết hình ảnh]" },
      { speaker: "Linh", text: "Was du erlebt hast, war nicht okay. Und es war nicht deine Schuld. Das möchte ich gerade laut sagen.", vi: "Điều cậu trải qua không okay. Và không phải lỗi của cậu. Điều đó mình muốn nói thành tiếng ngay bây giờ." },
      { speaker: "Sophie", text: "Niemand hat mir das je so direkt gesagt.", vi: "Chưa ai nói với mình điều đó trực tiếp như vậy." },
      { speaker: "Linh", text: "Es braucht Mut, das auszusprechen. Danke, dass du mir das anvertraust — das ist nicht selbstverständlich. Und es bleibt zwischen uns.", vi: "Cần dũng cảm để nói ra. Cám ơn cậu đã tin tưởng kể với mình — không phải mặc nhiên. Và sẽ ở giữa hai mình." },
      { speaker: "Sophie", text: "Manchmal frage ich mich, ob ich mit jemandem Professionellem darüber reden sollte. Aber ich habe Angst.", vi: "Đôi khi mình tự hỏi liệu mình có nên nói với chuyên gia không. Nhưng mình sợ." },
      { speaker: "Linh", text: "Wenn du soweit bist — manche Menschen finden es hilfreich, mit einem Therapeuten zu reden. Nicht weil mit dir etwas 'falsch' ist — sondern weil das ein sicherer Raum dafür ist. Ich kann dich begleiten, einen Termin zu suchen, wenn du möchtest.", vi: "Khi cậu sẵn sàng — nhiều người thấy nói với therapeut hữu ích. Không phải vì cậu 'có vấn đề' — mà vì đó là không gian an toàn cho điều này. Mình có thể đi cùng cậu tìm lịch hẹn, nếu cậu muốn." },
      { speaker: "Sophie", text: "Vielleicht. Heute noch nicht. Aber bald.", vi: "Có lẽ. Hôm nay thì chưa. Nhưng sớm thôi." },
      { speaker: "Linh", text: "Bereitness ist deine Entscheidung — kein Druck. Heute Abend — soll ich bei dir bleiben?", vi: "Sẵn sàng là quyết định của cậu — không áp lực. Tối nay — mình ở lại với cậu nhé?" },
      { speaker: "Sophie", text: "Ja. Bitte.", vi: "Vâng. Làm ơn." },
    ],
    roleplay_prompts: [
    ...
    idiom_glosses: [
      { idiom: "ein offenes Ohr haben", literal: "có cái tai mở", meaning: "sẵn sàng lắng nghe", example: "Wenn du irgendwann reden möchtest — ich habe immer ein offenes Ohr." },
      { idiom: "etwas auf dem Herzen haben", literal: "có điều gì đó trên trái tim", meaning: "có điều quan trọng muốn chia sẻ", example: "Du hast etwas auf dem Herzen — ich höre zu, ohne zu drängen." },
      { idiom: "sich vom Herzen reden", literal: "nói từ trái tim", meaning: "kể ra hết cảm xúc/chuyện đè nặng", example: "Manchmal hilft es, sich etwas vom Herzen zu reden — selbst wenn man keine Lösung sucht." },
      { idiom: "die Seele baumeln lassen", literal: "để tâm hồn lủng lẳng", meaning: "thư giãn, không nghĩ ngợi", example: "Nach so einem Gespräch braucht man Zeit, die Seele baumeln zu lassen." },
    ],
    exercises: [
      {
        type: "fill_blank",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Ich höre dir ___ — du musst nicht mehr erzählen, als sich gut anfühlt.", answer: "zu" },
          { prompt: "Danke, dass du mir das ___.", answer: "anvertraust" },
          { prompt: "Was du erlebt hast, war nicht ___ Schuld.", answer: "deine" },
          { prompt: "Ich werde nicht versuchen, es zu ___.", answer: "reparieren" },
        ],
      },
      {
        type: "matching",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Ich höre dir zu", answer: "Tín hiệu sẵn sàng lắng nghe" },
          { prompt: "Du hast nichts falsch gemacht", answer: "Validation chống Scham" },
          { prompt: "Das bleibt zwischen uns", answer: "Confidentiality formal" },
          { prompt: "ein offenes Ohr haben", answer: "Sẵn sàng lắng nghe (idiom)" },
        ],
      },
      {
        ...
        pronunciation_focus: ["empathetic listening"],
        items: [
          { prompt: "Mình nghe cậu — cậu không cần kể nhiều hơn mức ổn.", answer: "Ich höre dir zu — du musst nicht mehr erzählen, als sich gut anfühlt." },
          { prompt: "Cám ơn cậu đã tin tưởng kể — điều đó không phải mặc nhiên.", answer: "Danke, dass du mir das anvertraust — das ist nicht selbstverständlich." },
          { prompt: "Mình sẽ không cố 'sửa chữa' nó.", answer: "Ich werde nicht versuchen, es zu reparieren." },
          { prompt: "Mình ở lại — và điều đó không thay đổi cách mình nhìn cậu.", answer: "Ich bleibe — und das ändert nichts daran, wie ich dich sehe." },
        ],
      },
    ],
  },
  {
    ...
    sentences: [
      { en: "Anna, ich möchte mit dir über etwas sprechen, das mir in letzter Zeit auf dem Herzen liegt.", vi: "Anna, mình muốn nói với cậu về điều mình suy nghĩ thời gian qua.", pronunciation_focus: ["sprechen → SHPRÊ-khần", "Herzen → HÊ-tsần", "letzter → LET-stờ"] },
      { en: "Ich habe gemerkt, dass ich nach unseren Treffen oft erschöpft nach Hause gehe.", vi: "Mình nhận ra sau những lần gặp cậu mình thường về nhà kiệt sức.", pronunciation_focus: ["gemerkt → gê-MÊK-t", "Treffen → TRÊF-fần", "erschöpft → e-SHƠ-pft"] },
      { en: "Ich brauche andere Dinge in einer Freundschaft — mehr Gegenseitigkeit, weniger Krisenmodus.", vi: "Mình cần điều khác trong tình bạn — sự qua lại nhiều hơn, ít chế độ khủng hoảng hơn.", pronunciation_focus: ["Gegenseitigkeit → gê-gần-ZAI-tikh-kait", "Krisenmodus → KRI-zần-mô-đu-s", "Freundschaft → FROIN-shaft"] },
      { en: "Es ist nicht persönlich gegen dich — es ist eine Grenze, die ich für mich brauche.", vi: "Không phải chống cá nhân với cậu — là ranh giới mình cần cho bản thân.", pronunciation_focus: ["persönlich → pe-ZƠN-likh", "Grenze → GREN-tsê", "brauche → BRAU-khê"] },
      { en: "Ich kann dich um Mitternacht nicht mehr anrufen lassen — das ist mein Limit.", vi: "Mình không thể để cậu gọi lúc nửa đêm nữa — đó là giới hạn của mình.", pronunciation_focus: ["Mitternacht → MI-tờ-nakht", "anrufen → AN-ru-fần", "Limit → LI-mit"] },
    ],
    ...
    vocabulary: [
      { word: "die Grenze", en: "boundary, limit", vi: "ranh giới", pos: "noun (f)", pronunciation_vi: "đi GREN-tsê" },
      { word: "Grenze setzen", en: "to set a boundary", vi: "đặt ranh giới", pos: "verb phrase", pronunciation_vi: "GREN-tsê ZÉT-tsần" },
      { word: "die Selbstfürsorge", en: "self-care", vi: "tự chăm sóc bản thân", pos: "noun (f)", pronunciation_vi: "đi ZELP-st-fuy-zô-gê" },
      { word: "die Gegenseitigkeit", en: "mutuality, reciprocity", vi: "sự qua lại", pos: "noun (f)", pronunciation_vi: "đi gê-gần-ZAI-tikh-kait" },
      { word: "der Krisenmodus", en: "crisis mode", vi: "chế độ khủng hoảng", pos: "noun (m)", pronunciation_vi: "đe KRI-zần-mô-đu-s" },
      { word: "erschöpft", en: "exhausted", vi: "kiệt sức", pos: "adjective", pronunciation_vi: "e-SHƠ-pft" },
      { word: "die Anlaufstelle", en: "go-to point of contact", vi: "địa chỉ liên hệ chính", pos: "noun (f)", pronunciation_vi: "đi AN-laof-shtê-lê" },
      { word: "die Vereinbarung", en: "agreement", vi: "thỏa thuận", pos: "noun (f)", pronunciation_vi: "đi fe-AIN-ba-rung" },
      { word: "der Abstand", en: "distance, space", vi: "khoảng cách", pos: "noun (m)", pronunciation_vi: "đe AB-shtant" },
      { word: "auf dem Herzen liegen", en: "to weigh on one's heart, to be on one's mind", vi: "đè nặng trong lòng", pos: "phrase", pronunciation_vi: "aof đêm HÊ-tsần LI-gần" },
    ],
    dialogue: [
      { speaker: "Linh", text: "Anna, hast du Zeit für ein offenes Gespräch? Mir liegt etwas auf dem Herzen.", vi: "Anna, cậu có thời gian cho cuộc trò chuyện thẳng không? Mình có điều đè nặng trong lòng." },
      { speaker: "Anna", text: "Klar. Ist alles okay?", vi: "Được. Mọi thứ ổn không?" },
      { speaker: "Linh", text: "Ich habe gemerkt, dass ich nach unseren Treffen oft erschöpft nach Hause gehe — und ich brauche eine Veränderung.", vi: "Mình nhận ra sau những lần gặp cậu mình thường về nhà kiệt sức — và mình cần thay đổi." },
      { speaker: "Anna", text: "Bin ich zu viel?", vi: "Mình có quá đáng không?" },
    ],
    dialogue_long: [
      { speaker: "Linh", text: "Anna, hast du Zeit für ein offenes Gespräch? Mir liegt etwas auf dem Herzen — und ich möchte das direkt mit dir klären, nicht hinter deinem Rücken.", vi: "Anna, cậu có thời gian cho cuộc trò chuyện thẳng không? Mình có điều đè nặng — và mình muốn giải quyết trực tiếp với cậu, không sau lưng." },
      { speaker: "Anna", text: "Klar. Ist alles okay zwischen uns?", vi: "Được. Mọi thứ giữa hai mình ổn không?" },
      { speaker: "Linh", text: "Ich möchte zwischen uns etwas verändern, weil mir unsere Freundschaft wichtig ist. Ich habe in den letzten zwei Monaten gemerkt, dass ich nach unseren Treffen oft erschöpft nach Hause gehe.", vi: "Mình muốn thay đổi điều gì đó giữa hai mình, vì tình bạn của tụi mình quan trọng với mình. Hai tháng qua mình nhận ra sau những lần gặp mình về nhà kiệt sức." },
      { speaker: "Anna", text: "Was meinst du damit?", vi: "Cậu nói gì vậy?" },
      { speaker: "Linh", text: "In den letzten acht Wochen haben wir uns 14 Mal getroffen — und 13 von 14 Mal ging es um eine Krise: Job, Familie, Mathias. Ich höre dir gerne zu — gleichzeitig habe ich kaum noch Energie für mein eigenes Leben.", vi: "Tám tuần qua tụi mình gặp 14 lần — 13/14 lần xoay quanh khủng hoảng: công việc, gia đình, Mathias. Mình thích lắng nghe cậu — đồng thời mình hầu như không còn năng lượng cho cuộc sống mình." },
      { speaker: "Anna", text: "Du machst gerade aus einer Mücke einen Elefanten. Ich habe nun mal eine schwere Phase.", vi: "Cậu đang phóng đại đó. Mình đang trải qua giai đoạn nặng thôi." },
      { speaker: "Linh", text: "Ich verstehe, dass du gerade eine schwere Phase hast — und das ist real. Gleichzeitig: ich kann nicht mehr deine einzige Anlaufstelle sein. Es geht nicht um falsch oder richtig — es geht um das, was ich brauche.", vi: "Mình hiểu cậu đang giai đoạn nặng — đó là thực. Đồng thời: mình không thể là địa chỉ liên hệ duy nhất của cậu. Không phải về đúng sai — mà về điều mình cần." },
      { speaker: "Anna", text: "Bin ich zu viel?", vi: "Mình có quá đáng không?" },
      { speaker: "Linh", text: "Du bist nicht 'zu viel'. Aber ich brauche andere Dinge in einer Freundschaft — mehr Gegenseitigkeit, weniger Krisenmodus. Es ist nicht persönlich gegen dich — es ist eine Grenze, die ich für mich brauche.", vi: "Cậu không 'quá đáng'. Nhưng mình cần điều khác trong tình bạn — sự qua lại hơn, ít chế độ khủng hoảng hơn. Không phải chống cậu — là ranh giới mình cần cho bản thân." },
      { speaker: "Anna", text: "Was heißt das konkret?", vi: "Cụ thể là sao?" },
      { speaker: "Linh", text: "Konkret: Ich kann dich um Mitternacht nicht mehr anrufen lassen. Was möglich ist: einmal pro Woche treffen, davon eine Hälfte über deine Themen, eine Hälfte über meine — oder auch über etwas Schönes wie einen Film.", vi: "Cụ thể: mình không thể để cậu gọi lúc nửa đêm nữa. Có thể: gặp 1 lần/tuần, một nửa về chuyện cậu, một nửa về chuyện mình — hoặc về điều gì đó vui như phim." },
      { speaker: "Anna", text: "Das fühlt sich an wie eine Strafe.", vi: "Nghe có vẻ như hình phạt." },
      { speaker: "Linh", text: "Ich verstehe, dass das schwer zu hören ist. Es ist keine Strafe — es ist Selbstfürsorge für mich. Eine Freundschaft, in der ich erschöpft bin, ist auf Dauer nicht haltbar.", vi: "Mình hiểu khó nghe. Không phải hình phạt — là tự chăm sóc bản thân. Tình bạn mà mình kiệt sức không bền vững lâu dài." },
      { speaker: "Anna", text: "Hm. Ich brauche Zeit, das zu verdauen.", vi: "Hừm. Mình cần thời gian tiêu hóa." },
      { speaker: "Linh", text: "Das ist absolut fair. Lass uns in einer Woche nochmal sprechen — und in der Zwischenzeit halte ich mich an das, was ich gesagt habe. Nicht als Strafe — sondern weil ich es brauche.", vi: "Hoàn toàn công bằng. Tụi mình nói lại sau 1 tuần — và trong lúc đó mình giữ điều mình đã nói. Không phải hình phạt — mà vì mình cần." },
      { speaker: "Anna", text: "Okay. Eine Frage noch: Wenn ich wirklich nicht klarkomme nachts — was mache ich dann?", vi: "Được. Một câu hỏi nữa: nếu mình thực sự không chịu nổi vào ban đêm — thì sao?" },
      { speaker: "Linh", text: "Wenn es eine echte Krise ist — Telefonseelsorge: 0800 111 0 111, kostenlos, 24/7. Oder Hausarzt am nächsten Morgen. Du hast Optionen, die mehr leisten können als ich.", vi: "Nếu là khủng hoảng thật — Telefonseelsorge: 0800 111 0 111, miễn phí, 24/7. Hoặc bác sĩ gia đình sáng hôm sau. Cậu có lựa chọn có thể hỗ trợ nhiều hơn mình." },
      { speaker: "Anna", text: "Verstehe. Ich melde mich nächste Woche.", vi: "Hiểu. Tuần sau mình liên lạc." },
      { speaker: "Linh", text: "Danke, dass du zugehört hast — auch wenn es schwer war.", vi: "Cám ơn cậu đã lắng nghe — dù khó." },
    ],
    roleplay_prompts: [
    ...
    idiom_glosses: [
      { idiom: "aus einer Mücke einen Elefanten machen", literal: "biến con muỗi thành con voi", meaning: "phóng đại vấn đề", example: "Du machst aus einer Mücke einen Elefanten — ich habe doch nur dreimal angerufen." },
      { idiom: "die Reißleine ziehen", literal: "kéo dây kéo cứu (parachute)", meaning: "stop khẩn cấp khi tình huống đi quá xa", example: "Bei dieser Freundschaft musste ich die Reißleine ziehen — sonst wäre ich zusammengebrochen." },
      { idiom: "auf eigene Kappe nehmen", literal: "nhận lên mũ của chính mình", meaning: "chịu trách nhiệm về điều gì đó", example: "Diese Grenze nehme ich auf meine eigene Kappe — auch wenn andere es nicht verstehen." },
      { idiom: "den Knoten durchschlagen", literal: "chém đứt nút thắt (gốc Alexander Đại đế)", meaning: "giải quyết vấn đề phức tạp dứt khoát", example: "Mit diesem Gespräch haben wir den Knoten durchgeschlagen — endlich Klarheit." },
    ],
    exercises: [
      {
        type: "fill_blank",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Mir liegt etwas auf dem ___.", answer: "Herzen" },
          { prompt: "Ich habe ___, dass ich nach unseren Treffen oft erschöpft bin.", answer: "gemerkt" },
          { prompt: "Es ist nicht persönlich gegen dich — es ist eine ___, die ich brauche.", answer: "Grenze" },
          { prompt: "Eine Freundschaft, in der ich erschöpft bin, ist auf Dauer nicht ___.", answer: "haltbar" },
        ],
      },
      {
        type: "matching",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Selbstfürsorge", answer: "Tự chăm sóc bản thân (positive frame)" },
          { prompt: "Gegenseitigkeit", answer: "Sự qua lại trong friendship" },
          { prompt: "aus einer Mücke einen Elefanten machen", answer: "Phóng đại (idiom)" },
          { prompt: "die Reißleine ziehen", answer: "Stop khẩn cấp (idiom)" },
        ],
      },
      {
        type: "translation",
        instruction_vi: "Dịch sang tiếng Đức (Du, Grenze formal):",
        pronunciation_focus: ["setting boundaries"],
        items: [
          { prompt: "Mình muốn nói với cậu về điều mình suy nghĩ thời gian qua.", answer: "Ich möchte mit dir über etwas sprechen, das mir in letzter Zeit auf dem Herzen liegt." },
          { prompt: "Mình nhận ra sau những lần gặp cậu mình thường về nhà kiệt sức.", answer: "Ich habe gemerkt, dass ich nach unseren Treffen oft erschöpft nach Hause gehe." },
          { prompt: "Không phải chống cá nhân với cậu — là ranh giới mình cần.", answer: "Es ist nicht persönlich gegen dich — es ist eine Grenze, die ich für mich brauche." },
          { prompt: "Mình không thể để cậu gọi lúc nửa đêm — đó là giới hạn của mình.", answer: "Ich kann dich um Mitternacht nicht mehr anrufen lassen — das ist mein Limit." },
        ],
      },
    ],
  },
...
const C1_R1: GermanLesson[] = [
  ...
  },
  {
    ...
    sentences: [
      { en: "Gegen diese Lesart spricht jedoch ein gewichtiger Einwand, der in der Sekundärliteratur bislang unzureichend gewürdigt wurde.", vi: "Tuy nhiên một phản biện có trọng lượng phản đối cách đọc này, mà tài liệu thứ cấp cho đến nay chưa đánh giá đầy đủ.", pronunciation_focus: ["Lesart → LÊS-at", "gewichtiger → gê-VIKH-ti-gờ", "gewürdigt → gê-VUY-đikht"] },
      { en: "Unter der Voraussetzung, dass die Korpusgröße repräsentativ ist, ließe sich Ihre Schlussfolgerung tragen — andernfalls erscheint sie problematisch.", vi: "Với tiền đề rằng quy mô ngữ liệu mang tính đại diện, kết luận của bạn có thể đứng vững — nếu không nó trở nên có vấn đề.", pronunciation_focus: ["Voraussetzung → FÔ-rao-sê-tsung", "repräsentativ → rê-prê-zên-ta-TIF", "Schlussfolgerung → SHLUS-fôl-gê-rung"] },
      { en: "Ich teile Ihre Grundannahme, möchte indes die Reichweite der Schlussfolgerung in Frage stellen.", vi: "Tôi chia sẻ giả định nền tảng của bạn, song muốn đặt vấn đề về phạm vi của kết luận.", pronunciation_focus: ["Grundannahme → GRUNT-an-na-mê", "indes → in-ĐÊS", "Reichweite → RAIKH-vai-tê"] },
      { en: "Demgegenüber wäre einzuwenden, dass die Studie methodische Verzerrungen aufweist, die das Ergebnis erheblich relativieren.", vi: "Phản đối lại điều đó, cần lưu ý rằng nghiên cứu có những thiên lệch phương pháp luận làm tương đối hóa đáng kể kết quả.", pronunciation_focus: ["demgegenüber → đêm-gê-gần-UY-bờ", "einzuwenden → AIN-tsu-ven-đần", "relativieren → rê-la-ti-VI-rần"] },
      { en: "Insofern als die Datenlage uneindeutig ist, wäre eine vorschnelle Generalisierung wenig zielführend.", vi: "Xét rằng tình trạng dữ liệu không rõ ràng, một sự khái quát hóa vội vã sẽ ít có tính dẫn dắt.", pronunciation_focus: ["insofern als → in-zô-FE-n als", "Datenlage → ĐA-tần-la-gê", "zielführend → TSIL-fuy-rần"] },
    ],
    ...
    vocabulary: [
      { word: "der Einwand", en: "objection (in argument)", vi: "phản biện, phản đối", pos: "noun (m)", pronunciation_vi: "đe AIN-vant" },
      { word: "die Lesart", en: "reading, interpretation", vi: "cách đọc, cách hiểu", pos: "noun (f)", pronunciation_vi: "đi LÊS-at" },
      { word: "die Schlussfolgerung", en: "conclusion (logical)", vi: "kết luận", pos: "noun (f)", pronunciation_vi: "đi SHLUS-fôl-gê-rung" },
      { word: "die Voraussetzung", en: "premise, prerequisite", vi: "tiền đề", pos: "noun (f)", pronunciation_vi: "đi FÔ-rao-sê-tsung" },
      { word: "die Reichweite", en: "scope, range", vi: "phạm vi", pos: "noun (f)", pronunciation_vi: "đi RAIKH-vai-tê" },
      { word: "in Frage stellen", en: "to call into question", vi: "đặt vấn đề về", pos: "verb phrase", pronunciation_vi: "in FRA-gê SHTÊ-lần" },
      { word: "in Zweifel ziehen", en: "to draw into doubt", vi: "đưa vào nghi ngờ", pos: "verb phrase", pronunciation_vi: "in TSVAI-fệl TSI-ần" },
      { word: "einen Einwand erheben", en: "to raise an objection", vi: "đưa ra phản đối", pos: "verb phrase", pronunciation_vi: "AI-nần AIN-vant e-HÊ-bần" },
      { word: "die Verzerrung", en: "bias, distortion", vi: "thiên lệch, méo mó", pos: "noun (f)", pronunciation_vi: "đi fe-TSER-rung" },
      { word: "zielführend", en: "purposive, conducive to the goal", vi: "có tính dẫn dắt đến mục đích", pos: "adjective", pronunciation_vi: "TSIL-fuy-rần" },
    ],
    dialogue: [
      { speaker: "Dr. Akinwumi", text: "Ihre Schlussfolgerung erscheint mir voreilig — Sie generalisieren von 42 Stunden Korpus auf eine ganze Sprechergruppe.", vi: "Kết luận của bạn tôi thấy vội vã — bạn khái quát từ ngữ liệu 42 giờ ra một nhóm người nói toàn bộ." },
      { speaker: "Linh", text: "Das ist ein berechtigter Einwand. Allerdings erhebe ich keinen Anspruch auf statistische Repräsentativität, sondern auf typologische Tiefenschärfe.", vi: "Đó là phản biện có cơ sở. Tuy nhiên tôi không tuyên bố tính đại diện thống kê, mà là độ sắc nét loại hình học." },
      { speaker: "Dr. Akinwumi", text: "Das mag zutreffen. Demgegenüber wäre dennoch einzuwenden, dass Ihr Sample auf einen Universitätskontext begrenzt ist.", vi: "Điều đó có thể đúng. Đối lại vẫn cần phản đối rằng mẫu của bạn bị giới hạn ở môi trường đại học." },
      { speaker: "Linh", text: "In diesem Punkt müssen Sie mir Recht geben — der außeruniversitäre Kontext bleibt eine Lücke, die ich in einer Anschlussstudie schließen möchte.", vi: "Ở điểm này tôi phải thừa nhận bạn đúng — môi trường ngoài đại học vẫn là một khoảng trống tôi muốn khép lại ở nghiên cứu tiếp nối." },
    ],
    dialogue_long: [
      { speaker: "Dr. Akinwumi", text: "Frau Nguyễn, ich hätte einige Anmerkungen zu Ihrer Argumentation in Kapitel vier — gestatten Sie?", vi: "Cô Nguyễn, tôi có một vài nhận xét về lập luận trong chương bốn — cô cho phép chứ?" },
      { speaker: "Linh", text: "Selbstverständlich, Herr Doktor — Kritik nehme ich gern auf.", vi: "Tất nhiên, thưa Tiến sĩ — tôi sẵn lòng tiếp thu phê bình." },
      { speaker: "Dr. Akinwumi", text: "Ihre Schlussfolgerung erscheint mir voreilig. Sie generalisieren von einem 42-Stunden-Korpus auf eine ganze Sprechergruppe — das halte ich für methodologisch problematisch.", vi: "Kết luận của bạn tôi thấy vội vã. Bạn khái quát từ ngữ liệu 42 giờ ra một nhóm người nói toàn bộ — tôi cho đó là có vấn đề về phương pháp luận." },
      { speaker: "Linh", text: "Das ist ein berechtigter Einwand. Allerdings möchte ich differenziert darauf eingehen.", vi: "Đó là phản biện có cơ sở. Tuy nhiên tôi muốn trả lời điều đó một cách phân biệt." },
      { speaker: "Linh", text: "Erstens: ich erhebe keinen Anspruch auf statistische Repräsentativität, sondern auf typologische Tiefenschärfe. Das ist eine etablierte Position in der qualitativen Sozialforschung.", vi: "Thứ nhất: tôi không tuyên bố tính đại diện thống kê, mà là độ sắc nét loại hình học. Đó là quan điểm đã được thiết lập trong nghiên cứu xã hội định tính." },
      { speaker: "Linh", text: "Zweitens: meine Schlussfolgerungen sind explizit auf den Universitätskontext beschränkt — das geht aus Kapitel zwei hervor.", vi: "Thứ hai: kết luận của tôi được giới hạn rõ ràng vào bối cảnh đại học — điều đó được nêu rõ ở chương hai." },
      { speaker: "Dr. Akinwumi", text: "Das mag zutreffen. Demgegenüber wäre dennoch einzuwenden, dass die Formulierung in Kapitel vier den Eindruck erweckt, Sie behaupteten universelle Gültigkeit.", vi: "Điều đó có thể đúng. Đối lại vẫn cần phản đối rằng cách diễn đạt trong chương bốn gây ấn tượng rằng bạn tuyên bố tính hiệu lực phổ quát." },
      { speaker: "Linh", text: "Können Sie mir eine konkrete Stelle nennen?", vi: "Anh có thể chỉ cho tôi một chỗ cụ thể không?" },
      { speaker: "Dr. Akinwumi", text: "Seite 87, zweiter Absatz: ‚Code-Switcher zeigen systematisch...' — ohne Einschränkung auf Ihre Stichprobe.", vi: "Trang 87, đoạn hai: ‚Người chuyển mã cho thấy có hệ thống...' — không có giới hạn vào mẫu của bạn." },
      { speaker: "Linh", text: "In diesem Punkt müssen Sie mir Recht geben. Die Formulierung ist tatsächlich zu weit gefasst — ich werde sie zu ‚Code-Switcher in unserem Korpus zeigen...' präzisieren.", vi: "Ở điểm này tôi phải thừa nhận anh đúng. Cách diễn đạt thực sự quá rộng — tôi sẽ làm chính xác thành ‚Người chuyển mã trong ngữ liệu của chúng tôi cho thấy...'." },
      { speaker: "Dr. Akinwumi", text: "Ein zweiter Punkt: Sie behaupten, dass Ihre Befunde mit Auer (1998) inkompatibel seien. Diese Lesart teile ich nicht.", vi: "Một điểm thứ hai: bạn khẳng định kết quả của bạn không tương thích với Auer (1998). Cách đọc này tôi không chia sẻ." },
      { speaker: "Linh", text: "Gegen Ihre Auffassung spricht jedoch, dass Auer ein turn-taking-orientiertes Modell verwendet, während ich diskursanalytisch argumentiere. Insofern als die Erklärungsebenen verschieden sind, scheint mir die Inkompatibilität zwingend.", vi: "Tuy nhiên phản đối quan điểm của anh là Auer dùng mô hình hướng turn-taking, trong khi tôi lập luận theo phân tích diễn ngôn. Xét rằng cấp độ giải thích khác nhau, sự không tương thích đối với tôi là tất yếu." },
      { speaker: "Dr. Akinwumi", text: "Hier möchte ich präzisieren: Auer hat in seinen späteren Arbeiten (2007) selbst diskursanalytische Elemente integriert. Ihre Abgrenzung erscheint mir vor diesem Hintergrund zu starr.", vi: "Ở đây tôi muốn làm chính xác: Auer trong các công trình sau (2007) cũng đã tích hợp các yếu tố phân tích diễn ngôn. Sự phân tách của bạn đứng trước bối cảnh này có vẻ quá cứng." },
      { speaker: "Linh", text: "Das ist ein wichtiger Hinweis — ich war auf den Auer von 1998 fokussiert. Gestatten Sie, dass ich den Punkt schriftlich aufgreife und Ihnen den überarbeiteten Abschnitt nächste Woche zusende.", vi: "Đó là chỉ dẫn quan trọng — tôi tập trung vào Auer 1998. Cho phép tôi tiếp thu điểm đó bằng văn bản và gửi anh đoạn đã chỉnh sửa tuần sau." },
      { speaker: "Dr. Akinwumi", text: "Sehr gerne. Insgesamt halte ich Ihre Argumentation für tragfähig — die Modifikationen betreffen Formulierungen, nicht die Substanz.", vi: "Rất sẵn lòng. Tổng thể tôi cho rằng lập luận của bạn vững — những sửa đổi liên quan đến cách diễn đạt, không phải bản chất." },
      { speaker: "Linh", text: "Ich danke Ihnen für die kritische Lektüre — solche Einwände bringen die Arbeit voran.", vi: "Tôi cảm ơn anh vì sự đọc phê phán — những phản biện như vậy đẩy công trình tiến lên." },
    ],
    roleplay_prompts: [
    ...
    idiom_glosses: [
      { idiom: "den Finger in die Wunde legen", literal: "đặt ngón tay vào vết thương", meaning: "chỉ ra điểm yếu chính xác (gehoben/standardsprachlich)", example: "Mit diesem Einwand legen Sie den Finger in die Wunde — meine Stichprobenkonstruktion ist tatsächlich angreifbar." },
      { idiom: "auf wackligen Beinen stehen", literal: "đứng trên những chân run rẩy", meaning: "lập luận yếu, không vững (standardsprachlich)", example: "Ohne ein größeres Korpus steht die Generalisierung auf wackligen Beinen." },
      { idiom: "Wasser predigen und Wein trinken", literal: "rao giảng nước nhưng uống rượu", meaning: "không nhất quán giữa lời và việc, đạo đức giả (gehoben)", example: "Wer methodische Strenge fordert, aber selbst keine Triangulation anbietet, predigt Wasser und trinkt Wein." },
      { idiom: "ein Pferd vom anderen Ende aufzäumen", literal: "thắng yên ngựa từ đầu kia", meaning: "tiếp cận vấn đề sai chiều (standardsprachlich)", example: "Methodologisch zäumen Sie das Pferd vom anderen Ende auf — zuerst die Theorie, dann die Daten, nicht umgekehrt." },
    ],
    exercises: [
      {
        type: "fill_blank",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Gegen diese Lesart ___ jedoch ein gewichtiger Einwand.", answer: "spricht" },
          { prompt: "___ wäre einzuwenden, dass die Studie methodische Verzerrungen aufweist.", answer: "Demgegenüber" },
          { prompt: "In diesem Punkt müssen Sie mir Recht ___.", answer: "geben" },
          { prompt: "___ als die Datenlage uneindeutig ist, wäre eine Generalisierung zu vorschnell.", answer: "Insofern" },
        ],
      },
      {
        type: "matching",
        ...
        items: [
          { prompt: "in Frage stellen", answer: "bezweifeln" },
          { prompt: "einen Einwand erheben", answer: "einwenden" },
          { prompt: "einer Kritik unterziehen", answer: "kritisieren" },
          { prompt: "in Zweifel ziehen", answer: "anzweifeln" },
        ],
      },
      {
        type: "translation",
        instruction_vi: "Dịch sang tiếng Đức học thuật C1:",
        pronunciation_focus: ["argumentation"],
        items: [
          { prompt: "Tuy nhiên một phản biện có trọng lượng phản đối cách đọc này.", answer: "Gegen diese Lesart spricht jedoch ein gewichtiger Einwand." },
          { prompt: "Tôi chia sẻ giả định nền tảng của bạn, song muốn đặt vấn đề về phạm vi của kết luận.", answer: "Ich teile Ihre Grundannahme, möchte indes die Reichweite der Schlussfolgerung in Frage stellen." },
          { prompt: "Ở điểm này tôi phải thừa nhận bạn đúng.", answer: "In diesem Punkt müssen Sie mir Recht geben." },
          { prompt: "Cho phép tôi tiếp thu điểm đó bằng văn bản.", answer: "Gestatten Sie, dass ich den Punkt schriftlich aufgreife." },
        ],
      },
    ],
  },
  {
    ...
    sentences: [
      { en: "Es dürfte sich hierbei um ein methodisches Artefakt handeln, dessen Tragweite vorerst unklar bleibt.", vi: "Có lẽ ở đây đó là một hiện tượng nhân tạo về phương pháp luận, mà tầm vóc của nó tạm thời vẫn chưa rõ ràng.", pronunciation_focus: ["dürfte → ĐUYF-tê", "Artefakt → at-tê-FAKT", "Tragweite → TRAK-vai-tê"] },
      { en: "Vermutlich liegt der Effekt in der Stichprobenkonstruktion begründet, doch lässt sich dies anhand der vorhandenen Daten nicht abschließend klären.", vi: "Có thể hiệu ứng này có nguồn gốc trong cấu trúc mẫu, song điều đó không thể được làm rõ một cách chung quyết dựa trên dữ liệu hiện có.", pronunciation_focus: ["vermutlich → fe-MUT-likh", "Stichprobenkonstruktion → SHTIKH-prô-bần-kôn-struk-tsi-ôn", "abschließend → AB-shli-sần"] },
      { en: "Unter Umständen wäre denkbar, dass kontextuelle Variablen den beobachteten Zusammenhang teilweise erklären.", vi: "Trong một số trường hợp, có thể tưởng tượng rằng các biến số ngữ cảnh giải thích một phần mối quan hệ được quan sát.", pronunciation_focus: ["unter Umständen → UN-tờ UM-shten-đần", "denkbar → ĐENK-ba", "Zusammenhang → tsu-ZA-mần-hang"] },
      { en: "Die Befunde sprechen tendenziell für die Hypothese, ohne sie indes zwingend zu belegen.", vi: "Các kết quả có xu hướng ủng hộ giả thuyết, song không chứng minh nó một cách bắt buộc.", pronunciation_focus: ["tendenziell → tên-đên-tsi-ÊL", "indes → in-ĐÊS", "zwingend → TSVI-ngần"] },
      { en: "Eine endgültige Bewertung ließe sich erst auf der Grundlage repliktativer Studien vornehmen.", vi: "Một đánh giá chung cuộc chỉ có thể được tiến hành dựa trên các nghiên cứu lặp lại.", pronunciation_focus: ["endgültige → ENT-guyl-ti-gê", "Grundlage → GRUNT-la-gê", "repliktativ → rê-pli-ka-TIF"] },
    ],
    ...
    vocabulary: [
      { word: "vermutlich", en: "presumably, probably", vi: "có lẽ, có khả năng", pos: "adverb", pronunciation_vi: "fe-MUT-likh" },
      { word: "tendenziell", en: "tendentially, by tendency", vi: "có xu hướng", pos: "adverb", pronunciation_vi: "tên-đên-tsi-ÊL" },
      { word: "unter Umständen", en: "under (some) circumstances, possibly", vi: "trong một số trường hợp", pos: "phrase", pronunciation_vi: "UN-tờ UM-shten-đần" },
      { word: "gegebenenfalls", en: "if applicable, where appropriate", vi: "nếu áp dụng được", pos: "adverb", pronunciation_vi: "gê-GÊ-bê-nần-fals" },
      { word: "vorbehaltlich (+ Gen)", en: "subject to, conditional upon", vi: "với điều kiện, dành cho", pos: "preposition (Gen)", pronunciation_vi: "FÔ-bê-halt-likh" },
      { word: "indes", en: "however, yet (formal)", vi: "song, tuy nhiên (formal)", pos: "adverb", pronunciation_vi: "in-ĐÊS" },
      { word: "die Tragweite", en: "scope, ramification", vi: "tầm vóc, hệ quả", pos: "noun (f)", pronunciation_vi: "đi TRAK-vai-tê" },
      { word: "abschließend", en: "conclusive(ly), final(ly)", vi: "chung cuộc, cuối cùng", pos: "adjective/adverb", pronunciation_vi: "AB-shli-sần" },
      { word: "die Einschränkung", en: "limitation, qualification", vi: "hạn chế, giới hạn", pos: "noun (f)", pronunciation_vi: "đi AIN-shren-kung" },
      { word: "es lässt sich annehmen", en: "it can be assumed", vi: "có thể giả định", pos: "phrase", pronunciation_vi: "ês LE-st zikh AN-nê-mần" },
    ],
    dialogue: [
      { speaker: "Reviewer", text: "Sie schreiben in der Diskussion: ‚Eindeutig zeigt sich, dass Code-Switching identitätskonstitutiv ist.' Ist diese Formulierung angesichts Ihrer Datenlage nicht zu stark?", vi: "Bạn viết ở phần thảo luận: ‚Rõ ràng cho thấy chuyển mã có tính cấu thành căn tính'. Diễn đạt này không phải quá mạnh trước tình trạng dữ liệu của bạn sao?" },
      { speaker: "Linh", text: "Sie haben Recht — die Formulierung ist zu absolut. Ich werde sie zu ‚Die Befunde sprechen tendenziell dafür, dass...' abschwächen.", vi: "Bạn đúng — diễn đạt quá tuyệt đối. Tôi sẽ giảm xuống ‚Các kết quả có xu hướng ủng hộ rằng...'." },
      { speaker: "Reviewer", text: "Treffender. Erwägen Sie zudem den Zusatz ‚unter den Bedingungen unseres Korpus' — das sichert die epistemische Reichweite zusätzlich ab.", vi: "Chính xác hơn. Hãy thêm ‚trong điều kiện ngữ liệu của chúng tôi' — điều đó còn đảm bảo phạm vi tri thức." },
      { speaker: "Linh", text: "Übernehme ich. Vielen Dank für die präzisierende Lektüre.", vi: "Tôi tiếp thu. Cảm ơn vì sự đọc làm chính xác." },
    ],
    dialogue_long: [
      { speaker: "Reviewer", text: "Frau Nguyễn, im Rahmen meiner Begutachtung möchte ich auf einen wiederkehrenden stilistischen Punkt hinweisen — die Frage der epistemischen Modalisierung.", vi: "Cô Nguyễn, trong khuôn khổ thẩm định, tôi muốn lưu ý một điểm phong cách lặp lại — vấn đề điều biến tri thức." },
      { speaker: "Linh", text: "Bitte führen Sie aus.", vi: "Xin anh trình bày." },
      { speaker: "Reviewer", text: "An mehreren Stellen Ihrer Diskussion finden sich Formulierungen wie ‚eindeutig zeigt sich' oder ‚es steht außer Frage'. Angesichts Ihrer Datenlage erscheinen diese mir methodisch nicht hinreichend abgesichert.", vi: "Ở nhiều chỗ trong phần thảo luận của bạn có những diễn đạt như ‚rõ ràng cho thấy' hoặc ‚không nghi ngờ'. Trước tình trạng dữ liệu của bạn, đối với tôi chúng không được đảm bảo đầy đủ về phương pháp luận." },
      { speaker: "Linh", text: "Sie haben Recht. Welche Stelle haben Sie konkret im Sinn?", vi: "Bạn đúng. Anh có ý chỉ chỗ cụ thể nào?" },
      { speaker: "Reviewer", text: "Seite 142, dritter Absatz: ‚Eindeutig zeigt sich, dass Code-Switching identitätskonstitutiv ist.' Bei einem Korpus von 42 Stunden ist diese Aussage zu absolut.", vi: "Trang 142, đoạn ba: ‚Rõ ràng cho thấy chuyển mã có tính cấu thành căn tính'. Với một ngữ liệu 42 giờ, câu này quá tuyệt đối." },
      { speaker: "Linh", text: "Wie würden Sie die Formulierung anpassen?", vi: "Anh sẽ điều chỉnh cách diễn đạt như thế nào?" },
      { speaker: "Reviewer", text: "Ich würde vorschlagen: ‚Die Befunde sprechen tendenziell dafür, dass Code-Switching unter den Bedingungen unseres Korpus identitätskonstitutiv wirken kann.'", vi: "Tôi đề xuất: ‚Các kết quả có xu hướng ủng hộ rằng chuyển mã trong điều kiện ngữ liệu của chúng tôi có thể có tác dụng cấu thành căn tính.'" },
      { speaker: "Linh", text: "Das ist deutlich präziser. Mir war nicht bewusst, wie häufig ich anti-hedging verwende.", vi: "Đó là chính xác hơn nhiều. Tôi không nhận ra mình dùng anti-hedging thường xuyên đến vậy." },
      { speaker: "Reviewer", text: "Es ist ein verbreitetes Problem bei Doktorierenden, die aus Hochkontext-Kulturen kommen — dort werden starke Aussagen oft als Zeichen von Kompetenz gewertet, in der deutschen Wissenschaftssprache hingegen eher als Anmaßung.", vi: "Đó là vấn đề phổ biến ở nghiên cứu sinh đến từ các văn hóa cao ngữ cảnh — ở đó các phát biểu mạnh thường được đánh giá như dấu hiệu năng lực, trong ngôn ngữ khoa học Đức ngược lại được xem là kiêu căng." },
      { speaker: "Linh", text: "Das ist eine wichtige interkulturelle Beobachtung. Gibt es eine systematische Heuristik zur Hedge-Wahl?", vi: "Đó là quan sát liên văn hóa quan trọng. Có heuristic hệ thống nào cho việc chọn hedge không?" },
      { speaker: "Reviewer", text: "Ich orientiere mich an einem Fünfstufen-Modell: ‚nicht auszuschließen' bei 10 Prozent, ‚unter Umständen' bei 30, ‚vermutlich' bei 60, ‚wahrscheinlich' bei 75, ‚davon auszugehen' bei 90 Prozent Konfidenz.", vi: "Tôi định hướng theo mô hình năm cấp: ‚không thể loại trừ' ở 10 phần trăm, ‚trong một số trường hợp' ở 30, ‚có lẽ' ở 60, ‚có khả năng' ở 75, ‚có thể giả định' ở 90 phần trăm độ tin cậy." },
      { speaker: "Linh", text: "Das ist hilfreich. Ich werde meine Diskussion entlang dieses Schemas neu kalibrieren.", vi: "Hữu ích. Tôi sẽ hiệu chuẩn lại phần thảo luận của tôi theo lược đồ này." },
      { speaker: "Reviewer", text: "Beachten Sie zudem den Konjunktiv II in Hypothetika. ‚Wäre denkbar' statt ‚ist denkbar'; ‚ließe sich vermuten' statt ‚lässt sich vermuten' bei spekulativen Aussagen.", vi: "Cũng lưu ý Konjunktiv II ở các giả thiết. ‚Wäre denkbar' thay ‚ist denkbar'; ‚ließe sich vermuten' thay ‚lässt sich vermuten' ở các phát biểu mang tính suy đoán." },
      { speaker: "Linh", text: "Verstanden. Ein systematisches Issue, das ich in der Überarbeitung adressieren werde.", vi: "Tôi hiểu. Một vấn đề có hệ thống tôi sẽ giải quyết trong việc chỉnh sửa." },
      { speaker: "Reviewer", text: "Eines noch: vermeiden Sie ‚meiner Meinung nach' in geschriebener Wissenschaftssprache. Stattdessen ‚vor diesem Hintergrund liegt die Annahme nahe, dass...' — das ist epistemisch präziser.", vi: "Còn một điều: tránh ‚theo ý kiến của tôi' trong ngôn ngữ khoa học viết. Thay bằng ‚trước bối cảnh này, giả định rằng... là gần' — chính xác hơn về tri thức." },
      { speaker: "Linh", text: "Sehr aufschlussreich. Ich danke Ihnen — die Begutachtung ist substantiell hilfreich.", vi: "Rất khai sáng. Cảm ơn anh — sự thẩm định thực sự hữu ích." },
    ],
    roleplay_prompts: [
    ...
    idiom_glosses: [
      { idiom: "mit Vorsicht zu genießen sein", literal: "phải được hưởng dụng cẩn thận", meaning: "phải được tiếp nhận với sự dè dặt (standardsprachlich)", example: "Diese vorläufigen Befunde sind mit Vorsicht zu genießen — die Stichprobengröße ist begrenzt." },
      { idiom: "mit allen Wassern gewaschen sein", literal: "đã được tắm với mọi loại nước", meaning: "tinh thông, không dễ bị lừa (gehoben/standardsprachlich)", example: "Ein erfahrener Methodologe ist mit allen Wassern gewaschen — er erkennt anti-hedging sofort." },
      { idiom: "auf dünnem Eis stehen", literal: "đứng trên băng mỏng", meaning: "ở vị trí bấp bênh, dễ sụp (standardsprachlich)", example: "Ohne Replikation steht jede Generalisierung auf dünnem Eis." },
      { idiom: "ein Schuss ins Blaue sein", literal: "một phát súng vào màu xanh", meaning: "phỏng đoán không có cơ sở (standardsprachlich)", example: "Ohne Datenbasis wäre eine solche Behauptung ein Schuss ins Blaue." },
    ],
    exercises: [
      {
        type: "fill_blank",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "Es ___ sich hierbei um ein methodisches Artefakt handeln.", answer: "dürfte" },
          { prompt: "___ liegt der Effekt in der Stichprobenkonstruktion begründet.", answer: "Vermutlich" },
          { prompt: "Unter Umständen ___ denkbar, dass kontextuelle Variablen den Zusammenhang erklären.", answer: "wäre" },
          { prompt: "Die Befunde sprechen ___ für die Hypothese, ohne sie indes zu belegen.", answer: "tendenziell" },
        ],
      },
      {
        type: "matching",
        ...
        pronunciation_focus: [],
        items: [
          { prompt: "nicht auszuschließen", answer: "~10% (rất yếu)" },
          { prompt: "unter Umständen", answer: "~30% (yếu)" },
          { prompt: "vermutlich", answer: "~60% (trung bình)" },
          { prompt: "davon auszugehen", answer: "~90% (mạnh-hedge)" },
        ],
      },
      {
        type: "translation",
        instruction_vi: "Dịch sang tiếng Đức học thuật C1 (Konjunktiv II hedging):",
        pronunciation_focus: ["hedging"],
        items: [
          { prompt: "Có lẽ ở đây đó là một hiện tượng nhân tạo về phương pháp luận.", answer: "Es dürfte sich hierbei um ein methodisches Artefakt handeln." },
          { prompt: "Trong một số trường hợp, có thể tưởng tượng rằng các biến số ngữ cảnh giải thích mối quan hệ.", answer: "Unter Umständen wäre denkbar, dass kontextuelle Variablen den Zusammenhang erklären." },
          { prompt: "Các kết quả có xu hướng ủng hộ giả thuyết, song không chứng minh nó bắt buộc.", answer: "Die Befunde sprechen tendenziell für die Hypothese, ohne sie indes zwingend zu belegen." },
          { prompt: "Một đánh giá chung cuộc chỉ có thể dựa trên các nghiên cứu lặp lại.", answer: "Eine endgültige Bewertung ließe sich erst auf der Grundlage repliktativer Studien vornehmen." },
        ],
      },
    ],
  },
