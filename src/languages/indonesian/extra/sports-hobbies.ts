...
export const lessons: IndonesianLesson[] = [
  ...
  // ──────────────────────────────────────────────────────────────────────
  {
    ...
    vocabulary: [
      { word: "sepak bola", en: "football, soccer", vi: "bóng đá", pos: "noun", pronunciation_vi: "SE-pak BO-la", pronunciation_en: "SUH-pak BOH-lah" },
      { word: "tim", en: "team", vi: "đội", pos: "noun", pronunciation_vi: "TIM", pronunciation_en: "TEEM" },
      { word: "gol", en: "goal", vi: "bàn thắng", pos: "noun", pronunciation_vi: "GOL", pronunciation_en: "GOL" },
      { word: "menang", en: "to win", vi: "thắng", pos: "verb", pronunciation_vi: "me-NANG", pronunciation_en: "muh-NANG" },
      { word: "kalah", en: "to lose", vi: "thua", pos: "verb", pronunciation_vi: "KA-lah", pronunciation_en: "KAH-lah" },
      { word: "suporter", en: "supporter, fan", vi: "cổ động viên", pos: "noun", pronunciation_vi: "su-POR-ter", pronunciation_en: "soo-POR-ter" },
      { word: "wasit", en: "referee", vi: "trọng tài", pos: "noun", pronunciation_vi: "WA-sit", pronunciation_en: "WAH-sit" },
    ],
    dialogue: [
      { speaker: "Andi", text: "Tadi malam nonton bola? Persija menang 2-0!", vi: "Tối qua xem bóng không? Persija thắng 2-0!", en: "Did you watch the match last night? Persija won 2-0!" },
      { speaker: "Bayu", text: "Iya! Gol terakhir keren banget. Dukung tim apa?", vi: "Có! Bàn cuối hay cực. Cậu cổ vũ đội nào?", en: "Yes! The last goal was awesome. Which team do you support?" },
      { speaker: "Andi", text: "Aku Bobotoh, pendukung Persib. Hehe, rival nih.", vi: "Tớ là Bobotoh, fan Persib. Hehe, kình địch đấy.", en: "I'm Bobotoh, a Persib fan. Heh, rivals." },
    ],
    exercises: [
      {
        type: "matching",
  ...
  // ──────────────────────────────────────────────────────────────────────
  {
    ...
    vocabulary: [
      ...
      { word: "olahraga", en: "sport, exercise", vi: "thể thao", pos: "noun", pronunciation_vi: "o-lah-RA-ga", pronunciation_en: "oh-lah-RAH-gah" },
      { word: "pemain", en: "player", vi: "vận động viên", pos: "noun", pronunciation_vi: "pe-MA-in", pronunciation_en: "puh-MAH-in" },
      { word: "tunggal", en: "singles", vi: "đánh đơn", pos: "noun", pronunciation_vi: "TUNG-gal", pronunciation_en: "TOONG-gal" },
      { word: "ganda", en: "doubles", vi: "đánh đôi", pos: "noun", pronunciation_vi: "GAN-da", pronunciation_en: "GAN-dah" },
      { word: "medali", en: "medal", vi: "huy chương", pos: "noun", pronunciation_vi: "me-DA-li", pronunciation_en: "muh-DAH-lee" },
      { word: "juara", en: "champion", vi: "nhà vô địch", pos: "noun", pronunciation_vi: "ju-A-ra", pronunciation_en: "joo-AH-rah" },
    ],
    exercises: [
      {
        type: "fill_blank",
  ...
  // ──────────────────────────────────────────────────────────────────────
  {
    ...
    vocabulary: [
      { word: "kebugaran", en: "fitness", vi: "thể hình, sự khỏe khoắn", pos: "noun", pronunciation_vi: "ke-bu-GA-ran", pronunciation_en: "kuh-boo-GAH-ran" },
      { word: "otot", en: "muscle", vi: "cơ bắp", pos: "noun", pronunciation_vi: "O-tot", pronunciation_en: "OH-tot" },
      { word: "berat badan", en: "body weight", vi: "cân nặng", pos: "noun phrase", pronunciation_vi: "be-RAT BA-dan", pronunciation_en: "buh-RAT BAH-dan" },
      { word: "pemanasan", en: "warm-up", vi: "khởi động", pos: "noun", pronunciation_vi: "pe-ma-NA-san", pronunciation_en: "puh-mah-NAH-san" },
      { word: "angkat beban", en: "weightlifting", vi: "nâng tạ", pos: "noun phrase", pronunciation_vi: "ANG-kat be-BAN", pronunciation_en: "ANG-kat buh-BAN" },
      { word: "lari pagi", en: "morning run", vi: "chạy bộ buổi sáng", pos: "noun phrase", pronunciation_vi: "LA-ri PA-gi", pronunciation_en: "LAH-ree PAH-gee" },
    ],
    dialogue: [
      { speaker: "Rian", text: "Lo rutin nge-gym ya? Badan jadi kekar.", vi: "Cậu tập gym đều à? Người vạm vỡ ghê.", en: "You hit the gym regularly, huh? You're getting buff." },
      { speaker: "Dewi", text: "Iya, tiga kali seminggu. Mau ikut? Pemanasan dulu lho.", vi: "Ừ, ba lần một tuần. Đi cùng không? Phải khởi động trước nha.", en: "Yeah, three times a week. Wanna join? Warm up first, though." },
    ],
    exercises: [
      {
        type: "translation",
  ...
  // ──────────────────────────────────────────────────────────────────────
  {
    ...
    vocabulary: [
      { word: "gunung", en: "mountain", vi: "núi", pos: "noun", pronunciation_vi: "GU-nung", pronunciation_en: "GOO-noong" },
      { word: "mendaki", en: "to hike, climb", vi: "leo núi", pos: "verb", pronunciation_vi: "men-DA-ki", pronunciation_en: "men-DAH-kee" },
      { word: "puncak", en: "summit, peak", vi: "đỉnh", pos: "noun", pronunciation_vi: "PUN-cak", pronunciation_en: "POON-chak" },
      { word: "pendaki", en: "hiker", vi: "người leo núi", pos: "noun", pronunciation_vi: "pen-DA-ki", pronunciation_en: "pen-DAH-kee" },
      { word: "tenda", en: "tent", vi: "lều", pos: "noun", pronunciation_vi: "TEN-da", pronunciation_en: "TEN-dah" },
      { word: "matahari terbit", en: "sunrise", vi: "mặt trời mọc", pos: "noun phrase", pronunciation_vi: "ma-ta-HA-ri ter-BIT", pronunciation_en: "mah-tah-HAH-ree ter-BIT" },
    ],
    exercises: [
      {
        type: "fill_blank",
  ...
  // ──────────────────────────────────────────────────────────────────────
  {
    ...
    vocabulary: [
      { word: "menyelam", en: "to dive", vi: "lặn biển", pos: "verb", pronunciation_vi: "me-nye-LAM", pronunciation_en: "muh-nyuh-LAM" },
      { word: "berselancar", en: "to surf", vi: "lướt sóng", pos: "verb", pronunciation_vi: "ber-se-lan-CAR", pronunciation_en: "ber-suh-lan-CHAR" },
      { word: "ombak", en: "wave", vi: "sóng biển", pos: "noun", pronunciation_vi: "OM-bak", pronunciation_en: "OM-bak" },
      { word: "arus", en: "current", vi: "dòng chảy", pos: "noun", pronunciation_vi: "A-rus", pronunciation_en: "AH-roos" },
    ...
    dialogue: [
      { speaker: "Turis", text: "Saya mau belajar berselancar. Susah nggak?", vi: "Tôi muốn học lướt sóng. Có khó không?", en: "I want to learn to surf. Is it hard?" },
      { speaker: "Instruktur", text: "Nggak kok, tapi hati-hati dengan arus. Ombak hari ini sedang.", vi: "Không đâu, nhưng cẩn thận dòng chảy. Sóng hôm nay vừa phải.", en: "Not really, but watch the current. Today's waves are moderate." },
      { speaker: "Turis", text: "Oke, saya ikut kelas pemula dulu.", vi: "Ok, tôi học lớp người mới trước.", en: "Okay, I'll take the beginner class first." },
    ],
    exercises: [
      {
        type: "matching",
