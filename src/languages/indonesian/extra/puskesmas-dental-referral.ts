...
export const lessons: IndonesianLesson[] = [
  {
    ...
    vocabulary: [
      { word: "puskesmas", en: "community health center", vi: "trung tâm y tế cộng đồng", pos: "noun", pronunciation_vi: "pus-KES-mas", pronunciation_en: "poos-KES-mas" },
      { word: "rujukan dokter gigi", en: "dental referral", vi: "giấy chuyển tuyến nha khoa", pos: "noun phrase", pronunciation_vi: "ru-JU-kan DOK-ter GI-gi", pronunciation_en: "roo-JOO-kan DOK-ter GEE-gee" },
      { word: "daftar antrean", en: "register for a queue number", vi: "đăng ký lấy số", pos: "verb phrase", pronunciation_vi: "DAF-tar an-TRE-an", pronunciation_en: "DAF-tar an-TRE-an" },
      { word: "BPJS", en: "Indonesian national health insurance", vi: "bảo hiểm y tế BPJS", pos: "noun", pronunciation_vi: "be-pe-je-ES", pronunciation_en: "bay-pay-jay-ESS" },
      { word: "obat sementara", en: "temporary medicine", vi: "thuốc tạm thời", pos: "noun phrase", pronunciation_vi: "O-bat se-men-TA-ra", pronunciation_en: "OH-bat seh-men-TAH-rah" },
  ...
  },
  {
    ...
    vocabulary: [
      { word: "surat kontrol", en: "follow-up letter / appointment slip", vi: "giấy hẹn tái khám", pos: "noun phrase", pronunciation_vi: "SU-rat kon-TROL", pronunciation_en: "SOO-rat kon-TROL" },
      { word: "biaya tambahan", en: "additional cost", vi: "chi phí phát sinh", pos: "noun phrase", pronunciation_vi: "BI-a-ya tam-BA-han", pronunciation_en: "BEE-ah-yah tahm-BAH-han" },
      { word: "hasil rontgen", en: "X-ray result", vi: "kết quả X-quang", pos: "noun phrase", pronunciation_vi: "ha-SIL RON-tgen", pronunciation_en: "HA-sil RON-gen" },
      { word: "tindakan", en: "procedure / medical action", vi: "thủ thuật / can thiệp y tế", pos: "noun", pronunciation_vi: "tin-DA-kan", pronunciation_en: "tin-DAH-kan" },
      { word: "daftar antrean", en: "register for a queue number", vi: "đăng ký lấy số", pos: "verb phrase", pronunciation_vi: "DAF-tar an-TRE-an", pronunciation_en: "DAF-tar an-TRE-an" },
      { word: "kontrol ulang", en: "follow-up checkup", vi: "tái khám", pos: "noun phrase", pronunciation_vi: "kon-TROL u-LANG", pronunciation_en: "kon-TROL oo-LANG" },
      { word: "biaya", en: "cost / fee", vi: "chi phí", pos: "noun", pronunciation_vi: "BI-a-ya", pronunciation_en: "BEE-ah-yah" },
    ],
