...
export const lessons: VietnameseLesson[] = [
    ...
    ], cultural_note: "Mental health hotlines in Vietnam are still rare but growing; the vocabulary of tâm lý (psychology) and cảm xúc (emotions) is relatively new in Vietnamese daily speech.", tip: "The phrase em sợ em đang đi xuống — I am afraid I am going downhill — is a culturally intuitive way to describe depression that many Vietnamese listeners understand without clinical vocabulary." },
  {
    ...
    ], cultural_note: "In Vietnamese, ba yên tâm is the core phrase of final conversations — it signals to the dying person that the children are settled and they can stop worrying. Use it once, clearly, without elaboration.", tip: "Use ba yên tâm — rest easy — it is the most important phrase a dying Vietnamese parent needs to hear: that their work is done and their children are safe." },
  {
