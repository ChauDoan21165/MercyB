// FILE: RoomGridVIP3.tsx
// PATH: src/_legacy_next_pages/RoomGridVIP3.tsx
// NOTE: Surgical fix — VIP9 must pass VIP3 even if canAccessTier() is strict
...
// Special VIP3 rooms with custom styling (kept, even if unused here)
...
const RoomGridVIP3 = () => {
  ...
  // ✅ FIX: VIP9 must be allowed into VIP3 page (VIP9 >= VIP3)
  // This also covers the case where canAccessTier('vip3') is strict equality.
  const hasAccess = canAccessTier("vip3" as TierKey) || canAccessTier("vip9" as TierKey) || isHighAdmin;
  ...
  // VIP3 shows ALL VIP3 rooms, excluding VIP3II specialization rooms
        ...
        <div className="container mx-auto px-4 py-6 max-w-7xl">
          ...
          <div className="mb-8 space-y-4">
            ...
            <div className="text-center space-y-2">
              <p className="text-lg text-gray-700">You are in VIP 3 area / Bạn đang ở khu vực VIP 3</p>
              <p className="text-sm text-gray-600">{loading ? "Loading..." : `${vip3Rooms.length} exclusive rooms`}</p>
            </div>
          </div>
            ...
            >
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    <h3 className="text-2xl font-bold text-gray-800 mb-1">VIP3 II – {VIP3II_DESCRIPTION.en}</h3>
                    <p className="text-gray-600">Sexuality • Finance • Schizophrenia • Emotional Well-being</p>
                    <p className="text-sm text-gray-500 mt-1">{VIP3II_DESCRIPTION.vi}</p>
                  </div>
                </div>
          ...
          <RoomLoadShell isLoading={loading} error={error ? "Failed to load VIP3 rooms" : null} onRetry={handleRefreshRooms}>
            {vip3Rooms.length > 0 ? (
              <TierRoomColumns rooms={vip3Rooms} tier="vip3" excludeVip3II={true} />
            ) : (
