...
//
// Coverage gap motivating this file: the rule shipped with eval-
// fixture coverage (vi-gram-142, vi-gram-143) but zero dedicated unit
// tests. Per the enumeration in PR #1187, this is the second of three
// Round-6 detectors that need dedicated unit coverage; subject_gender
// (rule 66) remains in-flight on #1169.
//
// Mirrors the helper shape of l1-co-transfer.test.ts (PR #1187) and
// l1-rules-round5.test.ts. Tests only — does not import or modify
// the detector module beyond the public detectL1Error entry point.
