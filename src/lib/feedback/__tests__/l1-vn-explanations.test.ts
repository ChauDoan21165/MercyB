...
describe("L1_VN_EXPLANATIONS — coverage", () => {
  ...
  it("has exactly 81 entries — flags drift if the count changes unexpectedly", () => {
    ...
    // 76 → 81: Group D added 5 VN interference detectors.
    expect(listCoveredVnTags()).toHaveLength(81);
  });
});
