...
// Step 11 - Vietlish corpus WAVE 15 (A5 Content Factory) schema guard.
...
describe("step11 vietlish corpus wave 15 (A5 review queue)", () => {
  it("is the A5 wave-15 review queue, not wired into the engine", () => {
    expect(data.corpus).toBe("step11-vietlish-corpus-d4-wave15");
