...
import { speakTopics } from "@/lib/tutor/speakTopics/nailTechnicianEnglish";

describe("nail technician English speak topics", () => {
  it("ships D4 professional metadata and warm conversation direction", () => {
    ...
    // 3 original D4 topics + 2 salvaged from stale MR !602 (canonical-file port).
