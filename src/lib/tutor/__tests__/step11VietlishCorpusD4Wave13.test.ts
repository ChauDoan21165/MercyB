...
// Step 11 - Vietlish corpus WAVE 13 (A2 Content Factory) schema guard.
...
describe("step11 vietlish corpus wave 13 (A2 review queue)", () => {
  it("is the A2 wave-13 review queue, not wired into the engine", () => {
    expect(data.corpus).toBe("step11-vietlish-corpus-d4-wave13");
