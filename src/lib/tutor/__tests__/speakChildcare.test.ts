...
import { speakTopics } from "@/lib/tutor/speakTopics/childcare";

const VIETNAMESE_DIACRITIC_PATTERN = /[À-ỹ]/u;

describe("Childcare / daycare parent English speak topics", () => {
  it("ships the authored set and auto-registers in the speak topic library", () => {
    ...
    // 7 childcare/daycare customer-parent topics. Keep in sync if topics are added.
