...
// Step 11 - Vietlish corpus WAVE 17 (A4 Content Factory) schema guard.
...
describe("step11 vietlish corpus wave 17 (A4 review queue)", () => {
  it("is the A4 wave-17 review queue, not wired into the engine", () => {
    expect(data.corpus).toBe("step11-vietlish-corpus-d4-wave17");
  ...
  it("does not collide with live corpus or waves 1-16, case-insensitively", () => {
