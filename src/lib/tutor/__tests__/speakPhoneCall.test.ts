...
import { phoneCallSpeakTopics } from "@/lib/tutor/speakTopics/phoneCall";

// Covers the D4-deepened phone-call theme (10 topics).
...
describe("phone-call speak topics — D4 metadata", () => {
  ...
  it("topic ids are unique within the theme", () => {
    const ids = phoneCallSpeakTopics.map((t) => t.id);
