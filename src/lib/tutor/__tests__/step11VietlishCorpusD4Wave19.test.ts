...
// Step 11 - Vietlish corpus WAVE 19 (A4 Content Factory) schema guard.
...
describe("step11 vietlish corpus wave 19 (A4 review queue)", () => {
  it("is the A4 wave-19 review queue, not wired into the engine", () => {
    expect(data.corpus).toBe("step11-vietlish-corpus-d4-wave19");
  ...
  it("does not collide with live corpus or waves 1-18, case-insensitively", () => {
