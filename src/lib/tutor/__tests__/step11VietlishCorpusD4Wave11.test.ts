...
// Step 11 - Vietlish corpus WAVE 11 (F1 Content Factory) schema guard.
...
describe("step11 vietlish corpus wave 11 (F1 review queue)", () => {
  it("is the F1 wave-11 review queue, not wired into the engine", () => {
    expect(data.corpus).toBe("step11-vietlish-corpus-d4-wave11");
  ...
  it("does not collide with live corpus or waves 1-10, case-insensitively", () => {
