...
export const speakTopics = [
  ...
  {
    id: "topic-hospitality-giving-directions",
    labelEn: "Giving Directions In A Hotel",
    labelVi: "Chỉ đường trong khách sạn",
    category: "hospitality-worker-english",
    scenarioDescription: "The learner needs hotel direction English for elevators, lobby, breakfast area, parking, conference rooms, pool, gym, and nearby places.",
    aiRoleDefinition: "Act as a hotel guest asking for directions inside the hotel or to a nearby place.",
    conversationDirections: [
      "Ask where the guest wants to go.",
      "Give simple step-by-step directions.",
      "Use floor, elevator, hallway, and lobby vocabulary.",
      "Mention signs or landmarks.",
      "Check if the guest needs a map or repeat.",
      "Close with an offer of more help.",
    ],
    warmthPatterns: [
      "Use short direction chunks instead of one long sentence.",
      "Point to visible landmarks like the elevator or front desk.",
      "Offer to repeat directions without making the guest feel lost.",
    ],
    seedInputs: ["Take the elevator to the second floor, then turn left."],
    detectionPatterns: [
      /\b(?:hotel directions|where is the elevator|breakfast room|conference room|parking garage|lobby|second floor|turn left)\b/i,
    ],
    l1InterferenceNotes: [
      {
        id: "hospitality-directions-take-elevator",
        label: "Take the elevator",
        note: "English says 'take the elevator to the second floor.' Vietnamese learners may say 'go elevator' or 'use elevator'; 'take' is the common direction verb.",
      },
      {
        id: "hospitality-directions-floor",
        label: "Floor numbers",
        note: "Hotels use 'first floor,' 'second floor,' and 'lower level.' Clear floor words prevent guests from wandering.",
      },
      {
        id: "hospitality-directions-down-the-hall",
        label: "Down the hall",
        note: "'Down the hall' means farther along the hallway, not necessarily downstairs. It is useful hotel direction vocabulary.",
      },
    ],
    followUps: [
  ...
  {
    id: "topic-hospitality-hotel-check-in",
    labelEn: "Hotel Check-In",
    labelVi: "Làm thủ tục nhận phòng khách sạn",
    category: "hospitality-worker-english",
    scenarioDescription: "The learner needs front-desk English for greeting guests, finding a reservation, asking for ID and card, explaining deposits, and giving key information.",
    aiRoleDefinition: "Act as a hotel guest checking in, asking normal questions about the room, deposit, breakfast, and Wi-Fi.",
    conversationDirections: [
      "Greet the guest warmly and ask for the reservation name.",
      "Ask for ID and payment card politely.",
      "Explain deposit or incidental hold in simple terms.",
      "Give room number, elevator, Wi-Fi, and breakfast details.",
      "Answer one guest question without sounding rushed.",
      "Close with a welcoming line.",
    ],
    warmthPatterns: [
      "Use front-desk phrases like 'Welcome in' and 'I'll get you checked in.'",
      "Make document requests sound routine, not suspicious.",
      "End with practical warmth: 'Let us know if you need anything.'",
    ],
    seedInputs: ["Welcome in. May I have the name on the reservation, please?"],
    detectionPatterns: [
      /\b(?:hotel check-in|check in|reservation name|front desk|photo id|incidentals|room key|breakfast is included)\b/i,
    ],
    l1InterferenceNotes: [
      {
        id: "hospitality-checkin-reservation-name",
        label: "Name on the reservation",
        note: "A natural front-desk question is 'May I have the name on the reservation?' Vietnamese learners may say 'name of booking'; guests will understand, but this phrase sounds professional.",
      },
      {
        id: "hospitality-checkin-incidental-hold",
        label: "Incidental hold",
        note: "Hotels often say 'incidental hold' for a temporary card hold. Staff can explain it as 'It is not a charge unless there are extra costs.'",
      },
      {
        id: "hospitality-checkin-may-i",
        label: "May I have",
        note: "'Give me your ID' can sound too direct in English service work. 'May I have your ID, please?' is clear and warm.",
      },
    ],
    followUps: [
      { id: "hospitality-checkin-greeting", question: "How would you greet the guest?", salienceQuestion: "How would you welcome the {slot}?" },
      { id: "hospitality-checkin-name", question: "How would you ask for the reservation name?", salienceQuestion: "What name is on the {slot}?" },
      { id: "hospitality-checkin-id", question: "How would you ask for ID and card?", salienceQuestion: "What document is needed for the {slot}?" },
      { id: "hospitality-checkin-deposit", question: "How would you explain the deposit or hold?", salienceQuestion: "How would you explain the {slot}?" },
      { id: "hospitality-checkin-info", question: "What room and hotel details would you give?", salienceQuestion: "What details help with the {slot}?" },
      { id: "hospitality-checkin-close", question: "How would you close warmly?", salienceQuestion: "How would you welcome the guest to the {slot}?" },
    ],
  },
  {
    id: "topic-hospitality-check-out",
    labelEn: "Hotel Check-Out",
    labelVi: "Làm thủ tục trả phòng khách sạn",
    category: "hospitality-worker-english",
    scenarioDescription: "The learner needs check-out English for confirming room number, reviewing charges, asking about the stay, handling receipts, and explaining late check-out.",
    aiRoleDefinition: "Act as a hotel guest checking out who may ask about charges, receipt, luggage storage, or late check-out.",
    conversationDirections: [
      "Ask for the room number or guest name.",
      "Confirm whether the guest is checking out now.",
      "Review charges in plain language.",
      "Offer printed or emailed receipt.",
      "Ask briefly how the stay was.",
      "Explain luggage storage or late check-out if needed.",
    ],
    warmthPatterns: [
      "Keep money explanations calm and exact.",
      "Use a short care question: 'How was your stay?'",
      "Offer options instead of making the guest ask twice.",
    ],
    seedInputs: ["Are you ready to check out? I can email the receipt to you."],
    detectionPatterns: [
      /\b(?:hotel check-out|check out|checking out|room charges|receipt|late checkout|luggage storage|how was your stay)\b/i,
    ],
    l1InterferenceNotes: [
      {
        id: "hospitality-checkout-receipt",
        label: "Email the receipt",
        note: "A smooth check-out phrase is 'I can email the receipt to you.' Vietnamese learners may say 'send bill for you'; 'receipt' is the hotel word guests expect.",
      },
      {
        id: "hospitality-checkout-charges",
        label: "Charges, not money list",
        note: "Hotels usually say 'charges' for items on the account. 'Let me review the charges with you' sounds professional and calm.",
      },
      {
        id: "hospitality-checkout-late",
        label: "Late check-out",
        note: "'Late check-out' is the standard phrase for staying past the usual check-out time. It is not the same as being late by accident.",
      },
    ],
    followUps: [
