...
// - vip3_ii / vip3-ii / vip3 ii MUST map to "vip3"
 ...
 * - Special-case: VIP3 II => vip3 (vip3 / vip3_ii / vip3-ii / vip3 ii).
...
export function tierFromRoomId(id: string): TierId {
  ...
  // Accept: vip3, vip3_ii, vip3-ii, vip3 ii, _vip3_ii, -vip3-ii, etc.
  ...
  if (
    ...
    return "vip3" as TierId; // legacy vip3 -> vip3
  }
  ...
  for (let n = 9; n >= 1; n--) {
    // boundary match prevents vip3 being treated as vip3
