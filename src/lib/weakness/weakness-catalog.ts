...
export type WeaknessTag =
  ...
  | "vi_l1_if_will"
  // Indonesian-native C2 fanout (2026-06-23)
...
export const WEAKNESS_CATALOG: Record<WeaknessTag, WeaknessEntry> = {
  ...
  vi_l1_possessive_gender: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia menggunakan **-nya** untuk semua gender. Bahasa Inggris membedakan **his** untuk laki-laki dan **her** untuk perempuan, berdasarkan gender **pemiliknya**, bukan bendanya.",
    },
  ...
  vi_l1_preposition_transfer: {
    ...
    longDescription: {
      ...
      id: "Preposisi bahasa Indonesia tidak bisa diterjemahkan satu-satu ke bahasa Inggris. Kata seperti **on**, **in**, **at** punya pola yang harus dihafal, bukan diterjemahkan: **on Monday**, **in June**, **at 7pm**.",
    },
  ...
  vi_l1_can_no_infinitive: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia **bisa** / **harus** langsung diikuti kata kerja tanpa kata tambahan. Modal bahasa Inggris seperti **can** dan **must** diikuti kata kerja biasa — tidak ada **to** di antaranya.",
    },
  ...
  vi_l1_possessive_s_missing: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia meletakkan **milik** atau langsung menyambung kata benda — **buku Lan**. Bahasa Inggris menempelkan **'s** ke pemilik: **Lan's book**.",
    },
  ...
  vi_l1_comparative_double: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia nyaman menumpuk **lebih** dengan penguat tambahan. Bahasa Inggris memilih SATU bentuk pembanding: **better** ATAU **more + kata sifat** — tidak pernah **more better**.",
    },
  ...
  vi_l1_adjective_order: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia juga menempatkan kata sifat **setelah** kata benda: **baju merah**. Bahasa Inggris membaliknya — kata sifat datang **sebelum** kata benda: **a red shirt**.",
    },
  ...
  vi_l1_very_much_placement: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia **sangat** diletakkan sebelum kata kerja atau kata sifat: **sangat suka**. Dalam bahasa Inggris, **very** dipakai dengan kata sifat (**very happy**) tapi dengan kata kerja kamu bilang **… very much** di akhir.",
    },
  ...
  vi_l1_make_vs_do: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia **buat** / **lakukan** kadang bisa dibedakan tapi sering tertukar. Bahasa Inggris membagi: **make** untuk menciptakan (kue, keputusan, kesalahan); **do** untuk aktivitas (PR, cuci piring, pekerjaan).",
    },
  ...
  vi_l1_tag_question: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia menggunakan satu tag yang sama — **kan?**. Bahasa Inggris membalik kata bantu dan polaritasnya: kalimat positif pakai tag negatif — **You are Vietnamese, aren't you?**",
    },
  ...
  vi_l1_past_perfect_missing: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia menumpuk kata waktu seperti **sebelumnya** untuk menunjukkan satu kejadian lampau terjadi sebelum yang lain. Bahasa Inggris menggunakan **had + past participle** — **I had already eaten when she called**.",
    },
  ...
  vi_l1_reported_speech: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia sering mengutip langsung atau menggunakan **bilang** tanpa mengubah kata kerja. Bahasa Inggris mundurkan tenses-nya: **She said she was tired** — bukan **she is tired**.",
    },
  ...
  vi_l1_since_vs_for: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia **sejak** / **selama** bisa tertukar. Bahasa Inggris membedakan: **since** menunjuk ke satu momen (**since 2020**); **for** mengukur durasi (**for three years**).",
    },
  ...
  vi_l1_countable_much: {
    ...
    shortLabel: {
      ...
      id: "**Much** hanya untuk tak terhitung",
    },
    longDescription: {
      ...
      id: "Bahasa Indonesia **banyak** bisa dipakai untuk semua. Bahasa Inggris **much** hanya untuk kata benda tak terhitung: **much water**, **much time** — tapi BUKAN **much friends** (pakai **many** atau **a lot of**).",
    },
  ...
  vi_l1_some_vs_any: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia menggunakan **beberapa** atau **sedikit** di semua jenis kalimat. Bahasa Inggris berganti: **some** di kalimat positif (**I have some questions**); **any** di kalimat negatif dan sebagian besar pertanyaan (**Do you have any questions?**).",
    },
  ...
  vi_l1_reflexive_missing: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia menggunakan **sendiri** setelah kata kerja atau subjek. Bahasa Inggris butuh kata ganti refleksif setelah kata kerja: **I taught myself**, **she hurt herself**.",
    },
  ...
  vi_l1_conditional_mix: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia **kalau… maka…** tidak mengubah kata kerja. Bahasa Inggris mencocokkan pola: nyata = **If + present, will + V**; tidak nyata = **If + past, would + V** — jangan campur past dengan **will**.",
    },
  ...
  vi_l1_to_infinitive_after_ing: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia menggunakan kata kerja biasa di mana-mana. Bahasa Inggris memilih: kata kerja seperti **enjoy**, **finish**, **avoid** diikuti **-ing** (**I enjoy swimming**); kata kerja seperti **want**, **plan**, **decide** diikuti **to + verb** (**I want to swim**).",
    },
  ...
  vi_l1_passive_missing_be: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia menandai pasif dengan **di-** pada kata kerja. Bahasa Inggris butuh bentuk **be** ditambah past participle: **The letter was written**, bukan **The letter written**.",
    },
  ...
  vi_l1_used_to_vs_be_used_to: {
    ...
    longDescription: {
      ...
      id: "Dua pola bahasa Inggris ini mirip tapi beda arti. **Used to + V** = kebiasaan lama yang sudah berhenti (**I used to smoke**). **Be used to + V-ing** = sekarang sudah terbiasa dengan (**I'm used to waking up early**).",
    },
  ...
  vi_l1_another_vs_other: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia **lain** mencakup semua kasus. Bahasa Inggris membagi: **another** + kata benda tunggal (**another book**); **other** + jamak (**other books**); **others** berdiri sendiri (**I have others**).",
    },
  ...
  vi_l1_look_vs_see_vs_watch: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia **lihat** / **tonton** mencakup ketiganya. Bahasa Inggris memisahkan: **look (at)** = mengarahkan mata dengan sengaja; **see** = menyadari, melihat; **watch** = mengikuti sesuatu yang bergerak (film, pertandingan).",
    },
  ...
  vi_l1_by_vs_with: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia **dengan** / **pakai** mencakup alat dan transportasi. Bahasa Inggris membedakan: **by** untuk metode atau transportasi (**by bus**, **by email**); **with** untuk alat yang dipegang (**cut with a knife**, **write with a pen**).",
    },
  ...
  vi_l1_time_expressions: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia bisa menumpuk **yang lalu**, **sebelumnya** dengan bebas. Bahasa Inggris memilih: **ago** setelah durasi dari sekarang (**two days ago**); **last** sebelum periode (**last Monday**); **in** untuk jarak waktu ke depan (**in two hours**).",
    },
  ...
  vi_l1_present_perfect_vs_past: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia tidak memiliki aspek perfektif. Saat kalimat menyebut waktu lampau spesifik (**kemarin**, **minggu lalu**, **tahun 1990**), bahasa Inggris wajib pakai simple past — bukan **have/has + past participle**.",
    },
  ...
  vi_l1_subjunctive_were: {
    ...
    longDescription: {
      ...
      id: "Setelah **if** atau **wish**, bahasa Inggris menggunakan **were** untuk semua subjek di situasi tidak nyata/khayalan — *If I **were** you*, bukan *If I **was** you*.",
    },
  ...
  vi_l1_embedded_question_order: {
    ...
    longDescription: {
      ...
      id: "Pertanyaan di dalam kalimat lain menghilangkan urutan kata tanya — subjek datang sebelum kata bantu. **I don't know what this is**, bukan **what is this**.",
    },
  ...
  vi_l1_do_support_3ps: {
    ...
    longDescription: {
      ...
      vi: "[VI TBD — CC4]",
      id: "Dalam present simple, kata bantu untuk **he**, **she**, atau **it** adalah **doesn't** — bukan **don't**. **-s** menempel di kata bantu, jadi kata kerja utama tetap bentuk dasar.",
    },
  ...
  vi_l1_modal_perfect: {
    ...
    longDescription: {
      ...
      id: "Untuk membicarakan kemungkinan, penyesalan, atau kesimpulan masa lalu dengan modal, bahasa Inggris menggunakan **modal + have + past participle** — bukan kata kerja past tense langsung. **I should have done it**, bukan **I should did it**.",
    },
  ...
  vi_l1_phrasal_pronoun_order: {
    ...
    shortLabel: {
      ...
      vi: "[VI TBD — CC4]",
      id: "Kata ganti memisah phrasal verb",
    },
    longDescription: {
  ...
  vi_l1_comparative_more_long: {
    ...
    shortLabel: {
      ...
      vi: "[VI TBD — CC4]",
      ja: "長い形容詞の比較級は **more**",
      id: "**more** untuk kata sifat panjang",
    },
    longDescription: {
  ...
  vi_l1_many_with_uncount: {
    ...
    shortLabel: {
      ...
      vi: "[VI TBD — CC4]",
      id: "**much** untuk tak terhitung",
    },
    longDescription: {
      en: "Uncountable nouns (**water**, **money**, **advice**, **music**) take **much**, not **many**. *Many* is only for countable plurals.",
      vi: "[VI TBD — CC4]",
      id: "Kata benda tak terhitung (**water**, **money**, **advice**, **music**) menggunakan **much**, bukan **many**. *Many* hanya untuk jamak yang bisa dihitung.",
    },
  ...
  vi_l1_geographical_article: {
    ...
    longDescription: {
      ...
      vi: "[VI TBD — CC4]",
      id: "Sebagian besar nama negara tidak pakai artikel (**Indonesia**, **Japan**), tapi beberapa yang terdengar jamak memakainya (**the Philippines**, **the USA**, **the Netherlands**).",
    },
  ...
  vi_l1_double_negative: {
    ...
    longDescription: {
      ...
      vi: "[VI TBD — CC4]",
      id: "Bahasa Inggris standar hanya menggunakan **satu** kata negatif per klausa. *I don't have **no** money* → *I don't have **any** money*. Bahasa Indonesia terbiasa dengan negatif ganda seperti **nggak punya apa-apa**.",
    },
  ...
  vi_l1_adverb_before_subject: {
    ...
    longDescription: {
      ...
      vi: "[VI TBD — CC4]",
      id: "Kata keterangan frekuensi seperti **always**, **usually**, **sometimes** diletakkan **setelah** subjek dalam bahasa Inggris — *I **always** go*, bukan *Always I go*. Bahasa Indonesia terbiasa meletakkannya di awal: **Biasanya saya pergi**.",
    },
  ...
  vi_l1_make_let_bare: {
    ...
    shortLabel: {
      ...
      vi: "[VI TBD — CC4]",
      id: "**make / let** + kata kerja biasa",
    },
    longDescription: {
      en: "After **make**, **let**, and causative **have**, English uses the **bare verb** — no **to**. *She made me **cry***, not *She made me to cry*.",
      vi: "[VI TBD — CC4]",
      id: "Setelah **make**, **let**, dan kausatif **have**, bahasa Inggris menggunakan **kata kerja biasa** — tanpa **to**. *She made me **cry***, bukan *She made me to cry*.",
    },
  ...
  vi_l1_too_vs_very: {
    ...
    longDescription: {
      ...
      id: "**Too** menyiratkan kelebihan (ada masalah). Untuk penguat sederhana, gunakan **very**. *I am **very** happy to see you*, bukan *too happy*. Mirip bedanya **terlalu** vs **sangat** dalam bahasa Indonesia.",
    },
  ...
  vi_l1_a_vs_an_vowel: {
    ...
    longDescription: {
      ...
      vi: "[VI TBD — CC4]",
      id: "Gunakan **a** sebelum **bunyi** konsonan dan **an** sebelum **bunyi** vokal. Dengarkan, jangan hanya lihat hurufnya — *an **h**our* (h tidak berbunyi), *a **u**niversity* (diawali bunyi y).",
    },
  ...
  vi_l1_one_of_the_singular: {
    ...
    longDescription: {
      ...
      vi: "[VI TBD — CC4]",
      id: "Setelah **one of the / my / her / his / their**, kata bendanya jamak — meskipun seluruh frasa merujuk ke satu benda. **One of the students**, bukan **one of the student**.",
    },
  ...
  vi_l1_been_vs_gone: {
    ...
    longDescription: {
      ...
      vi: "[VI TBD — CC4]",
      id: "**gone to** = pergi ke sana dan masih di sana. **been to** = pernah mengunjungi dan sudah kembali. Kalimat dengan **times**, **before**, atau **ever** hampir selalu butuh **been to**.",
    },
  ...
  vi_l1_tag_polarity: {
    ...
    longDescription: {
      ...
      id: "Tag question membalik polaritas: kalimat positif → tag negatif, kalimat negatif → tag positif. *You like it, **don't you**?* — bukan *do you?* Bahasa Indonesia hanya pakai **kan?** untuk semuanya.",
    },
  ...
  vi_l1_no_article_generic: {
    ...
    longDescription: {
      ...
      vi: "[VI TBD — CC4]",
      id: "Kata benda abstrak dan umum (**life**, **love**, **music**, **nature**) biasanya tidak pakai artikel saat bermakna konsep secara umum. **Life is hard**, bukan **The life is hard**.",
    },
  ...
  vi_l1_if_will: {
    ...
    shortLabel: {
      ...
      vi: "[VI TBD — CC4]",
      id: "Tidak ada **will** di klausa **if**",
    },
    longDescription: {
      en: "In a first-conditional **if**-clause, English uses the present simple — **will** only appears in the main clause.",
      vi: "[VI TBD — CC4]",
      id: "Di klausa **if** conditional tipe pertama, bahasa Inggris menggunakan present simple — **will** hanya muncul di klausa utama.",
    },
  ...
  // ────────────────────────────────────────────────────────────────────────
  // Indonesian-native C2 fanout (2026-06-23)
  // High-proficiency transfer patterns for Indonesian-native English
  // learners at CEFR C2. All entries include full en + vi + id content.
  // No linked rooms — these are advanced topics without dedicated rooms.
  // ────────────────────────────────────────────────────────────────────────
