...
export const WEAKNESS_CATALOG: Record<WeaknessTag, WeaknessEntry> = {
  ...
  vi_l1_reported_speech: {
    ...
    shortLabel: {
      ...
      vi: "Câu tường thuật",
      ja: "間接話法（時制の一致）",
      id: "Reported speech (kalimat tidak langsung)",
    },
    longDescription: {
      ...
      id: "Bahasa Indonesia sering mengutip langsung atau menggunakan **bilang** tanpa mengubah kata kerja. Bahasa Inggris mundurkan tenses satu tingkat: **She said she was tired** — bukan **she is tired**.",
    },
  ...
  vi_l1_conditional_mix: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia **kalau… maka…** tidak mengubah kata kerja. Bahasa Inggris mencocokkan pola: nyata = **If + present, will + V**; khayalan = **If + past, would + V** — jangan campur lampau dengan **will**.",
    },
  ...
  vi_l1_passive_missing_be: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia menandai pasif dengan awalan **di-** sebelum kata kerja. Bahasa Inggris perlu bentuk **be** ditambah past participle: **The letter was written**, bukan **The letter written**.",
    },
  ...
  vi_l1_relative_pronoun: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia menggabungkan klausa dengan **yang** untuk semuanya. Bahasa Inggris memilih kata ganti relatif berdasarkan apa yang dirujuk: **who** untuk orang, **which** untuk benda, **that** untuk keduanya dalam klausa penentu.",
    },
  ...
  vi_l1_present_perfect_vs_past: {
    ...
    longDescription: {
      ...
      id: "Bahasa Indonesia tidak memiliki aspek perfektif. Saat kalimat menyebut waktu lampau spesifik (**yesterday**, **last week**, **in 1990**), bahasa Inggris mewajibkan past simple — bukan **have/has + past participle**.",
    },
