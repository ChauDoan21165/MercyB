...
export const WEAKNESS_CATALOG: Record<WeaknessTag, WeaknessEntry> = {
  ...
  vi_l1_conditional_mix: {
    ...
    shortLabel: {
      ...
      vi: "Câu **If** — hợp thì",
      ja: "**if**節の時制の組み合わせ",
      id: "Klausa **If** — cocokkan tenses-nya",
    },
    longDescription: {
      ...
      id: "Bahasa Indonesia **kalau… maka…** tidak mengubah kata kerja. Bahasa Inggris mencocokkan pola: nyata = **If + present, will + V**; tidak nyata = **If + past, would + V** — jangan pernah mencampur past dengan **will**.",
    },
  ...
  vi_l1_subjunctive_were: {
    ...
    longDescription: {
      ...
      id: "Setelah **if** atau **wish**, bahasa Inggris menggunakan **were** untuk semua subjek dalam situasi tidak nyata / imajiner — *If I **were** you*, bukan *If I **was** you*. Bahasa Indonesia tidak membedakan bentuk kata kerja untuk kondisi nyata vs tidak nyata: **Kalau saya jadi kamu** menggunakan kata kerja yang sama.",
    },
  ...
  vi_l1_embedded_question_order: {
    ...
    longDescription: {
      ...
      id: "Pertanyaan di dalam kalimat lain menghilangkan urutan kata tanya — subjek muncul sebelum auxiliary. **I don't know what this is** (Saya tidak tahu apa ini) — bukan **I don't know what is this**. Bahasa Indonesia tidak membedakan urutan: **Saya tidak tahu apa ini** menggunakan urutan yang sama baik sebagai pertanyaan langsung maupun tidak langsung.",
    },
  ...
  vi_l1_modal_perfect: {
    ...
    longDescription: {
      ...
      id: "Untuk membicarakan kemungkinan, penyesalan, atau kesimpulan masa lalu dengan modal, bahasa Inggris menggunakan **modal + have + past participle** — bukan kata kerja lampau langsung setelah modal. **I should have done it** (Seharusnya saya melakukannya) — bukan **I should did it**.",
    },
  ...
  vi_l1_negative_inversion: {
    ...
    longDescription: {
      ...
      vi: "[VI TBD — CC4]",
      id: "Saat kata keterangan negatif seperti **never**, **seldom**, **rarely**, atau **not only** membuka kalimat, subjek dan auxiliary bertukar posisi — *Never **have I** seen…* (Belum pernah saya melihat…). Bahasa Indonesia tidak memerlukan inversi: **Belum pernah saya melihat** tetap dengan urutan normal.",
    },
  ...
  vi_l1_tag_polarity: {
    ...
    longDescription: {
      ...
      id: "Tag question membalik polaritas: pernyataan positif → tag negatif, pernyataan negatif → tag positif. *You like it, **don't you**?* — bukan *do you?* Bahasa Indonesia menggunakan **kan?** yang sama untuk semua jenis kalimat, tanpa membalik polaritas.",
    },
