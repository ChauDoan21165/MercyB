...
export const ALL_ROOMS: RoomInfo[] = [
  ...
  { id: "business-negotiation", nameVi: "Đàm phán kinh doanh", nameEn: "Business Negotiation Compass", hasData: true, tier: "free", dataFile: "business_negotiation_compass.json" },
  ...
  { id: "crypto", nameVi: "Tiền mã hóa", nameEn: "Crypto", hasData: true, tier: "free", dataFile: "crypto.json" },
  { id: "depression", nameVi: "Trầm cảm", nameEn: "Depression", hasData: true, tier: "free", dataFile: "depression.json" },
  ...
  { id: "finance", nameVi: "Tài chính", nameEn: "Finance", hasData: true, tier: "free", dataFile: "finance.json" },
  ...
  { id: "soul-mate", nameVi: "Tìm bạn đời", nameEn: "How to Find Your Soul Mate", hasData: true, tier: "free", dataFile: "how_to_find_your_soul_mate.json" },
  { id: "husband-dealing", nameVi: "Ứng Xử Với Chồng", nameEn: "Husband Dealing", hasData: true, tier: "free", dataFile: "husband_dealing.json" },
  ...
  { id: "mental-health", nameVi: "Sức khỏe tâm thần", nameEn: "Mental Health", hasData: true, tier: "free", dataFile: "mental_health.json" },
  ...
  { id: "sexuality", nameVi: "Tình dục & Thân mật", nameEn: "Sexuality and Intimacy", hasData: true, tier: "free", dataFile: "sexuality_and_intimacy.json" },
  ...
  { id: "trauma", nameVi: "Chấn thương tâm lý", nameEn: "Trauma", hasData: true, tier: "free", dataFile: "trauma.json" },
  ...
  { id: "wife-dealing", nameVi: "Ứng Xử Với Vợ", nameEn: "Wife Dealing", hasData: true, tier: "free", dataFile: "wife_dealing.json" },
