...
export const ALL_ROOMS: RoomInfo[] = [
  ...
  { id: "career-burnout", nameVi: "Kiệt sức nghề nghiệp", nameEn: "Career Burnout", hasData: true, tier: "vip1", dataFile: "career_burnout.json" },
  ...
  { id: "confidence-building", nameVi: "Xây dựng sự tự tin", nameEn: "Confidence Building", hasData: true, tier: "vip1", dataFile: "confidence_building.json" },
  ...
  { id: "diabetes-advanced", nameVi: "Tiểu đường nâng cao", nameEn: "Diabetes Advanced", hasData: true, tier: "vip1", dataFile: "diabetes_advanced.json" },
  ...
  { id: "financial-planning", nameVi: "Kế hoạch tài chính", nameEn: "Financial Planning 101", hasData: true, tier: "vip2", dataFile: "financial_planning_101.json" },
  ...
  { id: "habit-building", nameVi: "Xây dựng thói quen", nameEn: "Habit Building", hasData: true, tier: "vip1", dataFile: "habit_building.json" },
  ...
  { id: "relationship-conflicts", nameVi: "Xung đột trong mối quan hệ", nameEn: "Relationship Conflicts", hasData: true, tier: "vip2", dataFile: "relationship_conflicts.json" },
  ...
  { id: "anxiety-toolkit", nameVi: "Bộ công cụ lo âu", nameEn: "Anxiety Toolkit", hasData: true, tier: "vip1", dataFile: "anxiety_toolkit.json" },
