...
export const ALL_ROOMS: RoomInfo[] = [
  ...
  { id: "injury-bleeding", nameVi: "Chấn thương & Chảy máu", nameEn: "Injury and Bleeding", hasData: true, tier: "vip3", dataFile: "injury_and_bleeding.json" },
  ...
  { id: "mental-health", nameVi: "Sức khỏe tâm thần", nameEn: "Mental Health", hasData: true, tier: "vip3", dataFile: "mental_health.json" },
  ...
  { id: "teen", nameVi: "Tuổi thiếu niên", nameEn: "Teen", hasData: true, tier: "vip3", dataFile: "teen.json" },
  { id: "toddler", nameVi: "Trẻ mới biết đi", nameEn: "Toddler", hasData: true, tier: "vip3", dataFile: "toddler.json" },
  { id: "train-brain", nameVi: "Luyện trí nhớ", nameEn: "Train Brain Memory", hasData: true, tier: "free", dataFile: "train_brain_memory.json" },
  { id: "trauma", nameVi: "Chấn thương tâm lý", nameEn: "Trauma", hasData: true, tier: "vip3", dataFile: "trauma.json" },
