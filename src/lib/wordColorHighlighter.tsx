...
export function highlightTextByRules(text: string, isVietnamese: boolean = false): React.ReactElement[] {
...
export function highlightPairedText(enText: string, viText: string): {
  enHighlighted: React.ReactElement[];
  viHighlighted: React.ReactElement[];
} {
  return {
