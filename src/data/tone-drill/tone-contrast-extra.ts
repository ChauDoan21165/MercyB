...
const ABOVE_FLOOR: PendingTonePair[] = [
  ...
  },
  {
    id: "di-ngang-vs-sac",
    family: "a1-vocab",
    contrast: [t("di", "ngang"), t("dí", "sắc")],
    glossEn: "level vs rising — ‘to move / shift’ vs ‘to press / poke at’",
    glossVi: "ngang vs sắc — ‘di’ (di chuyển nhẹ) vs ‘dí’ (dí vào)",
    needsChauValidation: true,
    trustFloor: "above",
    listenCompareOnly: false,
    validationNote: "Xác nhận ‘di’/‘dí’ là từ A1/A2 quen thuộc; chỉnh nghĩa nếu cần.",
  },
  {
...
const BELOW_FLOOR: PendingTonePair[] = [
  ...
  },
  {
    id: "ba-huyen-vs-hoi",
    family: "a1-vocab",
    contrast: [t("bà", "huyền"), t("bả", "hỏi")],
    glossEn: "falling vs dipping-rising — ‘grandmother’ vs ‘poison / her (colloq.)’ (LISTEN-COMPARE; hỏi abstained)",
    glossVi: "huyền vs hỏi — ‘bà’ (bà nội/ngoại) vs ‘bả’ (thuốc bả / bà ấy) — chỉ NGHE-SO-SÁNH",
    needsChauValidation: true,
    trustFloor: "below",
    listenCompareOnly: true,
    validationNote:
      "hỏi dưới ngưỡng — chỉ nghe-so-sánh. Xác nhận nghĩa ‘bả’; KHÔNG đưa vào chấm điểm.",
  },
  {
