...
- governance-final-blocked-safe-retention-summary: blocked_safe_missing_external_evidence; External archival governance evidence is absent in this A42 worktree; A42 preserves denial lineage and documents the gap.
- governance-future-validation-dependency-sequencing: blocked_safe_missing_external_evidence; External archival governance evidence is absent in this A42 worktree; A42 preserves denial lineage and documents the gap.
- governance-evidence-gap-master-ledger: blocked_safe_missing_external_evidence; External archival governance evidence is absent in this A42 worktree; A42 preserves denial lineage and documents the gap.
- governance-long-term-denial-preservation-board: blocked_safe_missing_external_evidence; External archival governance evidence is absent in this A42 worktree; A42 preserves denial lineage and documents the gap.
