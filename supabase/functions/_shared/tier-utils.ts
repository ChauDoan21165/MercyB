...
export type TierId = 
  | "free"
  | "vip1" | "vip2" | "vip3" | "vip3" | "vip4" | "vip5"
  | "vip6" | "vip7" | "vip8" | "vip9"
  | "kids_1" | "kids_2" | "kids_3";

export const VIP_TIER_IDS: TierId[] = [
  "vip1", "vip2", "vip3", "vip3", "vip4", "vip5", "vip6", "vip7", "vip8", "vip9"
];
...
export const TIER_ORDER: TierId[] = [
  'free', 'vip1', 'vip2', 'vip3', 'vip3', 'vip4', 'vip5',
  'vip6', 'vip7', 'vip8', 'vip9',
  'kids_1', 'kids_2', 'kids_3',
];
 ...
 * FREE = 0, VIP1 = 1, VIP2 = 2, VIP3 = 3, VIP3 = 3 (same level as VIP3), 
...
export const TIER_LEVEL: Record<TierId, number> = {
  ...
  vip2: 2,
  vip3: 3,
  vip3: 3, // Same level as VIP3 - it's a specialization, not a higher tier
  vip4: 4,
  vip5: 5,
  vip6: 6,
  vip7: 7,
...
export function normalizeTier(tier: string | null | undefined): TierId {
  ...
  // VIP tiers (check higher numbers first, and VIP3 before VIP3)
  ...
  // VIP3 must come before VIP3 to avoid false match
  if (s.includes("vip3") || s.includes("vip3 ii") || s === "vip3" || s.includes("vip3 ii / vip3 ii")) return "vip3";
