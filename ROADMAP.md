...
>   (§15), Duolingo competition strategy (§12), and the compressed
...
- **No streaks / XP / badges as primary loops.** Streaks may exist
  ...
  Per `STRATEGY.md` §12 — *"Duolingo tells you to keep a streak.
...
- **For Definition of Done across pairs**, see `STRATEGY.md` §15
...
### §15 (STRATEGY.md) relationship to the layer model

§15 (Vietnamese flagship Definition of Done, in STRATEGY.md)
