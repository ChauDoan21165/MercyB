...
export default defineConfig({
  ...
  webServer: {
    command: "VITE_SUPABASE_URL=https://placeholder.invalid.supabase.co VITE_SUPABASE_ANON_KEY=placeholder-anon-key-not-real VITE_PLACEMENT_TEST_ENABLED=true VITE_PLACEMENT_V3_UI_ENABLED=true VITE_E2E_AUTH_BYPASS=true npm run dev:frontend",
