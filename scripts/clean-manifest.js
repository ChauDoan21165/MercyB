...
`;
  ...
  console.log(`\n✅ Generated manifest with ${Object.keys(manifest).length} rooms`);
  console.log(`✅ Generated dataImports with ${Object.keys(dataImports).length} rooms`);
}

try {
  generateCleanManifest();
  console.log('\n✨ Clean manifest generation complete!');
} catch (err) {
