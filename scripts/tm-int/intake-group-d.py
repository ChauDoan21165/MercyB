...
SOURCE_QUEUE = "tm-design-group-d-20260716"


def main() -> int:
    repo = Path(__file__).resolve().parents[2]
    candidates_path = repo / "evidence" / SOURCE_QUEUE / "group_d_candidates.json"
    output_path = repo / "evidence" / SOURCE_QUEUE / "registry-intake.json"
