...
SOURCE_QUEUE = "tm-design-group-b2-cf-20260715"


def main() -> int:
    repo = Path(__file__).resolve().parents[2]
    evidence_dir = repo / "evidence" / "tm-design-group-b2-cf-20260715"
    candidates_path = evidence_dir / "group_b2_cf_candidates.json"
    output_path = evidence_dir / "registry-intake.json"
