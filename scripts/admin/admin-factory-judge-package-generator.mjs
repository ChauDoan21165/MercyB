...
const LINK_DIR = path.join("/Users/admin/autorun/reports", "admin-factory-traceability-links");
const OUT = path.join("/Users/admin/autorun/reports", "admin-factory-judge-packages");
