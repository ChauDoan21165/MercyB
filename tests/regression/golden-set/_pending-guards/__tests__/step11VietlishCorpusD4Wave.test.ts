...
// Guard for the A4/D4 Step 11 review-queue corpus. These 200 entries are
// staged candidates that MUST match the live VietlishCorpusEntry schema
...
const CORPUS_PATH = resolve(
  HERE,
  "..",
  "step11-vietlish-corpus-d4-wave-200.json",
);
